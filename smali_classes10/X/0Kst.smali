...
.method public constructor <init>(LX/0Ks2;)V
    ...
    iput-object p1, p0, LX/0Kst;->LL:LX/0Ks2;
...
.method public final onBufferedPercent(Ljava/lang/String;JI)V
    ...
    iget-object v5, p0, LX/0Kst;->LL:LX/0Ks2;

    iget-boolean v0, v5, LX/0Ks2;->LLJJLIIIJLLLLLLLZ:Z
    ...
    :cond_0
    iget-object v7, v5, LX/0Ks2;->LLJILLL:LX/0Kxa;

    if-eqz v7, :cond_3

    iget-boolean v0, v5, LX/0Ks2;->LLJL:Z

    if-nez v0, :cond_3

    iget-object v0, v5, LX/0Ks2;->LLJJIJIIJIL:Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    ...
    iget-wide v1, v0, Lcom/ss/android/ugc/aweme/search/performance/core/config/UserHorizontalVideoPreloadConfig;->prepareBufferingPercent:J

    cmp-long v0, v3, v1

    if-ltz v0, :cond_3

    iget-object v1, v5, LX/0Ks2;->LLILZ:LX/0K3Y;

    if-eqz v1, :cond_2

    invoke-virtual {v7}, LX/0Kxa;->getMScrollStateObserver()LX/0KoK;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v0}, LX/0KoK;->LIZIZ()I
    ...
    invoke-virtual {v1, v6, v0}, LX/0K3Y;->LIZ(Ljava/lang/Integer;Lkotlin/jvm/functions/Function1;)V

    :cond_2
    const/4 v0, 0x1

    iput-boolean v0, v5, LX/0Ks2;->LLJL:Z
...
.method public final onRenderFirstFrame(Ljava/lang/String;LX/0gKu;)V
    ...
    iget-object v1, p0, LX/0Kst;->LL:LX/0Ks2;

    iget-boolean v0, v1, LX/0Ks2;->LLJJL:Z
    ...
    :cond_0
    iget-object v0, v1, LX/0Ks2;->LLJILLL:LX/0Kxa;

    if-eqz v0, :cond_1

    iget-object v5, v1, LX/0Ks2;->LLILZ:LX/0K3Y;
    ...
    iget-wide v2, v0, Lcom/ss/android/ugc/aweme/search/performance/core/config/UserHorizontalVideoPreloadConfig;->preloadDelayTime:J
    ...
    invoke-virtual {v5, v4, v1}, LX/0K3Y;->LIZ(Ljava/lang/Integer;Lkotlin/jvm/functions/Function1;)V
