...
.method public constructor <init>(LX/0L5P;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/0LVh;->LIZ:LX/0L5P;

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/0LVh;->LJFF:Z

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, LX/0LVh;->LJI:Ljava/util/Map;

    return-void
.end method

.method public static LIZ(LX/0LVh;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 3

    iget-object v2, p0, LX/0LVh;->LJI:Ljava/util/Map;
    ...
    iget-object v0, p0, LX/0LVh;->LIZ:LX/0L5P;
...
# virtual methods
.method public final LIZIZ(LX/0LAm;ZIILjava/lang/String;J)V
    .locals 8
    ...
    iput-wide v0, p0, LX/0LVh;->LIZJ:J
    ...
    iget-wide v0, p0, LX/0LVh;->LIZJ:J
    ...
    iget-object v1, p0, LX/0LVh;->LJI:Ljava/util/Map;
    ...
    iget-wide v0, p0, LX/0LVh;->LIZIZ:J
    ...
    iget-object v0, p0, LX/0LVh;->LJI:Ljava/util/Map;
    ...
    :cond_2
    iget-boolean v0, p0, LX/0LVh;->LJFF:Z
    ...
    :cond_4
    invoke-static {v3, v2}, LX/01bJ;->LIZ(Ljava/lang/String;Ljava/util/Map;)V

    if-nez p2, :cond_5

    iput-boolean v4, p0, LX/0LVh;->LJFF:Z

    :cond_5
    return-void

    :cond_6
    const-string v3, "rd_ec_request_result"

    goto/16 :goto_0
.end method

.method public final LIZLLL(LX/0LAm;)V
    .locals 11
    ...
    invoke-static {v10}, Lcom/ss/android/ugc/aweme/ecommerce/dependency/apm/ApmDependencyService;->createIApmDependencyServicebyMonsterPlugin(Z)Lcom/ss/android/ugc/aweme/ecommerce/saas/core/dependency/apm/IApmDependencyService;
...
.method public final LJ(Ljava/lang/String;)V
    ...
    const-string v0, "native_request_count"
    ...
    iget-boolean v0, p0, LX/0LVh;->LIZLLL:Z
