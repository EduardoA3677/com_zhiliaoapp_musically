...
.method public final onCollectMusicEvent(LX/0UiC;)V
    ...
    :try_start_0
    iget-object v4, p0, LX/0KRQ;->LLILIL:LX/0KRA;

    if-eqz v4, :cond_0

    const-string v3, "changeMusicCollectState"
    ...
    invoke-virtual {v4, v3, v2}, LX/0KRA;->LIZ(Ljava/lang/String;Lorg/json/JSONObject;)V
    :try_end_0
