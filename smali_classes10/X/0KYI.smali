...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0KYI;->LIZ:Ljava/util/Map;
...
.method public static LIZ(Ljava/lang/String;)V
    ...
    sget-object v7, LX/0KYI;->LIZ:Ljava/util/Map;
    ...
    check-cast v0, LX/04mf;

    if-eqz v0, :cond_4

    iget-wide v1, v0, LX/04mf;->LIZIZ:J
    ...
    iget-object v0, v0, LX/04mf;->LIZ:Ljava/lang/Long;
    ...
    const-string v0, "BotVisible endCardShow before= "
    ...
    iget-wide v3, v0, LX/04mf;->LIZIZ:J
    ...
    invoke-direct {v0, v1, v2, v5}, LX/04mf;-><init>(JLjava/lang/Long;)V
...
.method public static LIZIZ(ILjava/lang/String;Ljava/util/Map;Z)V
    .locals 4

    if-eqz p3, :cond_0

    :try_start_0
    const-string v3, "tikbot_quick_interaction_show"

    goto :goto_0

    :cond_0
    const-string v3, "tikbot_quick_interaction_click"
    ...
    invoke-static {v2, p2}, LX/0KYI;->LJIIIZ(Lorg/json/JSONObject;Ljava/util/Map;)V
...
.method public static LIZJ(JLjava/util/Map;Ljava/lang/String;Ljava/lang/Integer;)V
    .locals 2
...
.method public static LIZLLL(Ljava/lang/Integer;Ljava/lang/String;Ljava/util/Map;)V
    .locals 3
...
.method public static LJ(ILjava/util/Map;)V
    ...
    :try_start_0
    invoke-static {v3, p1}, LX/0KYI;->LJIIIZ(Lorg/json/JSONObject;Ljava/util/Map;)V
...
.method public static LJFF(Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
...
.method public static LJI(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
...
.method public static LJII(Ljava/lang/String;)V
    ...
    const-string v0, "BotVisible startCardShow before= "

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-object v5, LX/0KYI;->LIZ:Ljava/util/Map;
    ...
    iget-wide v0, v0, LX/04mf;->LIZIZ:J

    new-instance v2, LX/04mf;

    invoke-direct {v2, v0, v1, v3}, LX/04mf;-><init>(JLjava/lang/Long;)V
    ...
    invoke-direct {v2, v1, v0}, LX/04mf;-><init>(Ljava/lang/Long;I)V
...
.method public static LJIIIIZZ(Ljava/lang/String;Ljava/util/Map;Z)V
    .locals 5
    ...
    :cond_0
    invoke-static {p0}, LX/0KYI;->LIZ(Ljava/lang/String;)V

    sget-object v0, LX/0KYI;->LIZ:Ljava/util/Map;
    ...
    check-cast p0, LX/04mf;

    if-eqz p0, :cond_2

    iget-wide v3, p0, LX/04mf;->LIZIZ:J
    ...
    iget-wide v0, p0, LX/04mf;->LIZIZ:J
