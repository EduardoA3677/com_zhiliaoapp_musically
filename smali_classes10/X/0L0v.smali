...
.field public final synthetic LLILIL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/ui/ISearchVideoHolderAbility;


# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/ui/ISearchVideoHolderAbility;Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;)V
    .locals 0

    iput-object p2, p0, LX/0L0v;->LL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;

    iput-object p1, p0, LX/0L0v;->LLILIL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/ui/ISearchVideoHolderAbility;
...
.method public final LIZ()V
    ...
    iget-object v0, p0, LX/0L0v;->LL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;

    iget-object v0, v0, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;->LL:LX/05ta;

    invoke-interface {v0}, LX/05ta;->getValue()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;

    if-eqz v1, :cond_1

    iget-object v0, v1, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;->LLILIL:Lkotlin/jvm/functions/Function0;
    ...
    :cond_0
    iget-object v1, v1, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;->LL:LX/0PRY;
    ...
    :cond_1
    iget-object v1, p0, LX/0L0v;->LL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;
...
.method public final LJZ()V
    ...
    iget-boolean v0, v1, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;->LLILIL:Z
    ...
    iget-object v0, v1, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;->LL:LX/05ta;

    invoke-interface {v0}, LX/05ta;->getValue()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;

    if-eqz v5, :cond_2

    new-instance v4, Lkotlin/jvm/internal/AwS367S0200000_9;

    iget-object v2, p0, LX/0L0v;->LLILIL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/ui/ISearchVideoHolderAbility;

    iget-object v1, p0, LX/0L0v;->LL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;

    const/16 v0, 0x4a

    invoke-direct {v4, v2, v1, v0}, Lkotlin/jvm/internal/AwS367S0200000_9;-><init>(Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/ui/ISearchVideoHolderAbility;Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;I)V
    ...
    invoke-direct {v2, v1, v0}, Lkotlin/jvm/internal/AwS485S0100000_9;-><init>(Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingVM;I)V

    iget-object v0, v5, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;->LLILIL:Lkotlin/jvm/functions/Function0;
    ...
    :cond_0
    iput-object v2, v5, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;->LLILIL:Lkotlin/jvm/functions/Function0;

    iget-object v0, v5, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;->LL:LX/0PRY;
    ...
    invoke-direct {v1, v4, v3}, LX/02dt;-><init>(Lkotlin/jvm/functions/Function0;LX/02wT;)V
    ...
    iput-object v0, v5, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/videwmodel/SearchLoadingDeferJobVM;->LL:LX/0PRY;
...
.method public final LLJJ()V
    ...
    invoke-virtual {p0}, LX/0L0v;->LIZ()V
...
.method public final U4(I)V
    ...
    iget-object v0, p0, LX/0L0v;->LLILIL:Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/ui/ISearchVideoHolderAbility;

    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/search/pages/result/common/searchvideo/core/ui/ISearchVideoHolderAbility;->getPlayerManager()LX/0NhM;
