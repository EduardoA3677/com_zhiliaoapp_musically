.class public final synthetic LX/0LGL;
...
.method public synthetic constructor <init>(LX/0LGI;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicBoolean;LX/0LJW;LX/0LJd;)V
    ...
    iput-object p1, p0, LX/0LGL;->LIZ:LX/0LGI;

    iput-object p2, p0, LX/0LGL;->LIZIZ:Ljava/lang/String;

    iput-object p3, p0, LX/0LGL;->LIZJ:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p4, p0, LX/0LGL;->LIZLLL:LX/0LJW;

    iput-object p5, p0, LX/0LGL;->LJ:LX/0LJd;
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    iget-object v2, p0, LX/0LGL;->LIZ:LX/0LGI;

    iget-object v7, p0, LX/0LGL;->LIZIZ:Ljava/lang/String;

    iget-object v3, p0, LX/0LGL;->LIZJ:Ljava/util/concurrent/atomic/AtomicBoolean;

    iget-object v1, p0, LX/0LGL;->LIZLLL:LX/0LJW;

    iget-object v6, p0, LX/0LGL;->LJ:LX/0LJd;
    ...
    invoke-virtual {v6, p1}, LX/0LJd;->LIZIZ(Lcom/ss/android/ugc/aweme/search/pages/sug/core/model/SearchSugResponse;)Z
    ...
    iget-wide v4, v3, LX/0LEC;->LIZLLL:J

    iget-wide v0, v3, LX/0LEC;->LIZJ:J

    sub-long/2addr v4, v0

    iput-wide v4, v2, LX/0LGI;->LLJJJ:J
