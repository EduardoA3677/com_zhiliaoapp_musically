...
.method public constructor <init>(Lkotlin/jvm/internal/AwS333S0200000_9;)V
    ...
    iput-object p1, p0, LX/0KXS;->LIZ:Lkotlin/jvm/functions/Function1;
...
.method public final LIZ()LX/0mPL;
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/search/arch/v2/services/SearchComponentService;->LJIIIIZZ()LX/0mSo;
...
.method public final getConfig()LX/00pD;
    ...
    iget-object v2, p0, LX/0KXS;->LIZ:Lkotlin/jvm/functions/Function1;

    const/4 v1, 0x0

    if-eqz v2, :cond_0

    new-instance v0, LX/0KXT;

    invoke-direct {v0, v1}, LX/0KXT;-><init>(Ljava/lang/Object;)V
