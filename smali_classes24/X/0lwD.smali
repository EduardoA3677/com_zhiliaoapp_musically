...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/ss/ugc/effectplatform/model/net/ProviderEffectListResponse;",
        ">;"
    }
.end annotation
...
.method public constructor <init>(LX/0m1N;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, v0, LX/0lwD;->LIZ:LX/0m1N;

    iput-object p3, v0, LX/0lwD;->LIZIZ:Ljava/lang/String;

    iput p4, v0, LX/0lwD;->LIZJ:I

    iput p5, v0, LX/0lwD;->LIZLLL:I

    iput-object p6, v0, LX/0lwD;->LJ:Ljava/lang/String;

    iput-object p7, v0, LX/0lwD;->LJFF:Ljava/lang/String;

    iput-object p8, v0, LX/0lwD;->LJI:Ljava/util/Map;
...
.method public final buildRequest()LX/0m16;
    ...
    iget-object v1, p0, LX/0lwD;->LIZIZ:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0lwD;->LJ:Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, LX/0lwD;->LJFF:Ljava/lang/String;
    ...
    :cond_2
    iget-object v0, p0, LX/0lwD;->LJI:Ljava/util/Map;
    ...
    const-string v0, "/stickers/recommend"
...
.method public final onSuccess(JJJLX/0lwO;)V
    ...
    check-cast p7, Lcom/ss/ugc/effectplatform/model/net/ProviderEffectListResponse;

    invoke-virtual {p7}, Lcom/ss/ugc/effectplatform/model/net/ProviderEffectListResponse;->getData()Lcom/ss/android/ugc/effectmanager/effect/model/ProviderEffectModel;

    move-result-object v2

    if-eqz v2, :cond_4

    invoke-virtual {v2}, Lcom/ss/android/ugc/effectmanager/effect/model/ProviderEffectModel;->getSticker_list()Ljava/util/List;
    ...
    invoke-virtual {v3, v0}, Lcom/ss/android/ugc/effectmanager/effect/model/ProviderEffect;->setPath(Ljava/lang/String;)V

    invoke-virtual {v3}, Lcom/ss/android/ugc/effectmanager/effect/model/ProviderEffect;->getMedia_source()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v2}, Lcom/ss/android/ugc/effectmanager/effect/model/ProviderEffectModel;->getMedia_source()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v3, v0}, Lcom/ss/android/ugc/effectmanager/effect/model/ProviderEffect;->setMedia_source(Ljava/lang/String;)V
    ...
    const-string v1, "FetchProviderEffectTask"
...
.method public final parseResponse(LX/0m07;Ljava/lang/String;)LX/0lwO;
    ...
    const-class v0, Lcom/ss/ugc/effectplatform/model/net/ProviderEffectListResponse;
