...
.method public constructor <init>(Landroid/widget/FrameLayout;Landroid/widget/FrameLayout;LX/0mjC;)V
    ...
    iput-object p1, p0, LX/0mih;->LLJJIJIIJIL:Landroid/widget/FrameLayout;

    iput-object p2, p0, LX/0mih;->LLJJIJIL:Landroid/widget/FrameLayout;

    iput-object p3, p0, LX/0mih;->LLJJJ:LX/0mjC;

    new-instance v1, Lkotlin/jvm/internal/AwS499S0100000_23;

    const/16 v0, 0x129

    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS499S0100000_23;-><init>(LX/0mih;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, LX/0mih;->LLJJJIL:LX/05ta;
...
.method public final LLLIZZ()LX/0miz;
    ...
    iget-object v0, p0, LX/0mih;->LLJJJJ:LX/0mkY;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, LX/0mih;->LLJJJJ:LX/0mkY;
    ...
    iget-object v1, v0, LX/0mid;->LIZ:Lcom/ss/android/ugc/aweme/tools/sticker/core/text/model/TextStickerModel;

    iget-object v0, p0, LX/0mih;->LLJJJ:LX/0mjC;
    ...
    :cond_0
    iget-object v3, p0, LX/0mih;->LLJJJJ:LX/0mkY;

    if-eqz v3, :cond_1

    iget-object v0, p0, LX/0mih;->LLJJIJIIJIL:Landroid/widget/FrameLayout;

    invoke-virtual {v0}, Landroid/view/View;->getLeft()I

    move-result v2

    iget-object v0, p0, LX/0mih;->LLJJIJIL:Landroid/widget/FrameLayout;
    ...
    const-string v0, "ImageModeTextEditPanelScene"
    ...
    iput-object v1, p0, LX/0mih;->LLJJJJJIL:LX/0scK;
    ...
    iput-object v0, p0, LX/0mih;->LLJJJJLIIL:LX/0mhZ;
    ...
    iput-object v0, p0, LX/0mih;->LLJJL:Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;

    invoke-virtual {p0}, LX/0mt5;->LLLIIIL()LX/0mt0;

    move-result-object v3

    sget-object v2, LX/0mie;->LL:LX/0mie;
    ...
    iget-object v1, p0, LX/0mih;->LLJJJJ:LX/0mkY;

    if-eqz v1, :cond_2

    new-instance v0, LX/0mim;

    invoke-direct {v0, p0}, LX/0mim;-><init>(LX/0mih;)V
    ...
    iget-object v0, p0, LX/0mih;->LLJJJJLIIL:LX/0mhZ;
    ...
    :cond_3
    iget-object v1, p0, LX/0mih;->LLJJJJLIIL:LX/0mhZ;

    if-eqz v1, :cond_4

    new-instance v0, LX/0mik;

    invoke-direct {v0, p0}, LX/0mik;-><init>(LX/0mih;)V
    ...
    iget-object v0, p0, LX/0mih;->LLJJJJJIL:LX/0scK;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/ViewGroup;
    ...
    iget-object v2, v0, LX/0mid;->LIZIZ:LX/0mUE;

    iget-object v1, p0, LX/0mih;->LLJJIJIL:Landroid/widget/FrameLayout;
    ...
    iput-object v4, p0, LX/0mih;->LLJJJJ:LX/0mkY;
