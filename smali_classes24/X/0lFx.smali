...
.field public final synthetic LLILL:Lcom/ss/android/ugc/gamora/recorder/sticker/x;
...
# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/sticker/types/ar/uploadpicsticker/UploadPicStickerMessageModule;Ljava/util/List;Lcom/ss/android/ugc/gamora/recorder/sticker/x;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0lFx;->LL:Lcom/ss/android/ugc/aweme/sticker/types/ar/uploadpicsticker/UploadPicStickerMessageModule;

    iput-object p2, p0, LX/0lFx;->LLILIL:Ljava/util/List;

    iput-object p3, p0, LX/0lFx;->LLILL:Lcom/ss/android/ugc/gamora/recorder/sticker/x;

    iput-object p4, p0, LX/0lFx;->LLILLIZIL:Ljava/util/List;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LX/0lFx;->LL:Lcom/ss/android/ugc/aweme/sticker/types/ar/uploadpicsticker/UploadPicStickerMessageModule;
    ...
    iget-object v0, p0, LX/0lFx;->LLILLIZIL:Ljava/util/List;
    ...
    iget-object v0, p0, LX/0lFx;->LLILL:Lcom/ss/android/ugc/gamora/recorder/sticker/x;

    invoke-virtual {v0}, LX/0lHL;->U4()LX/0lv4;

    move-result-object v3

    iget-object v1, p0, LX/0lFx;->LLILLIZIL:Ljava/util/List;
    ...
    iget-object v0, p0, LX/0lFx;->LLILIL:Ljava/util/List;
    ...
    iget-object v1, p0, LX/0lFx;->LLILIL:Ljava/util/List;
    ...
    :cond_3
    invoke-interface {v3, v2, p2}, LX/0lv4;->xl(Ljava/util/List;Ljava/util/List;)I
    ...
    :cond_4
    iget-object v3, p0, LX/0lFx;->LLILL:Lcom/ss/android/ugc/gamora/recorder/sticker/x;
    ...
    :cond_5
    iput-object v2, v3, Lcom/ss/android/ugc/gamora/recorder/sticker/x;->LLZZLLIL:Ljava/util/List;

    iget-object v2, p0, LX/0lFx;->LLILL:Lcom/ss/android/ugc/gamora/recorder/sticker/x;

    iget-object v1, p0, LX/0lFx;->LLILIL:Ljava/util/List;

    const/4 v0, 0x0

    new-array v0, v0, [LX/0Gfx;
    ...
    :cond_6
    iget-object v1, p0, LX/0lFx;->LLILL:Lcom/ss/android/ugc/gamora/recorder/sticker/x;
