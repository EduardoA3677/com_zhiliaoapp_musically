...
.field public final LJIILJJIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;Landroid/widget/FrameLayout;LX/0mnc;Landroidx/lifecycle/LifecycleOwner;LX/0mUE;)V
    .locals 8

    invoke-virtual {p2}, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->getBaseStickerModel()Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;
    ...
    iput-object v3, v2, LX/0mpv;->LJIILIIL:Landroid/content/Context;

    iput-object p2, v2, LX/0mpv;->LJIILJJIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;

    iput-object v5, v2, LX/0mpv;->LJIILL:LX/0mnc;

    iput-object v6, v2, LX/0mpv;->LJIILLIIL:Landroidx/lifecycle/LifecycleOwner;

    iput-object v7, v2, LX/0mpv;->LJIIZILJ:LX/0mUE;

    new-instance v1, Lkotlin/jvm/internal/AwS499S0100000_23;

    const/16 v0, 0x37a

    invoke-direct {v1, v2, v0}, Lkotlin/jvm/internal/AwS499S0100000_23;-><init>(LX/0mpv;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, v2, LX/0mpv;->LJIJ:LX/05ta;
    ...
    iput-object v0, v2, LX/0mpv;->LJIJI:LX/05ta;
...
.method public final LJIIJJI(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;)V
    ...
    check-cast v3, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;

    if-eqz v3, :cond_0

    invoke-virtual {p0}, LX/0mpv;->LJJJZ()LX/0mt1;
    ...
    invoke-direct {v1, v3, v0}, Lkotlin/jvm/internal/AwS533S0100000_23;-><init>(Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;I)V
    ...
    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->getBaseStickerModel()Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;
...
.method public final LJJIJIIJI(Lkotlin/jvm/internal/AwS371S0200000_13;)V
    ...
    iget-object v0, p0, LX/0mpv;->LJIJI:LX/05ta;
...
.method public final LJJIJLIJ()Landroidx/lifecycle/LifecycleOwner;
    ...
    iget-object v0, p0, LX/0mpv;->LJIILLIIL:Landroidx/lifecycle/LifecycleOwner;
...
.method public final LJJIZ()LX/0mnc;
    ...
    iget-object v0, p0, LX/0mpv;->LJIILL:LX/0mnc;
...
.method public final LJJJJ()LX/0moa;
    ...
    iget-object v1, p0, LX/0mpv;->LJIIZILJ:LX/0mUE;

    new-instance v0, LX/0mof;

    invoke-direct {v0, v2, p0, v1}, LX/0mof;-><init>(LX/0mt1;LX/0mpv;LX/0mUE;)V
...
.method public final LJJJZ()LX/0mt1;
    ...
    iget-object v0, p0, LX/0mpv;->LJIJ:LX/05ta;
...
.method public final setAlpha(F)V
    ...
    invoke-virtual/range {v53 .. v53}, LX/0mpv;->LJJJZ()LX/0mt1;

    move-result-object v0

    iget-object v1, v0, LX/0mt0;->LIZ:Ljava/lang/Object;

    check-cast v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;
    ...
    iget-object v5, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->id:Ljava/lang/Long;

    iget-object v4, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->expressions:Ljava/util/List;

    iget-object v3, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->lowResolutionUrl:Ljava/util/List;

    iget-object v2, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->midResolutionUrl:Ljava/util/List;

    iget-object v0, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->highResolutionUrl:Ljava/util/List;
    ...
    invoke-virtual/range {v6 .. v12}, Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;->copy(Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;Ljava/lang/Long;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/ss/android/ugc/aweme/tools/sticker/core/socialavatar/SocialAvatarStickerModel;
