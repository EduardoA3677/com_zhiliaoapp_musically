...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0CSB;->LJIJI:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, LX/0CSB;->LJIJJ:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, LX/0CSB;->LJIJJLI:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final LJIIJ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v0, p0, LX/0CSB;->LJIJI:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-static {v0}, LX/0CSB;->LJJIJIIJIL(Landroid/view/View;)V

    invoke-virtual {p0, p1}, LX/13M9;->LJIIIIZZ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V

    :cond_0
    iget-object v0, p0, LX/0CSB;->LJIJJ:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_1
    iget-object v0, p0, LX/0CSB;->LJIJJLI:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final LJIJ()V
    ...
    iget-object v0, v7, LX/0CSB;->LJIJJ:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-direct {v1, v7, v3, v0}, LY/ALAdapterS2S0200000_5;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    :cond_1
    iget-object v0, v7, LX/0CSB;->LJIJJLI:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-wide v0, v7, LX/13M9;->LIZJ:J

    invoke-virtual {v2, v0, v1}, Landroid/view/ViewPropertyAnimator;->setDuration(J)Landroid/view/ViewPropertyAnimator;

    move-result-object v0

    new-instance v5, LY/ALAdapterS1S0400000_5;

    const/16 v10, 0xb

    invoke-direct/range {v5 .. v10}, LY/ALAdapterS1S0400000_5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    :cond_3
    invoke-super {v7}, LX/0CS6;->LJIJ()V
