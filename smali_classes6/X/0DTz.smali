...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.osp.module.us.shop.USAggregationSkuVH$jumpUserRightSecondPage$2$2"
    f = "USAggregationSkuVH.kt"
    l = {
        0x32c
    }
    m = "invokeSuspend"
...
.field public final synthetic LLILLJJLI:LX/0DLp;
...
# direct methods
.method public constructor <init>(LX/00wO;Landroidx/fragment/app/Fragment;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;LX/0DLp;Ljava/util/HashMap;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0DTz;->LLILIL:LX/00wO;

    iput-object p2, p0, LX/0DTz;->LLILL:Landroidx/fragment/app/Fragment;

    iput-object p3, p0, LX/0DTz;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;

    iput-object p4, p0, LX/0DTz;->LLILLJJLI:LX/0DLp;

    iput-object p5, p0, LX/0DTz;->LLILLL:Ljava/util/HashMap;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0DTz;->LLILIL:LX/00wO;

    iget-object v2, p0, LX/0DTz;->LLILL:Landroidx/fragment/app/Fragment;

    iget-object v3, p0, LX/0DTz;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;

    iget-object v4, p0, LX/0DTz;->LLILLJJLI:LX/0DLp;

    iget-object v5, p0, LX/0DTz;->LLILLL:Ljava/util/HashMap;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v3, "USAggregationSkuVH@3fe1.jumpUserRightSecondPage$2$2"
    ...
    iget-object v0, p0, LX/0DTz;->LLILIL:LX/00wO;
    ...
    :cond_2
    iget-object v0, p0, LX/0DTz;->LLILL:Landroidx/fragment/app/Fragment;

    invoke-virtual {v0}, Landroidx/fragment/app/Fragment;->getFragmentManager()Landroidx/fragment/app/FragmentManager;

    move-result-object v4

    iget-object v0, p0, LX/0DTz;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;
    ...
    iget-object v0, p0, LX/0DTz;->LLILLJJLI:LX/0DLp;

    invoke-static {v0}, LX/0qP1;->LIZLLL(Landroid/view/View;)Ljava/lang/String;

    move-result-object v7

    iget-object v9, p0, LX/0DTz;->LLILLL:Ljava/util/HashMap;

    const/4 v10, 0x0

    const/16 p1, 0x180

    iput v8, p0, LX/0DTz;->LL:I
