...
# direct methods
.method public constructor <init>(LX/0DmU;Ljava/util/Map;ZLjava/lang/Object;JLjava/lang/String;ZLjava/lang/Integer;ZLjava/util/Map;Ljava/util/Map;Z)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0Dft;->LL:LX/0DmU;

    iput-object p2, p0, LX/0Dft;->LLILIL:Ljava/util/Map;

    iput-boolean p3, p0, LX/0Dft;->LLILL:Z

    iput-object p4, p0, LX/0Dft;->LLILLIZIL:Ljava/lang/Object;

    iput-wide p5, p0, LX/0Dft;->LLILLJJLI:J

    iput-object p7, p0, LX/0Dft;->LLILLL:Ljava/lang/String;

    iput-boolean p8, p0, LX/0Dft;->LLILZ:Z

    iput-object p9, p0, LX/0Dft;->LLILZIL:Ljava/lang/Integer;

    iput-boolean p10, p0, LX/0Dft;->LLILZLL:Z

    iput-object p11, p0, LX/0Dft;->LLIZ:Ljava/util/Map;

    iput-object p12, p0, LX/0Dft;->LLIZLLLIL:Ljava/util/Map;

    iput-boolean p13, p0, LX/0Dft;->LLJ:Z
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LX/0Dft;->LL:LX/0DmU;
    ...
    iget-object v0, p0, LX/0Dft;->LLILIL:Ljava/util/Map;
    ...
    iget-object v1, p0, LX/0Dft;->LL:LX/0DmU;

    iget-object v1, v1, LX/0DmU;->LJIILJJIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductPackStruct;
    ...
    invoke-static {v1}, LX/0Dga;->LIZLLL(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/BrandInfo;)Ljava/lang/String;
    ...
    iget-boolean v1, p0, LX/0Dft;->LLILL:Z
    ...
    iget-object v5, p0, LX/0Dft;->LLILLIZIL:Ljava/lang/Object;
    ...
    iget-wide v5, p0, LX/0Dft;->LLILLJJLI:J

    iget-object v1, p0, LX/0Dft;->LLILLIZIL:Ljava/lang/Object;
    ...
    iget-object v4, v1, LX/0DmU;->LJIILJJIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductPackStruct;
    ...
    iget-object v1, p0, LX/0Dft;->LLILLL:Ljava/lang/String;
    ...
    :cond_12
    iget-object v3, p0, LX/0Dft;->LL:LX/0DmU;

    iget-boolean v1, v3, LX/0DmU;->LJIJJ:Z

    if-eqz v1, :cond_13

    iget-object v1, v3, LX/0DmU;->LJIILJJIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductPackStruct;
    ...
    :cond_13
    iget-boolean v1, p0, LX/0Dft;->LLILZ:Z
    ...
    invoke-static {v1, v0, p1, v0, v2}, LX/0Dga;->LIZIZ(Ljava/util/Map;ZLX/01j9;ZLcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;)V

    iget-object v1, p0, LX/0Dft;->LL:LX/0DmU;

    iget-object v1, v1, LX/0DmU;->LIZ:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;
    ...
    invoke-static {p1, v1, v3}, LX/0Dga;->LJ(LX/01j9;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-virtual {v1, p1}, LX/0DmU;->LJII(LX/01j9;)V

    iget-object v1, p0, LX/0Dft;->LL:LX/0DmU;

    invoke-virtual {v1, p1}, LX/0DmU;->LIZLLL(LX/01j9;)V

    iget-object v1, p0, LX/0Dft;->LL:LX/0DmU;

    invoke-virtual {v1, p1}, LX/0DmU;->LJIIIZ(LX/01j9;)V

    iget-object v4, p0, LX/0Dft;->LL:LX/0DmU;

    iget-object v1, v4, LX/0DmU;->LJIILJJIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductPackStruct;
    ...
    invoke-virtual {v1, p1}, LX/0DmU;->LJIIJ(LX/01j9;)V

    iget-object v1, p0, LX/0Dft;->LL:LX/0DmU;

    invoke-virtual {v1, p1}, LX/0DmU;->LIZ(LX/01j9;)V

    iget-object v4, p0, LX/0Dft;->LL:LX/0DmU;

    iget-object v1, v4, LX/0DmU;->LIZIZ:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, LX/0Dft;->LLILZIL:Ljava/lang/Integer;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p1, v1}, LX/0DmU;->LJ(LX/01j9;Ljava/lang/Integer;)V
    ...
    :cond_1c
    iget-boolean v1, p0, LX/0Dft;->LLILZLL:Z
    ...
    iget-object v1, p0, LX/0Dft;->LLIZ:Ljava/util/Map;
    ...
    iget-object v3, p0, LX/0Dft;->LLIZLLLIL:Ljava/util/Map;
    ...
    invoke-virtual {v0}, LX/0Dr8;->LIZ()Ljava/util/Map;
    ...
    iget-object v0, v1, LX/0DmU;->LJIILJJIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductPackStruct;
    ...
    :catchall_0
    new-instance v6, Lkotlin/jvm/internal/AwS10S0220000_28;

    iget-object v7, p0, LX/0Dft;->LL:LX/0DmU;

    iget-boolean v8, p0, LX/0Dft;->LLJ:Z

    iget-boolean v10, p0, LX/0Dft;->LLILL:Z

    const/4 v11, 0x1

    invoke-direct/range {v6 .. v11}, Lkotlin/jvm/internal/AwS10S0220000_28;-><init>(LX/0DmU;ZLandroid/net/Uri;ZI)V

    const-string v0, "tiktokec_internal_enter_page_attribution_event"

    invoke-static {v0, v6}, LX/01bJ;->LJIIIIZZ(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
