...
.method public constructor <init>()V
    ...
    invoke-static {v2}, LX/0BOV;->xG(LX/0CDd;)V
    ...
    invoke-static {v2}, LX/0BOV;->Up(LX/0CDd;)V
    ...
    invoke-static {v1}, LX/0BOV;->hr(LX/0CDd;)V
    ...
    iput-object v3, v0, LX/0BOm;->LJ:Landroid/graphics/Paint;

    new-instance v2, LX/0CDd;

    invoke-direct {v2}, LX/0CDd;-><init>()V

    iput-object v2, v0, LX/0BOm;->LJFF:LX/0CDd;

    invoke-static {v2}, LX/0BOV;->YF(LX/0CDd;)V
    ...
    iput-object v1, v0, LX/0BOm;->LJI:Landroid/graphics/Paint;

    new-instance v5, LX/0CDd;

    invoke-direct {v5}, LX/0CDd;-><init>()V

    iput-object v5, v0, LX/0BOm;->LJII:LX/0CDd;

    invoke-static {v5}, LX/0BOV;->On(LX/0CDd;)V
    ...
    invoke-static {v5}, LX/0BOV;->bK(LX/0CDd;)V
    ...
    const v27, -0x3efee148    # -8.07f

    move-object/from16 v21, v5

    invoke-virtual/range {v21 .. v27}, LX/0CDd;->LJIIJJI(FFFFFF)V

    invoke-static {v5}, LX/0BOV;->su(LX/0CDd;)V

    const v4, 0x41e8e148    # 29.11f

    const v3, 0x422f70a4    # 43.86f

    invoke-virtual {v5, v4, v3}, LX/0CDd;->LJIIIZ(FF)V

    invoke-static {v5}, LX/0BOV;->Qr(LX/0CDd;)V

    const v3, 0x420eae14    # 35.67f

    invoke-virtual {v5, v3, v2}, LX/0CDd;->LJIIIZ(FF)V

    invoke-static {v5}, LX/0BOV;->mG(LX/0CDd;)V
    ...
    invoke-static {v5}, LX/0BOV;->VF(LX/0CDd;)V
...
.method public final LIZ(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, LX/0BOm;->LJFF:LX/0CDd;

    iget-object v1, v0, LX/0CDd;->LIZ:Landroid/graphics/Path;

    iget-object v0, p0, LX/0BOm;->LJ:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v0}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v0, p0, LX/0BOm;->LJII:LX/0CDd;

    iget-object v1, v0, LX/0CDd;->LIZ:Landroid/graphics/Path;

    iget-object v0, p0, LX/0BOm;->LJI:Landroid/graphics/Paint;
