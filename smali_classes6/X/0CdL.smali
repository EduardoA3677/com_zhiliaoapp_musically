...
.method public final LIZ(Landroid/content/Context;Landroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    invoke-direct {v4, v5, v0}, LX/12vh;-><init>(II)V
    ...
    :cond_3
    new-instance v6, LX/13KU;

    invoke-direct {v6, v14}, LX/13KU;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v6, v5, v4}, LX/12vh;-><init>(II)V
    ...
    invoke-direct {v9, v5, v4}, LX/12vh;-><init>(II)V
    ...
    iput v3, v9, LX/12vh;->topToBottom:I

    :cond_f
    const v0, 0x7f0e2017

    invoke-static {v14, v0, v10, v2, v2}, LX/0Cri;->LIZ(Landroid/content/Context;ILandroid/view/ViewGroup;ZI)Landroid/view/View;
    ...
    invoke-direct {v7, v3, v0}, LX/12vh;-><init>(II)V
    ...
    iput v2, v7, LX/12vh;->startToStart:I
    ...
    :cond_2b
    new-instance v4, LX/0CpK;

    const/4 v6, 0x0

    invoke-direct {v4, v14, v6}, LX/0CpK;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v5, v14, v6}, LX/0CpK;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v11, v0, v6}, Landroid/util/TypedValue;->applyDimension(IFLandroid/util/DisplayMetrics;)F
