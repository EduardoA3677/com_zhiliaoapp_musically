...
.method public constructor <init>()V
    ...
    iput-object v1, v2, LX/0BSc;->LJ:LX/0CDd;
    ...
    iput-object v3, v2, LX/0BSc;->LJFF:Landroid/graphics/Paint;

    new-instance v1, LX/0CDd;

    invoke-direct {v1}, LX/0CDd;-><init>()V

    iput-object v1, v2, LX/0BSc;->LJI:LX/0CDd;
    ...
    iput-object v1, v2, LX/0BSc;->LJII:Landroid/graphics/Paint;

    new-instance v5, LX/0CDd;

    invoke-direct {v5}, LX/0CDd;-><init>()V

    iput-object v5, v2, LX/0BSc;->LJIIIIZZ:LX/0CDd;
    ...
    invoke-static {v5}, LX/0BOV;->AF(LX/0CDd;)V

    const/high16 v10, -0x3f800000    # -4.0f

    invoke-virtual {v5, v10}, LX/0CDd;->LJIIL(F)V
    ...
    invoke-static {v5}, LX/0BOV;->BF(LX/0CDd;)V
    ...
    invoke-virtual {v5, v0, v4}, LX/0CDd;->LJIILJJIL(FF)V
...
.method public final LIZ(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, LX/0BSc;->LJ:LX/0CDd;

    iget-object v0, v0, LX/0CDd;->LIZ:Landroid/graphics/Path;

    invoke-virtual {p1, v0}, Landroid/graphics/Canvas;->clipPath(Landroid/graphics/Path;)Z

    iget-object v0, p0, LX/0BSc;->LJI:LX/0CDd;

    iget-object v1, v0, LX/0CDd;->LIZ:Landroid/graphics/Path;

    iget-object v0, p0, LX/0BSc;->LJFF:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v0}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v0, p0, LX/0BSc;->LJIIIIZZ:LX/0CDd;

    iget-object v1, v0, LX/0CDd;->LIZ:Landroid/graphics/Path;

    iget-object v0, p0, LX/0BSc;->LJII:Landroid/graphics/Paint;
