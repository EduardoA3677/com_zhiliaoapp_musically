...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0Dub;->LIZ:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LX/0Dub;->LIZIZ:Ljava/util/List;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, LX/0Dub;->LIZJ:Ljava/util/Map;

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/0Dub;->LIZLLL:Z
...
.method public final LIZ(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, LX/0Dub;->LIZJ:Ljava/util/Map;
    ...
    iput-boolean v2, v0, LX/0E0G;->LIZ:Z

    iput-boolean v2, v0, LX/0E0G;->LIZIZ:Z

    :cond_1
    return-void

    :cond_2
    iget-object v1, p0, LX/0Dub;->LIZJ:Ljava/util/Map;

    new-instance v0, LX/0E0G;

    invoke-direct {v0, v2}, LX/0E0G;-><init>(I)V
...
.method public final LIZIZ(Landroid/view/View;ILjava/lang/String;Lcom/ss/android/ugc/aweme/ecommerce/service/vo/Image;Ljava/lang/Boolean;)V
    .locals 11
    ...
    :cond_2
    iget-object v0, p0, LX/0Dub;->LIZIZ:Ljava/util/List;
    ...
    iget-boolean v7, v0, LX/0E0G;->LIZ:Z
    ...
    iget-boolean v8, v0, LX/0E0G;->LIZIZ:Z
    ...
    invoke-direct/range {v3 .. v10}, LX/0qae;-><init>(Landroid/view/View;Ljava/lang/String;IZZZLjava/lang/Boolean;)V
