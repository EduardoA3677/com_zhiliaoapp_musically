...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.osp.module.sea.shop.ShopSkuAdapter$jumpUserRightSecondPage$2$2"
    f = "ShopSkuAdapter.kt"
    l = {
        0x23f
    }
...
.field public final synthetic LLILL:LX/0DMD;
...
# direct methods
.method public constructor <init>(LX/00wO;LX/0DMD;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;Ljava/util/HashMap;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0DTt;->LLILIL:LX/00wO;

    iput-object p2, p0, LX/0DTt;->LLILL:LX/0DMD;

    iput-object p3, p0, LX/0DTt;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;

    iput-object p4, p0, LX/0DTt;->LLILLJJLI:Ljava/util/HashMap;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0DTt;->LLILIL:LX/00wO;

    iget-object v2, p0, LX/0DTt;->LLILL:LX/0DMD;

    iget-object v3, p0, LX/0DTt;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;

    iget-object v4, p0, LX/0DTt;->LLILLJJLI:Ljava/util/HashMap;

    move-object v5, p2

    invoke-direct/range {v0 .. v5}, LX/0DTt;-><init>(LX/00wO;LX/0DMD;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;Ljava/util/HashMap;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v3, "ShopSkuAdapter@f0f7.jumpUserRightSecondPage$2$2"
    ...
    iget-object v0, p0, LX/0DTt;->LLILIL:LX/00wO;
    ...
    :cond_2
    iget-object v0, p0, LX/0DTt;->LLILL:LX/0DMD;
    ...
    :goto_0
    iget-object v0, p0, LX/0DTt;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRightDetail;
    ...
    iget-object v9, p0, LX/0DTt;->LLILLJJLI:Ljava/util/HashMap;

    const/4 v10, 0x0

    const/16 p1, 0x180

    iput v8, p0, LX/0DTt;->LL:I
