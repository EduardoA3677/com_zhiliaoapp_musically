...
.method public constructor <init>(IIIII)V
    ...
    iput-object v0, p0, LX/0CmK;->LLILLL:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/drawable/ColorDrawable;

    invoke-direct {v0, p1}, Landroid/graphics/drawable/ColorDrawable;-><init>(I)V

    iput-object v0, p0, LX/0CmK;->LL:Landroid/graphics/drawable/Drawable;

    iput p2, p0, LX/0CmK;->LLILL:I

    iput p4, p0, LX/0CmK;->LLILLIZIL:I

    iput p5, p0, LX/0CmK;->LLILLJJLI:I

    iput p3, p0, LX/0CmK;->LLILIL:I
...
.method public LIZIZ(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;LX/13MF;)V
    ...
    iget-object v0, p0, LX/0CmK;->LL:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget v1, p0, LX/0CmK;->LLILIL:I

    const/4 v0, 0x1

    if-ne v1, v0, :cond_1

    iget v0, p0, LX/0CmK;->LLILL:I
...
.method public final LIZJ(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;LX/13MF;)V
    ...
    iget-object v0, p0, LX/0CmK;->LLILLL:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, LX/0CmK;->LL:Landroid/graphics/drawable/Drawable;

    iget v1, p0, LX/0CmK;->LLILLIZIL:I

    add-int/2addr v1, v6

    iget v0, p0, LX/0CmK;->LLILLJJLI:I
    ...
    invoke-virtual {p1, v2, v6, v1, v5}, Landroid/graphics/Canvas;->clipRect(IIII)Z
    ...
    invoke-virtual {v2, v3, v1, v8, v0}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
