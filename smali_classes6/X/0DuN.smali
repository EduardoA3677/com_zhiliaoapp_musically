...
.method public final requestActual(Ljava/lang/Object;)LX/0aLQ;
    ...
    :goto_0
    invoke-static {v0, v3}, LX/0vx0;->LJIILJJIL(Ljava/lang/String;Ljava/lang/String;)Ljava/util/HashMap;

    move-result-object v0

    invoke-interface {v2, v1, v0}, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/api/PdpApi;->getProductInfoBatchRaw(Ljava/util/Map;Ljava/util/HashMap;)LX/0aLQ;

    move-result-object v1

    sget-object v0, LX/04xv;->LL:LX/04xv;
    ...
    invoke-interface {v2, v1, v0}, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/api/PdpApi;->getProductInfoBatch(Ljava/util/Map;Ljava/util/HashMap;)LX/0aLQ;
