...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.sku.sea.vm.ISeaSkuPanelViewModel$refreshSkuInfo$1"
...
.field public final synthetic LLILLL:LX/0Dc2;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LX/0Dc2<",
...
.method public constructor <init>(LX/0Dc2;LX/02wT;)V
    ...
    iput-object p1, p0, LX/0DcV;->LLILLL:LX/0Dc2;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v0, p0, LX/0DcV;->LLILLL:LX/0Dc2;

    invoke-direct {v1, v0, p2}, LX/0DcV;-><init>(LX/0Dc2;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v17, "ISeaSkuPanelViewModel@3099.refreshSkuInfo$1"
    ...
    iget v1, v5, LX/0DcV;->LLILLJJLI:I
    ...
    iget-object v1, v5, LX/0DcV;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/sku/model/dto/SkuItem;

    iget-object v0, v5, LX/0DcV;->LLILL:Ljava/lang/Object;

    check-cast v0, Ljava/lang/String;

    iget-object v3, v5, LX/0DcV;->LLILIL:Ljava/lang/Object;

    check-cast v3, Ljava/lang/String;

    iget-object v2, v5, LX/0DcV;->LL:LX/0Dc2;
    ...
    iget-object v15, v4, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PackedProductSKUInfo;->daInfo:Ljava/lang/String;
    ...
    iget-object v14, v4, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PackedProductSKUInfo;->staticSellingPoints:Ljava/util/List;
    ...
    iget-object v13, v4, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PackedProductSKUInfo;->lockUpStaticSellingPoint:Ljava/lang/String;
    ...
    iget-object v12, v4, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PackedProductSKUInfo;->pdpReturnPolicyModule:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PDPReturnPolicyModule;
    ...
    iget-object v4, v4, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PackedProductSKUInfo;->returnPolicy:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/UserRight;
    ...
    invoke-interface {v2}, LX/0Dc2;->Y8()LX/0DZr;
    ...
    invoke-interface {v2, v4, v5}, LX/0Dc2;->Me(Ljava/lang/String;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PdpPaymentModule;)V
    ...
    iget-object v0, v5, LX/0DcV;->LLILLL:LX/0Dc2;
    ...
    iget-object v2, v5, LX/0DcV;->LLILLL:LX/0Dc2;
    ...
    invoke-interface {v2}, LX/0Dc2;->Oc()I
    ...
    invoke-interface {v2}, LX/0Dc2;->LLI()Lcom/ss/android/ugc/aweme/ecommerce/base/sku/SkuPanelStarter$SkuEnterParams;
    ...
    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/ecommerce/base/sku/model/SkuPanelState;->getProductId()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/ss/android/ugc/aweme/ecommerce/base/sku/SkuPanelStarter$SkuEnterParams;->getProductEnterContext()Ljava/util/Map;
    ...
    instance-of v6, v13, Ljava/util/Map;
    ...
    iget-object v6, v1, Lcom/ss/android/ugc/aweme/ecommerce/base/sku/model/dto/SkuItem;->warehouseId:Ljava/lang/String;
    ...
    invoke-interface {v2}, LX/0Dc2;->Ei()Z
    ...
    invoke-direct {v13, v9, v6}, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/RefreshModuleOption;-><init>(Ljava/lang/Boolean;Ljava/lang/Boolean;)V

    invoke-interface {v2}, LX/0Dc2;->Ug()Ljava/util/List;
    ...
    invoke-virtual {v6}, Lcom/ss/android/ugc/aweme/ecommerce/base/sku/SkuPanelStarter$SkuEnterParams;->getDisplayMode()Ljava/lang/Integer;
    ...
    invoke-virtual {v6}, Lcom/ss/android/ugc/aweme/ecommerce/base/sku/SkuPanelStarter$SkuEnterParams;->getOriginalSkuInfoForExchange()Ljava/util/Map;
    ...
    invoke-virtual {v6}, Lcom/ss/android/ugc/aweme/ecommerce/base/sku/SkuPanelStarter$SkuEnterParams;->getSchemaCustomField()Ljava/util/Map;

    move-result-object v37

    :goto_13
    new-instance v6, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/RefreshProductSKUInfoRequest;
    ...
    invoke-direct/range {v18 .. v38}, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/RefreshProductSKUInfoRequest;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/RefreshModuleOption;Ljava/util/Map;Lcom/ss/android/ugc/aweme/ecommerce/base/oneclickpay/OneClickPayContext;Ljava/util/List;Ljava/util/Map;Ljava/util/Map;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Map;Ljava/util/Map;Ljava/util/List;)V

    invoke-interface {v2}, LX/0Dc2;->Gb()LX/01fF;
    ...
    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/ecommerce/base/sku/SkuPanelStarter$SkuEnterParams;->getOcpContext()Lcom/ss/android/ugc/aweme/ecommerce/base/oneclickpay/OneClickPayContext;
    ...
    iget-object v4, v4, LX/01fF;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/oneclickpay/OneClickPayContext;
    ...
    iput-object v2, v5, LX/0DcV;->LL:LX/0Dc2;

    iput-object v3, v5, LX/0DcV;->LLILIL:Ljava/lang/Object;

    iput-object v0, v5, LX/0DcV;->LLILL:Ljava/lang/Object;

    iput-object v1, v5, LX/0DcV;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/sku/model/dto/SkuItem;

    const/4 v4, 0x1

    iput v4, v5, LX/0DcV;->LLILLJJLI:I

    invoke-virtual {v7, v6, v5}, LX/0vx0;->LJIILIIL(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/RefreshProductSKUInfoRequest;LX/02wT;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v0}, LX/0Dc2;->jo(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PdpPaymentModule;)V

    iget-object v0, v5, LX/0DcY;->LJIIIIZZ:Ljava/util/List;

    invoke-interface {v2, v0}, LX/0Dc2;->Dj(Ljava/util/List;)Lcom/bytedance/android/livesdk/model/message/ext/PromotionView;
    ...
    :cond_23
    :goto_15
    invoke-interface {v2, v0}, LX/0Dc2;->Rd(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PromotionLabelVO;)V
    ...
    invoke-interface {v2, v1}, LX/0Dc2;->LJJJJJ(Lkotlin/jvm/functions/Function1;)V
