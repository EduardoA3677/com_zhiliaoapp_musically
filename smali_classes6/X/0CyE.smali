...
.field public final synthetic LLILLL:Lcom/ss/android/ugc/aweme/search/detail/relatedsearch/ui/RelatedSearchWordCellOPT1;

.field public final synthetic LLILZ:Landroid/content/Context;


# direct methods
.method public constructor <init>(Lcom/bytedance/tux/input/TuxTextView;ILjava/lang/String;Landroid/text/TextPaint;LX/0KLg;Lcom/ss/android/ugc/aweme/search/detail/relatedsearch/ui/RelatedSearchWordCellOPT1;Landroid/content/Context;)V
    .locals 0

    iput-object p1, p0, LX/0CyE;->LL:Lcom/bytedance/tux/input/TuxTextView;

    iput p2, p0, LX/0CyE;->LLILIL:I

    iput-object p3, p0, LX/0CyE;->LLILL:Ljava/lang/String;

    iput-object p4, p0, LX/0CyE;->LLILLIZIL:Landroid/text/TextPaint;

    iput-object p5, p0, LX/0CyE;->LLILLJJLI:LX/0KLg;

    iput-object p6, p0, LX/0CyE;->LLILLL:Lcom/ss/android/ugc/aweme/search/detail/relatedsearch/ui/RelatedSearchWordCellOPT1;

    iput-object p7, p0, LX/0CyE;->LLILZ:Landroid/content/Context;
...
.method public final LIZ()V
    ...
    iget-object v0, p0, LX/0CyE;->LL:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iget v0, p0, LX/0CyE;->LLILIL:I

    sub-int/2addr v3, v0

    iget-object v2, p0, LX/0CyE;->LLILL:Ljava/lang/String;

    invoke-virtual {v2}, Ljava/lang/String;->length()I

    move-result v1

    iget-object v0, p0, LX/0CyE;->LLILLIZIL:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, LX/0CyE;->LLILL:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0CyE;->LLILL:Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, LX/0CyE;->LLILLJJLI:LX/0KLg;
    ...
    iget-object v0, p0, LX/0CyE;->LLILLL:Lcom/ss/android/ugc/aweme/search/detail/relatedsearch/ui/RelatedSearchWordCellOPT1;

    iget-object v8, p0, LX/0CyE;->LLILZ:Landroid/content/Context;
...
.method public final run()V
    ...
    const-string v2, "RelatedSearchWordCellOPT1@a4db.onBindItemView$2$1"
