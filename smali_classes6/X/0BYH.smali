...
.method public constructor <init>()V
    ...
    iput-object v1, p0, LX/0BYH;->LJ:LX/0CDd;
    ...
    iput-object v4, p0, LX/0BYH;->LJFF:Landroid/graphics/Paint;

    new-instance v3, LX/0CDd;

    invoke-direct {v3}, LX/0CDd;-><init>()V

    iput-object v3, p0, LX/0BYH;->LJI:LX/0CDd;
    ...
    iput-object v2, p0, LX/0BYH;->LJII:Landroid/graphics/Paint;

    new-instance v1, LX/0CDd;

    invoke-direct {v1}, LX/0CDd;-><init>()V

    iput-object v1, p0, LX/0BYH;->LJIIIIZZ:LX/0CDd;

    invoke-static {v1}, LX/0BOV;->Sv(LX/0CDd;)V
    ...
    iput-object v2, p0, LX/0BYH;->LJIIIZ:Landroid/graphics/Paint;

    new-instance v3, LX/0CDd;

    invoke-direct {v3}, LX/0CDd;-><init>()V

    iput-object v3, p0, LX/0BYH;->LJIIJ:LX/0CDd;

    const v1, 0x41fb0a3d    # 31.38f
    ...
    iput-object v1, p0, LX/0BYH;->LJIIJJI:Landroid/graphics/Paint;

    new-instance v3, LX/0CDd;

    invoke-direct {v3}, LX/0CDd;-><init>()V

    iput-object v3, p0, LX/0BYH;->LJIIL:LX/0CDd;

    const v2, 0x41ee8f5c    # 29.82f
    ...
    invoke-static {v3}, LX/0BOV;->Wc(LX/0CDd;)V
...
.method public final LIZ(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, LX/0BYH;->LJIIJ:LX/0CDd;

    iget-object v1, v0, LX/0CDd;->LIZ:Landroid/graphics/Path;

    iget-object v0, p0, LX/0BYH;->LJIIIZ:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v0}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v0, p0, LX/0BYH;->LJIIL:LX/0CDd;

    iget-object v1, v0, LX/0CDd;->LIZ:Landroid/graphics/Path;

    iget-object v0, p0, LX/0BYH;->LJIIJJI:Landroid/graphics/Paint;
