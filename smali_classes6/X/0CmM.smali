...
.method public constructor <init>(III)V
    ...
    iput p2, p0, LX/0CmM;->LL:I

    iput p3, p0, LX/0CmM;->LLILIL:I

    const/4 v1, 0x1

    iput v1, p0, LX/0CmM;->LLILL:I

    new-instance v0, Landroid/graphics/drawable/ColorDrawable;

    invoke-direct {v0, p1}, Landroid/graphics/drawable/ColorDrawable;-><init>(I)V

    iput-object v0, p0, LX/0CmM;->LLILLIZIL:Landroid/graphics/drawable/Drawable;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, LX/0CmM;->LLILLL:Landroid/graphics/Rect;

    iput v1, p0, LX/0CmM;->LLILLJJLI:I
...
.method public final LIZJ(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;LX/13MF;)V
    ...
    :cond_0
    iget v1, p0, LX/0CmM;->LLILLJJLI:I
    ...
    iget-object v0, p0, LX/0CmM;->LLILLL:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, LX/0CmM;->LLILLIZIL:Landroid/graphics/drawable/Drawable;

    iget v1, p0, LX/0CmM;->LL:I

    add-int/2addr v1, v7

    iget v0, p0, LX/0CmM;->LLILIL:I

    sub-int v0, v5, v0

    invoke-virtual {v2, v1, v3, v0, v8}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v0, p0, LX/0CmM;->LLILLIZIL:Landroid/graphics/drawable/Drawable;
