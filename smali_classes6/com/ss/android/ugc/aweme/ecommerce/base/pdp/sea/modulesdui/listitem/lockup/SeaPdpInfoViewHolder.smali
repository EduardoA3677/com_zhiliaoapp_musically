.class public final Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;
...
.method public constructor <init>(Landroid/view/ViewGroup;Lcom/ss/android/ugc/aweme/ecommerce/common/ECBaseFragment;Lkotlin/jvm/internal/AwS515S0100000_5;)V
    ...
    iput-object p2, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJILJIL:Landroidx/fragment/app/Fragment;

    iput-object p3, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJILJILJ:Lkotlin/jvm/functions/Function1;
    ...
    iput-object v10, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJILLL:Lcom/ss/android/ugc/aweme/ecommerce/core/view/CommerceProductInfoView;
    ...
    iput-object v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJJ:LX/05ta;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJJIII:J

    new-instance v9, LX/0Dip;

    invoke-direct {v9, p0, p1}, LX/0Dip;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;Landroid/view/ViewGroup;)V

    new-instance v8, LX/0Dih;

    invoke-direct {v8, p0}, LX/0Dih;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;)V

    new-instance v7, LX/0Dhv;

    invoke-direct {v7, p0}, LX/0Dhv;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;)V

    new-instance v6, LX/0DiA;

    invoke-direct {v6, p0}, LX/0DiA;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;)V

    new-instance v5, LX/0Di9;

    invoke-direct {v5}, LX/0Di9;-><init>()V

    new-instance v4, LX/0DiD;

    invoke-direct {v4, p0}, LX/0DiD;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;)V

    new-instance v3, LX/0DjV;

    invoke-direct {v3, p0}, LX/0DjV;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;)V

    new-instance v2, LX/0DRw;

    invoke-direct {v2, p0}, LX/0DRw;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;)V

    new-instance v1, LX/0Dfk;

    invoke-direct {v1, p0, p1}, LX/0Dfk;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;Landroid/view/ViewGroup;)V

    new-instance v0, LX/0DMH;

    invoke-direct {v0, p0}, LX/0DMH;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;)V
    ...
    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS481S0100000_5;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;I)V

    invoke-virtual {v10, v1}, Lcom/ss/android/ugc/aweme/ecommerce/core/view/CommerceProductInfoView;->setPopulateChannelShowListener(Lkotlin/jvm/functions/Function0;)V

    return-void
.end method

.method public static c7(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PdpPaymentModule;)Z
    .locals 2
    ...
    iget-object v0, v0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/BNPLTopWidget;->actionType:Ljava/lang/Integer;
...
.method public final Qn(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->d7()Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;
    ...
    :cond_0
    :goto_0
    iget-object v2, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJILLL:Lcom/ss/android/ugc/aweme/ecommerce/core/view/CommerceProductInfoView;
    ...
    iget-object v0, p1, LX/0DhF;->LJJIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PdpPaymentModule;

    invoke-static {v0}, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->c7(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/PdpPaymentModule;)Z

    move-result v0

    if-eqz v0, :cond_6

    iget-object v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJILLL:Lcom/ss/android/ugc/aweme/ecommerce/core/view/CommerceProductInfoView;
    ...
    iget-object v3, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJILLL:Lcom/ss/android/ugc/aweme/ecommerce/core/view/CommerceProductInfoView;
...
.method public final d7()Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;
    ...
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJJ:LX/05ta;
...
.method public final onCreate()V
    ...
    iget-object v1, p0, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;->LLJILLL:Lcom/ss/android/ugc/aweme/ecommerce/core/view/CommerceProductInfoView;
    ...
    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS515S0100000_5;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;I)V

    iget-object v0, v2, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;->LLJILLL:Ljava/util/List;
    ...
    sget-object v2, LX/0Dia;->LL:LX/0Dia;

    new-instance v1, Lkotlin/jvm/internal/AwS548S0100000_5;

    const/16 v0, 0x43

    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS548S0100000_5;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;I)V
    ...
    sget-object v3, LX/0DiS;->LL:LX/0DiS;

    sget-object v2, LX/0Di7;->LL:LX/0Di7;

    new-instance v1, Lkotlin/jvm/internal/AwS580S0100000_5;

    const/16 v0, 0x9

    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS580S0100000_5;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/modulesdui/listitem/lockup/SeaPdpInfoViewHolder;I)V
    ...
    sget-object v2, LX/0Dii;->LL:LX/0Dii;
