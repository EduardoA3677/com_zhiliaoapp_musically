...
# direct methods
.method public constructor <init>(Landroid/content/Context;LX/0u8c;LX/0u0H;)V
    .locals 0
...
.method public final LJFF(Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    ...
    iput-object p2, p0, LX/0u2S;->LJIIIZ:Lorg/json/JSONObject;
...
.method public final LJII(Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    ...
    iput-object v0, p0, LX/0u2S;->LJIIIIZZ:Ljava/lang/String;

    const-string v0, "verify_ticket"

    invoke-virtual {p2, v0}, Lorg/json/JSONObject;->optString(Ljava/lang/String;)Ljava/lang/String;

    iput-object p1, p0, LX/0u2S;->LJIIIZ:Lorg/json/JSONObject;
...
.method public final LJIIJ(ZLX/0uAT;)LX/0ZWG;
    ...
    new-instance v1, LX/0u3x;

    invoke-direct {v1, p1}, LX/0u3x;-><init>(Z)V

    if-eqz p1, :cond_0

    iget-object v0, p0, LX/0u2S;->LJIIIIZZ:Ljava/lang/String;

    iput-object v0, v1, LX/0u3x;->LJIIIZ:Ljava/lang/String;

    :goto_0
    iget-object v0, p0, LX/0u2S;->LJIIIZ:Lorg/json/JSONObject;
