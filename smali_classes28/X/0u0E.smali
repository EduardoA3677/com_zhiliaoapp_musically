...
.method public constructor <init>(LX/0tti;LX/0aL3;)V
    ...
    iput-object p2, p0, LX/0u0E;->LIZJ:LX/0KfU;

    iput-object p1, p0, LX/0u0E;->LIZLLL:LX/0tti;

    invoke-direct {p0}, LX/0u1y;-><init>()V
...
.method public final bridge synthetic LJ(LX/0ZWG;I)V
    ...
    invoke-virtual {p0, p1, p2}, LX/0u0E;->LJII(LX/0u1x;I)V
...
.method public final bridge synthetic LJI(LX/0ZWG;)V
    ...
    invoke-virtual {p0, p1}, LX/0u0E;->LJIIIIZZ(LX/0u1x;)V

    return-void
.end method

.method public final LJII(LX/0u1x;I)V
    .locals 9

    if-nez p1, :cond_0

    iget-object v3, p0, LX/0u0E;->LIZJ:LX/0KfU;

    sget-object v2, LX/0u0J;->Companion:LX/0u0A;

    iget-object v0, p0, LX/0u0E;->LIZLLL:LX/0tti;
    ...
    :cond_0
    iget-object v1, p0, LX/0u0E;->LIZJ:LX/0KfU;
...
.method public final LJIIIIZZ(LX/0u1x;)V
    .locals 8
    ...
    iget-object v0, p0, LX/0u0E;->LIZJ:LX/0KfU;
