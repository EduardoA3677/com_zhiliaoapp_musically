...
# direct methods
.method public constructor <init>(Ljava/util/Map;LX/0tti;Ljava/lang/String;ILjava/lang/String;ILX/0tw1;LX/0tvj;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0ttm;->LIZ:Ljava/util/Map;

    iput-object p2, p0, LX/0ttm;->LIZIZ:LX/0tti;

    iput-object p3, p0, LX/0ttm;->LIZJ:Ljava/lang/String;

    iput p4, p0, LX/0ttm;->LIZLLL:I

    iput-object p5, p0, LX/0ttm;->LJ:Ljava/lang/String;

    iput p6, p0, LX/0ttm;->LJFF:I

    iput-object p7, p0, LX/0ttm;->LJI:LX/0tw1;

    iput-object p8, p0, LX/0ttm;->LJII:LX/0tvj;
...
.method public final LIZ(LX/0aL3;)V
    ...
    :goto_0
    new-instance v9, LX/0tzv;

    iget-object v1, p0, LX/0ttm;->LJI:LX/0tw1;

    iget-object v0, p0, LX/0ttm;->LJII:LX/0tvj;

    invoke-direct {v9, p1, v1, v0}, LX/0tzv;-><init>(LX/0aL3;LX/0tw1;LX/0tvj;)V
    ...
    iget v2, p0, LX/0ttm;->LIZLLL:I

    iget-object v3, p0, LX/0ttm;->LJ:Ljava/lang/String;

    iget v4, p0, LX/0ttm;->LJFF:I
