.class public final Lcom/ss/android/ugc/aweme/pipo/auth/NetworkMonitorHandler;
...
.method public final LJIIJ(LX/0ZgW;LX/0t81;)V
    ...
    iget-object v3, p1, LX/0ZgW;->LJII:Ljava/lang/Object;

    instance-of v0, v3, Lcom/ss/android/ugc/aweme/pipo/auth/BaseResponse;

    if-eqz v0, :cond_6

    check-cast v3, Lcom/ss/android/ugc/aweme/pipo/auth/BaseResponse;

    if-eqz v3, :cond_6

    iget-object v1, v3, Lcom/ss/android/ugc/aweme/pipo/auth/BaseResponse;->resultCode:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, LX/0q3X;->LIZ(Ljava/lang/String;Ljava/util/Map;)V
    ...
    :cond_3
    iget-object v2, v3, Lcom/ss/android/ugc/aweme/pipo/auth/BaseResponse;->errorCode:Ljava/lang/String;
    ...
    :cond_4
    iget-object v0, v3, Lcom/ss/android/ugc/aweme/pipo/auth/BaseResponse;->errorContent:Ljava/lang/String;
    ...
    :cond_5
    iget-object v1, v3, Lcom/ss/android/ugc/aweme/pipo/auth/BaseResponse;->errorMsg:Ljava/lang/String;
