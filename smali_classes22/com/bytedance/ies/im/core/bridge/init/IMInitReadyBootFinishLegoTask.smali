.class public final Lcom/bytedance/ies/im/core/bridge/init/IMInitReadyBootFinishLegoTask;
...
.method public final key()Ljava/lang/String;
    ...
    const-string v0, "im_init_ready_boot_finish_task"
...
.method public final run(Landroid/content/Context;)V
    ...
    invoke-interface {v0}, LX/0iNs;->LJIJ()LX/0iYV;

    move-result-object v0

    invoke-virtual {v0}, LX/0iYV;->LJII()V
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/service/IAwemeImManager;->LJI()V
    ...
    invoke-virtual {v0}, LX/0i3Q;->LJJIJLIJ()V
    ...
    const-string v1, "tt_im_display_suggested_stickers_in_chat_page"
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/sticker/api/IMStickerApi;->LJII()LX/03r5;
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/chatlist/api/IMChatListApi;->LJFF()LX/03r5;
    ...
    invoke-direct {v2, v4, v0}, LX/01y7;-><init>(Ljava/util/List;I)V
    ...
    :cond_7
    sget-object v0, Lcom/ss/android/ugc/aweme/im/service/service/IMufAffinityScoreRepositoryInitializer;->LIZ:LX/0iaS;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v0, LX/0iaS;->LIZIZ:LX/05ta;

    invoke-interface {v0}, LX/05ta;->getValue()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/ss/android/ugc/aweme/im/service/service/IMufAffinityScoreRepositoryInitializer;

    if-eqz v0, :cond_8

    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/service/service/IMufAffinityScoreRepositoryInitializer;->init()V
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/streak/api/IStreakService;->LJJIL()V
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/streak/api/pet/IStreakPetService;->LJJIJIIJI()V
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/chatlist/api/IMChatListApi;->LJJII()V

    new-instance v1, Lkotlin/jvm/internal/AwS480S0100000_4;

    const/4 v0, 0x7

    invoke-direct {v1, v4, v0}, Lkotlin/jvm/internal/AwS480S0100000_4;-><init>(Ljava/util/List;I)V
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/im/saas/host/api/foundation/IMFoundationBridgeApi;->LIZ()Z
    ...
    :cond_9
    const-string v0, "imrequest_sparse"

    invoke-static {v0, v2, v1, v5}, LX/0Xe5;->LIZJ(Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Z)Ljava/lang/Object;
