...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.relation.usercard.source.MafUserPagingSource$loadFromPagingApi$pageResult$3"
...
.method public constructor <init>(Ljava/util/List;LX/02wT;)V
    ...
    iput-object p1, p0, LX/0jAR;->LL:Ljava/util/List;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v1, LX/0jAR;

    iget-object v0, p0, LX/0jAR;->LL:Ljava/util/List;

    invoke-direct {v1, v0, p2}, LX/0jAR;-><init>(Ljava/util/List;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v4, "MafUserPagingSource@b859.loadFromPagingApi$pageResult$3"
    ...
    invoke-static {v1}, LX/03ai;->LIZ(Ljava/util/List;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-static {v0}, LX/03ai;->LIZ(Ljava/util/List;)V

    :cond_1
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/profile/model/User;->getAvatar300()Lcom/ss/android/ugc/aweme/base/model/UrlModel;
