...
# instance fields
.field public final LIZIZ:LX/0iXZ;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0iWx;->LIZJ:Ljava/util/Map;

    return-void
.end method

.method public constructor <init>(LX/0iXZ;)V
    .locals 0

    invoke-direct {p0}, LX/0hvi;-><init>()V

    iput-object p1, p0, LX/0iWx;->LIZIZ:LX/0iXZ;
...
.method public final LIZ(LX/0hvZ;LX/02wT;)Ljava/lang/Object;
    ...
    const-string v1, "PublishVideoWrapperStep"

    const-string v0, "start execute PublishVideoWrapperStep"
    ...
    sget-object v2, LX/0iWx;->LIZJ:Ljava/util/Map;
    ...
    new-instance v3, LX/0iX5;

    iget-object v4, v0, LX/0iWz;->LIZ:Ljava/lang/String;

    iget-object v5, v0, LX/0iWz;->LIZIZ:LX/0iXB;

    iget-boolean v6, v0, LX/0iWz;->LIZJ:Z

    iget-object v7, v0, LX/0iWz;->LIZLLL:Ljava/util/Map;

    iget-object v8, v0, LX/0iWz;->LJ:Lcom/ss/android/ugc/aweme/shortvideo/BaseShortVideoContext;

    iget-object v9, v0, LX/0iWz;->LJFF:LX/0hvc;

    iget-object v10, v0, LX/0iWz;->LJI:LX/0iY9;

    iget-object v11, p0, LX/0iWx;->LIZIZ:LX/0iXZ;

    invoke-direct/range {v3 .. v11}, LX/0iX5;-><init>(Ljava/lang/String;LX/0iXB;ZLjava/util/Map;Lcom/ss/android/ugc/aweme/shortvideo/BaseShortVideoContext;LX/0hvc;LX/0iY9;LX/0iXZ;)V
    ...
    const-string v0, "video publishParams not found, ABORT"
    ...
    const-string v0, "video publishId not found, ABORT"
...
.method public final LIZIZ(LX/0hvh;)Z
    ...
    sget-object v0, LX/0iWx;->LIZJ:Ljava/util/Map;
