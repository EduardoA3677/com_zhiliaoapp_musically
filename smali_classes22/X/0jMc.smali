...
# instance fields
.field public final synthetic LIZ:LX/0jMf;


# direct methods
.method public constructor <init>(LX/0jMf;)V
    .locals 0

    iput-object p1, p0, LX/0jMc;->LIZ:LX/0jMf;
...
.method public final LIZ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Lcom/ss/android/ugc/aweme/notice/repo/list/bean/BaseNotice;IZ)V
    ...
    instance-of v0, p1, LX/0jLU;

    if-eqz v0, :cond_0

    check-cast p1, LX/0jLU;

    invoke-virtual {p1, p2}, LX/0jLU;->A6(Lcom/ss/android/ugc/aweme/notice/repo/list/bean/BaseNotice;)V
...
.method public final LIZJ(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v0, v1, Lcom/ss/android/ugc/aweme/notice/repo/list/bean/BaseNotice;->businessAccountNotice:Lcom/ss/android/ugc/aweme/notice/repo/list/bean/BusinessAccountNotice;
...
.method public final LJFF(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    new-instance v1, LX/0jLU;

    iget-object v0, p0, LX/0jMc;->LIZ:LX/0jMf;

    invoke-virtual {v0}, LX/0jMo;->LIZ()Lcom/ss/android/ugc/aweme/notification/vm/NotificationDetailVM;

    move-result-object v0

    invoke-direct {v1, v2, v0}, LX/0jLU;-><init>(Landroid/view/View;Lcom/ss/android/ugc/aweme/notification/vm/NotificationDetailVM;)V
