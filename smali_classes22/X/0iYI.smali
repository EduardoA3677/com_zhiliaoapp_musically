...
# direct methods
.method public constructor <init>(LX/0PLo;I)V
    .locals 5
    ...
    iput-object v0, p0, LX/0iYI;->LIZJ:Ljava/lang/Object;
    ...
    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/creation/config/DMBDImageUploadConfig;->getBackupNetworkType()I
    ...
    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/creation/config/DMBDImageUploadConfig;->getSocketNum()I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/ss/bduploader/BDImageXUploaderBase;->setSocketNum(I)V

    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/creation/config/DMBDImageUploadConfig;->getFileRetryCount()I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/ss/bduploader/BDImageXUploaderBase;->setFileRetryCount(I)V

    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/creation/config/DMBDImageUploadConfig;->getRwTimeout()I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/ss/bduploader/BDImageXUploaderBase;->setRWTimeout(I)V

    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/creation/config/DMBDImageUploadConfig;->getMaxFailTimes()I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/ss/bduploader/BDImageXUploaderBase;->setMaxFailTime(I)V

    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/creation/config/DMBDImageUploadConfig;->getHttpsEnable()I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/ss/bduploader/BDImageXUploaderBase;->setEnableHttps(I)V

    invoke-virtual {v3, v2}, Lcom/ss/bduploader/BDImageXUploaderBase;->setProcessActionType(I)V
    ...
    :goto_0
    iput-object v3, p0, LX/0iYI;->LJ:Lcom/ss/bduploader/BDImageXUploader;
...
.method public final LIZ()V
    ...
    iget-object v1, p0, LX/0iYI;->LIZIZ:LX/040L;
    ...
    :cond_0
    iget-object v0, p0, LX/0iYI;->LJ:Lcom/ss/bduploader/BDImageXUploader;
...
.method public final LIZIZ([Ljava/lang/String;LX/0PJi;)V
    .locals 5
    ...
    iget-object v1, p0, LX/0iYI;->LJ:Lcom/ss/bduploader/BDImageXUploader;
    ...
    invoke-direct {v0, p0, v2, v4, p2}, LX/0iYH;-><init>(LX/0iYI;LX/01rK;LX/01lt;LX/0PJi;)V
    ...
    invoke-direct {v2, v4, p0, p2, v1}, LX/03nr;-><init>(LX/01lt;LX/0iYI;LX/0iYL;LX/02wT;)V
    ...
    iput-object v0, p0, LX/0iYI;->LIZIZ:LX/040L;
