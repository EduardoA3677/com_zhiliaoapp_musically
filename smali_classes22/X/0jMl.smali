...
# instance fields
.field public final synthetic LIZ:LX/0jMk;


# direct methods
.method public constructor <init>(LX/0jMk;)V
    .locals 0

    iput-object p1, p0, LX/0jMl;->LIZ:LX/0jMk;
...
.method public final LIZ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Lcom/ss/android/ugc/aweme/notice/repo/list/bean/BaseNotice;IZ)V
    ...
    instance-of v0, p1, LX/0jMq;

    if-eqz v0, :cond_0

    check-cast p1, LX/0jMq;

    invoke-virtual {p1, p2}, LX/0jMq;->A6(Lcom/ss/android/ugc/aweme/notice/repo/list/bean/BaseNotice;)V
...
.method public final LJFF(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v0, p0, LX/0jMl;->LIZ:LX/0jMk;

    invoke-virtual {v0}, LX/0jMo;->LIZ()Lcom/ss/android/ugc/aweme/notification/vm/NotificationDetailVM;

    move-result-object v0

    invoke-direct {v1, v2, v0}, LX/0jMq;-><init>(Landroid/view/View;Lcom/ss/android/ugc/aweme/notification/vm/NotificationDetailVM;)V
