...
.method public constructor <init>(LX/0o6h;Landroid/content/Context;)V
    ...
    iput-object p1, p0, LX/0o6g;->LLILLJJLI:LX/0o6h;

    invoke-direct {p0, p2}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    const/4 v0, -0x1

    iput v0, p0, LX/0o6g;->LLILIL:I

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, LX/0o6g;->LLILLIZIL:Landroid/graphics/Paint;
...
.method public final LIZ()V
    ...
    iget-object v0, p0, LX/0o6g;->LLILLJJLI:LX/0o6h;
    ...
    iget-object v1, p0, LX/0o6g;->LLILLJJLI:LX/0o6h;

    iget-object v0, v1, LX/0o6h;->LLILIL:LX/0o6m;
    ...
    iget v0, v0, LX/0o6m;->LIZ:I

    invoke-static {v1, v2, v0}, LX/0o6e;->LIZ(LX/0o6h;Landroid/view/View;I)Landroid/graphics/RectF;
...
.method public final LIZIZ(Landroid/view/View;Landroid/view/View;F)V
    ...
    iget-object v2, p0, LX/0o6g;->LLILLJJLI:LX/0o6h;

    iget-object v1, v2, LX/0o6h;->LLILIL:LX/0o6m;

    if-eqz v1, :cond_0

    invoke-virtual {v2}, LX/0o6h;->getTabSelectedIndicator()Landroid/graphics/drawable/Drawable;

    move-result-object v5

    iget v0, v1, LX/0o6m;->LIZ:I

    invoke-static {v2, p1, v0}, LX/0o6e;->LIZ(LX/0o6h;Landroid/view/View;I)Landroid/graphics/RectF;

    move-result-object v7

    iget v0, v1, LX/0o6m;->LIZ:I

    invoke-static {v2, p2, v0}, LX/0o6e;->LIZ(LX/0o6h;Landroid/view/View;I)Landroid/graphics/RectF;
    ...
    invoke-virtual {v0}, LX/0o6h;->getTabSelectedIndicator()Landroid/graphics/drawable/Drawable;
...
.method public final LIZJ(ZII)V
    ...
    invoke-virtual {p0}, LX/0o6g;->LIZ()V
    ...
    iput-object v2, p0, LX/0o6g;->LL:Landroid/animation/ValueAnimator;
    ...
    :cond_2
    iget-object v0, p0, LX/0o6g;->LL:Landroid/animation/ValueAnimator;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, v2, LX/0o6h;->LLIZ:Z

    move-object v6, p1

    if-eqz v0, :cond_0

    iget-object v1, p0, LX/0o6g;->LLILLIZIL:Landroid/graphics/Paint;

    iget v0, v2, LX/0o6h;->LLILLJJLI:I
    ...
    iget-object v11, p0, LX/0o6g;->LLILLIZIL:Landroid/graphics/Paint;
...
.method public final onLayout(ZIIII)V
    ...
    iget v1, p0, LX/0o6g;->LLILIL:I

    const/4 v0, -0x1

    invoke-virtual {p0, v2, v1, v0}, LX/0o6g;->LIZJ(ZII)V
...
.method public final onMeasure(II)V
    ...
    iget-boolean v0, v0, LX/0o6h;->LLJJJIL:Z
    ...
    iput-boolean v2, v0, LX/0o6h;->LLJJJIL:Z
    ...
    iget v0, v1, LX/0o6h;->LLILZLL:I

    const/4 v3, 0x1

    if-ne v0, v3, :cond_3

    iget v0, v1, LX/0o6h;->LLILZIL:I
