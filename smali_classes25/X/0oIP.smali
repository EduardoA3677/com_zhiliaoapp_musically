...
# direct methods
.method public constructor <init>(LX/0oIJ;)V
    .locals 0

    iput-object p1, p0, LX/0oIP;->LIZ:LX/0oIJ;
...
.method public final LIZ(IIIZ)V
    ...
    iget-object v0, p0, LX/0oIP;->LIZ:LX/0oIJ;

    iget-object v0, v0, LX/0oIJ;->LIZLLL:LX/0oIM;
    ...
    :cond_1
    iget-object v1, p0, LX/0oIP;->LIZ:LX/0oIJ;

    iget-object v0, v1, LX/0oIJ;->LIZ:LX/0oRX;

    if-eqz v0, :cond_2

    invoke-virtual {v1}, LX/0oIJ;->LIZ()V
