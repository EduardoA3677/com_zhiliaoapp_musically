...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v3}, LX/0oOf;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/0oMW;->LLILZ:F

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, p0, LX/0oMW;->LLILZIL:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, LX/0oMW;->LLILZLL:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, LX/0oMW;->LLIZLLLIL:LX/05ta;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, LX/0oMW;->LLJ:Landroid/graphics/Path;
    ...
    iput v0, p0, LX/0oMW;->LLJI:F

    invoke-static {v1}, LX/0CPO;->LIZIZ(Ljava/lang/Number;)F

    move-result v0

    iput v0, p0, LX/0oMW;->LLJIJIL:F

    invoke-static {v1}, LX/0CPO;->LIZIZ(Ljava/lang/Number;)F

    move-result v0

    iput v0, p0, LX/0oMW;->LLJILJIL:F

    invoke-static {v1}, LX/0CPO;->LIZIZ(Ljava/lang/Number;)F

    move-result v0

    iput v0, p0, LX/0oMW;->LLJILJILJ:F
...
.method private final getHighLightPaint()Landroid/graphics/Paint;
    ...
    iget-object v0, p0, LX/0oMW;->LLIZLLLIL:LX/05ta;
...
.method public final LIZ(IZZLandroid/view/View;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Float;Z)V
    ...
    invoke-virtual {p0, v1}, LX/0oMW;->setHasLeftTail(Z)V

    invoke-virtual {p0, v1}, LX/0oMW;->setHasRightTail(Z)V

    iput-boolean v1, p0, LX/0oMW;->LLILLIZIL:Z

    iput-boolean v1, p0, LX/0oMW;->LLILLJJLI:Z
    ...
    invoke-virtual {p0, v2}, LX/0oMW;->setHasLeftTail(Z)V
    ...
    invoke-virtual {p0, v2}, LX/0oMW;->setHasRightTail(Z)V
    ...
    iput-boolean v2, p0, LX/0oMW;->LLILLIZIL:Z
    ...
    iput-boolean v2, p0, LX/0oMW;->LLILLJJLI:Z
...
.method public final dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0}, LX/0oMW;->getHasLeftTail()Z
    ...
    iget-boolean v1, v0, LX/0oMW;->LLILLIZIL:Z
    ...
    :goto_0
    invoke-virtual {v0}, LX/0oMW;->getHasRightTail()Z

    move-result v1

    if-nez v1, :cond_7

    iget-boolean v1, v0, LX/0oMW;->LLILLJJLI:Z
    ...
    :goto_1
    invoke-virtual {v0}, LX/0oMW;->getIndentation()F
    ...
    iget v4, v0, LX/0oMW;->LLJI:F

    invoke-virtual {v0, v4}, LX/0oMW;->LIZJ(F)F

    move-result v19

    iget v4, v0, LX/0oMW;->LLJIJIL:F

    invoke-virtual {v0, v4}, LX/0oMW;->LIZJ(F)F

    move-result v7

    iget v4, v0, LX/0oMW;->LLJILJILJ:F

    invoke-virtual {v0, v4}, LX/0oMW;->LIZJ(F)F

    move-result v18

    iget v4, v0, LX/0oMW;->LLJILJIL:F

    invoke-virtual {v0, v4}, LX/0oMW;->LIZJ(F)F

    move-result v17

    iget-object v4, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    iget-object v6, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;
    ...
    iget-object v7, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;
    ...
    iget-object v8, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;
    ...
    iget-object v9, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;
    ...
    iget-object v3, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;
    ...
    :cond_0
    invoke-virtual {v0}, LX/0oMW;->getDrawType()I
    ...
    iget-object v2, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;

    iget-object v1, v0, LX/0oMW;->LLILZIL:Landroid/graphics/Paint;

    invoke-virtual {v3, v2, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v2, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;

    iget-object v1, v0, LX/0oMW;->LLILZLL:Landroid/graphics/Paint;

    invoke-virtual {v3, v2, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    :cond_1
    :goto_4
    iget-boolean v1, v0, LX/0oMW;->LLIZ:Z

    if-eqz v1, :cond_2

    iget-object v2, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;

    invoke-direct {v0}, LX/0oMW;->getHighLightPaint()Landroid/graphics/Paint;
    ...
    invoke-super {v0, v3}, Landroid/view/ViewGroup;->dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, LX/0oMW;->LLJ:Landroid/graphics/Path;
...
.method public final dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v0}, LX/0oMW;->setClickX(F)V

    invoke-virtual {p1}, Landroid/view/MotionEvent;->getY()F

    move-result v0

    invoke-virtual {p0, v0}, LX/0oMW;->setClickY(F)V

    :cond_0
    invoke-super {p0, p1}, LX/0oOf;->dispatchTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public getHasLeftTail()Z
    ...
    iget-boolean v0, p0, LX/0oMW;->LLILIL:Z
...
.method public getHasRightTail()Z
    ...
    iget-boolean v0, p0, LX/0oMW;->LLILL:Z
...
.method public final getLocationInWindow([I)V
    ...
    invoke-super {p0, p1}, Landroid/view/ViewGroup;->getLocationInWindow([I)V
...
.method public setBackgroundDrawColor(I)V
    ...
    iget-object v0, p0, LX/0oMW;->LLILZIL:Landroid/graphics/Paint;
...
.method public setCornerRadius(F)V
    ...
    invoke-virtual {p0, v3, v2, v1, v0}, LX/0oMW;->LIZIZ(Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Float;)V
...
.method public setHasLeftTail(Z)V
    ...
    iput-boolean p1, p0, LX/0oMW;->LLILIL:Z
...
.method public setHasRightTail(Z)V
    ...
    iput-boolean p1, p0, LX/0oMW;->LLILL:Z
...
.method public setHighLightDrawColor(I)V
    ...
    invoke-direct {p0}, LX/0oMW;->getHighLightPaint()Landroid/graphics/Paint;
...
.method public setStrokeDrawColor(I)V
    ...
    iget-object v1, p0, LX/0oMW;->LLILZLL:Landroid/graphics/Paint;
...
.method public setUI(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-virtual {v7, v1}, LX/0oMW;->setDrawType(I)V
    ...
    invoke-virtual {v7, v1}, LX/0oMW;->setCornerRadius(F)V
    ...
    invoke-virtual {v7, v4, v3, v2, v1}, LX/0oMW;->LIZIZ(Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    invoke-virtual {v7, v1}, LX/0oMW;->setStrokeDrawColor(I)V
    ...
    invoke-virtual {v7, v1}, LX/0oMW;->setBackgroundDrawColor(I)V
    ...
    iput-boolean v1, v7, LX/0oMW;->LLIZ:Z

    invoke-virtual {v7, v2}, LX/0oMW;->setHighLightDrawColor(I)V
    ...
    invoke-virtual {v7, v0}, LX/0oMW;->setIndentation(F)V
    ...
    :cond_b
    iput-boolean v5, v7, LX/0oMW;->LLIZ:Z
