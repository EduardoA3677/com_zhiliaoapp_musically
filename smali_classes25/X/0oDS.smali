...
.method public constructor <init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)V
    ...
    iput v0, p0, LX/0oDS;->LJI:I

    iput-object p2, p0, LX/0oDS;->LJ:Landroid/graphics/drawable/Drawable;
...
.method public final LIZIZ()Landroid/view/View;
    ...
    new-instance v4, LX/14iI;

    const/4 v2, -0x1

    invoke-direct {v4, v2}, LX/14iI;-><init>(I)V

    iget v1, p0, LX/0oDS;->LJFF:I

    iget v0, p0, LX/0oDS;->LJI:I

    const/4 v3, 0x0

    invoke-virtual {v8, v3, v1, v3, v0}, Landroid/view/View;->setPadding(IIII)V

    invoke-static {v8, v4}, LX/0X3I;->Q2(LX/14iG;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v6, p0, LX/0oDS;->LJ:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v3}, LX/12ri;->LIZ(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
