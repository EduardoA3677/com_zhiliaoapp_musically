.class public final Lcom/ss/android/ugc/aweme/im/sdk/chat/analytics/IMChatAnalytics;
...
# static fields
.field public static final LIZIZ:Lcom/ss/android/ugc/aweme/im/sdk/chat/analytics/IMChatAnalytics;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lcom/ss/android/ugc/aweme/im/sdk/chat/analytics/IMChatAnalytics;

    invoke-direct {v0}, Lcom/ss/android/ugc/aweme/im/sdk/chat/analytics/IMChatAnalytics;-><init>()V

    sput-object v0, Lcom/ss/android/ugc/aweme/im/sdk/chat/analytics/IMChatAnalytics;->LIZIZ:Lcom/ss/android/ugc/aweme/im/sdk/chat/analytics/IMChatAnalytics;
...
.method public final LIZ(Ljava/lang/String;Ljava/lang/String;LX/03Nm;)V
    ...
    const-string v0, "chat_setting_click"
...
.method public final LIZIZ(Lcom/ss/android/ugc/aweme/im/chatroom/api/model/SessionInfo;LX/03Nm;)V
    ...
    invoke-interface {v1, p1, v0}, LX/0iqz;->LIZ(Lcom/ss/android/ugc/aweme/im/chatroom/api/model/SessionInfo;Z)Ljava/lang/String;
    ...
    const-string v0, "change_setting_toast_response"
...
.method public final LJ(LX/0bWu;LX/03Nm;)V
    ...
    invoke-virtual {p1}, LX/0bWu;->isRisky()Z
    ...
    invoke-virtual {v4, v0}, LX/0yYT;->putAll(Ljava/util/Map;)V
    ...
    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/im/chatroom/api/model/SessionInfo;->getExtraMobParams()Ljava/util/Map;

    move-result-object v0

    const-string v1, "chat_section"
    ...
    :cond_4
    const-string v0, "receive_message_request_show"

    invoke-interface {p2, v0, v4}, LX/03Nm;->LIZ(Ljava/lang/String;Ljava/util/Map;)V
...
.method public final LJFF(Ljava/lang/String;Ljava/util/Map;LX/02wT;)Ljava/lang/Object;
    ...
    instance-of v0, p3, LX/0bUU;

    if-eqz v0, :cond_e

    move-object v6, p3

    check-cast v6, LX/0bUU;

    iget v2, v6, LX/0bUU;->LLILLIZIL:I
    ...
    iput v2, v6, LX/0bUU;->LLILLIZIL:I

    :goto_0
    iget-object v3, v6, LX/0bUU;->LLILIL:Ljava/lang/Object;

    invoke-static {}, LX/0PB2;->LJFF()Ljava/lang/Object;

    move-result-object v7

    iget v0, v6, LX/0bUU;->LLILLIZIL:I
    ...
    iget-object p2, v6, LX/0bUU;->LL:Ljava/lang/Object;
    ...
    :cond_2
    sget-object v3, Lcom/ss/android/ugc/aweme/im/sdk/common/controller/analytics/IMAnalyticsUtil;->LIZIZ:Lcom/ss/android/ugc/aweme/im/sdk/common/controller/analytics/IMAnalyticsUtil;
    ...
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/im/chatroom/api/model/SessionInfo;->getExtrasInfoMobParams()Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/im/chatroom/api/model/SessionInfo;->getTrafficTypeForMob()Ljava/lang/String;
    ...
    :cond_4
    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/im/sdk/common/controller/analytics/IMAnalyticsUtil;->getPid()Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/im/chatroom/api/model/SessionInfo;->getTrafficType()Ljava/lang/String;
    ...
    iput-object p2, v6, LX/0bUU;->LL:Ljava/lang/Object;

    iput v2, v6, LX/0bUU;->LLILLIZIL:I

    const/4 v0, 0x0

    invoke-virtual {v1, p1, v0, v6}, LX/11fw;->LJJIII(Ljava/lang/String;Ljava/lang/String;LX/02wT;)Ljava/lang/Object;
    ...
    iput v4, v6, LX/0bUU;->LLILLIZIL:I

    invoke-virtual {v2, v1, v0, v6}, LX/11fw;->LJJIII(Ljava/lang/String;Ljava/lang/String;LX/02wT;)Ljava/lang/Object;
    ...
    :cond_e
    new-instance v6, LX/0bUU;

    invoke-direct {v6, p0, p3}, LX/0bUU;-><init>(Lcom/ss/android/ugc/aweme/im/sdk/chat/analytics/IMChatAnalytics;LX/02wT;)V
...
.method public final LJI(Lcom/ss/android/ugc/aweme/im/chatroom/api/model/SessionInfo;LX/03Nm;)V
    ...
    const-string v0, "change_setting_toast_show"
