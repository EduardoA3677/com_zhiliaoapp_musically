...
# direct methods
.method public static LIZ(LX/0ako;LX/0jXU;)LX/0ajd;
    .locals 6

    instance-of v0, p1, LX/0ako;
    ...
    check-cast v5, LX/0ako;

    if-eqz v5, :cond_1

    new-instance v3, LX/0akq;
    ...
    invoke-interface {v5}, LX/0ako;->LJI()LX/0CHB;

    move-result-object v1

    invoke-interface {p0}, LX/0ako;->LJI()LX/0CHB;
    ...
    invoke-direct {v3, v2, v0}, LX/0akq;-><init>(ZZ)V
