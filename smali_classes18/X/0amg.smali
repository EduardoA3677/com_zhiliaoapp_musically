...
# direct methods
.method public static LIZ(LX/0amj;LX/0jXU;)LX/0ajd;
    .locals 5

    instance-of v0, p1, LX/0amj;
    ...
    invoke-interface {p0}, LX/0amj;->LJIIIZ()Ljava/util/List;

    move-result-object v1

    move-object v2, p1

    check-cast v2, LX/0amj;

    invoke-interface {v2}, LX/0amj;->LJIIIZ()Ljava/util/List;
    ...
    invoke-interface {p0}, LX/0amj;->LJIILIIL()Z

    move-result v1

    invoke-interface {v2}, LX/0amj;->LJIILIIL()Z
    ...
    :goto_0
    invoke-interface {p0}, LX/0amj;->LIZJ()LX/0awN;

    move-result-object v1

    invoke-interface {v4}, LX/0amj;->LIZJ()LX/0awN;
