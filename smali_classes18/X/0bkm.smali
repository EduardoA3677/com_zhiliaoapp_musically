...
# static fields
.field public static final LLILL:LX/0bkm;
...
.field public final synthetic LLILIL:LX/0bkp;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0bkm;->LLILL:LX/0bkm;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, LX/0bkm;->LLILLIZIL:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0bkm;->LL:Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;

    sget-object v0, LX/0bkp;->LL:LX/0bkp;

    iput-object v0, p0, LX/0bkm;->LLILIL:LX/0bkp;
...
.method public final LIZ()LX/0bWC;
    ...
    iget-object v0, p0, LX/0bkm;->LL:Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;
...
.method public final LIZIZ(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, LX/0bkm;->LJJIJ(Ljava/lang/String;)Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;
    ...
    :cond_1
    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;->getQuoteText()Ljava/lang/String;
...
.method public final LJIILIIL(ZLX/0i9W;Landroid/util/Size;LX/0bas;LX/0awL;)Z
    .locals 5

    new-instance v1, LX/0b21;

    invoke-direct {v1, p2}, LX/0b21;-><init>(LX/0i9W;)V

    invoke-virtual {p0, p2}, LX/0bkm;->LJI(LX/0i9W;)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0, v0}, LX/0bkm;->LJJIJ(Ljava/lang/String;)Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;
    ...
    :cond_1
    invoke-virtual {v1}, LX/0b21;->LIZJ()Z

    move-result v0

    if-nez v0, :cond_2

    sget-object v0, LX/0b8t;->LIZIZ:LX/0b8t;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p3, p2, p4, p5, v3}, LX/0b8t;->LIZJ(Landroid/util/Size;LX/0i9W;LX/1295;LX/0bai;Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;)Z
    ...
    :cond_2
    sget-object v2, LX/0b8t;->LIZIZ:LX/0b8t;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p3, p2, p4, p5, v3}, LX/0b8t;->LIZ(Landroid/util/Size;LX/0i9W;LX/1295;LX/0bai;Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;)Z
    ...
    :cond_3
    iget-object v0, v2, LX/0b8t;->LIZ:LX/0bVb;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p4, v3}, LX/0bVb;->LIZIZ(Landroid/view/View;Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;)V
    ...
    invoke-static {v3, p4, p1, v4}, LX/0b8t;->LIZIZ(Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;LX/1295;ZZ)V

    iget-object v0, v2, LX/0b8t;->LIZ:LX/0bVb;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v3, p2}, LX/0bVb;->LIZ(Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;LX/0i9W;)V

    new-instance v0, LX/0b21;

    invoke-direct {v0, p2}, LX/0b21;-><init>(LX/0i9W;)V

    invoke-virtual {v0}, LX/0b21;->LIZLLL()V
...
.method public final LJIILL(Ljava/lang/String;Ljava/lang/String;Z)LX/04Vj;
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;->getQuoteTopReceiver()Ljava/lang/String;
    ...
    invoke-direct {v2, v1, v0}, LX/04Vj;-><init>(Ljava/lang/String;Ljava/util/List;)V

    return-object v2

    :cond_3
    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;->getQuoteTopSender()Ljava/lang/String;
...
.method public final LJIJJ(LX/0i9W;Lcom/ss/android/ugc/aweme/im/message/content/BaseContent;)LX/0b4F;
    ...
    iget-object v0, p0, LX/0bkm;->LLILIL:LX/0bkp;

    invoke-virtual {v0, p1, p2}, LX/0bkp;->LJIJJ(LX/0i9W;Lcom/ss/android/ugc/aweme/im/message/content/BaseContent;)LX/0b4F;
...
.method public final LJIL(LX/02wT;)Ljava/lang/Object;
    ...
    instance-of v0, p1, LX/0bky;

    if-eqz v0, :cond_3

    move-object v7, p1

    check-cast v7, LX/0bky;

    iget v2, v7, LX/0bky;->LLILLL:I
    ...
    iput v2, v7, LX/0bky;->LLILLL:I

    :goto_0
    iget-object v0, v7, LX/0bky;->LLILLIZIL:Ljava/lang/Object;

    invoke-static {}, LX/0PB2;->LJFF()Ljava/lang/Object;

    move-result-object v3

    iget v1, v7, LX/0bky;->LLILLL:I
    ...
    iget-object v4, v7, LX/0bky;->LLILL:Lcom/bytedance/geckox/OptionCheckUpdateParams;

    iget-object v5, v7, LX/0bky;->LLILIL:LX/0WWc;

    iget-object v6, v7, LX/0bky;->LL:Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;->getGeckoAnimationChannel()Ljava/lang/String;
    ...
    invoke-virtual {v4, v2}, Lcom/bytedance/geckox/OptionCheckUpdateParams;->setEnableDownloadAutoRetry(Z)Lcom/bytedance/geckox/OptionCheckUpdateParams;

    sget-object v0, Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;->LLJIJIL:Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;

    iput-object v6, v7, LX/0bky;->LL:Ljava/lang/Object;

    iput-object v5, v7, LX/0bky;->LLILIL:LX/0WWc;

    iput-object v4, v7, LX/0bky;->LLILL:Lcom/bytedance/geckox/OptionCheckUpdateParams;

    iput v2, v7, LX/0bky;->LLILLL:I

    invoke-virtual {v0, v7}, Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;->LJJLL(LX/02wT;)Ljava/lang/Object;
    ...
    :cond_3
    new-instance v7, LX/0bky;

    invoke-direct {v7, p0, p1}, LX/0bky;-><init>(LX/0bkm;LX/02wT;)V
...
.method public final LJJII(LX/0i9W;)LX/0b21;
    .locals 1

    new-instance v0, LX/0b21;

    invoke-direct {v0, p1}, LX/0b21;-><init>(LX/0i9W;)V

    return-object v0
.end method

.method public final LJJIII(ZLX/0i9W;Landroid/util/Size;Lcom/ss/android/ugc/aweme/base/ui/RemoteImageView;LX/0auB;)Z
    .locals 5
    ...
    invoke-static {p3, p2, p4, v0, v3}, LX/0b8t;->LIZ(Landroid/util/Size;LX/0i9W;LX/1295;LX/0bai;Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;)Z
...
.method public final LJJIIZI(LX/0i9W;Lkotlin/jvm/internal/AwS527S0100000_17;)V
    .locals 18
    ...
    invoke-virtual {v0, v1}, LX/0bkm;->LJJJZ(LX/0i9W;)Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;
    ...
    iget-object v3, v0, LX/0bkm;->LL:Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;

    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;->LJJZZIII()Lcom/ss/android/ugc/aweme/profile/model/User;
    ...
    sget-object v5, LX/0blf;->COMMON_LIGHT_INTERACTION:LX/0blf;

    invoke-static {v6, v5}, Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;->LJJZZI(Ljava/lang/String;LX/0blf;)LX/0blB;
    ...
    :goto_1
    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/im/lightinteract/impl/serviceimpl/LightInteractionManager;->LJLI()Lcom/ss/android/ugc/aweme/im/strategy/IStrategyPlatformService;

    move-result-object v0

    invoke-interface {v0, v5, v6, v4}, Lcom/ss/android/ugc/aweme/im/strategy/IStrategyPlatformService;->LIZJ(LX/0blf;Ljava/lang/String;Z)Ljava/util/Map;
    ...
    const-string v0, "streak_sticker_"
    ...
    :cond_6
    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;->getGeckoAnimationChannel()Ljava/lang/String;
    ...
    :cond_7
    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;->getFullscreenAnimateId()Ljava/lang/String;
    ...
    invoke-static {v2, v11, v0, v3}, LX/0WSn;->LIZJ(Ljava/lang/String;Ljava/lang/Long;ZLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v0, v15}, Lkotlin/text/v;->LJIILLIIL(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-direct {v0, v2}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;-><init>(Ljava/lang/String;)V

    invoke-static {}, Lcom/ss/android/ugc/aweme/framework/services/ServiceManager;->get()Lcom/ss/android/ugc/aweme/framework/services/ServiceManager;

    move-result-object v3

    const-class v2, Lcom/ss/android/ugc/aweme/im/strategy/resourceload/IDMResourceLoadService;
    ...
    invoke-interface {v2}, Lcom/ss/android/ugc/aweme/im/strategy/resourceload/IDMResourceLoadService;->LIZIZ()LX/0ioF;

    move-result-object v8

    const-string v9, "light_interaction_gecko"

    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;->getInteractionName()Ljava/lang/String;

    move-result-object v10

    invoke-static {}, LX/09Rz;->LIZ()D
    ...
    invoke-interface/range {v8 .. v14}, LX/0ioF;->LIZIZ(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/Double;)V
    ...
    invoke-static {v3, v2, v15}, Lkotlin/text/v;->LJIILLIIL(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v2

    if-eqz v2, :cond_9

    sget-object v3, LX/0bkm;->LLILLIZIL:Ljava/util/Map;
    ...
    check-cast v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;
    ...
    :goto_4
    :try_start_0
    invoke-static {v4}, LX/0Z1t;->LJI(Ljava/io/File;)Ljava/lang/String;

    move-result-object v3

    const-class v2, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel;

    invoke-static {v2, v3}, LX/0BDy;->LIZIZ(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel;
    ...
    const-string v13, "parse_exception"
    ...
    :cond_b
    sget-object v2, LX/0bkm;->LLILLIZIL:Ljava/util/Map;
    ...
    const-string v1, "alpha video config: "
    ...
    iget v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->align:I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setScaleType(I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->version:I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setVersion(I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->totalFrame:I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setTotalFrame(I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->videoWidth:I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setVideoWidth(I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->videoHeight:I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setVideoHeight(I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->actualWidth:I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setActualWidth(I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->actualHeight:I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setActualHeight(I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget-object v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->alphaFrame:[I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setAlphaArea([I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget-object v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->rgbFrame:[I

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setRgbArea([I)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    iget-object v1, v3, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;->masks:Ljava/util/Map;

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;->setMasks(Ljava/util/Map;)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;

    goto :goto_7

    :goto_5
    iget-object v3, v2, Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel;->portrait:Lcom/ss/android/ugc/aweme/im/lightinteract/api/model/AlphaVideoFileModel$Item;
    ...
    invoke-virtual {v1, v0}, Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource;->setPortraitDataInfo(Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource$DataInfo;)Lcom/ss/android/ugc/aweme/live/alphaplayer/model/DataSource;

    move-object/from16 v0, p2

    invoke-virtual {v0, v1}, Lkotlin/jvm/internal/AwS527S0100000_17;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v12, "light_interaction_gecko"
...
.method public final LJJJI(LX/0i9W;Lcom/ss/android/ugc/aweme/im/message/template/component/AttachmentComponent;Ljava/lang/String;Ljava/lang/String;)Lcom/ss/android/ugc/aweme/im/message/template/card/BaseTemplate;
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, LX/0bkp;->LJJJI(LX/0i9W;Lcom/ss/android/ugc/aweme/im/message/template/component/AttachmentComponent;Ljava/lang/String;Ljava/lang/String;)Lcom/ss/android/ugc/aweme/im/message/template/card/BaseTemplate;
...
.method public final LJJJJJL(JJLX/0i9W;)V
    .locals 6

    new-instance v5, LX/0b21;

    invoke-direct {v5, p5}, LX/0b21;-><init>(LX/0i9W;)V

    invoke-virtual {p5}, LX/0i9W;->getIndex()J
    ...
    :cond_0
    invoke-virtual {v5}, LX/0b21;->LIZ()Z
    ...
    const-string v0, "  isNewestLightInteraction:"

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v0, "  canInteract:"
    ...
    invoke-virtual {v5}, LX/0b21;->LJ()V
...
.method public final LJJJLL(LX/0i9W;Landroid/view/View;)Z
    .locals 4

    new-instance v3, LX/0b21;

    invoke-direct {v3, p1}, LX/0b21;-><init>(LX/0i9W;)V

    invoke-virtual {p0, p1}, LX/0bkm;->LJI(LX/0i9W;)Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v3}, LX/0b21;->LIZJ()Z
    ...
    :cond_2
    sget-object v1, LX/0b8u;->LIZIZ:LX/0b8u;

    iget-object v0, v1, LX/0b8u;->LIZ:LX/0bVb;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p2, v2}, LX/0bVb;->LIZIZ(Landroid/view/View;Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;)V

    iget-object v0, v1, LX/0b8u;->LIZ:LX/0bVb;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2, p1}, LX/0bVb;->LIZ(Lcom/ss/android/ugc/aweme/im/strategy/commonresource/LightInteractionCommonResource;LX/0i9W;)V
