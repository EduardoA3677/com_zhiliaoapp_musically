...
.method public final LIZJ(LX/02wT;)Ljava/lang/Object;
    ...
    instance-of v0, p1, LX/0aXC;

    if-eqz v0, :cond_5

    move-object v6, p1

    check-cast v6, LX/0aXC;

    iget v2, v6, LX/0aXC;->LLILLL:I
    ...
    iput v2, v6, LX/0aXC;->LLILLL:I

    :goto_0
    iget-object v7, v6, LX/0aXC;->LLILLIZIL:Ljava/lang/Object;

    invoke-static {}, LX/0PB2;->LJFF()Ljava/lang/Object;

    move-result-object v3

    iget v0, v6, LX/0aXC;->LLILLL:I

    const-string v1, "TopEffectBanner"
    ...
    iget-object v4, v6, LX/0aXC;->LLILL:Lcom/ss/android/ugc/profile/business/effect/dashboard/PopupBannerItem;

    iget-object v5, v6, LX/0aXC;->LLILIL:Ljava/lang/Object;

    check-cast v5, Landroid/content/Context;

    iget-object v2, v6, LX/0aXC;->LL:Ljava/lang/Object;
    ...
    invoke-virtual {v4}, Lcom/ss/android/ugc/profile/business/effect/dashboard/PopupBannerItem;->getEffectIconUrl()Ljava/lang/String;

    move-result-object v0

    iput-object v2, v6, LX/0aXC;->LL:Ljava/lang/Object;

    iput-object v5, v6, LX/0aXC;->LLILIL:Ljava/lang/Object;

    iput-object v4, v6, LX/0aXC;->LLILL:Lcom/ss/android/ugc/profile/business/effect/dashboard/PopupBannerItem;

    iput v8, v6, LX/0aXC;->LLILLL:I

    invoke-static {v0, v5, v6}, LX/0aXF;->LIZIZ(Ljava/lang/String;Landroid/content/Context;LX/0PAw;)Ljava/lang/Object;
    ...
    :cond_5
    new-instance v6, LX/0aXC;

    invoke-direct {v6, p0, p1}, LX/0aXC;-><init>(LX/0aXA;LX/02wT;)V
    ...
    invoke-direct {v1, p0, v4, v5, v0}, Lkotlin/jvm/internal/AwS215S0300000_17;-><init>(LX/0aXA;Lcom/ss/android/ugc/profile/business/effect/dashboard/PopupBannerItem;Landroid/content/Context;I)V

    iget-object v0, v3, LX/11G7;->LIZ:LX/0WCL;

    iput-object v1, v0, LX/0WCL;->LJIILJJIL:Lkotlin/jvm/functions/Function1;

    iput-object v3, p0, LX/0aXA;->LJI:LX/11G7;
...
.method public final LIZLLL()LX/11GA;
    ...
    iget-object v3, p0, LX/0aXF;->LIZJ:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v7, p0, LX/0aXA;->LJI:LX/11G7;
    ...
    :cond_1
    invoke-virtual {v3}, Lcom/ss/android/ugc/profile/business/effect/dashboard/PopupBannerItem;->getAppEffectId()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v3}, Lcom/ss/android/ugc/profile/business/effect/dashboard/PopupBannerItem;->getTopEffectRankingBanner()Lcom/ss/android/ugc/profile/business/effect/dashboard/TopEffectRankingBannerInfo;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lcom/ss/android/ugc/profile/business/effect/dashboard/TopEffectRankingBannerInfo;->getRankType()Ljava/lang/String;
    ...
    const-string v0, "self_profile_top_effect_banner_show"
    ...
    new-instance v0, LX/0aRU;

    invoke-direct {v0, v5, v4, v3, v8}, LX/0aRU;-><init>(Lcom/ss/android/ugc/profile/business/effect/EffectProfileListViewModel;ILjava/lang/String;LX/02wT;)V

    invoke-static {v2, v1, v8, v0, v6}, LX/15Ap;->LIZLLL(LX/02uK;Lkotlin/coroutines/CoroutineContext;LX/0PB8;Lkotlin/jvm/functions/Function2;I)LX/040L;

    :cond_4
    invoke-virtual {v7}, LX/11G7;->LJ()V

    iget-object v0, v7, LX/11G7;->LJ:LX/11GA;
