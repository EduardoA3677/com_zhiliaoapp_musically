...
.method public static LIZJ(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, p1}, LX/0IIF;-><init>(Ljava/util/List;)V
...
.method public static LIZLLL(Ljava/lang/String;Ljava/util/Map;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static LJ(Ljava/lang/Object;Ljava/lang/Object;)Z
    .locals 0
...
.method public static LJFF(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
    ...
    instance-of v0, p1, LX/0IIF;

    if-eqz v0, :cond_0

    check-cast p1, LX/0IIF;

    iget-object p1, p1, LX/0IIF;->LLILIL:Ljava/util/List;
    ...
    new-instance v1, LX/0HQP;

    invoke-direct {v1, p1}, LX/0HQP;-><init>(Ljava/util/List;)V
...
.method public static LJI(Ljava/lang/String;Ljava/util/Map;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static varargs LJII([Ljava/lang/Object;)V
    .locals 5
...
.method public static LJIIIIZZ()LX/0IIF;
    .locals 2
    ...
    invoke-direct {v1, v0}, LX/0IIF;-><init>(Ljava/util/List;)V

    return-object v1
.end method

.method public static LJIIIZ(Ljava/util/List;Lcom/squareup/wire/ProtoAdapter;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static LJIIJ(Ljava/util/Map;Lcom/squareup/wire/ProtoAdapter;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
