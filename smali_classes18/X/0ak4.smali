...
# direct methods
.method public static LIZ(LX/0ak5;LX/0jXU;)LX/0ajd;
    .locals 5

    instance-of v0, p1, LX/0ak5;
    ...
    invoke-interface {p0}, LX/0ak5;->LLIILZL()[C

    move-result-object v1

    invoke-interface {v4}, LX/0ak5;->LLIILZL()[C
    ...
    :goto_0
    invoke-interface {p0}, LX/0ak5;->LIZJ()LX/0awN;

    move-result-object v1

    invoke-interface {v4}, LX/0ak5;->LIZJ()LX/0awN;
