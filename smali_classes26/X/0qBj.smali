...
# static fields
.field public static final LIZ:LX/0qBj;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0qBj;->LIZ:LX/0qBj;
    ...
    sput-object v1, LX/0qBj;->LIZIZ:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/Stack;

    invoke-direct {v0}, Ljava/util/Stack;-><init>()V

    sput-object v0, LX/0qBj;->LIZJ:Ljava/util/Stack;
...
.method public static LIZJ(ZZLjava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    ...
    const-string v0, "&block_back_press=1"
    ...
    const-string v0, "&insert_loading_below_kitview=1"
    ...
    const-string v0, "&spark_perf_bid=pipo_spark_biz"
    ...
    const-string v0, "&keyboard_adjust=2"
    ...
    const-string v0, "&keyboard_compat=1"
    ...
    invoke-static {p6}, LX/0sz7;->LJ(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v0, LX/0sz5;->LJ:Ljava/lang/String;
    ...
    invoke-static {p0, v1, v0}, LX/0oE2;->LIZJ(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public static LIZLLL()V
    ...
    sget-object v0, LX/0qBj;->LIZIZ:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-class v3, Lcom/ss/android/ugc/aweme/pipo/IPipoService;
    ...
    const-class v3, Lcom/ss/android/ugc/aweme/bnpl/IBNPLService;
    ...
    invoke-static {v1, v8, v0}, LX/0Wpa;->LIZIZ(Ljava/lang/Class;LX/0WFr;I)V
    ...
    invoke-interface {v1}, Lcom/ss/android/ugc/aweme/pipo/IPipoContainerService;->init()V

    sget-object v0, LX/0q5d;->LIZJ:Lkotlin/jvm/internal/AFwS292S0000000_25;

    invoke-interface {v1, v0}, Lcom/ss/android/ugc/aweme/pipo/IPipoContainerService;->LJIIL(Lkotlin/jvm/internal/AFwS292S0000000_25;)V
...
.method public static LJ(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;Z)V
    .locals 7
    ...
    :cond_1
    invoke-virtual {v4, p2}, Lcom/bytedance/hybrid/spark/SparkContext;->LJJJLZIJ(Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, v4}, LX/0Wwo;-><init>(Landroid/content/Context;Lcom/bytedance/hybrid/spark/SparkContext;)V
