...
.method public static LIZLLL(Landroid/net/Uri;Ljava/util/List;)Landroid/net/Uri$Builder;
    .locals 4
...
# virtual methods
.method public final LIZ(Landroid/net/Uri;)LX/0qMK;
    .locals 10
    ...
    invoke-static {p1, v9}, Lcom/bytedance/mt/protector/impl/UriProtector;->com_bytedance_mt_protector_impl_UriProtector_com_ss_android_ugc_aweme_lancet_UriLancet_getQueryParameter(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, p0, LX/0qMJ;->LIZ:Lkotlin/jvm/functions/Function0;
    ...
    check-cast v2, LX/0qMK;

    sget-object v0, LX/0qMM;->NATIVE:LX/0qMM;

    iput-object v0, v2, LX/0qMK;->LLILL:LX/0qMM;

    iput-object p1, v2, LX/0qMK;->LLILLJJLI:Landroid/net/Uri;

    iput-object p1, v2, LX/0qMK;->LLILLIZIL:Landroid/net/Uri;
    ...
    invoke-static {v2, v0}, LX/0qMJ;->LIZLLL(Landroid/net/Uri;Ljava/util/List;)Landroid/net/Uri$Builder;
    ...
    invoke-static {v4, v5}, LX/0qMJ;->LIZLLL(Landroid/net/Uri;Ljava/util/List;)Landroid/net/Uri$Builder;
    ...
    invoke-static {v0, v7}, LX/06QM;->LIZ(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    iget-object v0, p0, LX/0qMJ;->LIZIZ:Lkotlin/jvm/functions/Function0;
    ...
    iput-object v1, v2, LX/0qMK;->LLILLJJLI:Landroid/net/Uri;
...
.method public final LIZIZ(Lkotlin/jvm/functions/Function0;)LX/0qME;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0qMJ;->LIZIZ:Lkotlin/jvm/functions/Function0;

    return-object p0
.end method

.method public final LIZJ(Lkotlin/jvm/functions/Function0;)LX/0qME;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0qMJ;->LIZ:Lkotlin/jvm/functions/Function0;
