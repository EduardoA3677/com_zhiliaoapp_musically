...
# static fields
.field public static LIZ:LX/0pZT;
...
.method public static LIZ(LX/0umh;)V
    .locals 5

    sget-object v0, LX/0pxA;->LIZ:LX/0pZT;
    ...
    :cond_0
    sget-object v0, LX/0pxC;->LIZIZ:LX/05ta;

    invoke-interface {v0}, LX/05ta;->getValue()Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/ss/android/ugc/aweme/ecommerce/anchor/settings/InviteAndShareConfig;
    ...
    invoke-direct {v2, v4, p0, v1}, LX/0pxD;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/anchor/settings/InviteAndShareConfig;LX/0umh;LX/02wT;)V
...
.method public static LIZIZ(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    sget-object v1, LX/0pxA;->LIZ:LX/0pZT;

    if-eqz v1, :cond_1

    iget-object v0, v1, LX/0pZT;->LIZ:Ljava/lang/String;
    ...
    iget-object v0, v1, LX/0pZT;->LIZIZ:Lcom/ss/android/ugc/aweme/ecommerce/anchor/utils/CampaignInfoModel;

    if-eqz v0, :cond_1

    iget-object v2, v0, Lcom/ss/android/ugc/aweme/ecommerce/anchor/utils/CampaignInfoModel;->campaignInfo:Ljava/lang/String;

    :cond_1
    return-object v2
.end method

.method public static LIZJ(Lcom/ss/android/ugc/aweme/feed/model/Aweme;)Ljava/util/Map;
    .locals 0
    ...
    :goto_0
    invoke-static {p0}, LX/0pxA;->LIZLLL(Ljava/lang/String;)Ljava/util/Map;
...
.method public static LJ(Lcom/ss/android/ugc/aweme/feed/model/Aweme;)Z
    ...
    iget-object v1, v0, LX/0pZT;->LIZ:Ljava/lang/String;
...
.method public static LJFF(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-class v0, Lcom/ss/android/ugc/aweme/ecommerce/anchor/utils/CampaignInfoModel;
    ...
    instance-of v0, v1, Lcom/ss/android/ugc/aweme/ecommerce/anchor/utils/CampaignInfoModel;
    ...
    :cond_1
    check-cast v1, Lcom/ss/android/ugc/aweme/ecommerce/anchor/utils/CampaignInfoModel;
    ...
    :cond_2
    new-instance v0, LX/0pZT;

    invoke-direct {v0, p0, v3, p2}, LX/0pZT;-><init>(Ljava/lang/String;Lcom/ss/android/ugc/aweme/ecommerce/anchor/utils/CampaignInfoModel;Z)V

    sput-object v0, LX/0pxA;->LIZ:LX/0pZT;

    const-string v0, "found ec_campaign_info -> "
...
.method public static LJI(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p0}, LX/0PZl;->LIZJ(Ljava/lang/CharSequence;)V
