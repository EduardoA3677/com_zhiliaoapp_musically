.class public final Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;
...
.method public static constructor <clinit>()V
    ...
    const-class v3, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;

    const-string v2, "packageListViewModel"

    const-string v0, "getPackageListViewModel()Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/PackageListViewModel;"
    ...
    sput-object v5, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->LLILL:[LX/10fb;
...
.method public constructor <init>()V
    ...
    :goto_0
    iput-object v8, v0, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->LL:Lcom/bytedance/assem/arch/viewModel/AssemVMLazy;
...
.method public final onBindItemView(LX/0jXU;)V
    ...
    check-cast v3, LX/0CQE;

    sget-object v5, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/recharge/util/PanelUIUtil;->LIZ:Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/recharge/util/PanelUIUtil;
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->y6()Lwebcast/data/FirstRechargeModel$RechargeBannerListConfig;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v0, v0, Lwebcast/data/FirstRechargeModel$RechargeBannerListConfig;->selectedTextColor:Lwebcast/data/TouchPointColor;
    ...
    invoke-static {p1, v4, v0}, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/recharge/util/PanelUIUtil;->LIZJ(LX/0p1B;Landroid/content/Context;I)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {v3, v0}, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/recharge/util/PanelUIUtil;->LIZ(LX/0CQE;Ljava/lang/String;)V

    invoke-virtual {v3, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->LLILIL:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v0}, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->z6(Z)V
...
.method public final onBindItemView(LX/0jXU;Ljava/util/List;)V
    ...
    instance-of v0, v1, LX/04dx;

    if-eqz v0, :cond_0

    check-cast v1, LX/04dx;

    if-eqz v1, :cond_0

    iget-boolean v0, v1, LX/04dx;->LIZ:Z
...
.method public final onItemViewCreated()V
    ...
    iput-object v0, p0, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->LLILIL:Landroid/widget/TextView;
...
.method public final y6()Lwebcast/data/FirstRechargeModel$RechargeBannerListConfig;
    .locals 2

    iget-object v1, p0, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->LL:Lcom/bytedance/assem/arch/viewModel/AssemVMLazy;
    ...
    iget-object v0, v0, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/PackageListViewModel;->LLILIL:Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/communication/TouchPointAbility;
    ...
    invoke-interface {v1, v0}, LX/0p0n;->LIZ(Z)Lwebcast/data/FirstRechargeModel$RechargeBannerListConfig;
...
.method public final z6(Z)V
    ...
    invoke-virtual {v5, v0}, LX/12vb;->setStrokeWidth(F)V
    ...
    iget-object v0, v0, Lwebcast/data/FirstRechargeModel$RechargeBannerListConfig;->selectedBorderColor:Lwebcast/data/TouchPointColor;
    ...
    :goto_0
    invoke-static {v5, v0}, LX/0jnG;->LIZ(LX/12vb;Ljava/lang/String;)V

    iget-object v2, p0, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->LLILIL:Landroid/widget/TextView;
    ...
    iget-object v0, v0, Lwebcast/data/FirstRechargeModel$RechargeBannerListConfig;->selectedBackgroundColor:Lwebcast/data/TouchPointColor;

    if-eqz v0, :cond_3

    iget-object v1, v0, Lwebcast/data/TouchPointColor;->light:Ljava/lang/String;
    ...
    iget-object v3, v0, Lwebcast/data/TouchPointColor;->light:Ljava/lang/String;

    :cond_1
    invoke-static {v2, v1, v3}, LX/0jnG;->LIZIZ(Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0}, LX/12vb;->setStrokeColor(I)V

    :cond_6
    iget-object v3, p0, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/common/packages/RechargeCellStyle2;->LLILIL:Landroid/widget/TextView;

    if-eqz v3, :cond_7

    sget-object v2, Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/recharge/util/PanelUIUtil;->LIZ:Lcom/bytedance/android/livesdk/impl/revenue/strategy/panel/recharge/util/PanelUIUtil;
