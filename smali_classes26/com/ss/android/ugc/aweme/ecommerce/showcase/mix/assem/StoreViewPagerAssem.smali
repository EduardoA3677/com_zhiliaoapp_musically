.class public final Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;
...
.method public static constructor <clinit>()V
    ...
    const-class v3, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;
    ...
    sput-object v5, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJJ:[LX/10fb;
...
.method public constructor <init>()V
    ...
    iput-object v0, v2, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLILZLL:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, v2, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLIZ:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, v2, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLIZLLLIL:Ljava/util/ArrayList;
    ...
    iput-object v0, v2, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJ:Lcom/bytedance/assem/arch/viewModel/AssemVMLazy;
    ...
    iput-object v1, v2, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJI:Lm83/a;
...
.method public final Tm(Ljava/util/List;)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            ">;)",
            "Ljava/util/List<",
            "Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/view/StoreLynxTabFragment;",
            ">;"
        }
    .end annotation
    ...
    invoke-static {v7, v0, v6}, LX/0X3I;->LJIJJ(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/Parcelable;)V
    ...
    invoke-static {v0, v2}, LX/0qAd;->LIZIZ(Ljava/lang/String;Ljava/util/Map;)V
...
.method public final Um()Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/viewmodel/StoreMixViewModel;
    .locals 1

    iget-object v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJ:Lcom/bytedance/assem/arch/viewModel/AssemVMLazy;
...
.method public final Ym()LX/0o0p;
    .locals 2

    iget-object v1, p0, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJIJIL:LX/0o0p;
    ...
    iput-object v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJIJIL:LX/0o0p;
...
.method public final j41(LX/0o6h;)V
    ...
    iput-object v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJILJIL:Ljava/lang/ref/WeakReference;

    new-instance v0, LX/0qB0;

    invoke-direct {v0, p0}, LX/0qB0;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;)V
...
.method public final om(Landroid/view/View;)V
    ...
    iget-object v2, v6, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLILZLL:Ljava/util/ArrayList;

    new-instance v7, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/TabBarItemData;

    sget-object v5, LX/0qAk;->PRODUCT:LX/0qAk;

    invoke-virtual {v5}, LX/0qAk;->getValue()J
    ...
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->Tm(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    invoke-virtual {v2, v0}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v2, v6, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLIZ:Ljava/util/ArrayList;
    ...
    invoke-virtual {v6}, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->Ym()LX/0o0p;
    ...
    invoke-direct {v0, v4, v6}, LX/0qAy;-><init>(Landroidx/fragment/app/Fragment;Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;)V
    ...
    :cond_1
    invoke-virtual {v6}, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->Um()Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/viewmodel/StoreMixViewModel;
    ...
    invoke-direct {v1, v6, v0}, Lkotlin/jvm/internal/AwS535S0100000_25;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;I)V
    ...
    sget-object v8, LX/0qB9;->LL:LX/0qB9;
    ...
    invoke-direct {v10, v6, v0}, Lkotlin/jvm/internal/AwS568S0100000_25;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;I)V
...
.method public final onDestroy()V
    ...
    iget-object v1, p0, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLJI:Lm83/a;
...
.method public final onEvent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0}, LX/0qBF;-><init>()V
    ...
    iget-object v1, p0, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLIZ:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->Ym()LX/0o0p;

    move-result-object v0

    if-eqz v0, :cond_10

    invoke-virtual {v0, v1, v9}, LX/0o0p;->LJ(IZ)V
    ...
    invoke-direct {v0}, LX/0qBC;-><init>()V
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->Um()Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/viewmodel/StoreMixViewModel;
    ...
    :cond_d
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/ecommerce/showcase/mix/assem/StoreViewPagerAssem;->LLIZLLLIL:Ljava/util/ArrayList;
