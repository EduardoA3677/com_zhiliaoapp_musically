.class public Lcom/ss/bduploader/net/BDHTTPNetwork$2;
...
.method public onFailure(LX/0yr0;Ljava/io/IOException;)V
    ...
    iget-object v4, p0, Lcom/ss/bduploader/net/BDHTTPNetwork$2;->val$listener:Lcom/ss/bduploader/net/BDVNetClient$CompletionListener;
...
.method public onResponse(LX/0yr0;LX/0yvx;)V
    ...
    iget-object v0, p0, Lcom/ss/bduploader/net/BDHTTPNetwork$2;->val$listener:Lcom/ss/bduploader/net/BDVNetClient$CompletionListener;

    invoke-interface {v0, v4, v5}, Lcom/ss/bduploader/net/BDVNetClient$CompletionListener;->onCompletion(Lorg/json/JSONObject;Lcom/ss/bduploader/net/Error;)V

    return-void

    :cond_2
    iget-object v2, p0, Lcom/ss/bduploader/net/BDHTTPNetwork$2;->val$listener:Lcom/ss/bduploader/net/BDVNetClient$CompletionListener;

    new-instance v1, Lcom/ss/bduploader/net/Error;

    const/4 v0, 0x0

    invoke-direct {v1, v0, v5, v5, v3}, Lcom/ss/bduploader/net/Error;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {v2, v4, v1}, Lcom/ss/bduploader/net/BDVNetClient$CompletionListener;->onCompletion(Lorg/json/JSONObject;Lcom/ss/bduploader/net/Error;)V
