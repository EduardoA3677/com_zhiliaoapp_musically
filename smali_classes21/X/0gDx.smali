...
.field public final synthetic LJIIIIZZ:Lcom/ss/android/ugc/aweme/video/preload/enginepreloader/EnginePreloader;


# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/video/preload/enginepreloader/EnginePreloader;Lcom/ss/android/ugc/playerkit/simapicommon/model/SimVideoUrlModel;Lcom/ss/android/ugc/aweme/video/preload/PreloadSessionManager$PreloadSession;ZILjava/lang/String;LX/0gER;LX/0gEe;)V
    .locals 0

    iput-object p1, p0, LX/0gDx;->LJIIIIZZ:Lcom/ss/android/ugc/aweme/video/preload/enginepreloader/EnginePreloader;

    iput-object p2, p0, LX/0gDx;->LIZIZ:Lcom/ss/android/ugc/playerkit/simapicommon/model/SimVideoUrlModel;

    iput-object p3, p0, LX/0gDx;->LIZJ:Lcom/ss/android/ugc/aweme/video/preload/PreloadSessionManager$PreloadSession;

    iput-boolean p4, p0, LX/0gDx;->LIZLLL:Z

    iput p5, p0, LX/0gDx;->LJ:I

    iput-object p6, p0, LX/0gDx;->LJFF:Ljava/lang/String;

    iput-object p7, p0, LX/0gDx;->LJI:LX/0gER;

    iput-object p8, p0, LX/0gDx;->LJII:LX/0gEe;
...
.method public final LIZ()J
    ...
    iget-object v0, p0, LX/0gDx;->LIZ:LX/0gFN;

    if-nez v0, :cond_0

    invoke-virtual {p0}, LX/0gDx;->getUrls()[Ljava/lang/String;

    :cond_0
    iget v5, p0, LX/0gDx;->LJ:I

    iget-object v0, p0, LX/0gDx;->LIZ:LX/0gFN;

    if-eqz v0, :cond_1

    iget-object v0, p0, LX/0gDx;->LJIIIIZZ:Lcom/ss/android/ugc/aweme/video/preload/enginepreloader/EnginePreloader;
    ...
    :cond_2
    iget-object v0, p0, LX/0gDx;->LIZIZ:Lcom/ss/android/ugc/playerkit/simapicommon/model/SimVideoUrlModel;
...
.method public final getCacheDir()Ljava/lang/String;
    ...
    iget-object v2, p0, LX/0gDx;->LJI:LX/0gER;
    ...
    :cond_0
    iget-object v1, p0, LX/0gDx;->LJIIIIZZ:Lcom/ss/android/ugc/aweme/video/preload/enginepreloader/EnginePreloader;

    iget-object v0, p0, LX/0gDx;->LJII:LX/0gEe;
...
.method public final getKey()Ljava/lang/String;
    ...
    :cond_0
    iget-object v3, p0, LX/0gDx;->LJIIIIZZ:Lcom/ss/android/ugc/aweme/video/preload/enginepreloader/EnginePreloader;

    iget-object v2, p0, LX/0gDx;->LIZIZ:Lcom/ss/android/ugc/playerkit/simapicommon/model/SimVideoUrlModel;

    iget v1, p0, LX/0gDx;->LJ:I
    ...
    iget-object v0, p0, LX/0gDx;->LJFF:Ljava/lang/String;
...
.method public final getUrls()[Ljava/lang/String;
    ...
    iget-object v1, p0, LX/0gDx;->LIZIZ:Lcom/ss/android/ugc/playerkit/simapicommon/model/SimVideoUrlModel;
    ...
    iput-object v0, p0, LX/0gDx;->LIZ:LX/0gFN;

    iget-object v0, p0, LX/0gDx;->LIZJ:Lcom/ss/android/ugc/aweme/video/preload/PreloadSessionManager$PreloadSession;
    ...
    iget-boolean v0, p0, LX/0gDx;->LIZLLL:Z
