...
.method public constructor <init>(Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;Ljava/lang/ref/WeakReference;Ljava/lang/ref/WeakReference;)V
    ...
    iput-object p2, p0, LX/0hjc;->LIZIZ:Ljava/lang/ref/WeakReference;

    iput-object p3, p0, LX/0hjc;->LIZJ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/0hLs;)Lorg/json/JSONObject;
    .locals 4
    ...
    invoke-interface {p0}, LX/0hLs;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/0hLs;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/0hLs;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, v4, LX/0hjc;->LIZIZ:Ljava/lang/ref/WeakReference;
    ...
    :cond_1
    iget-object v0, v4, LX/0hjc;->LIZJ:Ljava/lang/ref/WeakReference;
