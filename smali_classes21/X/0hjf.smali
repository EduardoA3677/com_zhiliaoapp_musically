...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;)V
    ...
    iput-object p1, p0, LX/0hjf;->LIZIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/0hOO;)Lorg/json/JSONObject;
    .locals 4
    ...
    invoke-interface {p0}, LX/0hOO;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/0hOO;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/0hOO;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, v4, LX/0hjf;->LIZIZ:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct/range {v3 .. v8}, LY/ARunnableS45S0300000_20;-><init>(LX/0hjf;Lorg/json/JSONObject;Landroid/app/Activity;Ljava/lang/Number;I)V
