...
# direct methods
.method public constructor <init>(Ljava/lang/ref/WeakReference;Ljava/lang/String;LX/14LL;ZI)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/14Xl;->LL:Ljava/lang/ref/WeakReference;

    iput-boolean p4, p0, LX/14Xl;->LLILIL:Z

    iput p5, p0, LX/14Xl;->LLILL:I

    iput-object p2, p0, LX/14Xl;->LLILLIZIL:Ljava/lang/String;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p3}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, LX/14Xl;->LLILLJJLI:Ljava/lang/ref/WeakReference;
...
.method public final LIZ()V
    ...
    iget-object v7, p0, LX/14Xl;->LLILLIZIL:Ljava/lang/String;
    ...
    :cond_0
    sget-boolean v0, LX/14Xj;->LJIIL:Z
    ...
    iget-object v0, p0, LX/14Xl;->LL:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, p0, LX/14Xl;->LLILLIZIL:Ljava/lang/String;

    sget v2, LX/14Xj;->LJIILIIL:I

    sget v1, LX/14Xj;->LJIILJJIL:I

    sget v0, LX/14Xj;->LJIILL:I
    ...
    iget-object v8, p0, LX/14Xl;->LLILLIZIL:Ljava/lang/String;
    ...
    invoke-direct {v4, v1, v2, v8, v3}, LX/0zXL;-><init>(JLjava/lang/String;Ljava/lang/String;)V

    invoke-static {v8}, LX/0n2N;->LIZ(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v4, LX/0zXL;->LJ:Ljava/lang/String;

    iget-boolean v1, p0, LX/14Xl;->LLILIL:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, LX/14Xl;->LL:Ljava/lang/ref/WeakReference;
    ...
    iget-object v0, p0, LX/14Xl;->LLILLIZIL:Ljava/lang/String;

    invoke-static {v3, v0}, LX/14YH;->LIZ(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, LX/14Xl;->LLILLJJLI:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LX/14LL;
    ...
    :cond_5
    iput-object v5, v4, LX/0zXL;->LIZLLL:Ljava/lang/String;
    ...
    invoke-direct {v0, v4}, LX/0H5h;-><init>(Lh7/n;)V
...
.method public final run()V
    ...
    const-string v2, "IDLXTakePhotoFeature$GenerateResponseTask@9fc5.run"

    invoke-static {v2}, LX/0Xz5;->LIZ(Ljava/lang/String;)V

    :try_start_0
    invoke-virtual {p0}, LX/14Xl;->LIZ()V
