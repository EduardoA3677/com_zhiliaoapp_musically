...
# direct methods
.method public constructor <init>(Landroid/app/Activity;Ljava/util/List;LX/14LN;Lkotlin/jvm/internal/AwS231S0300000_33;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/14Xo;->LL:Landroid/app/Activity;

    iput-object p2, p0, LX/14Xo;->LLILIL:Ljava/util/List;

    iput-object p4, p0, LX/14Xo;->LLILL:Lkotlin/jvm/functions/Function1;
...
.method public final LIZ()V
    ...
    sget-boolean v1, LX/14Xh;->LJIILIIL:Z

    const/4 v0, 0x1

    if-ne v1, v0, :cond_0

    iget-object v5, p0, LX/14Xo;->LLILL:Lkotlin/jvm/functions/Function1;

    iget-object v4, p0, LX/14Xo;->LLILIL:Ljava/util/List;

    sget v3, LX/14Xh;->LJIIJ:I

    sget v2, LX/14Xh;->LJIIJJI:I

    sget v1, LX/14Xh;->LJIIL:I

    iget-object v0, p0, LX/14Xo;->LL:Landroid/app/Activity;
    ...
    :cond_0
    iget-object v8, p0, LX/14Xo;->LLILIL:Ljava/util/List;
    ...
    sget v0, LX/14Xh;->LJIIJ:I

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    sget v0, LX/14Xh;->LJIIJJI:I
    ...
    invoke-direct {v0, v5, v8, v7}, LX/0H5g;-><init>(Ljava/util/ArrayList;Ljava/util/List;Lh7/n;)V
    ...
    iget-object v0, p0, LX/14Xo;->LLILL:Lkotlin/jvm/functions/Function1;
...
.method public final run()V
    ...
    const-string v2, "XPickPhotosFeature$GenerateMultiResponseTask@9670.run"

    invoke-static {v2}, LX/0Xz5;->LIZ(Ljava/lang/String;)V

    :try_start_0
    invoke-virtual {p0}, LX/14Xo;->LIZ()V
