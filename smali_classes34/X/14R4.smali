...
.field public final LIZIZ:LX/0zF2;

.field public LIZJ:LX/14R8;
...
.method public constructor <init>(Landroid/content/Context;LX/0zF2;)V
    ...
    iput-object p1, p0, LX/14R4;->LIZ:Landroid/content/Context;

    iput-object p2, p0, LX/14R4;->LIZIZ:LX/0zF2;

    const/4 v0, -0x1

    iput v0, p0, LX/14R4;->LIZLLL:I

    iget-object v0, p2, LX/0zF2;->LIZ:Ljava/lang/String;

    iput-object v0, p0, LX/14R4;->LJ:Ljava/lang/String;
...
.method public final LIZIZ()V
    ...
    check-cast v3, LX/14R6;

    const/4 v2, 0x0

    :try_start_1
    iget-object v0, v3, LX/14R6;->LJFF:LX/14R1;
    ...
    iget-object v0, v3, LX/14R4;->LIZJ:LX/14R8;

    if-eqz v0, :cond_0

    invoke-interface {v0, v2}, LX/14R8;->LIZJ(Z)V
    ...
    :cond_2
    invoke-virtual {p0, v4}, LX/14R4;->LIZLLL(I)V
...
.method public final LJ()V
    ...
    iget-object v1, p0, LX/14R4;->LIZ:Landroid/content/Context;
    ...
    check-cast v6, LX/14R6;

    iget-object v2, v6, LX/14R6;->LJFF:LX/14R1;
    ...
    iget-object v0, v6, LX/14R4;->LIZIZ:LX/0zF2;

    iget-object v4, v0, LX/0zF2;->LIZIZ:Lorg/json/JSONObject;
    ...
    iget-object v5, v0, LX/0zF2;->LIZJ:Lorg/json/JSONArray;
    ...
    iget-object v0, v0, LX/0zF2;->LIZ:Ljava/lang/String;
    ...
    iget-object v6, v2, LX/14R1;->LIZ:Lcom/bytedance/frameworks/baselib/network/http/cronet/websocket/IWsClient;
    ...
    sget-object v2, LX/14RG;->LIZ:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/14R4;->LJ:Ljava/lang/String;
    ...
    iget-object v1, p0, LX/14R4;->LIZJ:LX/14R8;

    if-eqz v1, :cond_9

    const-string v0, "net error"

    invoke-interface {v1, v0}, LX/14R8;->onFailed(Ljava/lang/String;)V
