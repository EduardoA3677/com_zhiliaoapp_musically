...
.method public constructor <init>(Ljava/lang/ref/WeakReference;LX/14XN;)V
    ...
    iput-object p1, p0, LX/14Xi;->LIZ:Ljava/lang/ref/WeakReference;

    iput-object p2, p0, LX/14Xi;->LIZIZ:LX/14LL;

    const/4 v0, 0x1

    iput v0, p0, LX/14Xi;->LIZJ:I

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/14Xi;->LJI:F
    ...
    iput-object v0, p0, LX/14Xi;->LJIIIZ:Ljava/util/concurrent/ExecutorService;
...
.method public static LIZLLL(Landroid/app/Activity;)V
    ...
    const-string v1, "dzBzEhEpEcvSUUUuTBbKc9NnF3kueWo2KOP5O5GAxDAg0EhgGtxkHDIi6Xb3iTsCKEWUGYwsQJyjc8TzFhhzJe7TjDFD+Bny8Q=="
...
.method public final LIZ(Landroid/app/Activity;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    iget-boolean v0, p0, LX/14Xi;->LJ:Z
    ...
    invoke-direct {v4, v0, v1, v3, v7}, LX/0zXL;-><init>(JLjava/lang/String;Ljava/lang/String;)V

    iget-boolean v0, p0, LX/14Xi;->LJ:Z

    if-eqz v0, :cond_1

    iput-object v3, v4, LX/0zXL;->LIZLLL:Ljava/lang/String;
    ...
    invoke-direct {v4, v0, v1, v10, v7}, LX/0zXL;-><init>(JLjava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    invoke-static {p1, v0}, LX/14YG;->LIZ(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public final LIZJ(Landroid/app/Activity;Ljava/util/List;)V
    ...
    :cond_1
    iget-object v1, p0, LX/14Xi;->LIZIZ:LX/14LL;
    ...
    :cond_2
    iget v0, p0, LX/14Xi;->LJII:I

    if-nez v0, :cond_3

    iget-boolean v0, p0, LX/14Xi;->LIZLLL:Z

    if-eqz v0, :cond_3

    iput v2, p0, LX/14Xi;->LJII:I
    ...
    invoke-virtual {p0, p1, v5, v0, v5}, LX/14Xi;->LIZ(Landroid/app/Activity;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V

    return-void

    :cond_5
    iget-object v4, p0, LX/14Xi;->LJIIIZ:Ljava/util/concurrent/ExecutorService;

    new-instance v3, LX/14Xn;

    iget-object v2, p0, LX/14Xi;->LIZIZ:LX/14LL;

    new-instance v1, Lkotlin/jvm/internal/AwS231S0300000_33;

    const/16 v0, 0xa

    invoke-direct {v1, p0, p1, v5, v0}, Lkotlin/jvm/internal/AwS231S0300000_33;-><init>(LX/14Xi;Landroid/app/Activity;Ljava/util/List;I)V

    invoke-direct {v3, p1, v5, v2, v1}, LX/14Xn;-><init>(Landroid/app/Activity;Ljava/util/List;LX/14LL;Lkotlin/jvm/internal/AwS231S0300000_33;)V
...
.method public final onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v0, p0, LX/14Xi;->LIZ:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v1, v6, v0}, LX/14LL;->LIZ(ILjava/lang/String;)V

    return-void

    :cond_0
    iget-boolean v0, p0, LX/14Xi;->LJFF:Z
    ...
    invoke-virtual {p0, v4, v0}, LX/14Xi;->LIZJ(Landroid/app/Activity;Ljava/util/List;)V
    ...
    :cond_7
    :goto_1
    invoke-virtual {p0, v4, v2}, LX/14Xi;->LIZJ(Landroid/app/Activity;Ljava/util/List;)V
