...
.field public final synthetic LLILLL:LX/0kcr;

.field public final synthetic LLILZ:LX/15cq;


# direct methods
.method public constructor <init>(LX/0kbb;LX/0kbb;IILX/0kcr;LX/15cq;)V
    .locals 1

    iput-object p1, p0, LX/15ct;->LL:LX/0kbb;

    iput-object p2, p0, LX/15ct;->LLILIL:LX/0kbb;

    iput p3, p0, LX/15ct;->LLILL:I

    iput p4, p0, LX/15ct;->LLILLIZIL:I

    const/4 v0, 0x0

    iput v0, p0, LX/15ct;->LLILLJJLI:I

    iput-object p5, p0, LX/15ct;->LLILLL:LX/0kcr;

    iput-object p6, p0, LX/15ct;->LLILZ:LX/15cq;
...
.method public final LIZ()V
    ...
    iget-object v0, p0, LX/15ct;->LL:LX/0kbb;
    ...
    iget-object v0, p0, LX/15ct;->LLILIL:LX/0kbb;
    ...
    :goto_0
    iget v4, p0, LX/15ct;->LLILL:I

    iget v3, p0, LX/15ct;->LLILLIZIL:I

    iget v2, p0, LX/15ct;->LLILLJJLI:I
    ...
    invoke-interface {v1, v6, v4, v3, v2}, LX/15cy;->LJLJJL(Lcom/google/android/gms/maps/model/LatLngBounds;III)LX/0Yg6;
    ...
    new-instance v4, LX/15d3;

    iget-object v2, p0, LX/15ct;->LLILLL:LX/0kcr;

    iget-object v3, p0, LX/15ct;->LLILZ:LX/15cq;

    invoke-direct {v4, v2, v3}, LX/15d3;-><init>(LX/0kcr;LX/15cq;)V
...
.method public final run()V
    ...
    const-string v2, "GoogleMapHandler@f4b9.moveCamera$3"

    invoke-static {v2}, LX/0Xz5;->LIZ(Ljava/lang/String;)V

    :try_start_0
    invoke-virtual {p0}, LX/15ct;->LIZ()V
