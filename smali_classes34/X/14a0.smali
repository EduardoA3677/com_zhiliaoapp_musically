...
# instance fields
.field public final LIZ:LX/14Zr;
...
.method public constructor <init>()V
    ...
    new-instance v0, LX/14Zr;

    invoke-direct {v0}, LX/14Zr;-><init>()V

    iput-object v0, p0, LX/14a0;->LIZ:LX/14Zr;

    invoke-static {}, LX/0AL5;->LIZ()I

    move-result v0

    iput v0, p0, LX/14a0;->LIZIZ:I
...
.method public final LIZ()Z
    ...
    :cond_0
    iget-object v1, p0, LX/14a0;->LIZ:LX/14Zr;

    monitor-enter v1

    :try_start_0
    iget-object v0, v1, LX/14Zr;->LIZ:LX/14a1;

    invoke-virtual {v0}, LX/14a1;->LIZJ()V
    :try_end_0
...
.method public final cancel()V
    ...
    invoke-virtual {v0}, LX/14a1;->LIZ()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final getSpeed()Lcom/ss/android/ugc/aweme/shortvideo/upload/UploadSpeedInfo;
    ...
    invoke-virtual {p0}, LX/14a0;->cancel()V

    iget-object v2, p0, LX/14a0;->LIZ:LX/14Zr;

    monitor-enter v2

    :try_start_0
    iget-object v1, v2, LX/14Zr;->LIZ:LX/14a1;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    monitor-exit v2

    instance-of v0, v1, LX/14a3;

    if-eqz v0, :cond_0

    check-cast v1, LX/14a3;

    iget-object v0, v1, LX/14a3;->LIZIZ:LX/0sRk;
    ...
    :cond_2
    instance-of v0, v1, LX/14a5;

    if-eqz v0, :cond_4

    check-cast v1, LX/14a5;

    iget-object v0, v1, LX/14a5;->LIZIZ:LX/0sRk;
    ...
    :cond_5
    instance-of v0, v1, LX/14Zw;

    if-nez v0, :cond_6

    instance-of v0, v1, LX/14Zv;
...
.method public final start()V
    ...
    invoke-virtual {v0}, LX/14a1;->LJII()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
