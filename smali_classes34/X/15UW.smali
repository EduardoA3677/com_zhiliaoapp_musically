...
.method public final decode(Lcom/squareup/wire/ProtoReader;)Ljava/lang/Object;
    ...
    new-instance v4, LX/15UX;

    invoke-direct {v4}, LX/15UX;-><init>()V
    ...
    iput-object v0, v4, LX/15UX;->LJFF:Ljava/lang/Long;
    ...
    iput-object v0, v4, LX/15UX;->LJ:LX/16YY;

    goto :goto_0

    :cond_2
    iget-object v1, v4, LX/15UX;->LIZLLL:Ljava/util/List;
    ...
    invoke-virtual {v4}, LX/15UX;->LIZIZ()LX/15UV;
...
.method public final encode(Lcom/squareup/wire/ProtoWriter;Ljava/lang/Object;)V
    ...
    check-cast p2, LX/15UV;

    sget-object v3, LX/16YY;->ADAPTER:Lcom/squareup/wire/ProtoAdapter;

    invoke-virtual {v3}, Lcom/squareup/wire/ProtoAdapter;->asRepeated()Lcom/squareup/wire/ProtoAdapter;

    move-result-object v2

    iget-object v1, p2, LX/15UV;->leavers:Ljava/util/List;
    ...
    iget-object v0, p2, LX/15UV;->operator_user:LX/16YY;
    ...
    iget-object v0, p2, LX/15UV;->group_channel_id:Ljava/lang/Long;
...
.method public final encodedSize(Ljava/lang/Object;)I
    ...
    check-cast p1, LX/15UV;

    sget-object v4, LX/16YY;->ADAPTER:Lcom/squareup/wire/ProtoAdapter;

    invoke-virtual {v4}, Lcom/squareup/wire/ProtoAdapter;->asRepeated()Lcom/squareup/wire/ProtoAdapter;

    move-result-object v2

    iget-object v1, p1, LX/15UV;->leavers:Ljava/util/List;
    ...
    iget-object v0, p1, LX/15UV;->operator_user:LX/16YY;
    ...
    iget-object v0, p1, LX/15UV;->group_channel_id:Ljava/lang/Long;
...
.method public final redact(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, LX/15UV;->newBuilder()LX/15UX;

    move-result-object v2

    iget-object v0, v2, LX/15UX;->LIZLLL:Ljava/util/List;

    sget-object v1, LX/16YY;->ADAPTER:Lcom/squareup/wire/ProtoAdapter;

    invoke-static {v0, v1}, LX/0bSS;->LJIIIZ(Ljava/util/List;Lcom/squareup/wire/ProtoAdapter;)V

    iget-object v0, v2, LX/15UX;->LJ:LX/16YY;
