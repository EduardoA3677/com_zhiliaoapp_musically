...
.method public constructor <init>(Landroid/content/Context;LX/0zF3;)V
    ...
    invoke-direct {p0, p1, p2}, LX/14R5;-><init>(Landroid/content/Context;LX/0zF3;)V
...
.method public final LIZ(ILjava/lang/String;)V
    ...
    iget-object v0, p0, LX/14R5;->LIZJ:LX/14R9;

    if-eqz v0, :cond_0

    invoke-interface {v0}, LX/14R9;->LIZ()V

    :cond_0
    monitor-enter p0

    :try_start_0
    iput v1, p0, LX/14R5;->LIZLLL:I
    :try_end_0
    ...
    invoke-interface {v0, p2, v1}, LX/14R9;->LIZJ(Ljava/lang/String;Z)V
    ...
    invoke-interface {v0, p2}, LX/14R9;->onFailed(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v2}, LX/14R9;->onFailed(Ljava/lang/String;)V
...
.method public final LIZJ(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, LX/14R7;->LJFF()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v1, p0, LX/14R7;->LJFF:LX/14RA;
    ...
    :try_start_0
    iget-object v1, v1, LX/14RA;->LIZ:Lcom/bytedance/frameworks/baselib/network/http/cronet/websocket/IWsClient;
...
.method public final LJFF()Z
    ...
    iget-object v0, p0, LX/14R7;->LJFF:LX/14RA;
...
.method public final onMessage([BI)V
    ...
    invoke-interface {v0, v1}, LX/14R9;->LIZIZ(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, LX/14R9;->onMessage([B)V
...
.method public final sendMessage([B)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, v0, LX/14RA;->LIZ:Lcom/bytedance/frameworks/baselib/network/http/cronet/websocket/IWsClient;
