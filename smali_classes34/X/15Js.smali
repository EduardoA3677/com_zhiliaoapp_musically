...
.method public final LIZ(Z)Z
    ...
    invoke-virtual {p0}, LX/15Js;->LJIIIIZZ()Z
    ...
    invoke-static {v0}, LX/15Gk;->LIZLLL(Lcom/bytedance/ies/sdk/datachannel/DataChannel;)I
...
.method public final LIZJ(Ljava/util/List;)V
    ...
    invoke-virtual {v9}, LX/15Js;->LJIIIIZZ()Z
    ...
    invoke-virtual/range {v9 .. v15}, LX/15Js;->LJIIZILJ(LX/145Q;JJZ)V
...
.method public final LIZLLL(Lcom/bytedance/android/livesdk/model/message/RankUpdateMessage;)V
    ...
    invoke-virtual/range {v35 .. v35}, LX/15Js;->LJIIIIZZ()Z
    ...
    iget-object v7, v0, LX/15Jt;->LIZJ:LX/145Q;
    ...
    iget v4, v8, Lcom/bytedance/android/livesdk/model/message/RankUpdate;->rankType:I
    ...
    iget-object v0, v8, Lcom/bytedance/android/livesdk/model/message/RankUpdate;->affiliatedInfo:Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;

    if-eqz v0, :cond_7

    iget-object v6, v0, Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;->stickerGapDesc:Lcom/bytedance/android/livesdk/model/message/common/Text;

    :goto_1
    iget-object v1, v8, Lcom/bytedance/android/livesdk/model/message/RankUpdate;->affiliatedInfo:Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;
    ...
    iget-wide v11, v1, Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;->stickerSettleShowDuration:J

    iget-object v0, v1, Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;->settleInfo:Lcom/bytedance/android/livesdk/rank/model/SettleInfo;

    if-eqz v0, :cond_4

    iget-wide v9, v0, Lcom/bytedance/android/livesdk/rank/model/SettleInfo;->rankSettleTimestamp:J

    :goto_3
    new-instance v13, LX/145Q;

    const/4 v0, 0x0

    invoke-static {v4, v0}, LX/0E3N;->LIZ(II)Lcom/bytedance/android/livesdk/rank/api/RankTypeV2;
    ...
    iget-wide v0, v7, LX/145Q;->LIZLLL:J

    move-wide/from16 v24, v0

    iget-wide v4, v7, LX/145Q;->LJ:J

    iget-wide v0, v8, Lcom/bytedance/android/livesdk/model/message/RankUpdate;->currentScore:J

    move-wide/from16 v19, v0

    iget-wide v14, v7, LX/145Q;->LJI:J

    iget-object v1, v8, Lcom/bytedance/android/livesdk/model/message/RankUpdate;->affiliatedInfo:Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;

    iget-object v0, v8, Lcom/bytedance/android/livesdk/model/message/RankUpdate;->classInfo:Lcom/bytedance/android/livesdk/rank/model/ClassInfo;

    invoke-static {v1, v0}, LX/145q;->LIZ(Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;Lcom/bytedance/android/livesdk/rank/model/ClassInfo;)LX/12QF;
    ...
    iget-object v0, v0, Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;->stickerTrackParam:Ljava/util/Map;
    ...
    iget-wide v0, v13, LX/145Q;->LIZLLL:J
    ...
    invoke-virtual/range {v0 .. v6}, LX/15Js;->LJIIZILJ(LX/145Q;JJZ)V
    ...
    :cond_5
    iget-wide v2, v8, Lcom/bytedance/android/livesdk/model/message/RankUpdate;->ownRank:J
    ...
    iget-object v6, v0, Lcom/bytedance/android/livesdk/model/message/RankUpdate$AffiliatedInfo;->gapDesc:Lcom/bytedance/android/livesdk/model/message/common/Text;
...
.method public final LJFF(LX/146F;)V
    ...
    :goto_0
    sput-object v0, LX/145t;->LIZIZ:Ljava/lang/String;
