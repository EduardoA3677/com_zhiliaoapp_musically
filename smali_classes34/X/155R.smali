...
.method public constructor <init>(Landroid/view/SurfaceHolder;)V
    ...
    iput v0, p0, LX/155R;->LIZJ:I

    iput v0, p0, LX/155R;->LIZLLL:I

    iput v0, p0, LX/155R;->LJ:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LX/155R;->LJFF:Ljava/util/List;

    new-instance v0, LX/155T;

    invoke-direct {v0, p0}, LX/155T;-><init>(LX/155R;)V

    iput-object p1, p0, LX/155R;->LIZ:Landroid/view/SurfaceHolder;
...
.method public final addCallback(Landroid/view/SurfaceHolder$Callback;)V
    ...
    iget-object v0, p0, LX/155R;->LJFF:Ljava/util/List;
    ...
    :cond_0
    iget-boolean v0, p0, LX/155R;->LIZIZ:Z

    if-eqz v0, :cond_1

    invoke-interface {p1, p0}, Landroid/view/SurfaceHolder$Callback;->surfaceCreated(Landroid/view/SurfaceHolder;)V

    iget v3, p0, LX/155R;->LIZJ:I

    const/4 v2, -0x1

    if-eq v3, v2, :cond_1

    iget v1, p0, LX/155R;->LIZLLL:I

    if-eq v1, v2, :cond_1

    iget v0, p0, LX/155R;->LJ:I
...
.method public final getSurface()Landroid/view/Surface;
    ...
    iget-object v0, p0, LX/155R;->LIZ:Landroid/view/SurfaceHolder;
