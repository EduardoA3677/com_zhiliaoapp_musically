.class public final enum Lnet/jpountz/lz4/LZ4ByteBufferUtils;
...
# static fields
.field public static final synthetic $VALUES:[Lnet/jpountz/lz4/LZ4ByteBufferUtils;
...
.method public static encodeSequence(Ljava/nio/ByteBuffer;IIIILjava/nio/ByteBuffer;II)I
    ...
    invoke-static {v0, p5, v2}, Lnet/jpountz/lz4/LZ4ByteBufferUtils;->writeLen(ILjava/nio/ByteBuffer;I)I
    ...
    :goto_0
    invoke-static {p0, p1, p5, v2, v6}, Lnet/jpountz/lz4/LZ4ByteBufferUtils;->wildArraycopy(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;II)V
    ...
    invoke-virtual {p5, v2, v0}, Ljava/nio/ByteBuffer;->put(IB)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p5, v1, v0}, Ljava/nio/ByteBuffer;->put(IB)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v2, p5, v6}, Lnet/jpountz/lz4/LZ4ByteBufferUtils;->writeLen(ILjava/nio/ByteBuffer;I)I
...
.method public static lastLiterals(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    ...
    invoke-static {v0, p3, v1}, Lnet/jpountz/lz4/LZ4ByteBufferUtils;->writeLen(ILjava/nio/ByteBuffer;I)I

    move-result v1

    :goto_0
    invoke-static {p0, p1, p3, v1, p2}, Lnet/jpountz/lz4/LZ4ByteBufferUtils;->safeArraycopy(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;II)V
...
.method public static wildIncrementalCopy(Ljava/nio/ByteBuffer;III)V
    ...
    invoke-static {p0, v0}, Lnet/jpountz/util/ByteBufferUtils;->readByte(Ljava/nio/ByteBuffer;I)B

    move-result v0

    invoke-static {p0, v1, v0}, Lnet/jpountz/util/ByteBufferUtils;->writeByte(Ljava/nio/ByteBuffer;II)V
    ...
    invoke-static {p0, v2, v0}, Lnet/jpountz/util/ByteBufferUtils;->writeInt(Ljava/nio/ByteBuffer;II)V
