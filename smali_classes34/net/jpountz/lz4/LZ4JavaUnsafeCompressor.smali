.class public final Lnet/jpountz/lz4/LZ4JavaUnsafeCompressor;
...
.method public static compress64k(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    ...
    invoke-static {v8, v3}, Lnet/jpountz/util/UnsafeUtils;->readShort([SI)I
    ...
    invoke-static {v8, v3, v0}, Lnet/jpountz/util/UnsafeUtils;->writeShort([SII)V
    ...
    invoke-static {v8, v0, v3}, Lnet/jpountz/util/UnsafeUtils;->writeShort([SII)V
...
.method public static compress64k([BII[BII)I
    ...
    invoke-static/range {v14 .. v19}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->lastLiterals([BII[BII)I
    ...
    :cond_0
    invoke-static {v14, v7}, Lnet/jpountz/util/UnsafeUtils;->readInt([BI)I
    ...
    invoke-static {v14, v5, v7}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->readIntEquals([BII)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {v14, v5, v7, v15, v6}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->commonBytesBackward([BIIII)I
    ...
    invoke-static {v11, v1, v0}, Lnet/jpountz/util/UnsafeUtils;->writeByte([BII)V

    add-int/lit8 v0, v4, -0xf

    invoke-static {v0, v11, v3}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->writeLen(I[BI)I

    move-result v3

    :goto_3
    invoke-static {v14, v6, v11, v3, v4}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->wildArraycopy([BI[BII)V
    ...
    invoke-static {v11, v3, v0}, Lnet/jpountz/util/UnsafeUtils;->writeShortLE([BII)V
    ...
    invoke-static {v14, v0, v7, v10}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->commonBytes([BIII)I
    ...
    invoke-static {v11, v1}, Lnet/jpountz/util/UnsafeUtils;->readByte([BI)B
    ...
    invoke-static {v14, v3}, Lnet/jpountz/util/UnsafeUtils;->readInt([BI)I
    ...
    invoke-static {v14, v7, v5}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->readIntEquals([BII)Z
    ...
    invoke-static {v11, v1, v4}, Lnet/jpountz/util/UnsafeUtils;->writeByte([BII)V
...
.method public compress(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    ...
    invoke-static {v8, v3}, Lnet/jpountz/util/UnsafeUtils;->readInt([II)I
    ...
    invoke-static {v8, v3, v9}, Lnet/jpountz/util/UnsafeUtils;->writeInt([III)V
    ...
    invoke-static {v8, v0, v4}, Lnet/jpountz/util/UnsafeUtils;->writeInt([III)V
    ...
    invoke-static {v8, v0}, Lnet/jpountz/util/UnsafeUtils;->readInt([II)I

    move-result v7

    invoke-static {v8, v0, v2}, Lnet/jpountz/util/UnsafeUtils;->writeInt([III)V
...
.method public compress([BII[BII)I
    ...
    invoke-static {v9, v8, v7}, Lnet/jpountz/util/UnsafeUtils;->checkRange([BII)V
    ...
    invoke-static {v6, v0, v1}, Lnet/jpountz/util/UnsafeUtils;->checkRange([BII)V
    ...
    invoke-static {v9, v4}, Lnet/jpountz/util/UnsafeUtils;->readInt([BI)I
    ...
    invoke-static {v3, v0}, Lnet/jpountz/util/UnsafeUtils;->readInt([II)I
    ...
    invoke-static {v3, v0, v4}, Lnet/jpountz/util/UnsafeUtils;->writeInt([III)V

    const/high16 v0, 0x10000

    if-ge v11, v0, :cond_6

    invoke-static {v9, v12, v4}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->readIntEquals([BII)Z

    move-result v0

    if-eqz v0, :cond_6

    invoke-static {v9, v12, v4, v8, v14}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->commonBytesBackward([BIIII)I
    ...
    invoke-static {v6, v1, v0}, Lnet/jpountz/util/UnsafeUtils;->writeByte([BII)V

    add-int/lit8 v0, v15, -0xf

    invoke-static {v0, v6, v13}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->writeLen(I[BI)I

    move-result v13

    :goto_2
    invoke-static {v9, v14, v6, v13, v15}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->wildArraycopy([BI[BII)V

    add-int/2addr v13, v15

    :goto_3
    invoke-static {v6, v13, v11}, Lnet/jpountz/util/UnsafeUtils;->writeShortLE([BII)V
    ...
    invoke-static {v9, v12, v4, v0}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->commonBytes([BIII)I
    ...
    invoke-static {v6, v1}, Lnet/jpountz/util/UnsafeUtils;->readByte([BI)B
    ...
    invoke-static {v0, v6, v11}, Lnet/jpountz/lz4/LZ4UnsafeUtils;->writeLen(I[BI)I
    ...
    invoke-static {v9, v11}, Lnet/jpountz/util/UnsafeUtils;->readInt([BI)I
    ...
    invoke-static {v3, v0, v11}, Lnet/jpountz/util/UnsafeUtils;->writeInt([III)V
    ...
    invoke-static {v6, v1, v12}, Lnet/jpountz/util/UnsafeUtils;->writeByte([BII)V
