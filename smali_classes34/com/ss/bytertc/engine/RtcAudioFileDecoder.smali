.class public Lcom/ss/bytertc/engine/RtcAudioFileDecoder;
...
.method public static INVOKEVIRTUAL_com_ss_bytertc_engine_RtcAudioFileDecoder_com_ss_android_ugc_aweme_net_lancet_UrlConnectionLancet_openConnection(Ljava/net/URL;)Ljava/net/URLConnection;
    .locals 3

    new-instance v2, LX/04q9;

    const-string v1, "dzBzEhEpEcjFQVIzURHKY0i/duFJK8UWX9ItYsQ5i73mSs+XrQbi43s="
...
.method private checkInfoChange()Z
    ...
    iget v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mSampleRate:I

    if-ne v0, v2, :cond_0

    iget v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mChannels:I
...
.method private isAvailableOnlineURL(Ljava/lang/String;)Z
    ...
    const-string v4, "RtcAudioFileDecoder"

    invoke-static {v4, v0}, Lcom/bytedance/realx/base/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->oc:Ljava/net/HttpURLConnection;
    ...
    invoke-static {v0}, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->INVOKEVIRTUAL_com_ss_bytertc_engine_RtcAudioFileDecoder_com_ss_android_ugc_aweme_net_lancet_UrlConnectionLancet_openConnection(Ljava/net/URL;)Ljava/net/URLConnection;
    ...
    iget-object v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->oc:Ljava/net/HttpURLConnection;
...
.method public getAudioTrackCount()I
    ...
    iget-object v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mTrackIds:Ljava/util/Vector;
...
.method public getDecodedData()[B
    ...
    iget-object v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mDecodedData:[B
...
.method public getFileLength()J
    ...
    iget-wide v2, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mFileLength:J
...
.method public getUsedTrackIdx()I
    ...
    iget v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mUsedTrackIdx:I
...
.method public init(Ljava/lang/String;I)Z
    ...
    iput-object v7, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mUsedTrackFormat:Landroid/media/MediaFormat;

    iput v4, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mUsedTrackIdx:I

    :cond_7
    add-int/lit8 v4, v4, 0x1

    iget-object v1, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mTrackIds:Ljava/util/Vector;
    ...
    iget-object v1, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mUsedTrackFormat:Landroid/media/MediaFormat;
    ...
    iput-wide v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mFileLength:J
...
.method public readAudioData()Z
    ...
    :try_start_0
    iget-object v6, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mMediaCodec:Landroid/media/MediaCodec;
    ...
    iget-boolean v5, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->eoInputStream:Z
    ...
    iget-object v5, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mMediaCodec:Landroid/media/MediaCodec;

    invoke-virtual {v5, v9}, Landroid/media/MediaCodec;->getInputBuffer(I)Ljava/nio/ByteBuffer;

    move-result-object v6

    iget-object v5, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mExtractor:Landroid/media/MediaExtractor;
    ...
    iput-boolean v2, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->eoInputStream:Z
    ...
    :cond_1
    iget-object v8, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mMediaCodec:Landroid/media/MediaCodec;
    ...
    :cond_2
    iget-boolean v5, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->eoOutputStream:Z
    ...
    iput-object v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mDecodedData:[B
    ...
    iput v10, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mRetryCount:I
    ...
    iput-boolean v2, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->eoOutputStream:Z
    ...
    iget-object v1, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mDecodedData:[B
    ...
    iget-object v2, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mDecodedData:[B
    ...
    iput-object v2, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mDecodedData:[B
    ...
    :cond_7
    iget v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mRetryCount:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mRetryCount:I
    ...
    :cond_b
    iget-boolean v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->eoInputStream:Z
...
.method public selectTrack(I)Z
    ...
    const-string v5, "RtcAudioFileDecoder"
    ...
    :cond_2
    iget-object v1, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mExtractor:Landroid/media/MediaExtractor;
    ...
    iget v1, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mSampleRate:I
    ...
    iget-object v7, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mExtractor:Landroid/media/MediaExtractor;
    ...
    invoke-virtual {v7, v0}, Landroid/media/MediaExtractor;->unselectTrack(I)V
    ...
    invoke-virtual {v1, v6, v0, v0, v4}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V

    iget-object v0, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mMediaCodec:Landroid/media/MediaCodec;

    invoke-virtual {v0}, Landroid/media/MediaCodec;->start()V

    iput-object v6, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mUsedTrackFormat:Landroid/media/MediaFormat;
...
.method public setCurrentFilePosition(J)V
    ...
    :goto_0
    :try_start_1
    iget-object v2, p0, Lcom/ss/bytertc/engine/RtcAudioFileDecoder;->mExtractor:Landroid/media/MediaExtractor;
