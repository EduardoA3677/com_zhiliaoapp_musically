.class public Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;
...
.method public constructor <init>(Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;->mHandler:Landroid/os/Handler;
...
.method public Encode(Lcom/ss/ttlivestreamer/core/buffer/VideoFrame;)I
    ...
    iget-object v1, p0, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;->mHandler:Landroid/os/Handler;

    new-instance v0, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder$2;

    invoke-direct {v0, p0, p1}, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder$2;-><init>(Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;Lcom/ss/ttlivestreamer/core/buffer/VideoFrame;)V
...
.method public InitEncoder(Lcom/ss/ttlivestreamer/core/utils/TEBundle;)Z
    ...
    iget-object v0, p0, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;->mHandler:Landroid/os/Handler;
    ...
    new-instance v0, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder$1;

    invoke-direct {v0, p0, v2, p1}, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder$1;-><init>(Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;[ZLcom/ss/ttlivestreamer/core/utils/TEBundle;)V
...
.method public declared-synchronized release()V
    ...
    :cond_0
    :try_start_1
    new-instance v0, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder$3;

    invoke-direct {v0, p0}, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder$3;-><init>(Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;)V

    invoke-static {v1, v0}, Lcom/ss/ttlivestreamer/core/utils/ThreadUtils;->invokeAtFrontUninterruptibly(Landroid/os/Handler;Ljava/lang/Runnable;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/ss/ttlivestreamer/core/codec/ByteVC1HWVideoEncoder;->mHandler:Landroid/os/Handler;
    :try_end_1
