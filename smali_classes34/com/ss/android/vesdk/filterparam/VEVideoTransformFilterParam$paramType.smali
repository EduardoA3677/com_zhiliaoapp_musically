...
# static fields
.field public static final synthetic $VALUES:[Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;
...
.field public static final enum UPDATE_VIDEO_ANIMATION_NEW:Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;
...
# direct methods
.method public static synthetic $values()[Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;
    .locals 3

    const/4 v0, 0x4

    new-array v2, v0, [Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;->UPDATE_VIDEO_TRANSFORM:Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;

    new-instance v2, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;

    const-string v1, "UPDATE_VIDEO_ANIMATION"

    const/4 v0, 0x1

    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;->UPDATE_VIDEO_ANIMATION:Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;

    new-instance v2, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;

    const-string v1, "UPDATE_VIDEO_ANIMATION_AND_ANIMATION"
    ...
    const-string v1, "UPDATE_VIDEO_ANIMATION_NEW"

    const/4 v0, 0x3

    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;->UPDATE_VIDEO_ANIMATION_NEW:Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;

    invoke-static {}, Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;->$values()[Lcom/ss/android/vesdk/filterparam/VEVideoTransformFilterParam$paramType;
