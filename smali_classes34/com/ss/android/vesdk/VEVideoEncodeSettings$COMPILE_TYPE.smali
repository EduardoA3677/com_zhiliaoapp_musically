...
.field public static final enum COMPILE_TYPE_WEBP:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
...
# direct methods
.method public static synthetic $values()[Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
    .locals 3

    const/4 v0, 0x7

    new-array v2, v0, [Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
    ...
    sget-object v0, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->COMPILE_TYPE_TRANSPARENT_GIF:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->COMPILE_TYPE_MP4:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
    ...
    sput-object v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->COMPILE_TYPE_GIF:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
    ...
    const-string v1, "COMPILE_TYPE_TRANSPARENT_GIF"

    const/4 v0, 0x3

    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->COMPILE_TYPE_TRANSPARENT_GIF:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;

    new-instance v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;

    const-string v1, "COMPILE_TYPE_JPEG"

    const/4 v0, 0x4

    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->COMPILE_TYPE_JPEG:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;

    new-instance v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;

    const-string v1, "COMPILE_TYPE_PNG"

    const/4 v0, 0x5

    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->COMPILE_TYPE_PNG:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
    ...
    sput-object v2, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->COMPILE_TYPE_WEBP:Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;
    ...
    sput-object v1, Lcom/ss/android/vesdk/VEVideoEncodeSettings$COMPILE_TYPE;->CREATOR:Landroid/os/Parcelable$Creator;
