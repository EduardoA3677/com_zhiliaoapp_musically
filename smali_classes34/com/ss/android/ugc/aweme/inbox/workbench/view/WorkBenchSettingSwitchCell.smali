.class public final Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;
...
.field public LLILLIZIL:LX/07CD;
...
.method public static constructor <clinit>()V
    ...
    const-class v3, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;

    const-string v2, "vm"

    const-string v0, "getVm()Lcom/ss/android/ugc/aweme/inbox/workbench/viewmodel/WorkBenchSettingViewModel;"
    ...
    sput-object v5, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILLJJLI:[LX/10fb;
...
.method public constructor <init>()V
    ...
    const-class v1, Lcom/ss/android/ugc/aweme/inbox/workbench/viewmodel/WorkBenchSettingViewModel;
    ...
    :goto_0
    iput-object v8, v0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LL:Lcom/bytedance/assem/arch/viewModel/AssemVMLazy;
...
.method public final onBindItemView(LX/0jXU;Ljava/util/List;)V
    ...
    check-cast p1, LX/07CD;

    invoke-super {p0, p1, p2}, Lcom/bytedance/ies/powerlist/PowerCell;->onBindItemView(LX/0jXU;Ljava/util/List;)V

    iput-object p1, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILLIZIL:LX/07CD;
    ...
    iget-object v3, p1, LX/07CD;->LL:Lcom/ss/android/ugc/aweme/notice/repo/list/bean/InboxEntranceFunction;

    if-eqz v3, :cond_0

    iget-object v2, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILIL:LX/0oaU;

    if-eqz v2, :cond_0

    iget-object v0, p1, LX/07CD;->LLILL:LX/0wqk;

    invoke-static {v2, v0}, LX/0wqm;->LIZIZ(LX/0oaU;LX/0wqk;)V

    new-instance v1, Lkotlin/jvm/internal/AwS328S0200000_3;

    const/16 v0, 0x109

    invoke-direct {v1, v3, v4, v0}, Lkotlin/jvm/internal/AwS328S0200000_3;-><init>(Lcom/ss/android/ugc/aweme/notice/repo/list/bean/InboxEntranceFunction;Landroid/content/Context;I)V
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->y6()V

    iget-object v1, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILL:LX/0oaG;

    if-eqz v1, :cond_0

    new-instance v0, LX/07CB;

    invoke-direct {v0, p0, p1, v3, v2}, LX/07CB;-><init>(Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;LX/07CD;Lcom/ss/android/ugc/aweme/notice/repo/list/bean/InboxEntranceFunction;LX/0oaU;)V
...
.method public final onCreateItemView(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILIL:LX/0oaU;
    ...
    :cond_0
    iput-object v2, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILL:LX/0oaG;
...
.method public final y6()V
    ...
    iget-object v2, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILL:LX/0oaG;

    const/4 v1, 0x0

    if-eqz v2, :cond_0

    iget-object v0, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILLIZIL:LX/07CD;

    if-eqz v0, :cond_2

    iget-object v0, v0, LX/07CD;->LL:Lcom/ss/android/ugc/aweme/notice/repo/list/bean/InboxEntranceFunction;
    ...
    :cond_0
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/inbox/workbench/view/WorkBenchSettingSwitchCell;->LLILL:LX/0oaG;
