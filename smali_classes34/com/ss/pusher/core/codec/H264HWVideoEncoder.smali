.class public Lcom/ss/pusher/core/codec/H264HWVideoEncoder;
...
.method public constructor <init>(Lcom/ss/pusher/core/live/VeLivePusherConfiguration;Landroid/os/Handler;)V
    ...
    iput-object p2, p0, Lcom/ss/pusher/core/codec/H264HWVideoEncoder;->mHandler:Landroid/os/Handler;
...
.method public Encode(Lcom/ss/pusher/core/buffer/VideoFrame;)I
    ...
    iget-object v1, p0, Lcom/ss/pusher/core/codec/H264HWVideoEncoder;->mHandler:Landroid/os/Handler;

    new-instance v0, Lcom/ss/pusher/core/codec/H264HWVideoEncoder$1;

    invoke-direct {v0, p0, p1}, Lcom/ss/pusher/core/codec/H264HWVideoEncoder$1;-><init>(Lcom/ss/pusher/core/codec/H264HWVideoEncoder;Lcom/ss/pusher/core/buffer/VideoFrame;)V
...
.method public InitEncoder(Lcom/ss/pusher/core/base/TEBundle;)Z
    ...
    iget-object v0, p0, Lcom/ss/pusher/core/codec/H264HWVideoEncoder;->mHandler:Landroid/os/Handler;
    ...
    new-instance v0, Lcom/ss/pusher/core/codec/H264HWVideoEncoder$2;

    invoke-direct {v0, p0, v2, p1}, Lcom/ss/pusher/core/codec/H264HWVideoEncoder$2;-><init>(Lcom/ss/pusher/core/codec/H264HWVideoEncoder;[ZLcom/ss/pusher/core/base/TEBundle;)V
...
.method public declared-synchronized release()V
    ...
    :cond_0
    :try_start_1
    new-instance v0, Lcom/ss/pusher/core/codec/H264HWVideoEncoder$3;

    invoke-direct {v0, p0}, Lcom/ss/pusher/core/codec/H264HWVideoEncoder$3;-><init>(Lcom/ss/pusher/core/codec/H264HWVideoEncoder;)V

    invoke-static {v1, v0}, Lcom/ss/pusher/core/utils/ThreadUtils;->invokeAtFrontUninterruptibly(Landroid/os/Handler;Ljava/lang/Runnable;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/ss/pusher/core/codec/H264HWVideoEncoder;->mHandler:Landroid/os/Handler;
    :try_end_1
