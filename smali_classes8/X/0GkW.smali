...
.method public constructor <init>(ZLcom/ss/android/ugc/aweme/creative/model/forward/ForwardVideo;Lcom/ss/android/ugc/aweme/services/story/forward/ForwardMediaDownloader$DownloadConfig;ZLcom/ss/android/ugc/aweme/services/story/forward/ForwardMediaDownloader$DownloadListener;LX/00zH;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, LX/0GkW;->LIZ:Z

    iput-object p2, p0, LX/0GkW;->LIZIZ:Lcom/ss/android/ugc/aweme/creative/model/forward/ForwardVideo;

    iput-object p3, p0, LX/0GkW;->LIZJ:Lcom/ss/android/ugc/aweme/services/story/forward/ForwardMediaDownloader$DownloadConfig;

    iput-boolean p4, p0, LX/0GkW;->LIZLLL:Z

    iput-object p5, p0, LX/0GkW;->LJ:Lcom/ss/android/ugc/aweme/services/story/forward/ForwardMediaDownloader$DownloadListener;

    iput-object p6, p0, LX/0GkW;->LJFF:LX/00zH;

    iput-object p7, p0, LX/0GkW;->LJI:Ljava/lang/String;
...
.method public final LIZ(JJ)V
    ...
    const-string v0, "newDownload: file info - mediaSize="
    ...
    iget-object v0, p0, LX/0GkW;->LJFF:LX/00zH;

    new-instance v1, Lcom/ss/android/ugc/aweme/canvas/VideoDownloadPartialResult;

    iget-object v6, p0, LX/0GkW;->LJI:Ljava/lang/String;
...
.method public final LIZIZ(I)V
    ...
    const-string v0, "newDownload: copy error, type="
    ...
    invoke-virtual {p0, p1, v0}, LX/0GkW;->LIZJ(ILcom/ss/android/ugc/aweme/canvas/VideoDownloadPartialResult;)V
...
.method public final LIZJ(ILcom/ss/android/ugc/aweme/canvas/VideoDownloadPartialResult;)V
    ...
    const-string v0, "newDownload: cache invalid, type="
    ...
    iget-boolean v0, p0, LX/0GkW;->LIZ:Z
    ...
    iget-object v1, p0, LX/0GkW;->LIZIZ:Lcom/ss/android/ugc/aweme/creative/model/forward/ForwardVideo;

    const/4 v0, 0x2

    invoke-virtual {v1, v0}, Lcom/ss/android/ugc/aweme/creative/model/forward/ForwardVideo;->setDownloadStatus(I)V

    iget-object v0, p0, LX/0GkW;->LIZIZ:Lcom/ss/android/ugc/aweme/creative/model/forward/ForwardVideo;

    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/creative/model/forward/ForwardVideo;->getPlayAddressList()Ljava/util/List;

    move-result-object v4

    iget-object v0, p0, LX/0GkW;->LIZJ:Lcom/ss/android/ugc/aweme/services/story/forward/ForwardMediaDownloader$DownloadConfig;
    ...
    iget-boolean v1, p0, LX/0GkW;->LIZLLL:Z

    iget-object v0, p0, LX/0GkW;->LJ:Lcom/ss/android/ugc/aweme/services/story/forward/ForwardMediaDownloader$DownloadListener;
    ...
    :cond_0
    iget-object v1, p0, LX/0GkW;->LJ:Lcom/ss/android/ugc/aweme/services/story/forward/ForwardMediaDownloader$DownloadListener;
...
.method public final onCopyComplete(ZILjava/lang/String;)V
    ...
    const-string v0, "newDownload: copy complete, isSuccess="
    ...
    iget-object v0, p0, LX/0GkW;->LJI:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, LX/0GkW;->LIZJ(ILcom/ss/android/ugc/aweme/canvas/VideoDownloadPartialResult;)V
