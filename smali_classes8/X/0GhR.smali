...
.method public constructor <init>(LX/0GhW;)V
    ...
    const-string v0, "CameraLayoutMediaDurationStrategy_LivePhoto"

    invoke-direct {p0, p1, v0}, LX/0GhQ;-><init>(LX/0GhW;Ljava/lang/String;)V

    iput-object p1, p0, LX/0GhR;->LIZLLL:LX/0GhW;
...
.method public final LIZ(Ljava/util/List;)J
    ...
    iget v3, v0, Lcom/ss/android/ugc/gamora/recorder/layout/duration/CameraLayoutDurationStrategyParams;->livePhotoLoopCount:I
...
.method public final LIZLLL(Lcom/bytedance/ies/nle/editor_jni/NLETrack;J)V
    ...
    const-string v0, "livePhotoToTargetDuration: track = "
    ...
    const-string v5, "CameraLayoutMediaDurationStrategy_LivePhoto"

    invoke-static {v5, v0}, LX/0Gsh;->LJIIIZ(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Lcom/bytedance/ies/nle/editor_jni/NLENode;->deepClone(Z)Lcom/bytedance/ies/nle/editor_jni/NLENode;
    ...
    invoke-virtual {v6, v1, v2}, Lcom/bytedance/ies/nle/editor_jni/NLETimeSpaceNode;->setDuration(J)V
    ...
    iget-object v0, p0, LX/0GhR;->LIZLLL:LX/0GhW;

    iget-object v3, v0, LX/0GhW;->LIZJ:Ljava/util/Map;
    ...
    iget-object v0, v0, LX/0GhX;->LIZ:Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;
    ...
    :cond_1
    invoke-virtual {p1, v6}, Lcom/bytedance/ies/nle/editor_jni/NLETrack;->LIZIZ(Lcom/bytedance/ies/nle/editor_jni/NLETrackSlot;)V

    invoke-virtual {p1, p2, p3}, Lcom/bytedance/ies/nle/editor_jni/NLETimeSpaceNode;->setDuration(J)V

    invoke-virtual {p1}, Lcom/bytedance/ies/nle/editor_jni/NLETrack;->LJJII()V

    invoke-static {}, LX/0Y9f;->LIZ()Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v0, "added LivePhoto freeze frame for "

    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v1, v2}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v0, "us, total duration = "

    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, p2, p3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v0, ", fetchLiveEffectCost = "
...
.method public final LJ(Ljava/util/List;)Ljava/lang/Long;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
