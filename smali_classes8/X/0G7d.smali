...
.method public constructor <init>(Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;LX/0G7c;LX/0G7f;)V
    ...
    iput-object p1, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;

    iput-object p2, p0, LX/0G7d;->LIZIZ:LX/0G7c;

    iput-object p3, p0, LX/0G7d;->LIZJ:LX/0G7f;
...
.method public final LIZ()Z
    ...
    iget-object v0, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;
    ...
    iget-object v3, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;
...
.method public final LIZJ(ZLcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/model/TikTokMediaModel;LX/0Gjp;)I
    ...
    iget-object v4, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;
    ...
    invoke-virtual {v0, p2}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->maybeUpdateAiContentNewFlag(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)V
    ...
    iget-object v2, v3, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->videoImageMixedController:LX/0G76;

    if-eqz v2, :cond_5

    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->enableAllTab()Z
    ...
    iget-object v0, v3, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->chooseAllFragment:LX/0GEo;
    ...
    :cond_2
    invoke-interface {v2, p2, p1, v4, p3}, LX/0G76;->LJIIL(Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/model/TikTokMediaModel;ZZLX/0Gjp;)I
    ...
    invoke-static {v0, v5}, LX/0GKv;->LIZLLL(IZ)Z
...
.method public final LJFF(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)V
    ...
    iget-object v3, v0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;

    iget-boolean v2, v3, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->enableBottomDocker:Z

    move-object/from16 v1, p1

    if-nez v2, :cond_0

    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->isSoundSyncMode()Z

    move-result v2

    if-nez v2, :cond_0

    iget-object v2, v0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;

    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->isUgcTemplateMode()Z
    ...
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->isAutoCutAnchorSoundSyncMode()Z
    ...
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->isFromAddFeaturedVideo()Z
    ...
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->isCutSameMode()Z
    ...
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->isDMAlbum()Z
    ...
    invoke-interface {v2}, Lcom/ss/android/ugc/aweme/services/IExternalService;->performanceMonitorService()Lcom/ss/android/ugc/aweme/services/performance/ICreativePerformanceMonitorService;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-interface {v2}, Lcom/ss/android/ugc/aweme/services/performance/ICreativePerformanceMonitorService;->getJatoBoostAbilityForEditPage()V
    ...
    iget-object v2, v0, LX/0G7d;->LIZIZ:LX/0G7c;

    invoke-virtual {v2, v1}, LX/0G7c;->LJFF(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)V

    :goto_0
    iget-object v2, v0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;

    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->supportStoryStandaloneAlbum()Z
    ...
    const-class v12, Lcom/ss/android/ugc/gamora/mixediting/IMixEditingFeatureExtractionService;
    ...
    invoke-interface {v2}, Lcom/ss/android/ugc/gamora/mixediting/IMixEditingFeatureExtractionService;->LJFF()Ljava/util/List;
    ...
    iget v2, v2, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->chooseScene:I
    ...
    iget-object v13, v1, Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;->id:Ljava/lang/String;
    ...
    invoke-direct/range {v6 .. v15}, LX/03w1;-><init>(Ljava/lang/String;JLjava/lang/Boolean;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;ZI)V

    invoke-static {}, LX/0Amf;->LIZIZ()Ljava/util/Set;

    move-result-object v8

    new-instance v7, LX/03w8;

    iget-object v6, v2, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->shootWay:Ljava/lang/String;

    iget-object v2, v2, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->contentSource:Ljava/lang/String;

    invoke-direct {v7, v6, v2, v11, v3}, LX/03w8;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V

    invoke-interface {v4, v5, v8, v7}, Lcom/ss/android/ugc/gamora/mixediting/IMixEditingFeatureExtractionService;->LJII(LX/03w1;Ljava/util/Set;LX/03w8;)V

    :cond_3
    :goto_2
    iget-object v0, v0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;

    invoke-virtual {v0, v1}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->maybeUpdateAiContentNewFlag(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)V
    ...
    :cond_7
    iget-object v2, v0, LX/0G7d;->LIZJ:LX/0G7f;

    invoke-virtual {v2, v1}, LX/0G7f;->LJFF(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)V
...
.method public final LJII()Z
    ...
    iget-object v5, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;
...
.method public final LJIIIIZZ(Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/model/TikTokMediaModel;Landroid/view/View;)V
    ...
    :cond_1
    iget-object v1, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;
    ...
    sget-object v0, LX/0GjV;->AI_CONTENT:LX/0GjV;
    ...
    invoke-virtual {v0, p1}, Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;->maybeUpdateAiContentNewFlag(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)V
...
.method public final LJIIJ(Ljava/util/List;LX/0Gjv;Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/model/TikTokMediaModel;)V
    ...
    iget-object v8, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;
    ...
    :cond_4
    iget-object v2, p0, LX/0G7d;->LIZ:Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/MvChoosePhotoScene;
