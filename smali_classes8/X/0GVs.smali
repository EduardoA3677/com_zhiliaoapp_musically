...
.field public final synthetic LLILIL:Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;
...
.field public final synthetic LLILLL:LX/0GjT;
...
.method public constructor <init>(Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;LX/0GjT;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;LX/0PM2;)V
    ...
    iput-object p8, p0, LX/0GVs;->LL:LX/02wT;

    iput-object p1, p0, LX/0GVs;->LLILIL:Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;

    iput-object p3, p0, LX/0GVs;->LLILL:Ljava/lang/String;

    iput-object p4, p0, LX/0GVs;->LLILLIZIL:Ljava/lang/String;

    iput-object p5, p0, LX/0GVs;->LLILLJJLI:Ljava/lang/String;

    iput-object p2, p0, LX/0GVs;->LLILLL:LX/0GjT;

    iput-object p6, p0, LX/0GVs;->LLILZ:Ljava/lang/String;

    iput-object p7, p0, LX/0GVs;->LLILZIL:Ljava/util/List;
...
.method public final onFailed(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;Lcom/ss/android/socialbase/downloader/exception/BaseException;)V
    ...
    iget-object v1, p0, LX/0GVs;->LLILL:Ljava/lang/String;

    iget-object v0, p0, LX/0GVs;->LLILLIZIL:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, LX/0GVs;->LLILIL:Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;
    ...
    iget-object v1, p0, LX/0GVs;->LL:LX/02wT;
...
.method public final onPause(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;)V
    ...
    invoke-virtual {v0, p1}, Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;->onPause(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;)V
...
.method public final onStart(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;)V
    ...
    invoke-virtual {v0, p1}, Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;->onStart(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;)V
...
.method public final onSuccessed(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;)V
    ...
    iget-object v4, p0, LX/0GVs;->LLILL:Ljava/lang/String;

    iget-object v3, p0, LX/0GVs;->LLILLIZIL:Ljava/lang/String;

    iget-object v2, p0, LX/0GVs;->LLILLJJLI:Ljava/lang/String;

    iget-object v1, p0, LX/0GVs;->LLILLL:LX/0GjT;

    iget-object v0, p0, LX/0GVs;->LLILZ:Ljava/lang/String;
    ...
    new-instance v2, LX/0GVt;

    iget-object v3, p0, LX/0GVs;->LL:LX/02wT;

    iget-object v4, p0, LX/0GVs;->LLILZ:Ljava/lang/String;

    iget-object v5, p0, LX/0GVs;->LLILLL:LX/0GjT;

    iget-object v6, p0, LX/0GVs;->LLILZIL:Ljava/util/List;

    iget-object v7, p0, LX/0GVs;->LLILIL:Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;

    invoke-direct/range {v2 .. v8}, LX/0GVt;-><init>(LX/02wT;Ljava/lang/String;LX/0GjT;Ljava/util/List;Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;LX/02wT;)V
    ...
    iget-object v2, p0, LX/0GVs;->LL:LX/02wT;
    ...
    :cond_3
    iget-object v2, p0, LX/0GVs;->LLILIL:Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;

    new-instance v1, Lcom/ss/android/socialbase/downloader/exception/BaseException;

    const/16 v0, 0x2766

    const-string v3, "Failed to process file"

    invoke-direct {v1, v0, v3}, Lcom/ss/android/socialbase/downloader/exception/BaseException;-><init>(ILjava/lang/String;)V

    invoke-virtual {v2, p1, v1}, Lcom/ss/android/socialbase/downloader/depend/AbsDownloadListener;->onFailed(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;Lcom/ss/android/socialbase/downloader/exception/BaseException;)V
