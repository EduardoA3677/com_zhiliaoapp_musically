...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, LX/0HJx;->LL:Z
    ...
    iput-object v1, p0, LX/0HJx;->LLILZ:Lm83/a;

    return-void
.end method

.method public static synthetic LIZ(LX/0HJx;)V
    .locals 2

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v1, "CancellableProgressDialog@6c8d.dismiss$1L"
...
.method public static LIZIZ(Landroid/content/Context;Ljava/lang/String;)LX/0HJx;
    .locals 4

    new-instance v3, LX/0HJx;

    invoke-direct {v3, p0}, LX/0HJx;-><init>(Landroid/content/Context;)V

    const/4 v2, 0x0

    invoke-virtual {v3, v2}, Landroid/app/Dialog;->setCancelable(Z)V

    invoke-virtual {v3, v2}, LX/0HJx;->setIndeterminate(Z)V
    ...
    :cond_0
    invoke-virtual {v3, p1}, LX/0HJx;->setMessage(Ljava/lang/CharSequence;)V
    ...
    iget-boolean v0, v3, LX/0HJx;->LL:Z
...
.method public final dismiss()V
    ...
    :cond_0
    iget-object v0, p0, LX/0HJx;->LLILZ:Lm83/a;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, LX/0HJx;->LLILIL:Z

    iget-object v0, p0, LX/0HJx;->LLILL:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0}, LX/0HJx;->setMessage(Ljava/lang/CharSequence;)V

    const/4 v3, 0x0

    invoke-virtual {p0, v3}, LX/0HJx;->setIndeterminate(Z)V

    iget-object v2, p0, LX/0HJx;->LLILLJJLI:Ljava/lang/String;

    iget-boolean v0, p0, LX/0HJx;->LLILIL:Z
    ...
    :cond_0
    iput-object v2, p0, LX/0HJx;->LLILLJJLI:Ljava/lang/String;

    iget-object v1, p0, LX/0HJx;->LLILLIZIL:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iput-object v1, p0, LX/0HJx;->LLILLIZIL:Landroid/graphics/drawable/Drawable;
    ...
    iput-wide v0, p0, LX/0HJx;->LLILLL:J
...
.method public final onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-wide v0, p0, LX/0HJx;->LLILLL:J
...
.method public final setMessage(Ljava/lang/CharSequence;)V
    ...
    :cond_0
    iput-object p1, p0, LX/0HJx;->LLILL:Ljava/lang/CharSequence;
