...
# instance fields
.field public final synthetic LIZ:LX/0HV0;

.field public final synthetic LIZIZ:Lwal/a;


# direct methods
.method public constructor <init>(LX/0HV0;Lwal/a;)V
    .locals 0

    iput-object p1, p0, LX/0HV1;->LIZ:LX/0HV0;

    iput-object p2, p0, LX/0HV1;->LIZIZ:Lwal/a;
...
.method public final onTabSelected(LX/0HXi;LX/0HUO;)Z
    ...
    iget-object v0, p0, LX/0HV1;->LIZ:LX/0HV0;

    invoke-virtual {v0}, LX/0HV0;->LIZIZ()Lcom/ss/android/ugc/aweme/shortvideo/ShortVideoContext;
    ...
    invoke-virtual {v0}, LX/0HV0;->LIZ()LX/0He6;
    ...
    :cond_0
    iget-object v2, p0, LX/0HV1;->LIZ:LX/0HV0;

    iget-object v1, v2, LX/0HV0;->LLJI:LX/0SxU;

    sget-object v7, LX/0HV0;->LLJILJIL:[LX/10fb;
    ...
    iget-object v1, v0, LX/0HV0;->LL:LX/0scK;
    ...
    invoke-interface {v0, v4}, LX/0HUo;->xI0(Z)V
    ...
    iget-object v0, v0, LX/0HV0;->LLILLL:LX/05ta;
    ...
    iget-object v1, v2, LX/0HV0;->LLILZLL:LX/0SxV;
    ...
    iget-object v0, v0, LX/0HV0;->LLILLJJLI:LX/05ta;
    ...
    sget-object v5, LX/0H47;->NON_COVER_SCENE:LX/0H47;
    ...
    invoke-virtual {v6, v5, v0}, LX/14NN;->LIZJ(LX/0H47;Lcom/bytedance/bpea/basics/Cert;)V
    ...
    invoke-interface {v0, v4}, LX/0HV3;->WZ1(Z)V
    ...
    :cond_8
    iget-object v7, p0, LX/0HV1;->LIZ:LX/0HV0;

    iget-object v0, p0, LX/0HV1;->LIZIZ:Lwal/a;
    ...
    iget-object v4, v5, Lcom/ss/android/ugc/aweme/creative/model/DMCameraModel;->sessionID:Ljava/lang/String;

    iget v2, v5, Lcom/ss/android/ugc/aweme/creative/model/DMCameraModel;->chatType:I

    iget-object v1, v5, Lcom/ss/android/ugc/aweme/creative/model/DMCameraModel;->enterDM:Ljava/lang/String;
    ...
    invoke-interface {v6, v2, v4, v1, v0}, LX/0bSv;->LIZ(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget v1, v7, LX/0HV0;->LLJIJIL:I
    ...
    :cond_b
    invoke-interface {v2, v3, v3}, LX/0HWI;->Ak(IZ)V

    invoke-interface {v2, v4, v4}, LX/0HWI;->fk2(ZZ)V
...
.method public final onTabUnselected(LX/0HXi;LX/0HUO;)Z
    ...
    iget-object v1, v2, LX/0HV0;->LLJ:LX/0SxU;

    sget-object v3, LX/0HV0;->LLJILJIL:[LX/10fb;
    ...
    invoke-interface {v0, v5}, LX/0HWI;->q8(Z)V
    ...
    :cond_1
    iget-object v1, p0, LX/0HV1;->LIZ:LX/0HV0;

    const/4 v0, 0x2

    iput v0, v1, LX/0HV0;->LLJIJIL:I
