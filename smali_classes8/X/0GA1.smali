...
.method public constructor <init>(LX/0GEp;)V
    ...
    iput-object p1, p0, LX/0GA1;->LIZ:LX/0GEp;
...
.method public final LIZ(Landroid/view/View;Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/model/TikTokMediaModel;)V
    ...
    iget-object v0, p0, LX/0GA1;->LIZ:LX/0GEp;
    ...
    invoke-interface {v0, v11}, LX/0GA0;->LIZIZ(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)Z
    ...
    invoke-interface {v1, v0, v11}, LX/0GA0;->LIZ(Landroid/content/Context;Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)Z
    ...
    iget-object v0, v0, LX/0GEp;->LLLLLJLJLL:LX/0GFn;
    ...
    invoke-virtual {v0}, LX/0GEp;->isEditorProReplace()Z

    move-result v0

    if-eqz v0, :cond_a

    iget-object v6, p0, LX/0GA1;->LIZ:LX/0GEp;

    iget-object v7, v6, Lcom/bytedance/scene/Scene;->mActivity:Landroid/app/Activity;

    if-eqz v7, :cond_6

    iget-object v0, v6, LX/0GEp;->LLLLLZ:LX/05ta;
    ...
    invoke-direct {v8, v11, v7, v6, v0}, Lkotlin/jvm/internal/AwS238S0300000_7;-><init>(Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/model/TikTokMediaModel;Landroid/app/Activity;LX/0GEp;I)V
    ...
    iget-wide v0, v6, LX/0GEp;->LLLLLLLZIL:J
    ...
    invoke-virtual {v6, p1, v11}, LX/0GEp;->LLLLZLL(Landroid/view/View;Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)Z
    ...
    :cond_a
    iget-object v1, p0, LX/0GA1;->LIZ:LX/0GEp;
    ...
    invoke-virtual {v1, p1, v11}, LX/0GEp;->LLLLZLL(Landroid/view/View;Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;)Z

    return-void

    :cond_b
    invoke-static {v11, v3}, LX/0GBv;->LIZIZ(Lcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;Z)Z
    ...
    :cond_d
    iget-object v8, p0, LX/0GA1;->LIZ:LX/0GEp;
    ...
    invoke-direct {v13, v8, v11, v0}, Lkotlin/jvm/internal/AwS365S0200000_7;-><init>(LX/0GEp;Lcom/ss/android/ugc/aweme/shortvideo/mvtemplate/choosemedia/model/TikTokMediaModel;I)V

    const/4 v9, 0x0

    invoke-virtual/range {v8 .. v13}, LX/0GEp;->LLLLLZIL(ZZLcom/ss/android/ugc/aweme/mediachoose/helper/MediaModel;ILkotlin/jvm/functions/Function0;)V
