...
.field public final synthetic LLILLJJLI:LX/0GFw;


# direct methods
.method public constructor <init>(Landroid/content/Context;IIILX/0GFw;)V
    .locals 1

    iput-object p1, p0, LX/0GFz;->LL:Landroid/content/Context;

    iput p2, p0, LX/0GFz;->LLILIL:I

    iput p3, p0, LX/0GFz;->LLILL:I

    iput p4, p0, LX/0GFz;->LLILLIZIL:I

    iput-object p5, p0, LX/0GFz;->LLILLJJLI:LX/0GFw;
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    iget-object v2, p0, LX/0GFz;->LL:Landroid/content/Context;

    if-eqz v2, :cond_0

    iget v0, p0, LX/0GFz;->LLILIL:I
    ...
    iget-object v0, p0, LX/0GFz;->LL:Landroid/content/Context;
    ...
    :cond_2
    :goto_1
    new-instance v3, LX/0GGT;

    iget v2, p0, LX/0GFz;->LLILIL:I

    iget-object v1, p0, LX/0GFz;->LLILLJJLI:LX/0GFw;

    iget v0, p0, LX/0GFz;->LLILL:I

    invoke-direct {v3, v2, v1, v0, v5}, LX/0GGT;-><init>(ILX/0GFw;ILjava/lang/String;)V
    ...
    :pswitch_5
    iget v0, p0, LX/0GFz;->LLILLIZIL:I
    ...
    iget-object v1, p0, LX/0GFz;->LL:Landroid/content/Context;
    ...
    invoke-virtual {v5, v3}, Lcom/ss/android/ugc/aweme/services/uikit/CreativeToastBuilder;->isTuxToastLegacy(Z)Lcom/ss/android/ugc/aweme/services/uikit/CreativeToastBuilder;

    invoke-static {v6, v4, v5}, LX/0oBz;->LIZ(Landroid/app/Activity;ILcom/ss/android/ugc/aweme/services/uikit/CreativeToastBuilder;)V
