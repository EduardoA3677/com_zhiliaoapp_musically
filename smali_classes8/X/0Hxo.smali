...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;LX/0Hxk;Landroid/content/Context;)V
    ...
    iput-object p1, p0, LX/0Hxo;->LIZ:Ljava/lang/String;

    iput-object p2, p0, LX/0Hxo;->LIZIZ:Ljava/lang/String;

    iput-object p3, p0, LX/0Hxo;->LIZJ:Ljava/lang/String;

    iput-object p4, p0, LX/0Hxo;->LIZLLL:LX/0Hxk;

    iput-object p5, p0, LX/0Hxo;->LJ:Landroid/content/Context;
...
.method public final onSuccess(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, LX/0Hxo;->LIZ:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0Hxo;->LIZIZ:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0Hxo;->LIZJ:Ljava/lang/String;
    ...
    invoke-virtual {v4, v2}, Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;->hideCameraUIOnStartRecord(Z)Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;

    invoke-virtual {v4, v2}, Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;->prepareFilter(Z)Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;
    ...
    invoke-virtual {v4, v2}, Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;->stickerParams(Ljava/util/Map;)Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;

    invoke-virtual {v4, v3}, Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;->recordFromFeed(Z)Lcom/ss/android/ugc/aweme/services/external/ui/RecordConfig$Builder;

    iget-object v2, p0, LX/0Hxo;->LIZLLL:LX/0Hxk;

    iget-object v1, p0, LX/0Hxo;->LJ:Landroid/content/Context;
