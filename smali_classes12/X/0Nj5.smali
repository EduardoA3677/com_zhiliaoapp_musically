...
.method public constructor <init>(LX/0Nj6;)V
    ...
    iput-object p1, p0, LX/0Nj5;->LL:LX/0Nj6;
...
.method public final onBufferedPercent(Ljava/lang/String;JI)V
    ...
    iget-object v0, p0, LX/0Nj5;->LL:LX/0Nj6;

    invoke-virtual {v0}, LX/0Nj6;->LIZ()Ljava/util/List;
...
.method public final onBuffering(Z)V
    ...
    iget-object v1, p0, LX/0Nj5;->LL:LX/0Nj6;

    iget-boolean v0, v1, LX/0Nj6;->LJIIJ:Z

    if-nez v0, :cond_3

    invoke-virtual {v1}, LX/0Nj6;->LIZ()Ljava/util/List;
    ...
    invoke-interface {v0, v1}, LX/0Nj4;->onBuffering(Z)V
    ...
    iput-boolean v1, v0, LX/0Nj6;->LJIIJ:Z
...
.method public final onPlayProgressChange(F)V
    ...
    :cond_0
    iget-object v3, p0, LX/0Nj5;->LL:LX/0Nj6;

    iget v0, v3, LX/0Nj6;->LJIIIIZZ:F
    ...
    iget v0, v3, LX/0Nj6;->LJIIIZ:I

    add-int/lit8 v0, v0, 0x1

    iput v0, v3, LX/0Nj6;->LJIIIZ:I
    ...
    invoke-virtual {p0, v1}, LX/0Nj5;->onBuffering(Z)V

    :goto_2
    iget-object v0, p0, LX/0Nj5;->LL:LX/0Nj6;

    iput p1, v0, LX/0Nj6;->LJIIIIZZ:F

    return-void

    :cond_1
    invoke-virtual {p0, v2}, LX/0Nj5;->onBuffering(Z)V

    goto :goto_2

    :cond_2
    iput v2, v3, LX/0Nj6;->LJIIIZ:I
