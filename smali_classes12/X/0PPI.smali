...
# direct methods
.method public static final LIZ(LX/060w;ZZLX/0OZs;I)V
    .locals 36
    ...
    invoke-direct/range {v6 .. v11}, Lkotlin/jvm/internal/AwS1S0121000_11;-><init>(LX/060w;ZZII)V
    ...
    iget-object v1, v5, LX/060w;->LL:Ljava/lang/Integer;
    ...
    invoke-virtual {v6, v12}, LX/0P7t;->LJIJI(I)Z
    ...
    :cond_4
    new-instance v1, LX/061R;

    const/4 v0, 0x0

    invoke-direct {v1, v12, v9, v0}, LX/061R;-><init>(ILandroid/content/Context;LX/02wT;)V
    ...
    invoke-static {v11, v1, v6}, LX/0OSS;->LJFF(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;LX/0OZs;)V

    :cond_6
    invoke-virtual {v6, v8}, LX/0P7t;->LJJJJJ(Z)V

    iget-object v0, v5, LX/060w;->LLILLIZIL:Ljava/lang/Integer;
    ...
    iget-object v0, v5, LX/060w;->LLILL:Ljava/lang/Integer;
    ...
    iget-object v1, v5, LX/060w;->LLILIL:Lkotlin/jvm/functions/Function1;
    ...
    invoke-direct {v10, v5, v9, v0}, Lkotlin/jvm/internal/AwS360S0200000_2;-><init>(LX/060w;Landroid/content/Context;I)V
    ...
    invoke-static {v10, v0, v1, v6, v8}, LX/0OU1;->LIZ(Lkotlin/jvm/functions/Function0;JLX/0OZs;I)Lkotlin/jvm/functions/Function0;

    move-result-object v29

    const/4 v13, 0x0

    sget-object v35, LX/0PPJ;->LIZ:LX/0m8H;

    and-int/lit8 p2, v7, 0x70
...
.method public static final LIZIZ(ZZLcom/ss/android/ugc/aweme/setting/ui/rvmpcompose/group/cache/cell/CheckUpdateSettingsVM;LX/0OZs;II)V
    .locals 18
    ...
    invoke-direct/range {v16 .. v22}, Lkotlin/jvm/internal/AwS0S0122000_11;-><init>(ZZLcom/ss/android/ugc/aweme/setting/ui/rvmpcompose/group/cache/cell/CheckUpdateSettingsVM;III)V
    ...
    invoke-static {v2, v10, v3}, LX/0OE7;->LIZ(Landroidx/lifecycle/LifecycleEventObserver;LX/0OZs;I)V

    const/4 v1, 0x7

    invoke-static {v2, v8, v10, v3, v1}, LX/0Opi;->LIZ(Lcom/bytedance/assem/arch/viewModel/AssemViewModel;Landroidx/lifecycle/Lifecycle$State;LX/0OZs;II)LX/03o4;
    ...
    invoke-static {v3, v12, v11, v10, v0}, LX/0PPI;->LIZ(LX/060w;ZZLX/0OZs;I)V
    ...
    const-class v1, Lcom/ss/android/ugc/aweme/setting/ui/rvmpcompose/group/cache/cell/CheckUpdateSettingsVM;
    ...
    invoke-direct {v15, v3, v1}, Lkotlin/jvm/internal/AwS487S0100000_11;-><init>(LX/0mPL;I)V

    invoke-virtual {v10, v15}, LX/0P7t;->LJJIJIIJI(Ljava/lang/Object;)V
    ...
    invoke-virtual {v10, v7}, LX/0P7t;->LJJJJJ(Z)V
    ...
    invoke-virtual {v10, v1}, LX/0P7t;->LJJIL(LX/0P5n;)Ljava/lang/Object;
    ...
    invoke-virtual {v10, v2}, LX/0P7t;->LJJIL(LX/0P5n;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v5, v7}, LX/041Q;-><init>(Landroidx/lifecycle/LifecycleOwner;Z)V

    new-instance v3, LX/0NHh;

    invoke-direct {v3, v1, v7}, LX/0NHh;-><init>(Landroidx/lifecycle/ViewModelStoreOwner;Z)V
    ...
    check-cast v2, Lcom/ss/android/ugc/aweme/setting/ui/rvmpcompose/group/cache/cell/CheckUpdateSettingsVM;
    ...
    invoke-virtual {v10, v11}, LX/0P7t;->LJIIZILJ(Z)Z
    ...
    invoke-virtual {v10, v12}, LX/0P7t;->LJIIZILJ(Z)Z
