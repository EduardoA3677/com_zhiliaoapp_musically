...
# direct methods
.method public static final LIZ(LX/0POn;LX/0POV;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;LX/0OZs;I)V
    .locals 17
    ...
    invoke-direct/range {v16 .. v22}, Lkotlin/jvm/internal/AwS17S0401000_11;-><init>(LX/0POn;LX/0POV;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;II)V
    ...
    iget-object v12, v3, LX/0POn;->LIZJ:LX/0POR;
    ...
    iget-object v7, v3, LX/0POn;->LJFF:LX/0POt;
    ...
    sget-object v0, LX/0POw;->LIZ:LX/0POw;
    ...
    :goto_a
    iget-object v7, v3, LX/0POn;->LJI:LX/0POs;

    sget-object v0, LX/0POx;->LIZ:LX/0POx;
    ...
    :cond_9
    instance-of v0, v7, LX/0POq;

    if-eqz v0, :cond_a

    const v0, -0xee2c445    # -7.785817E29f

    invoke-virtual {v15, v0}, LX/0P7t;->LJJIIJZLJL(I)V

    check-cast v7, LX/0POq;

    iget-object v0, v7, LX/0POq;->LIZ:Ljava/lang/String;

    invoke-static {v1, v0, v15, v6}, LX/0PFP;->LJ(LX/0OLq;Ljava/lang/String;LX/0OZs;I)V
    ...
    check-cast v7, LX/0POr;

    iget v0, v7, LX/0POr;->LIZ:I

    invoke-static {v1, v0, v15, v6}, LX/0PFP;->LIZLLL(LX/0OLq;ILX/0OZs;I)V
    ...
    :cond_b
    sget-object v0, LX/0POy;->LIZ:LX/0POy;
    ...
    invoke-static {v1, v15, v6}, LX/0PFP;->LIZJ(LX/0OLq;LX/0OZs;I)V
    ...
    iget-object v0, v7, LX/0POp;->LIZ:LX/0arw;

    invoke-interface {v0}, LX/0arw;->LIZ()LX/0PFQ;

    move-result-object v0

    invoke-static {v1, v0, v15, v6}, LX/0PFP;->LJIIIZ(LX/0OLq;LX/0PFQ;LX/0OZs;I)V
    ...
    check-cast v7, LX/0POo;

    iget-object v0, v7, LX/0POo;->LIZ:LX/0arw;

    invoke-interface {v0}, LX/0arw;->LIZ()LX/0PFQ;

    move-result-object v0

    invoke-static {v1, v0, v15, v6}, LX/0PFP;->LJIIIIZZ(LX/0OLq;LX/0PFQ;LX/0OZs;I)V
    ...
    invoke-static {v1, v15, v6}, LX/0PFP;->LIZIZ(LX/0OLq;LX/0OZs;I)V
    ...
    invoke-static {v1, v15, v6}, LX/0PFP;->LIZ(LX/0OLq;LX/0OZs;I)V
    ...
    :cond_10
    iget-object v7, v3, LX/0POn;->LJ:LX/0POt;

    goto/16 :goto_9

    :cond_11
    iget-object v7, v3, LX/0POn;->LIZLLL:LX/0POt;

    goto/16 :goto_9

    :cond_12
    sget-object v7, LX/0POw;->LIZ:LX/0POw;
