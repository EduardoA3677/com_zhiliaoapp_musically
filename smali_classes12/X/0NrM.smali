...
.method public constructor <init>(LX/0u4T;LY/ARunnableS83S0100000_27;)V
    ...
    iput-object p1, p0, LX/0NrM;->LIZJ:LX/0u4T;

    iput-object p2, p0, LX/0NrM;->LIZLLL:Ljava/lang/Runnable;
...
.method public final LJ(LX/0ZWG;I)V
    ...
    iget-object v0, p0, LX/0NrM;->LIZJ:LX/0u4T;
    ...
    iget-object v2, p0, LX/0NrM;->LIZLLL:Ljava/lang/Runnable;

    iget-object v0, p0, LX/0NrM;->LIZJ:LX/0u4T;

    const/4 v1, 0x0

    invoke-direct {v3, p1, v0, v2, v1}, LX/0NrI;-><init>(LX/0u4n;LX/0u4T;Ljava/lang/Runnable;LX/02wT;)V
...
.method public final LJI(LX/0ZWG;)V
    ...
    iget-object v2, p0, LX/0NrM;->LIZJ:LX/0u4T;

    iget-object v0, p0, LX/0NrM;->LIZLLL:Ljava/lang/Runnable;

    const/4 v1, 0x0

    invoke-direct {v3, p1, v2, v0, v1}, LX/0NrK;-><init>(LX/0u4n;LX/0u4T;Ljava/lang/Runnable;LX/02wT;)V
