.class public final Lcom/ss/android/ugc/aweme/ecommercelive/framework/serviceimpl/ILiveParasiticModuleLaunchServiceECImpl;
...
.method public final LIZ()V
    ...
    invoke-direct {v0}, LX/0v60;-><init>()V
    ...
    sget-object v0, LX/0v6W;->LJ:LX/05ta;
    ...
    sget-object v0, LX/03TH;->LIZ:LX/05ta;

    invoke-interface {v0}, LX/05ta;->getValue()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LX/03TH;
    ...
    sget-object v1, LX/0cYC;->ECOMMERCE:LX/0cYC;

    sget-object v0, LX/0v7G;->LIZ:LX/05ta;
    ...
    invoke-interface {v2, v1, v0}, LX/0v8Z;->LIZ(LX/0cYC;LX/0v7G;)V

    new-instance v3, LX/0uMA;

    invoke-direct {v3}, LX/0uMA;-><init>()V

    invoke-static {}, LX/0uMA;->LIZIZ()Ljava/util/List;
    ...
    invoke-virtual {v2}, Lkotlin/jvm/internal/AFwS192S0000000_17;->invoke()Ljava/lang/Object;

    :cond_4
    return-void

    :cond_5
    new-instance v0, Lcom/ss/android/ugc/aweme/ecommercelive/business/clientai/EcLivePitayaMessageRegistry$checkSdkReady$1;

    invoke-direct {v0, v2}, Lcom/ss/android/ugc/aweme/ecommercelive/business/clientai/EcLivePitayaMessageRegistry$checkSdkReady$1;-><init>(Lkotlin/jvm/functions/Function0;)V
