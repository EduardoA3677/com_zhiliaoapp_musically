...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.pdp.sea.vm.manager.promotion.SeaPdpPromotionMgr$followAndClaimCoupon$1"
...
# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/ecommerce/base/coupon/repository/dto/Voucher;LX/0ua1;Landroid/content/Context;ILX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0uZO;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/coupon/repository/dto/Voucher;

    iput-object p2, p0, LX/0uZO;->LLILIL:LX/0ua1;

    iput-object p3, p0, LX/0uZO;->LLILL:Landroid/content/Context;

    iput p4, p0, LX/0uZO;->LLILLIZIL:I
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0uZO;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/coupon/repository/dto/Voucher;

    iget-object v2, p0, LX/0uZO;->LLILIL:LX/0ua1;

    iget-object v3, p0, LX/0uZO;->LLILL:Landroid/content/Context;

    iget v4, p0, LX/0uZO;->LLILLIZIL:I

    move-object v5, p2

    invoke-direct/range {v0 .. v5}, LX/0uZO;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/coupon/repository/dto/Voucher;LX/0ua1;Landroid/content/Context;ILX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v6, "SeaPdpPromotionMgr@45da.followAndClaimCoupon$1"
    ...
    iget-object v0, p0, LX/0uZO;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/coupon/repository/dto/Voucher;
    ...
    iget-object v0, p0, LX/0uZO;->LLILIL:LX/0ua1;
    ...
    new-instance v4, LX/0JMh;

    iget-object v3, p0, LX/0uZO;->LLILIL:LX/0ua1;

    iget-object v2, p0, LX/0uZO;->LLILL:Landroid/content/Context;

    iget v1, p0, LX/0uZO;->LLILLIZIL:I

    iget-object v0, p0, LX/0uZO;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/coupon/repository/dto/Voucher;

    invoke-direct {v4, v3, v2, v1, v0}, LX/0JMh;-><init>(LX/0ua1;Landroid/content/Context;ILcom/ss/android/ugc/aweme/ecommerce/base/coupon/repository/dto/Voucher;)V
