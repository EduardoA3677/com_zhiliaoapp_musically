...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.pdp.sea.vm.manager.promotion.SeaPdpPromotionMgr$claimTask$1"
...
.field public final synthetic LLILZ:LX/0ua1;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;LX/0ua1;Landroid/view/View;Ljava/lang/String;ZLX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0uZJ;->LLILLL:Ljava/lang/String;

    iput-object p2, p0, LX/0uZJ;->LLILZ:LX/0ua1;

    iput-object p3, p0, LX/0uZJ;->LLILZIL:Landroid/view/View;

    iput-object p4, p0, LX/0uZJ;->LLILZLL:Ljava/lang/String;

    iput-boolean p5, p0, LX/0uZJ;->LLIZ:Z
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0uZJ;->LLILLL:Ljava/lang/String;

    iget-object v2, p0, LX/0uZJ;->LLILZ:LX/0ua1;

    iget-object v3, p0, LX/0uZJ;->LLILZIL:Landroid/view/View;

    iget-object v4, p0, LX/0uZJ;->LLILZLL:Ljava/lang/String;

    iget-boolean v5, p0, LX/0uZJ;->LLIZ:Z

    move-object v6, p2

    invoke-direct/range {v0 .. v6}, LX/0uZJ;-><init>(Ljava/lang/String;LX/0ua1;Landroid/view/View;Ljava/lang/String;ZLX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v10, "SeaPdpPromotionMgr@45da.claimTask$1"
    ...
    iget v0, p0, LX/0uZJ;->LLILLJJLI:I
    ...
    iget-boolean v6, p0, LX/0uZJ;->LLILLIZIL:Z

    iget-object v7, p0, LX/0uZJ;->LLILL:Ljava/lang/Object;

    check-cast v7, Ljava/lang/String;

    iget-object v5, p0, LX/0uZJ;->LLILIL:Ljava/lang/Object;

    check-cast v5, Landroid/view/View;

    iget-object v9, p0, LX/0uZJ;->LL:LX/0ua1;
    ...
    iget-object v9, p0, LX/0uZJ;->LLILZ:LX/0ua1;

    iget-object v5, p0, LX/0uZJ;->LLILZIL:Landroid/view/View;

    iget-object v7, p0, LX/0uZJ;->LLILZLL:Ljava/lang/String;

    iget-boolean v6, p0, LX/0uZJ;->LLIZ:Z
    ...
    iput-object v9, p0, LX/0uZJ;->LL:LX/0ua1;

    iput-object v5, p0, LX/0uZJ;->LLILIL:Ljava/lang/Object;

    iput-object v7, p0, LX/0uZJ;->LLILL:Ljava/lang/Object;

    iput-boolean v6, p0, LX/0uZJ;->LLILLIZIL:Z

    iput v8, p0, LX/0uZJ;->LLILLJJLI:I
    ...
    iget-object v1, v9, LX/0ua1;->LIZ:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;

    invoke-static {v8}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, v1, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;->r:Ljava/lang/Boolean;
    ...
    iget-object v0, v9, LX/0ua1;->LIZ:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;
    ...
    invoke-direct {v1, v4, v0}, LX/0Dni;-><init>(LX/0ua1;LX/02wT;)V
    ...
    :cond_4
    invoke-virtual {v0, v5, v8, v7}, LX/0ua1;->LJFF(Landroid/view/View;ZLjava/lang/String;)V
