...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.pdp.sea.starter.SeaPdpStarterOptimized$jump2PdpInterceptor$1$1"
...
.field public final synthetic LLIZ:LX/0uTu;

.field public final synthetic LLIZLLLIL:J


# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;Ljava/lang/String;LX/0uTr;ZLkotlin/jvm/functions/Function0;LX/0t7j;LX/0uTu;JLX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0uTz;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;

    iput-object p2, p0, LX/0uTz;->LLILLJJLI:Ljava/lang/String;

    iput-object p3, p0, LX/0uTz;->LLILLL:LX/0uTr;

    iput-boolean p4, p0, LX/0uTz;->LLILZ:Z

    iput-object p5, p0, LX/0uTz;->LLILZIL:Lkotlin/jvm/functions/Function0;

    iput-object p6, p0, LX/0uTz;->LLILZLL:LX/0t7j;

    iput-object p7, p0, LX/0uTz;->LLIZ:LX/0uTu;

    iput-wide p8, p0, LX/0uTz;->LLIZLLLIL:J
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0uTz;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;

    iget-object v2, p0, LX/0uTz;->LLILLJJLI:Ljava/lang/String;

    iget-object v3, p0, LX/0uTz;->LLILLL:LX/0uTr;

    iget-boolean v4, p0, LX/0uTz;->LLILZ:Z

    iget-object v5, p0, LX/0uTz;->LLILZIL:Lkotlin/jvm/functions/Function0;

    iget-object v6, p0, LX/0uTz;->LLILZLL:LX/0t7j;

    iget-object v7, p0, LX/0uTz;->LLIZ:LX/0uTu;

    iget-wide v8, p0, LX/0uTz;->LLIZLLLIL:J

    move-object v10, p2

    invoke-direct/range {v0 .. v10}, LX/0uTz;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;Ljava/lang/String;LX/0uTr;ZLkotlin/jvm/functions/Function0;LX/0t7j;LX/0uTu;JLX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v10, "SeaPdpStarterOptimized@3f18.jump2PdpInterceptor$1$1"
    ...
    iget-object v3, v8, LX/0uTz;->LLILIL:LX/0aEi;

    iget-object v12, v8, LX/0uTz;->LL:LX/01ej;

    invoke-static/range {p1 .. p1}, LX/01jw;->LIZIZ(Ljava/lang/Object;)V

    :cond_0
    iget-object v0, v8, LX/0uTz;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;
    ...
    iget-boolean v0, v8, LX/0uTz;->LLILZ:Z
    ...
    iget-object v0, v8, LX/0uTz;->LLILZIL:Lkotlin/jvm/functions/Function0;
    ...
    iget-object v2, v8, LX/0uTz;->LLILLJJLI:Ljava/lang/String;
    ...
    iget-object v6, v8, LX/0uTz;->LLILLL:LX/0uTr;

    iget-object v5, v6, LX/0uTr;->LIZJ:LX/0aLQ;

    new-instance v11, LY/AfS0S0510300_28;

    iget-object v13, v8, LX/0uTz;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;

    iget-boolean v14, v8, LX/0uTz;->LLILZ:Z

    iget-object v9, v8, LX/0uTz;->LLILZLL:LX/0t7j;

    iget-object v4, v8, LX/0uTz;->LLIZ:LX/0uTu;

    iget-wide v2, v8, LX/0uTz;->LLIZLLLIL:J
    ...
    iput-object v12, v8, LX/0uTz;->LL:LX/01ej;

    move-object v2, v3

    check-cast v2, LX/0aEi;

    iput-object v2, v8, LX/0uTz;->LLILIL:LX/0aEi;

    const/4 v2, 0x1

    iput v2, v8, LX/0uTz;->LLILL:I
