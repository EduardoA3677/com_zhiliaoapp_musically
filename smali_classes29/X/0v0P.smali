...
.field public LJ:LX/0v0V;

.field public LJFF:I

.field public LJI:I

.field public LJII:LX/0v0R;
...
.method public constructor <init>(Landroid/widget/LinearLayout;)V
    ...
    iput-object p1, p0, LX/0v0P;->LIZLLL:Landroid/widget/LinearLayout;

    new-instance v0, LX/0v0S;

    invoke-direct {v0}, LX/0v0S;-><init>()V

    iput-object v0, p0, LX/0v0P;->LJ:LX/0v0V;

    const/4 v0, 0x2

    iput v0, p0, LX/0v0P;->LJFF:I
    ...
    iput-object v0, p0, LX/0v0P;->LJIIIIZZ:LX/05ta;
    ...
    iput-object v0, p0, LX/0v0P;->LJIIIZ:LX/05ta;
    ...
    iput-object v0, p0, LX/0v0P;->LJIIJ:LX/05ta;

    new-instance v1, Lkotlin/jvm/internal/AwS481S0100000_5;

    const/16 v0, 0x4b3

    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS481S0100000_5;-><init>(LX/0v0P;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, LX/0v0P;->LJIIJJI:LX/05ta;
    ...
    iput-object v0, p0, LX/0v0P;->LJIIL:LX/05ta;
...
.method public final LJIIJ()Landroid/view/View;
    ...
    iget-object v0, p0, LX/0v0P;->LIZLLL:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, LX/0v0P;->LIZLLL:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, LX/0v0P;->LJ:LX/0v0V;

    invoke-interface {v0}, LX/0v0V;->getWidth()I
    ...
    invoke-interface {v0}, LX/0v0V;->getHeight()I
    ...
    invoke-interface {v0}, LX/0v0V;->LJIIJ()F
...
.method public final LJIIJJI()V
    ...
    iget-object v4, v3, LX/0v0P;->LJII:LX/0v0R;

    if-eqz v4, :cond_21

    iget-object v0, v3, LX/0v0P;->LJIIIZ:LX/05ta;
    ...
    iget v2, v3, LX/0v0P;->LJFF:I

    sub-int/2addr v2, v5

    iget-object v0, v4, LX/0v0R;->LIZ:Ljava/util/List;
    ...
    iget-object v0, v3, LX/0v0P;->LIZLLL:Landroid/widget/LinearLayout;
    ...
    :goto_2
    invoke-virtual {v3, v1, v8, v0}, LX/0v0P;->LJIIL(Landroid/view/View;ZZ)V

    :cond_2
    :goto_3
    new-instance v0, LX/0v0Q;

    invoke-direct {v0, v4, v6, v9}, LX/0v0Q;-><init>(LX/0v0R;Lcom/ss/android/ugc/aweme/ecommercelive/common/data/Product;I)V
    ...
    iget-object v0, v3, LX/0v0P;->LJII:LX/0v0R;

    if-eqz v0, :cond_f

    iget v0, v0, LX/0v0R;->LIZJ:I
    ...
    invoke-static {v7, v9, v9, v0}, LX/0um0;->LJI(Ljava/lang/String;IILX/0uto;)Ljava/lang/String;
    ...
    iget-object v0, v3, LX/0v0P;->LJ:LX/0v0V;

    invoke-interface {v0}, LX/0v0V;->LJIIL()Z
    ...
    iget-object v0, v3, LX/0v0P;->LJIIIIZZ:LX/05ta;
    ...
    iget-object v0, v0, LX/0v0R;->LJ:Lkotlin/jvm/functions/Function1;
    ...
    :cond_11
    iget-object v0, v3, LX/0v0P;->LJIIJ:LX/05ta;
    ...
    invoke-virtual {v3}, LX/0v0P;->LJIIJ()Landroid/view/View;
    ...
    :cond_14
    iget v2, v4, LX/0v0R;->LIZIZ:I

    iget v0, v3, LX/0v0P;->LJFF:I
    ...
    invoke-interface {v0}, LX/0v0V;->LJIIJJI()Z
    ...
    :cond_1e
    invoke-virtual {v3, v1, v5, v5}, LX/0v0P;->LJIIL(Landroid/view/View;ZZ)V
...
.method public final LJIIL(Landroid/view/View;ZZ)V
    .locals 7
    ...
    invoke-interface {v0}, LX/0v0V;->LIZ()I
    ...
    iget-object v0, p0, LX/0v0P;->LJIIL:LX/05ta;
    ...
    iget-object v0, p0, LX/0v0P;->LJIIJJI:LX/05ta;
...
.method public final LJIILIIL(I)V
    ...
    iget v0, p0, LX/0v0P;->LJI:I

    if-eq p1, v0, :cond_2

    iput p1, p0, LX/0v0P;->LJI:I
    ...
    iget v0, p0, LX/0v0P;->LJFF:I

    if-eq v1, v0, :cond_2

    invoke-virtual {p0}, LX/0v0P;->LJIIJJI()V
