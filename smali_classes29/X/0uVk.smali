...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.pdp.sea.starter.SeaPdpStarterOptimized$loadPdpHeadImage$1"
    f = "SeaPdpStarterOptimized.kt"
    l = {}
    m = "invokeSuspend"
.end annotation
...
.method public constructor <init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;Landroid/content/Context;LX/02wT;)V
    ...
    iput-object p1, p0, LX/0uVk;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;

    iput-object p2, p0, LX/0uVk;->LLILIL:Landroid/content/Context;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0uVk;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;

    iget-object v0, p0, LX/0uVk;->LLILIL:Landroid/content/Context;

    invoke-direct {v2, v1, v0, p2}, LX/0uVk;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;Landroid/content/Context;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v8, "SeaPdpStarterOptimized@3f18.loadPdpHeadImage$1"
    ...
    sput-object v1, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/module/header/opt/HeaderDisplayImageOpt;->LIZJ:Ljava/lang/String;

    move-object/from16 v0, p0

    iget-object v2, v0, LX/0uVk;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;
    ...
    iget-object v3, v0, LX/0uVk;->LLILIL:Landroid/content/Context;

    invoke-static {v3}, LX/0vnb;->LIZ(Landroid/content/Context;)LX/0vMm;

    move-result-object v4

    iget-object v3, v0, LX/0uVk;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;
    ...
    invoke-direct {v3}, LX/0uTx;-><init>()V
    ...
    :cond_7
    iget-object v4, v0, LX/0uVk;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;
    ...
    const-string v19, "pdp_preview"

    :goto_4
    sget-object v10, LX/0uto;->PDP_HEADER_FAKE:LX/0uto;
    ...
    sget-object v15, LX/01bK;->LL:LX/01bK;
    ...
    sget-object v16, LX/0uto;->PDP_HEADER:LX/0uto;
    ...
    invoke-static/range {v15 .. v22}, LX/0uW4;->LIZIZ(Ljava/lang/String;LX/0uto;Ljava/lang/String;Ljava/lang/Integer;ZZLjava/lang/Integer;Ljava/util/Map;)Ljava/lang/String;
    ...
    iget-object v0, v0, LX/0uVk;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;
    ...
    :goto_5
    invoke-static {v6, v5, v1, v0}, LX/0uVt;->LIZJ(IILjava/lang/String;Z)Lkotlin/Pair;
    ...
    invoke-static {v4, v0, v3}, LX/0um0;->LJFF(IILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v1, v0, v13}, Lkotlin/text/v;->LJJ(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v0, "ec_pdp_image_click_preload"

    invoke-virtual {v3, v1, v13, v0, v14}, LX/0B4U;->LJIIJJI(IILjava/lang/String;Z)I

    move-result v0

    if-ne v0, v14, :cond_14

    sput-object v4, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/module/header/opt/HeaderDisplayImageOpt;->LIZJ:Ljava/lang/String;

    sget-boolean v0, LX/0vpY;->LIZ:Z

    invoke-static {v4}, LX/0vpY;->LIZJ(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v2}, LX/129q;->LJIL(LX/11eY;)V
    ...
    :cond_11
    invoke-static {v9}, LX/0uVm;->LIZIZ(Ljava/lang/String;)Ljava/lang/String;
