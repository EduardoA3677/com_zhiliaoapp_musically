...
.field public LLIZ:LX/0CVT;

.field public LLIZLLLIL:Lcom/bytedance/tux/icon/TuxIconView;

.field public LLJ:LX/0uzN;

.field public final LLJI:LX/0uub;

.field public final LLJIJIL:LX/0utj;

.field public final LLJILJIL:LX/0uwi;
...
.field public final LLJILLL:LX/0utT;

.field public final LLJJ:LX/0utU;

.field public final LLJJI:LX/0uuS;

.field public LLJJIII:LX/0uu1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v4, p0, LX/0uuA;->LLJI:LX/0uub;
    ...
    invoke-virtual {p0}, LX/0uuA;->getEcommerceliveProductMainImageLayoutFromXml()Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    new-instance v0, LX/0CkE;

    invoke-direct {v0}, LX/0CkE;-><init>()V

    invoke-virtual {v5, v0}, LX/0uur;->LJIJJ(LX/0CkC;)V

    iput-object v5, p0, LX/0uuA;->LLJILJILJ:LX/0uur;

    new-instance v1, LX/0utj;

    invoke-virtual {p0}, LX/0uuA;->getEcommerceliveProductDescFromXml()LX/0v0K;

    move-result-object v0

    invoke-direct {v1, v0}, LX/0utj;-><init>(LX/0v0K;)V

    iput-object v1, p0, LX/0uuA;->LLJIJIL:LX/0utj;

    new-instance v2, LX/0utT;

    invoke-virtual {p0}, LX/0uuA;->getSellingPointOrUserRightViewFromXml()LX/0CiC;

    move-result-object v0

    invoke-direct {v2, v0}, LX/0utT;-><init>(LX/0CiC;)V

    new-instance v1, LX/04wt;

    invoke-direct {v1}, LX/04wt;-><init>()V
    ...
    iput-object v2, p0, LX/0uuA;->LLJILLL:LX/0utT;

    new-instance v1, LX/0utU;

    invoke-virtual {p0}, LX/0uuA;->getEcommerceliveFansTagFromXml()Landroid/widget/FrameLayout;

    move-result-object v0

    invoke-direct {v1, v0}, LX/0utU;-><init>(Landroid/widget/FrameLayout;)V

    iput-object v1, p0, LX/0uuA;->LLJJ:LX/0utU;

    new-instance v3, LX/0uuS;

    invoke-virtual {p0}, LX/0uuA;->getEcommercelivePromotionLayoutFromXml()LX/0CiC;
    ...
    iput-object v3, p0, LX/0uuA;->LLJJI:LX/0uuS;

    new-instance v2, LX/0uwi;

    invoke-virtual {p0}, LX/0uuA;->getEcommerceliveProductPriceLayoutFromXml()LX/0CVT;
    ...
    new-instance v0, LX/0CFE;

    invoke-direct {v0}, LX/0CFE;-><init>()V

    invoke-virtual {v2, v0}, LX/0uwi;->LJJ(LX/0CjN;)V

    iput-object v2, p0, LX/0uuA;->LLJILJIL:LX/0uwi;

    invoke-virtual {v4, v3}, LX/0uub;->LIZ(LX/0uuc;)V

    invoke-virtual {v4, v5}, LX/0uub;->LIZ(LX/0uuc;)V

    invoke-virtual {p0}, LX/0uuA;->getEcommerceliveIconCloseFromXml()Lcom/bytedance/tux/icon/TuxIconView;
...
.method public final d0(Landroid/view/View;)Ljava/util/Map;
    ...
    iget-object v3, p0, LX/0uuA;->LLJILLL:LX/0utT;

    iget-object v2, v3, LX/0utT;->LIZJ:LX/0uvk;

    iget-object v0, v3, LX/0utT;->LIZ:LX/0Cwc;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, LX/0uuA;->LLJJI:LX/0uuS;
    ...
    iget-object v3, p0, LX/0uuA;->LLJIJIL:LX/0utj;
    ...
    iget-object v0, v3, LX/0utT;->LIZIZ:LX/0ugy;
    ...
    invoke-virtual {v0, v1}, LX/0ugt;->LJIIJ(Ljava/util/Map;)V

    goto :goto_0

    :cond_3
    iget-object v0, p0, LX/0uuA;->LLJ:LX/0uzN;

    if-eqz v0, :cond_4

    iget-object v0, v0, LX/0uzN;->LIZIZ:Lcom/ss/android/ugc/aweme/ecommercelive/common/data/Product;
...
.method public final getEcommerceliveFansTagFromXml()Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, LX/0uuA;->LLILZIL:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, LX/0uuA;->LLILZIL:Landroid/widget/FrameLayout;
...
.method public final getEcommerceliveIconCloseFromXml()Lcom/bytedance/tux/icon/TuxIconView;
    ...
    iget-object v1, p0, LX/0uuA;->LLIZLLLIL:Lcom/bytedance/tux/icon/TuxIconView;
    ...
    iput-object v0, p0, LX/0uuA;->LLIZLLLIL:Lcom/bytedance/tux/icon/TuxIconView;
...
.method public final getEcommerceliveProductDescFromXml()LX/0v0K;
    ...
    iget-object v1, p0, LX/0uuA;->LLILLL:LX/0v0K;
    ...
    iput-object v0, p0, LX/0uuA;->LLILLL:LX/0v0K;
...
.method public final getEcommerceliveProductMainImageLayoutFromXml()Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    iget-object v1, p0, LX/0uuA;->LLILLJJLI:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    iput-object v0, p0, LX/0uuA;->LLILLJJLI:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public final getEcommerceliveProductPriceLayoutFromXml()LX/0CVT;
    ...
    iget-object v1, p0, LX/0uuA;->LLIZ:LX/0CVT;
    ...
    iput-object v0, p0, LX/0uuA;->LLIZ:LX/0CVT;
...
.method public final getEcommercelivePromotionLayoutFromXml()LX/0CiC;
    ...
    iget-object v1, p0, LX/0uuA;->LLILZLL:LX/0CiC;
    ...
    iput-object v0, p0, LX/0uuA;->LLILZLL:LX/0CiC;
...
.method public final getSellingPointOrUserRightViewFromXml()LX/0CiC;
    .locals 2

    iget-object v1, p0, LX/0uuA;->LLILZ:LX/0CiC;
    ...
    iput-object v0, p0, LX/0uuA;->LLILZ:LX/0CiC;
...
.method public final h0(LX/0uzN;J)V
    ...
    iput-object v1, v0, LX/0uuA;->LLJ:LX/0uzN;

    iget-object v1, v1, LX/0uzN;->LIZIZ:Lcom/ss/android/ugc/aweme/ecommercelive/common/data/Product;
    ...
    :cond_0
    new-instance v3, LX/0uu1;

    const/4 v2, 0x1

    move-wide/from16 v4, p2

    invoke-direct {v3, v4, v5, v2}, LX/0uu1;-><init>(JI)V

    iput-object v3, v0, LX/0uuA;->LLJJIII:LX/0uu1;
    ...
    iget-object v4, v0, LX/0uuA;->LLJILJILJ:LX/0uur;
    ...
    :cond_2
    iget-object v8, v0, LX/0uuA;->LLJIJIL:LX/0utj;
    ...
    invoke-virtual {v0, v1}, LX/0uuA;->i0(Lcom/ss/android/ugc/aweme/ecommercelive/common/data/Product;)V
    ...
    iget-object v4, v0, LX/0uuA;->LLJILJIL:LX/0uwi;
    ...
    iget-object v3, v0, LX/0uuA;->LLJILJIL:LX/0uwi;
    ...
    :cond_4
    iget-object v2, v0, LX/0uuA;->LLJILJILJ:LX/0uur;
...
.method public final i0(Lcom/ss/android/ugc/aweme/ecommercelive/common/data/Product;)V
    .locals 13
    ...
    :cond_1
    iget-object v0, p0, LX/0uuA;->LLJJ:LX/0utU;
    ...
    iget-object v2, p0, LX/0uuA;->LLJILLL:LX/0utT;

    iget-object v1, p1, Lcom/ss/android/ugc/aweme/ecommercelive/common/data/Product;->userRightView:Lcom/ss/android/ugc/aweme/ecommercelive/common/data/UserRightView;
    ...
    iget-object v2, p0, LX/0uuA;->LLJJI:LX/0uuS;

    new-instance v4, LX/0uuU;

    iget-object v0, p0, LX/0uuA;->LLJJIII:LX/0uu1;

    const-wide/16 v8, 0x0

    if-eqz v0, :cond_4

    iget-wide v6, v0, LX/0uu1;->LIZ:J

    iget-wide v8, v0, LX/0uu1;->LIZIZ:J
    ...
    invoke-direct {v0, p0, p1}, LX/0uuE;-><init>(LX/0uuA;Lcom/ss/android/ugc/aweme/ecommercelive/common/data/Product;)V
    ...
    :cond_3
    iget-object v1, p0, LX/0uuA;->LLJIJIL:LX/0utj;
    ...
    :cond_5
    iget-object v0, p0, LX/0uuA;->LLJIJIL:LX/0utj;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, LX/0uuA;->LLJI:LX/0uub;
...
.method public final setEcommerceliveFansTagFromXml(Landroid/widget/FrameLayout;)V
    ...
    iput-object p1, p0, LX/0uuA;->LLILZIL:Landroid/widget/FrameLayout;
...
.method public final setEcommerceliveIconCloseFromXml(Lcom/bytedance/tux/icon/TuxIconView;)V
    ...
    iput-object p1, p0, LX/0uuA;->LLIZLLLIL:Lcom/bytedance/tux/icon/TuxIconView;
...
.method public final setEcommerceliveProductDescFromXml(LX/0v0K;)V
    ...
    iput-object p1, p0, LX/0uuA;->LLILLL:LX/0v0K;
...
.method public final setEcommerceliveProductMainImageLayoutFromXml(Landroidx/constraintlayout/widget/ConstraintLayout;)V
    ...
    iput-object p1, p0, LX/0uuA;->LLILLJJLI:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public final setEcommerceliveProductPriceLayoutFromXml(LX/0CVT;)V
    ...
    iput-object p1, p0, LX/0uuA;->LLIZ:LX/0CVT;
...
.method public final setEcommercelivePromotionLayoutFromXml(LX/0CiC;)V
    ...
    iput-object p1, p0, LX/0uuA;->LLILZLL:LX/0CiC;

    return-void
.end method

.method public final setSellingPointOrUserRightViewFromXml(LX/0CiC;)V
    .locals 0

    iput-object p1, p0, LX/0uuA;->LLILZ:LX/0CiC;
