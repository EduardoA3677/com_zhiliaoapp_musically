...
.field public final LIZJ:LX/0vEc;


# direct methods
.method public constructor <init>(Ljava/lang/String;Lcom/bytedance/android/livesdk/model/ShortTouchPreviewSetting;Landroid/content/Context;)V
    .locals 6
    ...
    invoke-static {p1, p2}, LX/0v7p;->LIZIZ(Ljava/lang/String;Lcom/bytedance/android/livesdk/model/ShortTouchPreviewSetting;)LX/0PQd;

    move-result-object v4

    new-instance v5, LX/0v9z;

    invoke-direct {v5, p0}, LX/0v9z;-><init>(LX/0vA0;)V

    move-object v1, p3

    invoke-direct/range {v0 .. v5}, LX/0vEc;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;ILX/0PQd;LX/0vEa;)V

    iput-object v0, p0, LX/0vA0;->LIZJ:LX/0vEc;
...
.method public final LIZ(Landroid/view/ViewGroup;)LX/0cUO;
    ...
    :goto_0
    iget-object v2, p0, LX/0vA0;->LIZJ:LX/0vEc;
    ...
    invoke-direct {v0, p0}, LX/0vA2;-><init>(LX/0vA0;)V
...
.method public final LLLIIIIL()Landroid/view/View;
    ...
    iget-object v0, p0, LX/0vA0;->LIZJ:LX/0vEc;
