...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.pdp.vm.manager.trigger.PdpTriggerMgr$configTriggers$1"
    f = "PdpTriggerMgr.kt"
    l = {
        0x39
    }
...
.method public constructor <init>(Ljava/util/List;LX/0DpD;LX/02wT;)V
    ...
    iput-object p1, p0, LX/0uXn;->LLILIL:Ljava/util/List;

    iput-object p2, p0, LX/0uXn;->LLILL:LX/0DpD;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0uXn;->LLILIL:Ljava/util/List;

    iget-object v0, p0, LX/0uXn;->LLILL:LX/0DpD;

    invoke-direct {v2, v1, v0, p2}, LX/0uXn;-><init>(Ljava/util/List;LX/0DpD;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v10, "PdpTriggerMgr@7cf7.configTriggers$1"
    ...
    iget-object v0, p0, LX/0uXn;->LLILIL:Ljava/util/List;
    ...
    iget-object v5, p0, LX/0uXn;->LLILL:LX/0DpD;

    iget-boolean v0, v5, LX/0DpD;->LIZJ:Z
    ...
    :cond_2
    iput-boolean v7, v5, LX/0DpD;->LIZJ:Z
    ...
    new-instance v1, LX/0uXx;

    invoke-direct {v1}, LX/0uXx;-><init>()V
    ...
    new-instance v1, LX/0uY0;

    invoke-direct {v1}, LX/0uY0;-><init>()V
    ...
    new-instance v1, LX/0uXz;

    invoke-direct {v1, v6, v2}, LX/0uXz;-><init>(LX/0uZf;LX/0uXu;)V
    ...
    new-instance v1, LX/0uY1;

    invoke-direct {v1, v6, v2}, LX/0uY1;-><init>(LX/0uZf;LX/0uXu;)V
    ...
    new-instance v1, LX/0uY2;

    invoke-virtual {v0}, Ljava/lang/Integer;->intValue()I

    move-result v0

    invoke-direct {v1, v0, v6, v2}, LX/0uY2;-><init>(ILX/0uZf;LX/0uXu;)V
    ...
    invoke-direct {v1}, LX/0uXw;-><init>()V

    goto :goto_1

    :cond_8
    iput v7, p0, LX/0uXn;->LL:I

    new-instance v1, LX/0J61;

    const/4 v0, 0x0

    invoke-direct {v1, v4, v5, v0}, LX/0J61;-><init>(Ljava/util/List;LX/0DpD;LX/02wT;)V
