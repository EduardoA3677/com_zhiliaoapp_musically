...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommercelive.business.audience.slot.ECAudienceWidget$preRequestAssembleData$1$1"
...
# direct methods
.method public constructor <init>(LX/0v7O;Ljava/util/Map;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0v6t;->LLILIL:LX/0v7O;

    iput-object p2, p0, LX/0v6t;->LLILL:Ljava/util/Map;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v2, LX/0v6t;

    iget-object v1, p0, LX/0v6t;->LLILIL:LX/0v7O;

    iget-object v0, p0, LX/0v6t;->LLILL:Ljava/util/Map;

    invoke-direct {v2, v1, v0, p2}, LX/0v6t;-><init>(LX/0v7O;Ljava/util/Map;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v11, "ECAudienceWidget@705d.preRequestAssembleData$1$1"
    ...
    iget-object v0, v5, LX/0v6t;->LLILIL:LX/0v7O;

    invoke-virtual {v0}, LX/0v7O;->LJJIJ()Z

    move-result v0

    if-eqz v0, :cond_3

    iget-object v2, v5, LX/0v6t;->LLILIL:LX/0v7O;

    const-string v1, "pre_request_assemble_from_client"

    iget-object v0, v5, LX/0v6t;->LLILL:Ljava/util/Map;

    invoke-virtual {v2, v1, v0}, LX/0v7O;->LJJIJIIJI(Ljava/lang/String;Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_3
    :try_start_0
    iget-object v1, v5, LX/0v6t;->LLILL:Ljava/util/Map;
    ...
    iget-object v0, v0, LX/0v7O;->LLLLLLIL:LX/05ta;
    ...
    invoke-direct {v0}, LX/0v6v;-><init>()V
    ...
    new-instance v12, Lcom/ss/android/ugc/aweme/ecommercelive/business/audience/api/BagAssembleRequest;
    ...
    iget-object v6, v0, LX/0v7O;->LLJJL:Ljava/util/Map;
    ...
    :goto_e
    invoke-static {v14, v0}, LX/0q1r;->LIZJ(ILjava/lang/String;)[I
    ...
    invoke-direct/range {v12 .. v20}, Lcom/ss/android/ugc/aweme/ecommercelive/business/audience/api/BagAssembleRequest;-><init>(Ljava/lang/String;ZLjava/lang/Long;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/Integer;)V

    iput v14, v5, LX/0v6t;->LL:I

    invoke-virtual {v2, v1, v12, v5}, LX/0agt;->LIZ(Ljava/lang/String;Lcom/ss/android/ugc/aweme/ecommercelive/business/audience/api/BagAssembleRequest;LX/02wT;)Ljava/lang/Object;
