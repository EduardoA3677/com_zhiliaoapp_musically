...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.search.page.mix.MixShopVerticalAssem$streamResultHandler$1$1"
...
.field public final synthetic LLILL:Lcom/ss/android/ugc/aweme/ecommerce/search/page/mix/MixShopVerticalAssem;


# direct methods
.method public constructor <init>(LX/0vJq;Lcom/ss/android/ugc/aweme/ecommerce/search/page/mix/MixShopVerticalAssem;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0vII;->LLILIL:LX/0vJq;

    iput-object p2, p0, LX/0vII;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/search/page/mix/MixShopVerticalAssem;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v2, LX/0vII;

    iget-object v1, p0, LX/0vII;->LLILIL:LX/0vJq;

    iget-object v0, p0, LX/0vII;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/search/page/mix/MixShopVerticalAssem;

    invoke-direct {v2, v1, v0, p2}, LX/0vII;-><init>(LX/0vJq;Lcom/ss/android/ugc/aweme/ecommerce/search/page/mix/MixShopVerticalAssem;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v8, "MixShopVerticalAssem@5940.streamResultHandler$1$1"
    ...
    iget-object v2, p0, LX/0vII;->LLILIL:LX/0vJq;
    ...
    new-instance v3, LX/0vIL;

    iget-object v2, p0, LX/0vII;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/search/page/mix/MixShopVerticalAssem;

    iget-object v1, p0, LX/0vII;->LLILIL:LX/0vJq;

    const/4 v0, 0x0

    invoke-direct {v3, v2, v5, v1, v0}, LX/0vIL;-><init>(Lcom/ss/android/ugc/aweme/ecommerce/search/page/mix/MixShopVerticalAssem;Lcom/ss/android/ugc/aweme/discover/model/SearchApiResult;LX/0vJq;LX/02wT;)V

    iput v7, p0, LX/0vII;->LL:I
