...
# interfaces
.implements Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostUserDepend;


# instance fields
.field public LIZ:LX/0wDV;
...
.method public final getUserModelExt()Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostUserDepend$UserModelExt;
    .locals 3
    ...
    :goto_0
    new-instance v1, Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostUserDepend$UserModelExt;

    invoke-direct {v1}, Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostUserDepend$UserModelExt;-><init>()V
    ...
    :cond_2
    :goto_2
    invoke-virtual {v1, v0}, Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostUserDepend$UserModelExt;->setShortID(Ljava/lang/String;)V
...
.method public final login(Landroid/app/Activity;LX/0wDV;Ljava/util/Map;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, LX/0wDX;->LIZ:LX/0wDV;
...
.method public final login(Landroid/app/Activity;LX/0wDV;Ljava/util/Map;Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostUserDepend$LoginParamsExt;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;",
            "Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostUserDepend$LoginParamsExt;",
            ")V"
        }
    .end annotation

    invoke-virtual {p0, p1, p2, p3}, LX/0wDX;->login(Landroid/app/Activity;LX/0wDV;Ljava/util/Map;)V

    return-void
.end method

.method public final logout(Landroid/app/Activity;LX/0wAd;Ljava/util/Map;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p2}, LX/0wDZ;-><init>(LX/0wAd;)V
