...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommercelive.common.popcard.AbsECLiveExplanationCardWidget$onMessage$5"
...
# direct methods
.method public constructor <init>(LX/0v4t;Ljava/lang/String;Ljava/lang/Integer;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0uzg;->LLILIL:LX/0v4t;

    iput-object p2, p0, LX/0uzg;->LLILL:Ljava/lang/String;

    iput-object p3, p0, LX/0uzg;->LLILLIZIL:Ljava/lang/Integer;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v3, LX/0uzg;

    iget-object v2, p0, LX/0uzg;->LLILIL:LX/0v4t;

    iget-object v1, p0, LX/0uzg;->LLILL:Ljava/lang/String;

    iget-object v0, p0, LX/0uzg;->LLILLIZIL:Ljava/lang/Integer;

    invoke-direct {v3, v2, v1, v0, p2}, LX/0uzg;-><init>(LX/0v4t;Ljava/lang/String;Ljava/lang/Integer;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v11, "AbsECLiveExplanationCardWidget@5d6e.onMessage$5"
    ...
    :cond_0
    check-cast v8, Lcom/ss/android/ugc/aweme/ecommercelive/common/api/ProductListApi$GetProductPromotionAndPriceResponse;

    if-eqz v8, :cond_1b

    iget-object v0, v5, LX/0uzg;->LLILIL:LX/0v4t;

    invoke-virtual {v0}, LX/0v4t;->LJJIII()LX/0v4I;

    move-result-object v0

    iget-object v6, v0, LX/0v4I;->LL:Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;

    if-eqz v6, :cond_8

    iget-object v9, v5, LX/0uzg;->LLILL:Ljava/lang/String;

    iget-object v4, v5, LX/0uzg;->LLILIL:LX/0v4t;
    ...
    iget-object v0, v8, Lcom/ss/android/ugc/aweme/ecommercelive/common/api/ProductListApi$GetProductPromotionAndPriceResponse;->products:Ljava/util/List;
    ...
    :goto_2
    iget-object v0, v8, Lcom/ss/android/ugc/aweme/ecommercelive/common/api/ProductListApi$GetProductPromotionAndPriceResponse;->flashAtmosphereInfo:Ljava/util/List;
    ...
    iget-object v0, v8, Lcom/ss/android/ugc/aweme/ecommercelive/common/api/ProductListApi$GetProductPromotionAndPriceResponse;->promotionStyleConfig:Lcom/ss/android/ugc/aweme/ecommercebase/promotion/data/style/PromotionStyleConfig;
    ...
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setFormatAvailablePrice(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setFormatOriginPrice(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setPromotionInfo(Lcom/ss/android/ugc/aweme/ecommercebase/promotion/data/PromotionInfo;)V
    ...
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setDiscount(Ljava/lang/String;)V
    ...
    :goto_7
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setBuyButtonType(I)V
    ...
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setAdvancedFlashSale(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setBcmStandardTrack(Lcom/ss/android/ugc/aweme/ecommerce/model/BcmStandardTrack;)V

    :cond_4
    iget-object v0, v8, Lcom/ss/android/ugc/aweme/ecommercelive/common/api/ProductListApi$GetProductPromotionAndPriceResponse;->flashSaleRefreshControl:Lcom/ss/android/ugc/aweme/ecommercelive/common/data/FlashSaleControl;
    ...
    :goto_8
    invoke-virtual {v6, v5}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setFlashSaleAtmosphereInfo(Lcom/ss/android/ugc/aweme/ecommercelive/common/data/FlashSaleAtmosphereInfo;)V
    ...
    :goto_9
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setEnableLiveFlashSaleAtmosphere(Z)V
    ...
    :goto_a
    invoke-virtual {v6, v0, v1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setShowAtmosphereBeginMilliSecond(J)V

    invoke-virtual {v6, v9}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setFlashSaleStockLimit(I)V
    ...
    :goto_b
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setPopupCardStatus(Ljava/lang/Integer;)V
    ...
    :goto_c
    invoke-virtual {v6, v0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/popcard/vo/PopupCardVO;->setProductStatus(I)V

    iget-object v0, v4, LX/0cgB;->LLILLIZIL:LX/0v5W;

    if-eqz v0, :cond_9

    invoke-interface {v0, v4}, LX/0v5W;->LJIIL(LX/0cgB;)Z
    ...
    :cond_7
    invoke-virtual {v4}, LX/0v4t;->LJJIIZ()LX/0v3B;

    move-result-object v0

    invoke-virtual {v0}, LX/0v3B;->LJFF()V
    ...
    :cond_9
    iget-object v0, v4, LX/0v4t;->LLIZLLLIL:Lcom/bytedance/android/live/slot/IFrameSlot$SlotViewModel;
    ...
    invoke-virtual {v4}, LX/0v4t;->LJJIII()LX/0v4I;
    ...
    invoke-static {v0}, LX/0v4t;->LJJIJ(Ljava/lang/Integer;)Z
    ...
    invoke-interface {v0, v3}, LX/0uzj;->LJIIIIZZ(Z)V
    ...
    invoke-interface {v0, v2}, LX/0uzj;->LJIIIZ(Lcom/ss/android/ugc/aweme/ecommercelive/common/data/FlashSaleAtmosphere;)V

    iget-object v0, v4, LX/0v4t;->LLLIIII:LX/033Y;
    ...
    :cond_1b
    iget-object v0, v5, LX/0uzg;->LLILLIZIL:Ljava/lang/Integer;
    ...
    sget-object v12, Lcom/ss/android/ugc/aweme/ecommercelive/common/api/ProductListApi;->LIZ:LX/02yE;

    iget-object v0, v5, LX/0uzg;->LLILIL:LX/0v4t;

    iget-object v13, v0, LX/0v4t;->LLJZIJLIL:LX/02sS;
    ...
    iget-object v1, v0, LX/0v4t;->LLJZ:Ljava/lang/String;

    iget-object v0, v5, LX/0uzg;->LLILL:Ljava/lang/String;

    invoke-static {v0}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v17

    iput v3, v5, LX/0uzg;->LL:I

    move-object/from16 v18, v5

    move-object/from16 v16, v1

    invoke-virtual/range {v12 .. v18}, LX/02yE;->LIZ(LX/02sS;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;LX/02wT;)Ljava/lang/Object;
