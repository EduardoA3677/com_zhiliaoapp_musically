...
.field public final synthetic LIZLLL:Lcom/ss/android/ugc/aweme/vision/model/PhotoSearchPdpEnterParams;

.field public final synthetic LJ:Lcom/ss/android/ugc/aweme/ecommerce/saas/core/dependency/ecsearch/IEcomSearchDependencyService;

.field public final synthetic LJFF:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;Lcom/ss/android/ugc/aweme/ecommerce/saas/core/dependency/ecsearch/IEcomSearchDependencyService;Lcom/ss/android/ugc/aweme/vision/model/PhotoSearchPdpEnterParams;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    iput-object p1, p0, LX/0ubb;->LIZ:Landroid/content/Context;

    iput-object p2, p0, LX/0ubb;->LIZIZ:Landroid/view/View;

    iput-object p7, p0, LX/0ubb;->LIZJ:Lkotlin/jvm/functions/Function1;

    iput-object p5, p0, LX/0ubb;->LIZLLL:Lcom/ss/android/ugc/aweme/vision/model/PhotoSearchPdpEnterParams;

    iput-object p4, p0, LX/0ubb;->LJ:Lcom/ss/android/ugc/aweme/ecommerce/saas/core/dependency/ecsearch/IEcomSearchDependencyService;

    iput-object p3, p0, LX/0ubb;->LJFF:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;

    iput-object p6, p0, LX/0ubb;->LJI:Ljava/lang/String;
...
.method public final LIZ(Landroid/view/View;LX/0ubZ;I)V
    ...
    iget-object v0, p0, LX/0ubb;->LIZ:Landroid/content/Context;
    ...
    iget-object v0, p0, LX/0ubb;->LIZIZ:Landroid/view/View;
    ...
    iget-object v2, p0, LX/0ubb;->LIZLLL:Lcom/ss/android/ugc/aweme/vision/model/PhotoSearchPdpEnterParams;
    ...
    invoke-virtual {v2}, Lcom/ss/android/ugc/aweme/vision/model/PhotoSearchPdpEnterParams;->getRawPhotoSource()Ljava/lang/String;
    ...
    iget-object v1, p0, LX/0ubb;->LIZLLL:Lcom/ss/android/ugc/aweme/vision/model/PhotoSearchPdpEnterParams;
    ...
    iget-object v6, p0, LX/0ubb;->LJ:Lcom/ss/android/ugc/aweme/ecommerce/saas/core/dependency/ecsearch/IEcomSearchDependencyService;

    iget-object v7, p0, LX/0ubb;->LIZ:Landroid/content/Context;

    iget-object v8, p0, LX/0ubb;->LJFF:Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/starter/IPdpStarter$PdpEnterParam;

    iget-object v9, p0, LX/0ubb;->LIZLLL:Lcom/ss/android/ugc/aweme/vision/model/PhotoSearchPdpEnterParams;

    iget-object v13, p0, LX/0ubb;->LJI:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0ubb;->LIZJ:Lkotlin/jvm/functions/Function1;
    ...
    new-instance v1, LX/02qZ;

    iget-object v0, p0, LX/0ubb;->LIZJ:Lkotlin/jvm/functions/Function1;

    invoke-direct {v1, v4, v3, v5, v0}, LX/02qZ;-><init>(ILX/02wT;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;)V
