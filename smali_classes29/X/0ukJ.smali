...
.method public static LIZIZ(Ljava/lang/String;Ljava/util/Map;)V
    ...
    const-string v0, "ECLogger: failed to convert "

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, " from json to map"
...
.method public static LIZJ(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Lcom/bytedance/android/btm/api/model/PageFinder;)V
    .locals 10
    ...
    :cond_0
    invoke-static {p0, v3}, LX/0ukJ;->LIZIZ(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static LIZLLL(Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    const-class v2, Lcom/ss/android/ugc/aweme/ecommerce/network/ECNetworkQualityReportConfigModel;

    sget-object v1, LX/00WO;->LIZ:Lcom/ss/android/ugc/aweme/ecommerce/network/ECNetworkQualityReportConfigModel;

    const-string v0, "ec_network_quality_report_config"

    invoke-virtual {v3, v0, v2, v1}, Lcom/bytedance/ies/abmock/SettingsManager;->LJIIIIZZ(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/ss/android/ugc/aweme/ecommerce/network/ECNetworkQualityReportConfigModel;
    ...
    :cond_1
    iget-object v1, v1, Lcom/ss/android/ugc/aweme/ecommerce/network/ECNetworkQualityReportConfigModel;->networkQualityEvents:Ljava/util/List;
    ...
    const-string v1, "downstream_kbps"

    iget v0, v4, LX/0s1u;->LIZJ:I

    invoke-virtual {p1, v1, v0}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string v1, "http_rtt"

    iget v0, v4, LX/0s1u;->LIZIZ:I

    invoke-virtual {p1, v1, v0}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string v1, "transport_rtt"

    iget v0, v4, LX/0s1u;->LIZ:I

    invoke-virtual {p1, v1, v0}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string v1, "throughput_kbps"
    ...
    iget-boolean v0, v2, LX/0ukO;->LIZ:Z
    ...
    invoke-direct {v0, p0, p1}, LX/0YKf;-><init>(Ljava/lang/String;Lorg/json/JSONObject;)V

    invoke-virtual {v0}, LX/0YKf;->invoke()Ljava/lang/Object;

    return-void
.end method

.method public static LJ(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Lcom/bytedance/android/btm/api/model/PageFinder;)V
    .locals 6
...
.method public static LJFF(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/ss/android/ugc/aweme/ecommerce/saas/core/dependency/event/ILogDependencyService;->onEventV3(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static LJI(Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/ss/android/ugc/aweme/ecommerce/saas/core/dependency/event/ILogDependencyService;->onEventV3(Ljava/lang/String;Lorg/json/JSONObject;)V
