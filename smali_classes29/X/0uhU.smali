...
.method public constructor <init>(LX/0v4H;)V
    ...
    iput-object p1, p0, LX/0uhU;->LIZ:LX/0v4H;

    return-void
.end method

.method public static LJI(Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;)V
    .locals 9

    new-instance v2, LX/0uft;

    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSkuIds()Ljava/util/List;
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getProductId()J
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getTitle()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSellerId()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getImageUrl()Ljava/lang/String;
...
.method public final LIZLLL()Ljava/util/Map;
    ...
    iget-object v1, p0, LX/0uhU;->LIZ:LX/0v4H;
...
.method public final LJ(Ljava/lang/String;Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;LX/0uc7;)V
    .locals 10
    ...
    invoke-virtual {v6, v0, v8, v3}, LX/0uc7;->LJIIIIZZ(Ljava/lang/String;Ljava/lang/String;Z)V

    :cond_1
    move-object v4, p0

    iget-object v0, v4, LX/0uhU;->LIZ:LX/0v4H;
    ...
    sget-object v2, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->Companion:LX/0uzb;
    ...
    :cond_8
    invoke-virtual {v5}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getBcmStandardTrack()Lcom/ss/android/ugc/aweme/ecommerce/model/BcmStandardTrack;
    ...
    invoke-virtual {v4, v2, v0, p1, v1}, LX/0uhU;->LIZJ(ILjava/lang/Integer;Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;

    move-result-object v9

    invoke-virtual/range {v4 .. v9}, LX/0uhU;->LJFF(Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;LX/0uc7;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final LJFF(Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;LX/0uc7;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    .locals 72
    ...
    invoke-static/range {p1 .. p1}, LX/0uhU;->LJI(Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;)V

    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSkuIds()Ljava/util/List;
    ...
    iget-object v2, v2, LX/0uhU;->LIZ:LX/0v4H;

    iget-object v2, v2, LX/0v4H;->LLILLJJLI:Landroid/view/View;
    ...
    invoke-virtual/range {v71 .. v71}, LX/0uhU;->LIZLLL()Ljava/util/Map;
    ...
    :goto_3
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getChainKey()Ljava/lang/String;

    move-result-object v8

    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSellerId()Ljava/lang/String;

    move-result-object v9

    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getPromotionView()Lcom/bytedance/android/livesdk/model/message/ext/PromotionView;
    ...
    iget-object v0, v0, LX/0uhU;->LIZ:LX/0v4H;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getVisitReportParams()Ljava/lang/String;

    move-result-object v4

    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSkcInfo()Ljava/util/List;
    ...
    iget-object v2, v0, LX/0uhU;->LIZ:LX/0v4H;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getPlatform()I
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSource()Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSchema()Ljava/lang/String;
    ...
    iget-object v4, v4, LX/0uhU;->LIZ:LX/0v4H;

    iget v4, v4, LX/0v4H;->LLILL:I
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getFormatAvailablePrice()Ljava/lang/String;

    move-result-object v9

    if-nez v9, :cond_18

    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getFormatOriginPrice()Ljava/lang/String;

    move-result-object v9

    :cond_18
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getTitle()Ljava/lang/String;

    move-result-object v8

    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getJumpPdpSetCacheEnable()Z

    move-result v4

    if-eqz v4, :cond_2d

    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getSmartAiCoverIndex()Ljava/lang/Integer;
    ...
    :goto_1a
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getAuctionData()Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/data/AuctionData;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getPdpTopBubble()Lcom/ss/android/ugc/aweme/ecommercelive/common/data/PdpTopBubble;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/ss/android/ugc/aweme/ecommercelive/common/biz/us/popcard/vo/UsPopupCardVO;->getOpenUrl()Ljava/lang/String;
