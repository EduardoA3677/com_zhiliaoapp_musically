...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.sku.vm.ISkuPanelViewModel$notifyMe$1"
...
.method public constructor <init>(LX/0Dc1;Ljava/lang/String;Landroid/view/View;Ljava/util/LinkedHashMap;LX/02wT;)V
    ...
    iput-object p1, p0, LX/0vwv;->LLILIL:LX/0Dc1;

    iput-object p2, p0, LX/0vwv;->LLILL:Ljava/lang/String;

    iput-object p3, p0, LX/0vwv;->LLILLIZIL:Landroid/view/View;

    iput-object p4, p0, LX/0vwv;->LLILLJJLI:Ljava/util/LinkedHashMap;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v0, LX/0vwv;

    iget-object v1, p0, LX/0vwv;->LLILIL:LX/0Dc1;

    iget-object v2, p0, LX/0vwv;->LLILL:Ljava/lang/String;

    iget-object v3, p0, LX/0vwv;->LLILLIZIL:Landroid/view/View;

    iget-object v4, p0, LX/0vwv;->LLILLJJLI:Ljava/util/LinkedHashMap;

    move-object v5, p2

    invoke-direct/range {v0 .. v5}, LX/0vwv;-><init>(LX/0Dc1;Ljava/lang/String;Landroid/view/View;Ljava/util/LinkedHashMap;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v11, "ISkuPanelViewModel@f37b.notifyMe$1"
    ...
    iget-object v8, p0, LX/0vwv;->LLILIL:LX/0Dc1;

    iget-object v7, p0, LX/0vwv;->LLILL:Ljava/lang/String;

    :try_start_0
    new-array v9, v4, [Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductNotifyRelation;

    new-instance v6, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductNotifyRelation;
    ...
    invoke-direct {v6, v3, v2, v1, v0}, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/repository/dto/ProductNotifyRelation;-><init>(Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v8}, LX/0Dc1;->zf0()Z
    ...
    :goto_1
    iget-object v2, p0, LX/0vwv;->LLILLIZIL:Landroid/view/View;
    ...
    invoke-static {v2, v0}, LX/0vwt;->LIZIZ(Landroid/view/View;Ljava/lang/String;)V

    invoke-static {}, LX/0NsT;->LIZ()Lcom/ss/android/ugc/aweme/ecommerce/service/IEventCenter;

    move-result-object v3

    invoke-interface {v1}, LX/0Dc1;->getProductId()Ljava/lang/String;
    ...
    :cond_5
    :goto_2
    iget-object v1, p0, LX/0vwv;->LLILLIZIL:Landroid/view/View;
    ...
    invoke-static {v2, v0}, LX/0vwt;->LIZ(Landroid/view/View;Ljava/lang/String;)V
