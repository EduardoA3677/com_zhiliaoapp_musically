.class public final LX/179I;
.super Ljava/lang/Object;
.source "SourceFile"


# direct methods
.method public static final LIZ(Ljava/util/Map;Lcom/bytedance/lynx/spark/schema/model/SparkPopupSchemaParam;)V
    .locals 7
    ...
    :cond_e
    invoke-static {v5, v3, p0}, LX/0WI6;->LIZJ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)LX/0WEm;
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDelaySparkViewLoad(Z)V
    ...
    :cond_1a
    const-string v0, "disable_outside_click_close"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDisableOutsideClickClose(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragBack(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragByGesture(Z)V

    :cond_1f
    const-string v3, "drag_down_close_threshold"
    ...
    invoke-static {v3, v0, p0, v2}, LX/0WI6;->LIZIZ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Z)I

    move-result v0

    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragDownCloseThreshold(I)V

    :cond_20
    const-string v3, "drag_down_threshold"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragDownThreshold(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragHandleForceFlat(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragHandleInvisible(Z)V

    :cond_23
    const-string v3, "drag_height"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragHeight(I)V

    :cond_24
    const-string v3, "drag_min_margin_top"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragMinMarginTop(I)V

    :cond_25
    const-string v3, "drag_up_threshold"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setDragUpThreshold(I)V
    ...
    invoke-static {v3, v0, p0, v4}, LX/0WI6;->LIZIZ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Z)I
    ...
    :cond_28
    const-string v3, "enable_auto_concurrency"
    ...
    :cond_2d
    const-string v3, "enable_extra_info"
    ...
    :cond_30
    const-string v3, "enable_gecko_pre_decompress"
    ...
    :cond_35
    const-string v3, "enable_lynx_prefetch"
    ...
    :cond_3a
    const-string v3, "enable_pre_code_cache"
    ...
    :cond_3b
    const-string v3, "enable_pre_decode"
    ...
    :cond_3c
    const-string v3, "enable_pre_decode_template"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setEnablePullDownClose(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setEnableRelativeCalculation(Z)V
    ...
    :cond_42
    const-string v0, "enable_sheet_handle_opt"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setEnableSparkPopupSheetHandleOpt(Z)V
    ...
    :cond_46
    const-string v0, "enable_update_screen_metrics"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setEnableUpdateScreenMetrics(Z)V
    ...
    :cond_49
    const-string v0, "fix_top_view_height_issue"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setFixTopViewHeightIssue(Z)V
    ...
    :cond_4c
    const-string v0, "force_dialog_non_cancelable"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setForceDialogNonCancelable(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setGravity(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setGravityWithoutDefault(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setHeight(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setIgnoreKeyboardStatusChange(Z)V
    ...
    :cond_64
    const-string v3, "keyboard_adjust"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setLandscapeGravity(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setLandscapeHeight(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setLandscapeTransitionAnimation(Ljava/lang/String;)V

    :cond_6a
    const-string v3, "landscape_width"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setLandscapeWidth(I)V

    :cond_6b
    const-string v6, "loading_bg_color"
    ...
    :cond_6d
    const-string v3, "loading_height_in_adaptive_mode"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setLoadingHeightInAdaptiveMode(I)V
    ...
    :cond_6f
    const-string v0, "lock_variable_height_expanded"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setLockVariableHeightExpanded(Z)V
    ...
    invoke-static {v0, v3, p0, v2}, LX/0WI6;->LIZIZ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Z)I
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMarginBottom(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMarginEnd(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMarginLeft(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMarginRight(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMarginStart(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMarginTop(I)V
    ...
    const-string v0, "mask_bg_color_dark"

    invoke-virtual {v1, v0}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    const-string v0, "mask_bg_color_light"
    ...
    invoke-static {v0, v5, p0}, LX/0WI6;->LIZJ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)LX/0WEm;

    move-result-object v0

    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMaskBgColor(LX/0WEm;)V

    :cond_7b
    const-string v0, "mask_close_until_loaded"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMaskCloseUntilLoaded(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setMinMarginTop(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setNavigationBarBgColor(LX/0WEm;)V

    :cond_7f
    const-string v0, "navigation_font_mode"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setNavigationFontMode(Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, p0, v4}, LX/0WI6;->LIZIZ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Z)I
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setPeekDownCloseThreshold(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setPopupCompatShowEvent(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setPopupFollowActivityUi(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setRadius(I)V
    ...
    :cond_95
    const-string v0, "resize_duration"
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setResizeDuration(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setSelfAdaptiveHeight(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setShowMask(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setSilentLoadType(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setStatusBarBgColor(LX/0WEm;)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setStatusFontMode(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setTransNavigationBar(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setTransStatusBar(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setTransitionAnimation(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setVariableHeight(I)V
    ...
    invoke-static {v0, v1, p0, v2}, LX/0WI6;->LIZIZ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Z)I

    move-result v0

    invoke-virtual {p1, v0}, Lcom/bytedance/lynx/spark/schema/model/AbsModel/AbsSparkPopupSchemaParam;->setWidth(I)V
