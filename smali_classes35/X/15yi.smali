...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/15yi;->LLJJJ:LX/05ta;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/15yi;->LLJJI:Ljava/util/List;

    const-string v0, ""

    iput-object v0, p0, LX/15yi;->LLJJIII:Ljava/lang/String;
...
.method public final LJFF(Ljava/util/List;Lcom/bytedance/touchpoint/core/pendant/manager/SpecActPendantManager;)V
    ...
    iput-object p2, v5, LX/15yi;->LLJILJILJ:LX/15yz;

    :cond_2
    iput-boolean v4, v5, LX/15yi;->LLJJIJI:Z

    const-string v6, "multi_stage_ui_task"

    const-string v7, "activation_multi_stage_task_time"

    const-string v8, "activation_multi_stage_task_time"

    const-string v9, ""

    const-string v10, "background_task_date"

    const-string v11, "has_active_manually"

    const-string v12, ""

    invoke-virtual/range {v5 .. v12}, LX/15yn;->LJJIIJ(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v5, p1}, LX/15yn;->LJJIJ(Ljava/util/List;)V

    iput-boolean v3, v5, LX/15yi;->LLJJ:Z
...
.method public final LJIIJ()Z
    ...
    iget-object v0, p0, LX/15yi;->LLJJI:Ljava/util/List;
...
.method public final LJIIJJI()V
    ...
    :cond_0
    iget-object v0, p0, LX/15yi;->LLJILJILJ:LX/15yz;
...
.method public final LJIJJ()V
    ...
    iget-boolean v0, p0, LX/15yi;->LLJILLL:Z
    ...
    iput-boolean v4, p0, LX/15yi;->LLJJIJIIJIL:Z
    ...
    iput-object v2, p0, LX/15yi;->LLJJIII:Ljava/lang/String;
    ...
    :cond_5
    iget-object v2, p0, LX/15yi;->LLJILJILJ:LX/15yz;

    if-eqz v2, :cond_3

    iget-boolean v1, p0, LX/15yi;->LLJILLL:Z
...
.method public final LJIJJLI()V
    ...
    iget-object v0, v12, LX/15yn;->LLILLJJLI:Lcom/bytedance/touchpoint/api/model/ActivityTask;

    if-eqz v0, :cond_4

    iget-object v6, v0, Lcom/bytedance/touchpoint/api/model/ActivityTask;->roundTime:Ljava/lang/Integer;
    ...
    iget-object v2, v12, LX/15yi;->LLJILJILJ:LX/15yz;

    if-eqz v2, :cond_0

    invoke-interface {v2}, LX/15yz;->tryShowTimerExpandStatus()V
    ...
    iget-object v4, v12, LX/15yi;->LLJILJILJ:LX/15yz;
    ...
    invoke-interface {v4, v3, v2}, LX/15yz;->updateProgress(II)V

    :cond_1
    if-nez v5, :cond_3

    iget-object v2, v0, Lcom/bytedance/touchpoint/api/model/ActivityTask;->autoDone:Ljava/lang/Boolean;
    ...
    iput-boolean v3, v12, LX/15yi;->LLJJIJIL:Z

    invoke-virtual {v12}, LX/15yn;->LJIIZILJ()LX/0wIa;

    move-result-object v4

    iget-object v5, v0, Lcom/bytedance/touchpoint/api/model/ActivityTask;->taskKey:Ljava/lang/String;

    iget v6, v0, Lcom/bytedance/touchpoint/api/model/ActivityTask;->time:I

    iget-wide v7, v12, LX/15yn;->LLILIL:J

    const/4 v9, 0x0

    new-instance v10, Lkotlin/jvm/internal/AwS358S0200000_34;

    const/16 v2, 0x20

    invoke-direct {v10, v12, v0, v2}, Lkotlin/jvm/internal/AwS358S0200000_34;-><init>(LX/15yi;Lcom/bytedance/touchpoint/api/model/ActivityTask;I)V

    new-instance v11, Lkotlin/jvm/internal/AwS544S0100000_34;

    const/16 v2, 0xbd

    invoke-direct {v11, v12, v2}, Lkotlin/jvm/internal/AwS544S0100000_34;-><init>(LX/15yi;I)V
    ...
    :cond_2
    iget-object v2, v12, LX/15yn;->LLILLJJLI:Lcom/bytedance/touchpoint/api/model/ActivityTask;

    const/4 v8, 0x0

    if-eqz v2, :cond_9

    iget v2, v2, Lcom/bytedance/touchpoint/api/model/ActivityTask;->time:I

    :goto_1
    iget-wide v6, v12, LX/15yn;->LLILIL:J
    ...
    iget-object v2, v2, Lcom/bytedance/touchpoint/api/model/TimerPendant;->rewardLottieName:Ljava/lang/String;
    ...
    iput-boolean v3, v12, LX/15yi;->LLJJIJI:Z
    ...
    invoke-direct {v14, v12, v2}, Lkotlin/jvm/internal/AwS544S0100000_34;-><init>(LX/15yi;I)V
    ...
    new-instance v11, LX/15z4;

    invoke-direct/range {v11 .. v16}, LX/15z4;-><init>(LX/15yi;ZLkotlin/jvm/internal/AwS544S0100000_34;ZZ)V
    ...
    iget-object v1, v12, LX/15yi;->LLJILJILJ:LX/15yz;
...
.method public final LJIL()V
    ...
    iget-object v4, p0, LX/15yi;->LLJILJILJ:LX/15yz;

    if-eqz v4, :cond_0

    iget-boolean v3, p0, LX/15yi;->LLJILLL:Z
    ...
    :goto_0
    iget-boolean v1, p0, LX/15yi;->LLJJIJIIJIL:Z
...
.method public final LJJ(Lcom/bytedance/touchpoint/api/model/ActivityTask;)V
    ...
    iget v4, p1, Lcom/bytedance/touchpoint/api/model/ActivityTask;->time:I

    iget-object v1, p1, Lcom/bytedance/touchpoint/api/model/ActivityTask;->autoDone:Ljava/lang/Boolean;
    ...
    iget-object v1, p1, Lcom/bytedance/touchpoint/api/model/ActivityTask;->roundTimeDone:Ljava/lang/Boolean;
    ...
    new-instance v8, Lkotlin/jvm/internal/AwS143S1100000_34;

    const/4 v0, 0x4

    invoke-direct {v8, p0, v3, v0}, Lkotlin/jvm/internal/AwS143S1100000_34;-><init>(LX/15yi;Ljava/lang/String;I)V

    new-instance v9, Lkotlin/jvm/internal/AwS544S0100000_34;

    const/16 v0, 0xbb

    invoke-direct {v9, p0, v0}, Lkotlin/jvm/internal/AwS544S0100000_34;-><init>(LX/15yi;I)V
    ...
    invoke-static/range {v2 .. v9}, LX/0wIa;->LIZIZ(LX/0wIa;Ljava/lang/String;IJZLkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;)V

    :cond_0
    iget v0, p0, LX/15yi;->LLJILJIL:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, LX/15yi;->LLJILJIL:I
    ...
    iget-object v0, p0, LX/15yi;->LLJJIII:Ljava/lang/String;
...
.method public final LJJIII()V
    ...
    iput-boolean v0, p0, LX/15yi;->LLJJIJIIJIL:Z
    ...
    iput-boolean v0, p0, LX/15yi;->LLJILLL:Z
    ...
    iget-object v2, p0, LX/15yi;->LLJJIII:Ljava/lang/String;
...
.method public final LJJIJIL()V
    ...
    iput-boolean v2, p0, LX/15yi;->LLJJIJIIJIL:Z
...
.method public final LJJIJL()Z
    ...
    iget-boolean v0, p0, LX/15yi;->LLJJIJI:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, LX/15yi;->LLJJIJIL:Z
...
.method public final LJJIZ()I
    ...
    invoke-virtual {v1}, LX/0wHi;->LJJIJ()Z
    ...
    :cond_0
    sget-object v1, LX/15yk;->LLJJIJI:LX/05ta;
    ...
    invoke-virtual {v1}, LX/15yk;->LJJJ()I

    move-result v13

    iget v2, p0, LX/15yi;->LLJILJIL:I
...
.method public final LJJJI()V
    ...
    :cond_0
    iget-boolean v0, p0, LX/15yi;->LLJJIJIIJIL:Z

    invoke-interface {v2, v1, v4, v5, v0}, LX/15yz;->LJFF(ILjava/lang/String;ZZ)V
    ...
    iget-object v1, p0, LX/15yi;->LLJILJILJ:LX/15yz;

    if-eqz v1, :cond_2

    invoke-virtual {p0}, LX/15yi;->LJJIZ()I
    ...
    invoke-interface {v1, v0, v3}, LX/15yz;->showOrHideBottomWallet(ZZ)V
    ...
    invoke-interface {v1, v0, v4, v3, v3}, LX/15yz;->LJFF(ILjava/lang/String;ZZ)V
...
.method public final clear()V
    ...
    iput-boolean v0, p0, LX/15yi;->LLJJ:Z
