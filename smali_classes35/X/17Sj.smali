...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v0, LX/17Sp;

    invoke-direct {v0}, LX/17Sp;-><init>()V
    ...
    new-instance v0, LX/17Sn;

    invoke-direct {v0}, LX/17Sn;-><init>()V
    ...
    new-instance v0, LX/17Sk;

    invoke-direct {v0}, LX/17Sk;-><init>()V
    ...
    new-instance v0, LX/17Sq;

    invoke-direct {v0}, LX/17Sq;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v2}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/13mQ;

    invoke-direct {v1}, LX/13mQ;-><init>()V

    new-instance v0, LX/17Sm;

    invoke-direct {v0}, LX/17Sm;-><init>()V
    ...
    new-instance v0, LX/17So;

    invoke-direct {v0}, LX/17So;-><init>()V

    iput-object v0, v2, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v2, v3}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/13LE;

    invoke-direct {v1}, LX/13LE;-><init>()V

    new-instance v0, LX/17Sl;

    invoke-direct {v0}, LX/17Sl;-><init>()V
