...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v0, LX/17fi;

    invoke-direct {v0}, LX/17fi;-><init>()V
    ...
    new-instance v0, LX/17fh;

    invoke-direct {v0}, LX/17fh;-><init>()V
    ...
    new-instance v0, LX/17ff;

    invoke-direct {v0}, LX/17ff;-><init>()V
    ...
    new-instance v0, LX/17fk;

    invoke-direct {v0}, LX/17fk;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v2}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/12P9;

    invoke-direct {v1}, LX/12P9;-><init>()V

    new-instance v0, LX/17fg;

    invoke-direct {v0}, LX/17fg;-><init>()V
    ...
    new-instance v0, LX/17fj;

    invoke-direct {v0}, LX/17fj;-><init>()V
