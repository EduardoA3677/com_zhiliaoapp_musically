...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v3, LX/15vs;

    invoke-direct {v3}, LX/15vs;-><init>()V

    new-instance v0, LX/17Fq;

    invoke-direct {v0}, LX/17Fq;-><init>()V
    ...
    new-instance v0, LX/17Fo;

    invoke-direct {v0}, LX/17Fo;-><init>()V
    ...
    new-instance v0, LX/17Fp;

    invoke-direct {v0}, LX/17Fp;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v3}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v2, LX/12NX;

    invoke-direct {v2}, LX/12NX;-><init>()V

    new-instance v0, LX/17Fm;

    invoke-direct {v0}, LX/17Fm;-><init>()V
    ...
    invoke-direct {v1}, LX/12MF;-><init>()V

    new-instance v0, LX/17Fn;

    invoke-direct {v0}, LX/17Fn;-><init>()V
