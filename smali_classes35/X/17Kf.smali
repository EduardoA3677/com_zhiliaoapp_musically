...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v1, LX/12jM;

    invoke-direct {v1}, LX/12jM;-><init>()V

    new-instance v0, LX/17Kg;

    invoke-direct {v0}, LX/17Kg;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v3}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/157S;

    invoke-direct {v1}, LX/157S;-><init>()V

    new-instance v0, LX/17Kj;

    invoke-direct {v0}, LX/17Kj;-><init>()V
    ...
    new-instance v0, LX/17Ki;

    invoke-direct {v0}, LX/17Ki;-><init>()V
    ...
    new-instance v0, LX/17Kk;

    invoke-direct {v0}, LX/17Kk;-><init>()V
