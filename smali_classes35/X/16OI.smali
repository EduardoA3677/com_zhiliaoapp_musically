...
.field public final synthetic LIZJ:Lcom/ss/android/ugc/profile/business/ur/platform/business/BioUserWebSiteComponent;

.field public final synthetic LIZLLL:LX/0WRs;


# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/profile/business/ur/platform/business/BioUserWebSiteComponent;LX/0WRs;)V
    .locals 3

    iput-object p1, p0, LX/16OI;->LIZJ:Lcom/ss/android/ugc/profile/business/ur/platform/business/BioUserWebSiteComponent;

    iput-object p2, p0, LX/16OI;->LIZLLL:LX/0WRs;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-virtual {p1}, Lcom/ss/android/ugc/profile/platform/base/component/BaseUIComponent;->dn()Lcom/ss/android/ugc/profile/platform/base/data/ProfileCommonInfo;
    ...
    :goto_0
    iput-boolean v0, p0, LX/16OI;->LIZ:Z

    if-nez v0, :cond_2

    iget-object v0, p1, Lcom/ss/android/ugc/profile/platform/business/header/business/bio/base/BioBaseUIComponent;->LLJJJJLIIL:Lcom/ss/android/ugc/profile/platform/base/data/BizBaseData;
    ...
    :goto_1
    iput-boolean v2, p0, LX/16OI;->LIZIZ:Z
...
.method public final LIZ(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget-object v0, p0, LX/16OI;->LIZLLL:LX/0WRs;
    ...
    iget-boolean v0, p0, LX/16OI;->LIZ:Z
    ...
    :cond_3
    iget-object v0, p0, LX/16OI;->LIZJ:Lcom/ss/android/ugc/profile/business/ur/platform/business/BioUserWebSiteComponent;

    invoke-virtual {v0, p1}, Lcom/ss/android/ugc/profile/business/ur/platform/business/BioUserWebSiteComponent;->Xn(Landroid/content/Context;)V
    ...
    :cond_5
    iget-boolean v0, p0, LX/16OI;->LIZIZ:Z
    ...
    :goto_0
    iget-object v1, p0, LX/16OI;->LIZJ:Lcom/ss/android/ugc/profile/business/ur/platform/business/BioUserWebSiteComponent;
