...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v0, LX/17Ng;

    invoke-direct {v0}, LX/17Ng;-><init>()V
    ...
    new-instance v0, LX/17Nd;

    invoke-direct {v0}, LX/17Nd;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v2}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/12Oo;

    invoke-direct {v1}, LX/12Oo;-><init>()V

    new-instance v0, LX/17Ni;

    invoke-direct {v0}, LX/17Ni;-><init>()V
    ...
    new-instance v0, LX/17Nf;

    invoke-direct {v0}, LX/17Nf;-><init>()V
    ...
    new-instance v0, LX/17Ne;

    invoke-direct {v0}, LX/17Ne;-><init>()V
    ...
    new-instance v0, LX/17Nh;

    invoke-direct {v0}, LX/17Nh;-><init>()V
