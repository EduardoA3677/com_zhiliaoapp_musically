...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v3, LX/12PL;

    invoke-direct {v3}, LX/12PL;-><init>()V

    new-instance v0, LX/17p7;

    invoke-direct {v0}, LX/17p7;-><init>()V

    iput-object v0, v3, LX/0Yxe;->LJFF:LX/0Yxp;

    new-instance v1, LX/12OH;

    invoke-direct {v1}, LX/12OH;-><init>()V

    new-instance v0, LX/17pH;

    invoke-direct {v0}, LX/17pH;-><init>()V
    ...
    new-instance v0, LX/17pA;

    invoke-direct {v0}, LX/17pA;-><init>()V
    ...
    new-instance v0, LX/17p9;

    invoke-direct {v0}, LX/17p9;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v3}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v2, LX/13mT;

    invoke-direct {v2}, LX/13mT;-><init>()V

    new-instance v0, LX/17pE;

    invoke-direct {v0}, LX/17pE;-><init>()V
    ...
    new-instance v0, LX/17pI;

    invoke-direct {v0}, LX/17pI;-><init>()V
    ...
    new-instance v0, LX/17pB;

    invoke-direct {v0}, LX/17pB;-><init>()V

    iput-object v0, v4, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v4, v3}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/13mR;

    invoke-direct {v1}, LX/13mR;-><init>()V

    new-instance v0, LX/17pD;

    invoke-direct {v0}, LX/17pD;-><init>()V
    ...
    new-instance v0, LX/17pG;

    invoke-direct {v0}, LX/17pG;-><init>()V
    ...
    new-instance v0, LX/17pC;

    invoke-direct {v0}, LX/17pC;-><init>()V
    ...
    new-instance v0, LX/17pF;

    invoke-direct {v0}, LX/17pF;-><init>()V
    ...
    invoke-direct {v1}, LX/12PE;-><init>()V

    new-instance v0, LX/17p8;

    invoke-direct {v0}, LX/17p8;-><init>()V
