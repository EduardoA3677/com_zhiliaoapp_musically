...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v0, LX/17aK;

    invoke-direct {v0}, LX/17aK;-><init>()V
    ...
    new-instance v0, LX/17aH;

    invoke-direct {v0}, LX/17aH;-><init>()V
    ...
    new-instance v0, LX/17aF;

    invoke-direct {v0}, LX/17aF;-><init>()V
    ...
    new-instance v0, LX/17aL;

    invoke-direct {v0}, LX/17aL;-><init>()V
    ...
    new-instance v0, LX/17aD;

    invoke-direct {v0}, LX/17aD;-><init>()V
    ...
    new-instance v0, LX/17aJ;

    invoke-direct {v0}, LX/17aJ;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v2}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/14hR;

    invoke-direct {v1}, LX/14hR;-><init>()V

    new-instance v0, LX/17aI;

    invoke-direct {v0}, LX/17aI;-><init>()V
    ...
    new-instance v0, LX/17aC;

    invoke-direct {v0}, LX/17aC;-><init>()V
    ...
    new-instance v0, LX/17aE;

    invoke-direct {v0}, LX/17aE;-><init>()V
    ...
    new-instance v0, LX/17aG;

    invoke-direct {v0}, LX/17aG;-><init>()V
    ...
    new-instance v0, LX/17aM;

    invoke-direct {v0}, LX/17aM;-><init>()V
