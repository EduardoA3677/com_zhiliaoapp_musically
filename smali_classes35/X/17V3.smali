...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v0, LX/17V9;

    invoke-direct {v0}, LX/17V9;-><init>()V
    ...
    new-instance v0, LX/17V8;

    invoke-direct {v0}, LX/17V8;-><init>()V
    ...
    new-instance v0, LX/17V7;

    invoke-direct {v0}, LX/17V7;-><init>()V
    ...
    new-instance v0, LX/17V4;

    invoke-direct {v0}, LX/17V4;-><init>()V
    ...
    new-instance v0, LX/17V6;

    invoke-direct {v0}, LX/17V6;-><init>()V

    iput-object v0, v2, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v2, v3}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/14hU;

    invoke-direct {v1}, LX/14hU;-><init>()V

    new-instance v0, LX/17VA;

    invoke-direct {v0}, LX/17VA;-><init>()V
    ...
    new-instance v0, LX/17V5;

    invoke-direct {v0}, LX/17V5;-><init>()V
