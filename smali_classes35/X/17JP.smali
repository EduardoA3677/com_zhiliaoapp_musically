...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v0, LX/17JS;

    invoke-direct {v0}, LX/17JS;-><init>()V

    iput-object v0, v2, LX/0Yxe;->LJFF:LX/0Yxp;

    new-instance v1, LX/12u4;

    invoke-direct {v1}, LX/12u4;-><init>()V

    new-instance v0, LX/17JR;

    invoke-direct {v0}, LX/17JR;-><init>()V
    ...
    invoke-direct {v1}, LX/12qn;-><init>()V

    new-instance v0, LX/17JT;

    invoke-direct {v0}, LX/17JT;-><init>()V
    ...
    new-instance v0, LX/17JQ;

    invoke-direct {v0}, LX/17JQ;-><init>()V
