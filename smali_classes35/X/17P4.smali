...
.method public final LIZ(LX/0YxM;)LX/0YxT;
    ...
    new-instance v3, LX/12OC;

    invoke-direct {v3}, LX/12OC;-><init>()V
    ...
    new-instance v0, LX/17P5;

    invoke-direct {v0}, LX/17P5;-><init>()V

    iput-object v0, v2, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v2, v3}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/12OG;

    invoke-direct {v1}, LX/12OG;-><init>()V

    new-instance v0, LX/17P6;

    invoke-direct {v0}, LX/17P6;-><init>()V

    iput-object v0, v1, LX/0Yxe;->LJFF:LX/0Yxp;

    invoke-virtual {v1, v2}, LX/0Yxe;->LJIIZILJ(LX/0Yxe;)V

    new-instance v1, LX/12M4;

    invoke-direct {v1}, LX/12M4;-><init>()V
