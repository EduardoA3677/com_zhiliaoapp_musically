...
.field public static sDefaultTrustManager:Lcom/ss/mediakit/vcnlib/X509Util$X509TrustManagerImplementation;
...
.field public static sTestTrustManager:Lcom/ss/mediakit/vcnlib/X509Util$X509TrustManagerImplementation;

.field public static sTrustStorageListener:Lcom/ss/mediakit/vcnlib/X509Util$TrustStorageListener;
...
.method public static addTestRootCertificate([B)V
    ...
    sget-object v3, Lcom/ss/mediakit/vcnlib/X509Util;->sLock:Ljava/lang/Object;
...
.method public static createCertificateFromBytes([B)Ljava/security/cert/X509Certificate;
    ...
    sget-object v1, Lcom/ss/mediakit/vcnlib/X509Util;->sCertificateFactory:Ljava/security/cert/CertificateFactory;
...
.method public static createTrustManager(Ljava/security/KeyStore;)Lcom/ss/mediakit/vcnlib/X509Util$X509TrustManagerImplementation;
    .locals 5
    ...
    :try_start_0
    new-instance v1, Lcom/ss/mediakit/vcnlib/X509Util$X509TrustManagerJellyBean;

    move-object v0, v2

    check-cast v0, Ljavax/net/ssl/X509TrustManager;

    invoke-direct {v1, v0}, Lcom/ss/mediakit/vcnlib/X509Util$X509TrustManagerJellyBean;-><init>(Ljavax/net/ssl/X509TrustManager;)V
...
.method public static ensureInitializedLocked()V
    ...
    invoke-static {v3}, Lcom/ss/mediakit/vcnlib/X509Util;->createTrustManager(Ljava/security/KeyStore;)Lcom/ss/mediakit/vcnlib/X509Util$X509TrustManagerImplementation;
    ...
    sput-object v2, Lcom/ss/mediakit/vcnlib/X509Util;->sSystemCertificateDirectory:Ljava/io/File;
    :try_end_2
    ...
    invoke-direct {v0}, Lcom/ss/mediakit/vcnlib/X509Util$TrustStorageListener;-><init>()V
...
.method public static isKnownRoot(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {v0}, Lcom/ss/mediakit/vcnlib/X509Util;->hashPrincipal(Ljavax/security/auth/x500/X500Principal;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/ss/mediakit/vcnlib/X509Util;->sSystemCertificateDirectory:Ljava/io/File;
    ...
    :cond_2
    sget-object v2, Lcom/ss/mediakit/vcnlib/X509Util;->sSystemKeyStore:Ljava/security/KeyStore;
...
.method public static verifyServerCertificates([[BLjava/lang/String;Ljava/lang/String;)Lcom/ss/mediakit/vcnlib/AndroidCertVerifyResult;
    ...
    invoke-static {v0}, Lcom/ss/mediakit/vcnlib/X509Util;->createCertificateFromBytes([B)Ljava/security/cert/X509Certificate;
    ...
    invoke-static {v0}, Lcom/ss/mediakit/vcnlib/X509Util;->verifyKeyUsage(Ljava/security/cert/X509Certificate;)Z

    move-result v0

    if-nez v0, :cond_1

    new-instance v1, Lcom/ss/mediakit/vcnlib/AndroidCertVerifyResult;

    const/4 v0, -0x6

    invoke-direct {v1, v0}, Lcom/ss/mediakit/vcnlib/AndroidCertVerifyResult;-><init>(I)V
    ...
    new-instance v0, Lcom/ss/mediakit/vcnlib/AndroidCertVerifyResult;

    invoke-direct {v0, v2}, Lcom/ss/mediakit/vcnlib/AndroidCertVerifyResult;-><init>(I)V
    ...
    :cond_2
    :try_start_5
    invoke-interface {v0, v1, p1, p2}, Lcom/ss/mediakit/vcnlib/X509Util$X509TrustManagerImplementation;->checkServerTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0}, Lcom/ss/mediakit/vcnlib/X509Util;->isKnownRoot(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-direct {v0, v4, v1, v2}, Lcom/ss/mediakit/vcnlib/AndroidCertVerifyResult;-><init>(IZLjava/util/List;)V
