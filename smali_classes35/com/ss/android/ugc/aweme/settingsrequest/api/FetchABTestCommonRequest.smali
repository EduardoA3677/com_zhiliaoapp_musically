.class public final Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;
...
.method public constructor <init>(I)V
    ...
    iput p1, p0, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LL:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILIL:Z

    new-instance v0, LX/0aNS;

    invoke-direct {v0}, LX/0aNS;-><init>()V

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILL:LX/0aNS;
...
.method public final LIZLLL(Lcom/google/gson/n;Lcom/google/gson/n;Ljava/util/Set;)V
    ...
    invoke-virtual {p0, v0}, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LJI(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LJI(Ljava/lang/String;)V
    ...
    new-instance v0, LX/0B5Q;

    invoke-direct {v0, v6, v4, p3, p2}, LX/0B5Q;-><init>(Ljava/util/HashMap;Ljava/util/Map$Entry;Ljava/util/Set;Lcom/google/gson/n;)V
...
.method public final LJFF(Landroid/content/Context;Z)V
    ...
    sget-boolean v0, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILLIZIL:Z
    ...
    sput-boolean v3, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILLIZIL:Z

    sget-object v0, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILLL:LX/0Yke;
    ...
    :goto_0
    iget v0, v2, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LL:I
    ...
    iput-wide v7, v6, LX/16CR;->LIZLLL:J
    ...
    iput-wide v7, v6, LX/16CR;->LJJII:J
    ...
    iget-boolean v0, v2, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILIL:Z

    if-eqz v0, :cond_6

    iput v1, v6, LX/16CR;->LIZJ:I
    ...
    :catchall_0
    :cond_a
    sput-boolean v3, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILLJJLI:Z
    ...
    iput-boolean v0, v2, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILIL:Z
    ...
    :cond_e
    new-instance v5, Lcom/ss/android/ugc/aweme/setting/api/ABTestRequestBody;
    ...
    invoke-direct {v5, v3, v1}, Lcom/ss/android/ugc/aweme/setting/api/ABTestRequestBody;-><init>(ILjava/util/List;)V
    ...
    invoke-static {v5, v1}, LX/0n4t;->LJJJZ([Ljava/lang/Object;Lkotlin/ranges/IntRange;)Ljava/util/List;
    ...
    :cond_15
    sget-object v3, LX/16CY;->LIZ:LX/16CY;

    monitor-enter v3

    :try_start_1
    sput-boolean v1, LX/16CY;->LIZJ:Z
    :try_end_1
    ...
    invoke-virtual {v5, v0}, LX/0aKv;->LJIJJLI(LX/0aNa;)LX/0aFa;
    ...
    invoke-direct {v1, v6, v0}, LY/AkS429S0100000_26;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v3, v1}, LX/0aKv;->LJIILIIL(LX/0SDB;)LX/0aF7;

    move-result-object v1

    sget-object v0, LX/1604;->LL:LX/1604;

    invoke-virtual {v1, v0}, LX/0aKv;->LJIIJ(LX/0aHB;)LX/0aKv;

    move-result-object v1

    sget-object v0, LX/1602;->LL:LX/1602;

    invoke-virtual {v1, v0}, LX/0aKv;->LJIILIIL(LX/0SDB;)LX/0aF7;

    move-result-object v5

    sget-object v3, LX/1606;->LL:LX/1606;

    const-wide/16 v0, 0x1

    invoke-virtual {v5, v0, v1, v3}, LX/0aKv;->LJIILL(JLX/0aHB;)LX/0aIu;

    move-result-object v5

    new-instance v3, LX/16CU;

    invoke-direct {v3, v6, v2}, LX/16CU;-><init>(LX/16CR;Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;)V

    new-instance v1, LY/AfS156S0100000_34;

    const/4 v0, 0x2

    invoke-direct {v1, v6, v0}, LY/AfS156S0100000_34;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v5, v3, v1}, LX/0aKv;->LJIJ(LX/0E38;LX/0E38;)LX/02SD;

    move-result-object v1

    iget-object v0, v2, Lcom/ss/android/ugc/aweme/settingsrequest/api/FetchABTestCommonRequest;->LLILL:LX/0aNS;

    invoke-virtual {v0, v1}, LX/0aNS;->LIZJ(LX/02SD;)Z

    sget-object v1, LX/0uFY;->LIZLLL:LX/0uFY;

    invoke-virtual {v1, v4}, LX/0uFY;->LJI(Ljava/lang/String;)V
...
.method public final key()Ljava/lang/String;
    ...
    const-string v0, "FetchABTestCommonRequest"
