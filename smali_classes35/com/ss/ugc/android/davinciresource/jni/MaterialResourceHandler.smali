.class public Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;
...
.method public constructor <init>(JZ)V
    ...
    invoke-static {p1, p2}, Lcom/ss/ugc/android/davinciresource/jni/DavinciResourceJniJNI;->MaterialResourceHandler_SWIGSmartPtrUpcast(J)J
    ...
    iput-boolean p3, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCMemOwnDerived:Z

    iput-wide p1, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCPtr:J

    return-void
.end method

.method public constructor <init>(Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceConfig;)V
    .locals 3

    invoke-static {p1}, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceConfig;->getCPtr(Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceConfig;)J

    move-result-wide v0

    invoke-static {v0, v1, p1}, Lcom/ss/ugc/android/davinciresource/jni/DavinciResourceJniJNI;->new_MaterialResourceHandler(JLcom/ss/ugc/android/davinciresource/jni/MaterialResourceConfig;)J

    move-result-wide v1

    const/4 v0, 0x1

    invoke-direct {p0, v1, v2, v0}, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;-><init>(JZ)V

    return-void
.end method

.method public static getCPtr(Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;)J
    .locals 1
    ...
    :cond_0
    iget-wide v0, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCPtr:J
...
.method public canHandle(Lcom/ss/ugc/android/davinciresource/jni/DAVResource;)Z
    ...
    iget-wide v0, v2, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCPtr:J
    ...
    invoke-static/range {v0 .. v5}, Lcom/ss/ugc/android/davinciresource/jni/DavinciResourceJniJNI;->MaterialResourceHandler_canHandle(JLcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;JLcom/ss/ugc/android/davinciresource/jni/DAVResource;)Z
...
.method public declared-synchronized delete()V
    ...
    :try_start_0
    iget-wide v3, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCPtr:J
    ...
    iget-boolean v0, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCMemOwnDerived:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCMemOwnDerived:Z

    invoke-static {v3, v4}, Lcom/ss/ugc/android/davinciresource/jni/DavinciResourceJniJNI;->delete_MaterialResourceHandler(J)V

    :cond_0
    iput-wide v1, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCPtr:J
...
.method public fetchResourceFromCache(Ljava/lang/String;)Lcom/ss/ugc/android/davinciresource/jni/DAVResource;
    ...
    invoke-static {v0, v1, p0, p1}, Lcom/ss/ugc/android/davinciresource/jni/DavinciResourceJniJNI;->MaterialResourceHandler_fetchResourceFromCache__SWIG_1(JLcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;Ljava/lang/String;)J
...
.method public fetchResourceFromCache(Ljava/lang/String;Lcom/ss/ugc/android/davinciresource/jni/MapStringString;)Lcom/ss/ugc/android/davinciresource/jni/DAVResource;
    ...
    invoke-static/range {v0 .. v6}, Lcom/ss/ugc/android/davinciresource/jni/DavinciResourceJniJNI;->MaterialResourceHandler_fetchResourceFromCache__SWIG_0(JLcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;Ljava/lang/String;JLcom/ss/ugc/android/davinciresource/jni/MapStringString;)J
...
.method public swigSetCMemOwn(Z)V
    ...
    iput-boolean p1, p0, Lcom/ss/ugc/android/davinciresource/jni/MaterialResourceHandler;->swigCMemOwnDerived:Z
