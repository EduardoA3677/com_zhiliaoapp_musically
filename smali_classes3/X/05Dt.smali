...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/05Dt;->LIZ:LX/05ta;

    invoke-static {}, LX/03Jv;->LIZIZ()LX/02sS;

    move-result-object v0

    sput-object v0, LX/05Dt;->LIZIZ:LX/02sS;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    sput-object v0, LX/05Dt;->LIZJ:Ljava/util/Map;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    sput-object v0, LX/05Dt;->LIZLLL:Ljava/util/Map;

    const/16 v0, 0x2ee

    sput v0, LX/05Dt;->LJFF:I
...
.method public static LIZ(Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, LX/05Dt;->LIZLLL:Ljava/util/Map;
    ...
    :cond_1
    iget-object v9, v1, LX/05Du;->LIZJ:Ljava/util/Map;

    iget-object v8, v1, LX/05Du;->LIZ:Ljava/lang/CharSequence;
    ...
    const-class v0, Lcom/ss/android/ugc/aweme/commercialize/chatagent/common/ui/markdown/typewriter/ForegroundAlphaSpan;
    ...
    new-instance v1, Lcom/ss/android/ugc/aweme/commercialize/chatagent/common/ui/markdown/typewriter/ForegroundAlphaSpan;

    invoke-static {v2, v6, v6, v6}, Landroid/graphics/Color;->argb(IIII)I

    move-result v0

    invoke-direct {v1, v0, v2}, Lcom/ss/android/ugc/aweme/commercialize/chatagent/common/ui/markdown/typewriter/ForegroundAlphaSpan;-><init>(II)V
