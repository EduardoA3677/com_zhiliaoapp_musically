...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/05D8;->LIZ:LX/05ta;

    const-wide/16 v0, 0x1f4

    iput-wide v0, p0, LX/05D8;->LIZIZ:J

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object v0, p0, LX/05D8;->LIZLLL:Ljava/util/Set;

    invoke-static {}, LX/03Jv;->LIZIZ()LX/02sS;

    move-result-object v0

    iput-object v0, p0, LX/05D8;->LJ:LX/02sS;
...
.method public final LIZ(LX/0oRH;Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, LX/05D8;->LIZJ:LX/05CF;

    const/4 v3, 0x0

    if-nez v0, :cond_0

    new-instance v0, LX/05CF;

    invoke-direct {v0, p2}, LX/05CF;-><init>(Ljava/lang/CharSequence;)V

    iput-object v0, p0, LX/05D8;->LIZJ:LX/05CF;

    move-object v6, v3

    :goto_0
    iget-object v5, p0, LX/05D8;->LIZJ:LX/05CF;
    ...
    :cond_0
    iget-object v6, v0, LX/05CF;->LIZ:Ljava/lang/CharSequence;
    ...
    iget-object v2, v5, LX/05CF;->LIZIZ:Ljava/util/Map;
    ...
    :cond_2
    :goto_1
    iput-object p2, v5, LX/05CF;->LIZ:Ljava/lang/CharSequence;

    iget-object v0, v5, LX/05CF;->LIZIZ:Ljava/util/Map;
    ...
    :cond_4
    iget-object v0, p0, LX/05D8;->LIZLLL:Ljava/util/Set;

    invoke-interface {v0, p1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0}, LX/05D8;->LIZIZ()V

    iget-boolean v0, p0, LX/05D8;->LJFF:Z

    if-nez v0, :cond_5

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/05D8;->LJFF:Z

    iget-object v2, p0, LX/05D8;->LJ:LX/02sS;

    new-instance v1, LX/05CE;

    invoke-direct {v1, p0, v3}, LX/05CE;-><init>(LX/05D8;LX/02wT;)V
...
.method public final LIZIZ()V
    ...
    :cond_0
    iget-object v11, p0, LX/05D8;->LIZLLL:Ljava/util/Set;

    iget-object v10, v0, LX/05CF;->LIZIZ:Ljava/util/Map;

    iget-object v9, v0, LX/05CF;->LIZ:Ljava/lang/CharSequence;
