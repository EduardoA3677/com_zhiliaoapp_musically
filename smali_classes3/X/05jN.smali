...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, LX/05jN;->LLILL:Ljava/util/List;

    const v0, 0x7f040741

    invoke-virtual {p0, v0}, Landroid/view/View;->setBackgroundResource(I)V

    sget v0, LX/05jN;->LLILLIZIL:I
...
.method public final LIZ(Ljava/util/List;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {v8, v0, p1}, LX/0Du0;->LIZIZ(Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    invoke-virtual {v9, v2}, LX/05jN;->setTitles(Ljava/util/List;)V
    ...
    iget-object v3, v8, Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;->LLJLL:LX/0DmU;
    ...
    invoke-static {v3, v2, v0, v0, v1}, LX/0DmU;->LJIJJLI(LX/0DmU;Ljava/lang/String;Ljava/util/HashMap;Ljava/util/Map;I)V
    ...
    :cond_3
    invoke-virtual {v9, v2}, LX/05jN;->setTabPositionList(Ljava/util/List;)V
    ...
    invoke-direct/range {v6 .. v11}, Lkotlin/jvm/internal/AwS93S0400000_2;-><init>(Ljava/util/List;Lcom/ss/android/ugc/aweme/ecommerce/base/pdp/sea/vm/SeaPdpViewModel;LX/05jN;Lkotlin/jvm/functions/Function1;I)V

    iput-object v6, v9, LX/05jN;->LLILIL:Lkotlin/jvm/functions/Function1;
...
.method public final getClickStrategy()Lkotlin/jvm/functions/Function1;
    ...
    iget-object v0, p0, LX/05jN;->LLILIL:Lkotlin/jvm/functions/Function1;
...
.method public final setClickStrategy(Lkotlin/jvm/functions/Function1;)V
    ...
    iput-object p1, p0, LX/05jN;->LLILIL:Lkotlin/jvm/functions/Function1;
...
.method public final setCurIndex(I)V
    ...
    iget v0, p0, LX/05jN;->LL:I

    if-eq v0, p1, :cond_5

    iput p1, p0, LX/05jN;->LL:I
    ...
    :cond_0
    invoke-virtual {v3, v1}, LX/05jM;->setIsSelected(Z)V
...
.method public setTabPosition(I)V
    ...
    iget-object v0, p0, LX/05jN;->LLILL:Ljava/util/List;
    ...
    :cond_1
    invoke-virtual {p0, v1}, LX/05jN;->setCurIndex(I)V
...
.method public final setTitles(Ljava/util/List;)V
    ...
    new-instance v4, LX/05jM;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {v4, v0}, LX/05jM;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v1}, LX/05jM;->setTitle(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-virtual {v4, v0}, LX/05jM;->setIsSelected(Z)V
