...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v4, p0, LX/05uS;->LL:F

    const v0, 0x40e66666    # 7.2f

    iput v0, p0, LX/05uS;->LLILIL:F
    ...
    iput-object v1, p0, LX/05uS;->LLILLJJLI:Landroid/graphics/Paint;
    ...
    iput-object v1, p0, LX/05uS;->LLILLL:Landroid/graphics/RectF;
    ...
    iput-object v2, p0, LX/05uS;->LLILZ:Lcom/bytedance/tux/input/TuxTextView;
...
.method public final dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, LX/05uS;->LLILL:F

    add-float/2addr v6, v1

    iget v3, p0, LX/05uS;->LLILZLL:I
    ...
    iget v0, p0, LX/05uS;->LLILZIL:I

    if-ge v2, v0, :cond_0

    iget-object v5, p0, LX/05uS;->LLILLL:Landroid/graphics/RectF;

    const/4 v8, 0x0

    iget-object v9, p0, LX/05uS;->LLILLJJLI:Landroid/graphics/Paint;

    invoke-virtual/range {v4 .. v9}, Landroid/graphics/Canvas;->drawArc(Landroid/graphics/RectF;FFZLandroid/graphics/Paint;)V

    :goto_1
    iget v1, p0, LX/05uS;->LLILIL:F

    add-float/2addr v1, v7

    iget v0, p0, LX/05uS;->LLILL:F
    ...
    iget-object v9, p0, LX/05uS;->LLILLIZIL:Landroid/graphics/Paint;
...
.method public final onSizeChanged(IIII)V
    ...
    iput-object v7, p0, LX/05uS;->LLILLL:Landroid/graphics/RectF;

    iget v0, p0, LX/05uS;->LL:F
