...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, LX/0Vek;-><init>()V
...
.method public final handle(Lcom/bytedance/sdk/xbridge/registry/core/model/idl/XBaseParamModel;Lcom/bytedance/sdk/xbridge/registry/core/model/idl/CompletionBlock;LX/0WFr;)V
    ...
    check-cast v1, LX/0Vel;

    if-eqz v3, :cond_2

    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/commercialize/hybrid/api/web/model/NonAdWebModel;->getItemId()Ljava/lang/String;

    move-result-object v0

    :goto_2
    invoke-interface {v1, v0}, LX/0Vel;->setItemId(Ljava/lang/String;)V

    if-eqz v3, :cond_1

    invoke-virtual {v3}, Lcom/ss/android/ugc/aweme/commercialize/hybrid/api/web/model/NonAdWebModel;->getOrganicLogExtra()Ljava/lang/String;

    move-result-object v4

    :cond_1
    invoke-interface {v1, v4}, LX/0Vel;->setOrganicLogExtra(Ljava/lang/String;)V
