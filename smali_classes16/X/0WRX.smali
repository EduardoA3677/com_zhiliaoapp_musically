...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;)V
    ...
    iput-object p1, p0, LX/0WRX;->LIZIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/0WRR;)Lorg/json/JSONObject;
    .locals 4
    ...
    invoke-interface {p0}, LX/0WRR;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/0WRR;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/0WRR;->getCanReceiveReward()Ljava/lang/Boolean;
    ...
    invoke-interface {p0}, LX/0WRR;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, v4, LX/0WRX;->LIZIZ:Ljava/lang/ref/WeakReference;
    ...
    :cond_1
    new-instance v3, LY/ARunnableS40S0300000_15;

    const/16 v8, 0x15

    invoke-direct/range {v3 .. v8}, LY/ARunnableS40S0300000_15;-><init>(LX/0WRX;Lorg/json/JSONObject;Landroid/app/Activity;Ljava/lang/Number;I)V
