...
.method public constructor <init>(LX/0V5P;)V
    ...
    iput-object p1, p0, LX/0V5Q;->LIZ:LX/0V5P;
...
.method public final l2()LX/0V6U;
    ...
    iget-object v0, p0, LX/0V5Q;->LIZ:LX/0V5P;

    iget-object v0, v0, LX/0V5P;->LLIZ:Landroid/view/ViewGroup;
...
.method public final v2(Ljava/lang/String;LX/0V0M;Lcom/ss/android/ugc/aweme/commercialize/model/AnoleComponentAppearModel;)Z
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/commercialize/anchor/interfaces/ICommerceAnchorService;->LJ()Z
    ...
    invoke-interface {v1, v0}, Lcom/ss/android/ugc/aweme/commercialize/anchor/interfaces/ICommerceAnchorService;->LJIILIIL(Lcom/ss/android/ugc/aweme/feed/model/AnchorCommonStruct;)Z

    move-result v0

    if-nez v0, :cond_1

    iget-object v1, p0, LX/0V5Q;->LIZ:LX/0V5P;

    const-string v0, "time_limit"

    invoke-virtual {v1, v0}, LX/0V5P;->LIZJ(Ljava/lang/String;)V
    ...
    invoke-interface {v0}, Lcom/ss/android/ugc/aweme/commercialize/anchor/interfaces/ICommerceAnchorService;->LIZIZ()Z
