...
.method public static LIZLLL(LX/0XgT;)V
    .locals 7
    ...
    :try_start_2
    invoke-static {v4}, LX/0WW4;->LIZ(LX/0XgT;)V
    ...
    :catch_0
    invoke-static {v4}, LX/0WYi;->LIZJ(LX/0XgT;)Ljava/lang/String;
    ...
    const-string v0, "file broken, but md5 is the same, file length: "
...
.method public final LIZJ(LX/0WXB;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v9}, Lcom/bytedance/geckox/model/UpdatePackage;->getDecompressFrom()I
    ...
    const-string v0, "start active channel:"
    ...
    const-string v0, "gecko-debug-tagRenameChannel"
    ...
    invoke-virtual {v9}, Lcom/bytedance/geckox/model/UpdatePackage;->isSingleFile()Z
    ...
    :goto_3
    :try_start_0
    invoke-static {v7}, LX/0WW0;->LIZLLL(LX/0XgT;)V
    :try_end_0
    ...
    invoke-interface {p1, v1}, LX/0WXB;->proceed(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v7}, LX/0WW4;->LIZLLL(Ljava/io/File;)Z
    ...
    const-string v0, "check file broken failed: "
    ...
    const-string v0, "delete old dir failed:"
