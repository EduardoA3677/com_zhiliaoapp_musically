...
.method public static LIZ(LX/0VMn;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lkotlin/jvm/functions/Function1;)V
    .locals 8
    ...
    check-cast v5, Lcom/ss/android/ugc/aweme/RewardAdAdapterApi;

    :cond_5
    sget-object v1, LX/0VMm;->LIZ:[I
    ...
    :cond_6
    invoke-interface {v5, p1, p2, p3}, Lcom/ss/android/ugc/aweme/RewardAdAdapterApi;->postRequest(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)LX/0aSK;
    ...
    :cond_9
    invoke-interface {v5, p1, p2, p3}, Lcom/ss/android/ugc/aweme/RewardAdAdapterApi;->getRequest(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)LX/0aSK;
    ...
    invoke-direct {v0, p4}, LX/0Vah;-><init>(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v0, v2}, LX/0Vaj;-><init>(Ljava/lang/Throwable;)V
