...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, LX/0X1p;->LIZIZ:Landroid/content/ContentValues;

    invoke-static {p1}, LX/0X3I;->P(Landroid/content/Context;)Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, LX/0X1p;->LIZ:Landroid/content/Context;
...
.method public final declared-synchronized LIZ()V
    ...
    :try_start_0
    iget-object v0, p0, LX/0X1p;->LIZ:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v5

    iget-object v2, p0, LX/0X1p;->LIZ:Landroid/content/Context;
    ...
    iget-object v3, p0, LX/0X1p;->LIZIZ:Landroid/content/ContentValues;

    new-instance v2, LX/04q9;

    const-string v1, "dzBzEgAjS8/YVFkiQFyHacu2SzYe/bvZip/6gIBD6s5VEfn+T9fnirLcQeLPotovHeCvPS8w4YkKDjFSRJNgbuuT"
...
.method public final declared-synchronized LIZIZ()V
    ...
    :try_start_0
    invoke-virtual {p0}, LX/0X1p;->LIZ()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
