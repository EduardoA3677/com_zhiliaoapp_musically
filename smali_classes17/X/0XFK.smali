...
.method public constructor <init>()V
    ...
    iput-object v1, p0, LX/0XFK;->LL:Landroid/os/HandlerThread;
...
.method public final LIZ(LX/0XGK;)V
    ...
    iget-object v0, p0, LX/0XFK;->LLILIL:LX/0XF6;

    const/4 v3, 0x0

    if-nez v0, :cond_0

    new-instance v1, LX/0XF6;

    iget-object v0, p0, LX/0XFK;->LL:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, v0}, LX/0XF6;-><init>(Landroid/os/Looper;)V

    iput-object v1, p0, LX/0XFK;->LLILIL:LX/0XF6;
    ...
    iget-object v1, p0, LX/0XFK;->LLILIL:LX/0XF6;

    monitor-enter v1

    :try_start_0
    iget-object v0, v1, LX/0XF6;->LL:Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object v0, v1, LX/0XF6;->LLILIL:LX/0B6c;
