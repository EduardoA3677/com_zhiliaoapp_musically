...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0XUA;->LIZ:Ljava/util/List;
...
.method public static LIZIZ(Landroid/content/Context;Ljava/lang/String;)LX/0XgT;
    .locals 5
    ...
    invoke-static {p0}, LX/0XUA;->LIZ(Landroid/content/Context;)Ljava/io/File;
...
.method public static declared-synchronized LIZJ(Landroid/content/Context;Ljava/lang/String;)Z
    .locals 7

    const-string v5, "monitorcollector-lib"

    const-class v6, LX/0XUA;

    monitor-enter v6

    :try_start_0
    sget-object v2, LX/0XUA;->LIZ:Ljava/util/List;
    ...
    :try_start_2
    const-string v1, "APM-LoadLibrary"

    const-string v0, "System loadFailed"

    invoke-static {v1, v0, v2}, LX/0XoO;->LIZJ(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-static {p0, p1}, LX/0XUA;->LIZIZ(Landroid/content/Context;Ljava/lang/String;)LX/0XgT;
    ...
    :cond_2
    invoke-static {p0, v1}, LX/0XUA;->LIZLLL(Landroid/content/Context;LX/0XgT;)Ljava/lang/String;
    ...
    sget-object v0, LX/0XUA;->LIZ:Ljava/util/List;
    ...
    const-string v0, "Unpack loadFailed"
...
.method public static LIZLLL(Landroid/content/Context;LX/0XgT;)Ljava/lang/String;
    .locals 9

    const-string v8, "monitorcollector-lib"
    ...
    invoke-static {v0}, LX/0BCK;->LIZIZ(Ljava/lang/String;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_2
    ...
    invoke-static {v7}, LX/0BCK;->LIZ(Ljava/io/Closeable;)V
