...
# static fields
.field public static final LIZ:LX/0XNo;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0YHv;->LIZ:LX/0XNo;
...
.method public static LIZIZ(Ljava/io/File;LX/0Xgf;)V
    .locals 7

    sget-object v0, LX/0YHv;->LIZ:LX/0XNo;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p0}, LX/0XNo;->LIZ(Ljava/io/File;)LX/0XT4;
    ...
    const-string p0, "Failed to copy from->"
    ...
    const-string v0, "begin to copy from->"
    ...
    :goto_1
    invoke-static {v2}, LX/0HDQ;->LIZIZ(LX/0XgU;)V

    invoke-static {p1}, LX/0HDQ;->LIZ(Ljava/io/OutputStream;)V
    ...
    const-string v0, "because of srcFile not exist"
...
.method public static LIZJ(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0}, LX/0XT4;-><init>(Ljava/lang/String;)V

    new-instance v1, LX/0XT4;

    invoke-direct {v1, p1}, LX/0XT4;-><init>(Ljava/lang/String;)V

    sget-object v0, LX/0YHv;->LIZ:LX/0XNo;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2}, LX/0XNo;->LIZ(Ljava/io/File;)LX/0XT4;

    move-result-object v4

    invoke-static {v1}, LX/0XNo;->LIZ(Ljava/io/File;)LX/0XT4;
    ...
    const-string v6, "Failed to copy from->"
    ...
    invoke-virtual {v3}, LX/0XT4;->getParentFile()Ljava/io/File;
    ...
    const-string v0, " because of dest parent mkdir failed"
    ...
    const-string v0, "because of destFile cant write!"
    ...
    invoke-direct {v6, v4}, LX/0XgU;-><init>(Ljava/io/File;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    :goto_1
    invoke-static {v6}, LX/0HDQ;->LIZIZ(LX/0XgU;)V

    invoke-static {v2}, LX/0HDQ;->LIZ(Ljava/io/OutputStream;)V
    ...
    :goto_3
    invoke-static {v1}, LX/0HDQ;->LIZIZ(LX/0XgU;)V
    ...
    const-string v0, "Failed to copy same path from->"
...
.method public static LIZLLL(LX/0XgU;Ljava/io/OutputStream;)V
    .locals 3
    ...
    :goto_1
    invoke-static {p0}, LX/0HDQ;->LIZIZ(LX/0XgU;)V
...
.method public static LJ(Landroid/content/Context;)J
    ...
    invoke-static {p0}, LX/0YHv;->LIZ(Landroid/content/Context;)Ljava/io/File;
    ...
    const-string v5, "diZqWQY7UcnZG14uCzCAQMxj1gbLqVjAtQ=="
...
.method public static LJFF(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/InputStream;
    .locals 6
    ...
    invoke-static {v2, v0}, LX/0XgX;->LJ(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
