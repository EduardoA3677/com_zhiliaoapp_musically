...
.method public static LIZ(Lorg/json/JSONObject;)V
    ...
    const-string/jumbo v5, "un_duplicate_message_settings"

    const-string v4, "sdk_key_PushSDK"
    ...
    invoke-static {p0, v4}, Lcom/bytedance/mt/protector/impl/JSONObjectProtectorUtils;->getJSONObject(Lorg/json/JSONObject;Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    :goto_1
    const-string v1, "max_cache_time_in_hour"
    ...
    const-string v0, "exception_updateMaxCacheTime4LocalNotify"
    ...
    const-string/jumbo v0, "updateMaxCacheTime4LocalNotify() - New Settings: "
