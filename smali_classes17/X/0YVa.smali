...
.method public constructor <init>(LX/0YVc;LX/0ZBv;Ljava/util/List;LX/0ZBv;)V
    ...
    iput-object p1, p0, LX/0YVa;->LLILLIZIL:LX/0YVc;

    iput-object p3, p0, LX/0YVa;->LLILIL:Ljava/util/List;

    iput-object p4, p0, LX/0YVa;->LLILL:LX/0ZBv;
...
.method public final LIZ()V
    ...
    :try_start_0
    iget-object v1, p0, LX/0YVa;->LLILLIZIL:LX/0YVc;
    ...
    iget-object v0, p0, LX/0YVa;->LLILIL:Ljava/util/List;
    ...
    new-instance v2, LX/0YWh;

    iget-object v1, p0, LX/0YVa;->LLILLIZIL:LX/0YVc;

    iget-object v0, p0, LX/0YVa;->LLILL:LX/0ZBv;

    invoke-direct {v2, v1, v0}, LX/0YWh;-><init>(LX/0YVc;LX/0ZBv;)V

    invoke-interface {v6, v5, v4, v3, v2}, LX/0YVe;->o0(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;LX/0YWh;)V
    ...
    iget-object v1, p0, LX/0YVa;->LLILL:LX/0ZBv;
