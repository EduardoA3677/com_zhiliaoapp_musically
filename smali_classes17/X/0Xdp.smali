...
.method public static declared-synchronized LIZIZ(Lorg/json/JSONObject;)V
    .locals 14

    const-class v7, LX/0Xdp;

    monitor-enter v7

    :try_start_0
    const-class v6, LX/0XpL;
    ...
    sget-object v0, LX/0Xdp;->LIZ:Ljava/nio/MappedByteBuffer;
    ...
    invoke-static {v0}, LX/0Xdp;->LIZ(Landroid/content/Context;)Ljava/io/File;
    ...
    sput-object v0, LX/0Xdp;->LIZ:Ljava/nio/MappedByteBuffer;

    if-nez v3, :cond_1

    invoke-virtual {v0, v5, v10, v11}, Ljava/nio/ByteBuffer;->putLong(IJ)Ljava/nio/ByteBuffer;
    ...
    sget-object v2, LX/0Xdp;->LIZ:Ljava/nio/MappedByteBuffer;

    const-wide/16 v0, 0x1

    add-long/2addr v3, v0

    invoke-virtual {v2, v5, v3, v4}, Ljava/nio/ByteBuffer;->putLong(IJ)Ljava/nio/ByteBuffer;
