...
# instance fields
.field public final synthetic LIZ:Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;
...
# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;Landroid/app/Activity;Lkotlin/jvm/functions/Function1;ZZLcom/ss/android/ugc/aweme/unifiedauthapi/mob/PushPermissionStatusEvent;LX/01lt;ZZZZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0Z0k;->LIZ:Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;

    iput-object p2, p0, LX/0Z0k;->LIZIZ:Landroid/app/Activity;

    iput-object p3, p0, LX/0Z0k;->LIZJ:Lkotlin/jvm/functions/Function1;

    iput-boolean p4, p0, LX/0Z0k;->LIZLLL:Z

    iput-boolean p5, p0, LX/0Z0k;->LJ:Z

    iput-object p6, p0, LX/0Z0k;->LJFF:Lcom/ss/android/ugc/aweme/unifiedauthapi/mob/PushPermissionStatusEvent;

    iput-object p7, p0, LX/0Z0k;->LJI:LX/01lt;

    iput-boolean p8, p0, LX/0Z0k;->LJII:Z

    iput-boolean p9, p0, LX/0Z0k;->LJIIIIZZ:Z

    iput-boolean p10, p0, LX/0Z0k;->LJIIIZ:Z

    iput-boolean p11, p0, LX/0Z0k;->LJIIJ:Z
...
.method public final varargs LIZ([LX/0Gfe;)V
    ...
    iget-object v0, v2, LX/0Z0k;->LIZ:Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;

    iget-object v1, v0, Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;->LIZIZ:LX/0Z0p;
    ...
    :cond_0
    iget-object v4, v2, LX/0Z0k;->LIZ:Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;

    iget-object v3, v2, LX/0Z0k;->LIZIZ:Landroid/app/Activity;
    ...
    const-string v18, "[Push-Sys]"

    invoke-static/range {v18 .. v18}, LX/0PR6;->LIZ(Ljava/lang/String;)V
    ...
    iget-object v1, v2, LX/0Z0k;->LIZIZ:Landroid/app/Activity;
    ...
    :goto_0
    iget-boolean v0, v2, LX/0Z0k;->LIZLLL:Z
    ...
    iget-boolean v0, v2, LX/0Z0k;->LJ:Z
    ...
    iget-object v0, v2, LX/0Z0k;->LJI:LX/01lt;
    ...
    iget-object v0, v2, LX/0Z0k;->LJFF:Lcom/ss/android/ugc/aweme/unifiedauthapi/mob/PushPermissionStatusEvent;
    ...
    iget-boolean v0, v2, LX/0Z0k;->LJII:Z

    if-nez v0, :cond_2

    iget-boolean v0, v2, LX/0Z0k;->LJIIIIZZ:Z
    ...
    :cond_3
    iget-boolean v1, v2, LX/0Z0k;->LJIIIZ:Z

    iget-boolean v0, v2, LX/0Z0k;->LJIIJ:Z

    invoke-virtual {v4, v3, v1, v0}, Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;->LJIIL(ZZZ)V

    iget-object v1, v2, LX/0Z0k;->LIZJ:Lkotlin/jvm/functions/Function1;
    ...
    :cond_4
    :goto_2
    iget-object v5, v2, LX/0Z0k;->LJFF:Lcom/ss/android/ugc/aweme/unifiedauthapi/mob/PushPermissionStatusEvent;
    ...
    iget-object v0, v0, Lcom/ss/android/ugc/aweme/unifiedauth/manager/PushSystemPopupManager;->LJ:LX/05ta;
