...
# instance fields
.field public final LIZ:Landroid/telephony/CellInfoLte;
...
.method public constructor <init>(Landroid/telephony/CellInfoLte;)V
    ...
    iput-object p1, p0, LX/0ZSQ;->LIZ:Landroid/telephony/CellInfoLte;
...
.method public final LIZ()Ljava/util/Map;
    ...
    iget-object v0, v6, LX/0ZSQ;->LIZ:Landroid/telephony/CellInfoLte;

    invoke-virtual {v0}, Landroid/telephony/CellInfoLte;->getCellIdentity()Landroid/telephony/CellIdentityLte;

    move-result-object v18

    iget-object v13, v6, LX/0ZSQ;->LIZ:Landroid/telephony/CellInfoLte;

    new-instance v1, LX/04q9;

    const-string v3, "dzBzEgAjS8/YVFkiQFyNN/m6abexR8WXbuK7oK7xlMulOVlW4knk6hrS+zfVctKZKvdU"
    ...
    const-string v0, "()Landroid/telephony/CellSignalStrengthLte;"

    invoke-direct {v14, v15, v0, v1}, LX/0a1V;-><init>(ZLjava/lang/String;LX/04q9;)V

    const/16 v8, 0x283f

    const-string v21, "android/telephony/CellInfoLte"

    const-string v22, "getCellSignalStrength"

    const-string v25, "android.telephony.CellSignalStrengthLte"
    ...
    const-string v9, "android/telephony/CellInfoLte"
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/CellIdentityLte;->getMccString()Ljava/lang/String;
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/CellIdentityLte;->getMncString()Ljava/lang/String;
    ...
    const-string v16, "android/telephony/CellIdentityLte"

    const-string v17, "getTac"
    ...
    const-string v14, "android/telephony/CellIdentityLte"
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/CellIdentityLte;->getEarfcn()I
    ...
    iget-object v1, v6, LX/0ZSQ;->LIZ:Landroid/telephony/CellInfoLte;
    ...
    :cond_2
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/CellIdentityLte;->getBandwidth()I
    ...
    const-string v21, "android/telephony/CellIdentityLte"

    const-string v22, "getBandwidth"
    ...
    :cond_3
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/CellIdentityLte;->getPci()I
    ...
    :cond_4
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/CellIdentityLte;->getCi()I
    ...
    :cond_5
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/CellIdentityLte;->getTac()I
