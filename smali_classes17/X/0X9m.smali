...
.method public constructor <init>(Landroid/view/View;Landroid/view/ViewTreeObserver$OnDrawListener;Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;Landroid/view/ViewTreeObserver$OnScrollChangedListener;Landroid/view/ViewTreeObserver$OnWindowFocusChangeListener;)V
    ...
    iput-object p1, p0, LX/0X9m;->LL:Landroid/view/View;

    iput-object p3, p0, LX/0X9m;->LLILIL:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    iput-object p4, p0, LX/0X9m;->LLILL:Landroid/view/ViewTreeObserver$OnScrollChangedListener;

    iput-object p5, p0, LX/0X9m;->LLILLIZIL:Landroid/view/ViewTreeObserver$OnWindowFocusChangeListener;

    iput-object p2, p0, LX/0X9m;->LLILLJJLI:Landroid/view/ViewTreeObserver$OnDrawListener;
...
.method public final run()V
    ...
    const-string v5, "ExposeViewExtKt@24b7.addListeners$1$onViewAttachedToWindow$1"

    invoke-static {v5}, LX/0Xz5;->LIZ(Ljava/lang/String;)V

    :try_start_0
    iget-object v0, p0, LX/0X9m;->LL:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v4

    iget-object v0, p0, LX/0X9m;->LLILIL:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    iget-object v3, p0, LX/0X9m;->LLILL:Landroid/view/ViewTreeObserver$OnScrollChangedListener;

    iget-object v2, p0, LX/0X9m;->LLILLIZIL:Landroid/view/ViewTreeObserver$OnWindowFocusChangeListener;

    iget-object v1, p0, LX/0X9m;->LLILLJJLI:Landroid/view/ViewTreeObserver$OnDrawListener;
    ...
    invoke-virtual {v4, v2}, Landroid/view/ViewTreeObserver;->addOnWindowFocusChangeListener(Landroid/view/ViewTreeObserver$OnWindowFocusChangeListener;)V

    invoke-virtual {v4, v1}, Landroid/view/ViewTreeObserver;->addOnDrawListener(Landroid/view/ViewTreeObserver$OnDrawListener;)V
