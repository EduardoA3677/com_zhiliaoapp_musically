...
.method public constructor <init>(Landroid/app/Activity;Landroidx/fragment/app/Fragment;)V
    ...
    iput-object p1, p0, LX/0YNV;->LIZ:Landroid/app/Activity;

    iput-object p2, p0, LX/0YNV;->LIZIZ:Landroidx/fragment/app/Fragment;

    const v0, 0x9c43

    iput v0, p0, LX/0YNV;->LIZJ:I
...
.method public final varargs LIZJ([Ljava/lang/String;)V
    ...
    iget-object v1, p0, LX/0YNV;->LIZ:Landroid/app/Activity;
    ...
    invoke-static {v0, p1}, LX/0Tnh;->LIZ(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_0
    iget-object v2, p0, LX/0YNV;->LIZIZ:Landroidx/fragment/app/Fragment;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const/4 v5, 0x0

    const-string v4, "dzBzEgAjS8/YVFkiQFyFaHCZkp+e+K86yefFGJAl6Thf6sjOPGmeD/UIh/V6eBO3Ifp+Gp9Q1VypT8E3FjzuxWjpTdaPE/b/NQ2wgfPthFZF"

    if-eqz v2, :cond_3

    :try_start_1
    iget v1, p0, LX/0YNV;->LIZJ:I
    ...
    :cond_3
    iget-object v3, p0, LX/0YNV;->LIZ:Landroid/app/Activity;

    iget v2, p0, LX/0YNV;->LIZJ:I
