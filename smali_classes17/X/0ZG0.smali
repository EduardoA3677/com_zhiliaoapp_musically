...
.method public static LIZIZ(ILandroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    ...
    invoke-static {p2, v3, v2}, Lkotlin/text/b0;->LJJIIZ(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    const-string/jumbo v1, "set_hint_by_sug_word"
...
.method public static LIZJ(Landroid/net/Uri;ILjava/lang/String;Ljava/lang/String;LX/0ZEV;)Landroid/net/Uri;
    .locals 12
    ...
    const-string v8, "external_link"

    const-string/jumbo v1, "uid"

    const-string v11, "://chatting/message?"
    ...
    const-string v0, "://profile?unique_id="
    ...
    const-string v0, "://mix_video/detail/"
    ...
    const-string v0, "://search/trending?type="
    ...
    const-string v0, "://challenge/detail?id="

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, "&group=0&is_commerce=1"
    ...
    const-string v0, "://goods/shop/?uid="
    ...
    const-string v0, "://openRecord?recordParam=sticker&id="
    ...
    const-string v0, "://live?unique_id="
    ...
    const-string v0, "://messages/group?invite_id="
    ...
    const-string v1, "invitation_code"
    ...
    const-string v1, "inviter_sec_uid"
    ...
    invoke-interface {v0, p0}, Lcom/ss/android/ugc/aweme/ecommerce/ug/outofapp/service/IEcUgOutOfAppService;->LIZIZ(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v0, p0, p2}, LX/0ZG0;->LIZIZ(ILandroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "://assmusic/category?cid="
    ...
    const-string/jumbo v1, "trackParams"
    ...
    invoke-interface {v0, p0, v6}, Lcom/ss/android/ugc/aweme/ecommerce/ug/outofapp/service/IEcUgOutOfAppService;->LIZLLL(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "://openRecord?enter_from=direct_shoot&tab=live&record_type=live&exit_room=0"
    ...
    const-string v0, "://now/feed?unique_id="
    ...
    invoke-static {p2, v1, v9, v0}, Lkotlin/text/b0;->LJJJIL(Ljava/lang/CharSequence;Ljava/lang/String;II)I
    ...
    const-string v0, "reflow_collection"
    ...
    invoke-static {p3, v1, v0}, LX/0ZET;->LIZIZ(Ljava/lang/String;LX/0ZEV;LX/0ZF5;)LX/0ZEd;
    ...
    iget-object v4, v0, LX/0Jck;->LIZ:Ljava/util/HashMap;
    ...
    iget-object v3, v0, LX/0ZEU;->LJI:[Ljava/lang/String;
    ...
    invoke-static {v4, v1, v9}, Lkotlin/text/v;->LJJIII(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v0, "subscribe_entry_share_scheme"

    invoke-interface {v1, v6, v0}, LX/0qxa;->LIZJ(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v3, v0, v1, v9}, Lkotlin/text/v;->LJJ(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {p0, v10}, Lcom/bytedance/mt/protector/impl/UriProtector;->com_bytedance_mt_protector_impl_UriProtector_com_ss_android_ugc_aweme_lancet_UriLancet_getQueryParameter(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "enter_blank_page"
    ...
    const-string/jumbo v0, "set_hint_by_sug_word"
    ...
    invoke-static {v0, v5}, LX/03uy;->LIZIZ(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0, p0}, Lcom/ss/android/ugc/aweme/ecommerce/ug/outofapp/service/IEcUgOutOfAppService;->LJFF(Landroid/net/Uri;)Ljava/lang/String;
...
# virtual methods
.method public abstract LIZ(Landroid/net/Uri;LX/0ZEV;)Landroid/net/Uri;
.end method
