...
.method public static LIZ(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    const-string v1, "dzBzEhEpEcvSUUUuTBbKc9NnF3kueWo2KO6tZo/C1TxW+nisb6k2v/7Dg/diPhY="
...
.method public static LJ(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_0
    sget-object v5, LX/0ZFc;->LIZ:[Ljava/lang/String;
    ...
    :cond_2
    const-string/jumbo v2, "tiktok.me"
    ...
    sget-object v0, LX/16q7;->LIZ:Ljava/util/List;
...
.method public static LJFF(Landroid/net/Uri;)Z
    ...
    const-string v2, "linker_platform_config"
    ...
    const-class v0, [Lcom/ss/android/ugc/aweme/setting/DeeplinkPersonalizationConfig;
    ...
    check-cast v0, [Lcom/ss/android/ugc/aweme/setting/DeeplinkPersonalizationConfig;
    ...
    const-string/jumbo v1, "sharer_biz"
    ...
    iget-object v0, v1, Lcom/ss/android/ugc/aweme/setting/DeeplinkPersonalizationConfig;->urlRegex:Ljava/lang/String;
    ...
    iget-object v0, v1, Lcom/ss/android/ugc/aweme/setting/DeeplinkPersonalizationConfig;->urlConfig:Ljava/util/List;
    ...
    check-cast v1, Lcom/ss/android/ugc/aweme/setting/PersonalizationModel;

    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/setting/PersonalizationModel;->getBizName()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/setting/PersonalizationModel;->getNeedPersonalization()Z
    ...
    sput-boolean v0, LX/0ZEv;->LJIIL:Z
...
.method public static LJI(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    invoke-interface {v0, v2}, Lcom/ss/android/ugc/aweme/services/IMainService;->getAppLinkHandlerActivityClass(Z)Ljava/lang/Class;
    ...
    invoke-interface {v0, v2}, Lcom/ss/android/ugc/aweme/services/IMainService;->getDeepLinkHandlerActivityClass(Z)Ljava/lang/Class;
    ...
    invoke-static {p0, v4}, LX/0ZDc;->LIZ(Landroid/app/Activity;Landroid/content/Intent;)V
