...
.method public final LIZ(Landroid/app/Activity;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    invoke-static {v3, p2}, LX/11Ny;->LJI(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v2

    sget-object v0, LX/11bp;->LIZJ:LX/11bp;

    invoke-virtual {v0, p1, v1}, LX/11bp;->LJJIIZI(Landroid/content/Context;I)Landroid/content/Intent;

    move-result-object v1

    if-eqz v1, :cond_1

    const-string v0, "bundle_puid"

    invoke-virtual {v1, v0, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v0, "bundle_sec_puid"

    invoke-virtual {v1, v0, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v0, "bundle_recommend_user_type"
...
.method public final LIZJ(ZLandroid/net/Uri;)Ljava/lang/String;
    ...
    const-string v0, "friend_recommend"
