.class public Lcom/bytedance/framwork/core/sdklib/apm6/http/DefaultTTNetImpl;
...
.method public buildMultipartUpload(Ljava/lang/String;Ljava/lang/String;Z)LX/0Xmi;
    ...
    new-instance v1, LX/0Xzz;

    const/4 v0, 0x0

    invoke-direct {v1, p1, v0}, LX/0Xzz;-><init>(Ljava/lang/String;Ljava/util/Map;)V
...
.method public buildMultipartUpload(Ljava/lang/String;Ljava/lang/String;ZLjava/util/Map;)LX/0Xmi;
    ...
    new-instance v0, LX/0Xzz;

    invoke-direct {v0, p1, p4}, LX/0Xzz;-><init>(Ljava/lang/String;Ljava/util/Map;)V
...
.method public doGet(Ljava/lang/String;Ljava/util/Map;)LX/0Xpv;
    ...
    invoke-static {v0}, Lcom/bytedance/framwork/core/sdklib/apm6/http/DefaultTTNetImpl;->convertHeaderMap(Ljava/util/Map;)Ljava/util/List;

    move-result-object v3

    const-class v0, Lcom/bytedance/framwork/core/sdklib/apm6/http/RetrofitMonitorService;

    invoke-static {v0, p1}, LX/0z6P;->LJIIIZ(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/bytedance/framwork/core/sdklib/apm6/http/RetrofitMonitorService;
    ...
    invoke-interface {v2, p1, v3, p2, v1}, Lcom/bytedance/framwork/core/sdklib/apm6/http/RetrofitMonitorService;->fetch(Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Z)LX/0aSK;
    ...
    invoke-static {v0}, Lcom/bytedance/framwork/core/sdklib/apm6/http/DefaultTTNetImpl;->toByteArray(Ljava/io/InputStream;)[B
    ...
    :cond_0
    invoke-interface {v2, p1, p2, v1}, Lcom/bytedance/framwork/core/sdklib/apm6/http/RetrofitMonitorService;->fetch(Ljava/lang/String;Ljava/util/Map;Z)LX/0aSK;
...
.method public doPost(Ljava/lang/String;[BLjava/util/Map;)LX/0Xpv;
    ...
    check-cast v5, Lcom/bytedance/framwork/core/sdklib/apm6/http/RetrofitMonitorService;

    invoke-static {p3}, Lcom/bytedance/framwork/core/sdklib/apm6/http/DefaultTTNetImpl;->convertHeaderMap(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-interface {v5, p1, v2, v4, v3}, Lcom/bytedance/framwork/core/sdklib/apm6/http/RetrofitMonitorService;->report(Ljava/lang/String;Lcom/bytedance/retrofit2/mime/TypedOutput;Ljava/util/List;Z)LX/0aSK;
...
.method public uploadFiles(Ljava/lang/String;Ljava/util/List;Ljava/util/Map;)LX/0Xpv;
    ...
    new-instance v1, Lcom/bytedance/framwork/core/sdklib/apm6/http/DefaultTTNetImpl;

    invoke-direct {v1}, Lcom/bytedance/framwork/core/sdklib/apm6/http/DefaultTTNetImpl;-><init>()V
