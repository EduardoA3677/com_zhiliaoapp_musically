...
.method private setEffectCallback()V
    ...
    invoke-direct {p0, v1, v2, v0}, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->nativeSetEffectCallback(JLcom/ss/android/ttve/nativePort/TEEffectCallback;)I
...
.method public callEffectAPI(Lcom/ss/android/vesdk/VERecorder$IVECallEffectAPIRunnable;LX/0bOg;Ljava/lang/String;)I
    ...
    iget-wide v3, v5, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->mHandle:J
    ...
    :cond_0
    iget-wide v6, v5, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->mHandle:J
    ...
    invoke-direct/range {v5 .. v10}, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->nativeCallEffectAPI(JLcom/ss/android/vesdk/VERecorder$IVECallEffectAPIRunnable;ILjava/lang/String;)I
...
.method public callEffectInterface(Lcom/ss/android/ttve/nativePort/TEBundle;)I
    ...
    iget-wide v3, p0, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->mHandle:J
    ...
    :cond_0
    iget-wide v2, p0, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->mHandle:J

    invoke-virtual {p1}, Lcom/ss/android/ttve/nativePort/TEBundle;->getHandle()J

    move-result-wide v0

    invoke-direct {p0, v2, v3, v0, v1}, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->nativeCallEffectInterface(JJ)I
...
.method public callEffectInterfaceWithObjectParams(Lcom/ss/android/ttve/nativePort/TEBundle;[Ljava/lang/Object;)I
    ...
    invoke-direct/range {v5 .. v10}, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->nativeCallEffectInterfaceWithObjectParams(JJ[Ljava/lang/Object;)I
...
.method public callEffectInterfaceWithResult(Lcom/ss/android/ttve/nativePort/TEBundle;Lcom/ss/android/ttve/nativePort/TEBundle;)I
    ...
    invoke-direct/range {v5 .. v11}, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->nativeCallEffectInterfaceWithResult(JJJ)I
...
.method public callEffectInterfaceWithResult(Lcom/ss/android/ttve/nativePort/TEBundle;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v2, v3, v0, v1}, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->nativeCallEffectInterfaceWithObjectResult(JJ)Ljava/lang/Object;
...
.method public setEffectGeneralCallback(Lcom/ss/android/vesdk/VERecorder$IVEEffectGeneralCallback;)I
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/ss/android/ttve/nativePort/TEEffectInterface;->nativeSetEffectGeneralCallback(JLcom/ss/android/vesdk/VERecorder$IVEEffectGeneralCallback;)I
