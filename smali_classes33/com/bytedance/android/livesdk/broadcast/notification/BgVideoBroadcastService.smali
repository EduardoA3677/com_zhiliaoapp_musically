.class public final Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;
...
.field public static LLJILLL:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

.field public static LLJJ:Landroidx/fragment/app/Fragment;
...
.field public final LLILZIL:LX/13qX;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLJ:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILZ:Z

    new-instance v0, LX/13qX;

    invoke-direct {v0, p0}, LX/13qX;-><init>(Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;)V

    iput-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILZIL:LX/13qX;

    new-instance v1, Lkotlin/jvm/internal/AwS508S0100000_32;

    const/16 v0, 0x72

    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS508S0100000_32;-><init>(Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILZLL:LX/05ta;
...
.method public final LIZ()Landroid/app/Notification;
    ...
    iget-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LL:Landroid/app/NotificationManager;
    ...
    invoke-static {p0, v7, v4, v0}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    :goto_0
    sget-object v2, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLJILLL:Lcom/bytedance/ies/sdk/datachannel/DataChannel;
    ...
    invoke-virtual {v0, v4, v5}, LX/0YuF;->LJII(IZ)V
    ...
    invoke-virtual {v0, v1, v5}, LX/0YuF;->LJII(IZ)V
    ...
    iput v4, v0, LX/0YuF;->LJIIJ:I

    :cond_2
    invoke-virtual {v0, v5}, LX/0YuF;->LIZLLL(Z)V

    iput v7, v0, LX/0YuF;->LJJ:I
    ...
    :cond_3
    iget-boolean v1, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILZ:Z
    ...
    :cond_5
    sget-boolean v1, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLJI:Z
...
.method public final LIZIZ()V
    ...
    iget-boolean v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILLL:Z
    ...
    iget-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILZLL:LX/05ta;
    ...
    iget-object v1, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LL:Landroid/app/NotificationManager;
...
.method public final LIZLLL()V
    ...
    iget-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILL:Landroid/media/SoundPool;
    ...
    iput-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILL:Landroid/media/SoundPool;

    :cond_0
    iget-object v2, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILL:Landroid/media/SoundPool;

    if-eqz v2, :cond_3

    iget-boolean v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILLIZIL:Z
    ...
    iput-boolean v3, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILLIZIL:Z
    ...
    invoke-direct {v0, v1, p0}, LX/13qV;-><init>(ILcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;)V
...
.method public final LJ(Landroid/app/Notification;Z)V
    ...
    sput-boolean v0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLIZ:Z
    ...
    invoke-static {v0}, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LIZJ(Z)V
...
.method public final LJFF()V
    ...
    const-string v1, "BgVideoBroadcastService"
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LIZ()Landroid/app/Notification;
...
.method public final onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    const-string v0, "dzBzEgAjS8/YVFkiQFyFaHCZkp+e+K86yefFGJAl6Thf6sjOPGmeD/IJh/lucBOiiryHprqpoLc3lCGKSJuEpmuCAOU8l+8HrUkv8A=="
    ...
    const-string v6, "com/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService"
...
.method public final onCreate()V
    ...
    iget-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILZIL:LX/13qX;
    ...
    iput-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILLJJLI:LX/02SD;

    invoke-static {p0}, LX/0X3I;->LLZLL(Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;)Ljava/lang/Object;
    ...
    :goto_0
    iput-object v1, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LL:Landroid/app/NotificationManager;

    invoke-virtual {p0}, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LIZ()Landroid/app/Notification;

    move-result-object v0

    iput-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILIL:Landroid/app/Notification;

    const/4 v1, 0x0

    invoke-virtual {p0, v0, v1}, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LJ(Landroid/app/Notification;Z)V
    ...
    invoke-static {v1}, LX/0rVL;->LIZJ(Z)V

    sput-boolean v1, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLIZLLLIL:Z
...
.method public final onDestroy()V
    ...
    sput-boolean v2, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLIZ:Z

    sput-boolean v2, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLIZLLLIL:Z

    invoke-virtual {p0}, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LIZIZ()V
    ...
    iput-object v1, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILIL:Landroid/app/Notification;
    ...
    :cond_0
    iput-object v1, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILL:Landroid/media/SoundPool;

    iput-boolean v2, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILLIZIL:Z

    sput-object v1, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLJILLL:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    sput-object v1, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLJJ:Landroidx/fragment/app/Fragment;

    iget-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILLJJLI:LX/02SD;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    sput-boolean v0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLJILJILJ:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LLILIL:Landroid/app/Notification;
    ...
    invoke-virtual {p0, v0, v2}, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LJ(Landroid/app/Notification;Z)V

    :cond_2
    invoke-virtual {p0}, Lcom/bytedance/android/livesdk/broadcast/notification/BgVideoBroadcastService;->LIZLLL()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
