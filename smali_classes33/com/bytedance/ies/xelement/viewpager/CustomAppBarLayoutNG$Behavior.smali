.class public Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;
...
.field public final synthetic LJI:LX/12nn;
...
.method public constructor <init>(LX/12nn;)V
    ...
    iput-object p1, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJI:LX/12nn;

    invoke-direct {p0}, Lcom/google/android/material/appbar/AppBarLayout$Behavior;-><init>()V

    new-instance v0, LX/12ns;

    invoke-direct {v0}, LX/12ns;-><init>()V
...
.method public final LIZ()Ljava/lang/reflect/Field;
    ...
    iget-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZJ:Ljava/lang/reflect/Field;
    ...
    iput-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZJ:Ljava/lang/reflect/Field;
...
.method public final LIZIZ(LX/12nk;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZ()Ljava/lang/reflect/Field;
...
.method public final onInterceptTouchEvent(LX/12nR;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZ:Z

    iput-boolean v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZIZ:Z
    ...
    iget-boolean v0, v0, LX/12nn;->LLJJIII:Z

    if-eqz v0, :cond_1

    :cond_0
    invoke-virtual {p0, p2}, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZIZ(LX/12nk;)V
...
.method public final onNestedFling(LX/12nR;Landroid/view/View;Landroid/view/View;FFZ)Z
    ...
    iget-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJI:LX/12nn;

    iget-object v0, v0, LX/12nn;->LLJJI:LX/12nr;

    if-eqz v0, :cond_0

    invoke-interface {v0}, LX/12nr;->LIZLLL()V
...
.method public final onNestedPreScroll(LX/12nR;LX/12nk;Landroid/view/View;II[II)V
    ...
    iput-boolean v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZ:Z

    :cond_0
    iget-boolean v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZIZ:Z
...
.method public final onNestedScroll(LX/12nR;LX/12nk;Landroid/view/View;IIIII[I)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZLLL:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZLLL:Ljava/lang/reflect/Method;

    invoke-virtual {v0, v4}, Ljava/lang/reflect/AccessibleObject;->setAccessible(Z)V

    :cond_0
    iget-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJ:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJ:Ljava/lang/reflect/Method;

    invoke-virtual {v0, v4}, Ljava/lang/reflect/AccessibleObject;->setAccessible(Z)V

    :cond_1
    iget-object v1, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJ:Ljava/lang/reflect/Method;
    ...
    iget-object v2, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LIZLLL:Ljava/lang/reflect/Method;
    ...
    iget-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJFF:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJFF:Ljava/lang/reflect/Method;

    invoke-virtual {v0, v4}, Ljava/lang/reflect/AccessibleObject;->setAccessible(Z)V

    :cond_3
    iget-object v1, p0, Lcom/bytedance/ies/xelement/viewpager/CustomAppBarLayoutNG$Behavior;->LJFF:Ljava/lang/reflect/Method;
...
.method public final onStartNestedScroll(LX/12nR;LX/12nk;Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-interface {v0}, LX/12nr;->LIZJ()V
...
.method public final onStopNestedScroll(LX/12nR;LX/12nk;Landroid/view/View;I)V
    ...
    invoke-interface {v0}, LX/12nr;->LIZIZ()V
