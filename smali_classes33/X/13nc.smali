...
# instance fields
.field public LL:LX/13nd;

.field public LLILIL:Lcom/ss/android/ugc/profile/business/ur/camera/datachannel/DataChannel;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS508S0100000_32;-><init>(LX/13nc;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, LX/13nc;->LLILLJJLI:LX/05ta;
    ...
    iput-object v0, p0, LX/13nc;->LLILLL:LX/05ta;
...
.method private final getGestureDetector()Landroid/view/GestureDetector;
    ...
    iget-object v0, p0, LX/13nc;->LLILLL:LX/05ta;
...
.method private final getScaleGestureDetector()Landroid/view/ScaleGestureDetector;
    ...
    iget-object v0, p0, LX/13nc;->LLILLJJLI:LX/05ta;
...
.method public final LIZ(ILcom/bytedance/bpea/basics/Cert;)V
    ...
    invoke-virtual {p0}, LX/13nc;->getCameraProxy()LX/13nd;
    ...
    iput-object v0, v5, LX/13nd;->LIZJ:Landroid/hardware/Camera;

    iput-boolean v10, v5, LX/13nd;->LJIIIZ:Z

    sget-object v0, LX/12fo;->OFF:LX/12fo;

    iput-object v0, v5, LX/13nd;->LJFF:LX/12fo;

    invoke-virtual {v5}, LX/13nd;->LIZ()Landroid/hardware/Camera$Parameters;
    ...
    :goto_0
    iput-boolean v0, v5, LX/13nd;->LJI:Z

    iget-object v3, v5, LX/13nd;->LIZIZ:Lcom/ss/android/ugc/profile/business/ur/camera/datachannel/DataChannel;

    const-class v1, Lcom/ss/android/ugc/profile/business/ur/camera/LiveCoverIsFlashSupportedChannel;

    invoke-static {v0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v0

    invoke-virtual {v3, v1, v0}, Lcom/ss/android/ugc/profile/business/ur/camera/datachannel/DataChannel;->ku2(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-virtual {v5}, LX/13nd;->LJ()V
    ...
    invoke-direct {v6, p0, v0}, Lkotlin/jvm/internal/AwS508S0100000_32;-><init>(LX/13nc;I)V

    iget-object v5, v7, LX/13nd;->LIZJ:Landroid/hardware/Camera;

    const-string v3, "dzBzEhEpEcvSUUUuTBbKc9NnF2grc2E6au/mYYrd1TyhAn5voztDnewuxPUCCa6JqknrXKmM2CRm4SJqgSPD3f6e/Ci75sJypw=="

    const/4 v1, 0x2

    if-eqz v5, :cond_1

    iget-object v8, v7, LX/13nd;->LIZ:Landroid/content/Context;

    iget v0, v7, LX/13nd;->LIZLLL:I
    ...
    :cond_1
    iget-object v0, v7, LX/13nd;->LIZJ:Landroid/hardware/Camera;
    ...
    invoke-virtual {v7}, LX/13nd;->LIZ()Landroid/hardware/Camera$Parameters;
    ...
    iget-object v0, v7, LX/13nd;->LIZ:Landroid/content/Context;
    ...
    :cond_d
    invoke-virtual {v7, v9}, LX/13nd;->LJFF(Landroid/hardware/Camera$Parameters;)V

    iget-object v0, v7, LX/13nd;->LJFF:LX/12fo;

    invoke-virtual {v7, v0}, LX/13nd;->LJI(LX/12fo;)V
    ...
    iput-boolean v0, v5, LX/13nd;->LJ:Z
...
.method public final getCameraProxy()LX/13nd;
    .locals 1

    iget-object v0, p0, LX/13nc;->LL:LX/13nd;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0}, LX/13nc;->getScaleGestureDetector()Landroid/view/ScaleGestureDetector;
    ...
    :cond_0
    invoke-direct {p0}, LX/13nc;->getGestureDetector()Landroid/view/GestureDetector;
...
.method public final setCameraProxy(LX/13nd;)V
    .locals 0

    iput-object p1, p0, LX/13nc;->LL:LX/13nd;
...
.method public final setCheckFragVisibleCallback(Lkotlin/jvm/functions/Function0;)V
    ...
    iput-object p1, p0, LX/13nc;->LLILZ:Lkotlin/jvm/functions/Function0;
...
.method public final surfaceChanged(Landroid/view/SurfaceHolder;III)V
    ...
    iget-object v0, p0, LX/13nc;->LLILZ:Lkotlin/jvm/functions/Function0;
    ...
    iget v2, v0, LX/13nd;->LIZLLL:I

    const-string v1, "bpea-live_cover_or_profile_camera_open"
    ...
    invoke-virtual {p0, v2, v0}, LX/13nc;->LIZ(ILcom/bytedance/bpea/basics/Cert;)V
...
.method public final surfaceDestroyed(Landroid/view/SurfaceHolder;)V
    ...
    invoke-virtual {v0}, LX/13nd;->LIZLLL()V
