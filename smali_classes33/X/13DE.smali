...
# instance fields
.field public LL:LX/13DC;

.field public LLILIL:Z

.field public LLILL:LX/13DG;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, LX/13DE;->LLJILJILJ:I
    ...
    iput-object v0, p0, LX/13DE;->LLIZLLLIL:Ljava/util/ArrayList;

    iget-object v0, p0, LX/13DE;->LL:LX/13DC;
    ...
    invoke-direct {v1, p0, v0}, LX/13DC;-><init>(LX/13DE;Landroid/content/Context;)V

    iput-object v1, p0, LX/13DE;->LL:LX/13DC;
    ...
    new-instance v1, LX/13DG;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {v1, p0, v0}, LX/13DG;-><init>(LX/13DE;Landroid/content/Context;)V

    iput-object v1, p0, LX/13DE;->LLILL:LX/13DG;

    invoke-virtual {v1, v4}, Landroid/view/View;->setHorizontalScrollBarEnabled(Z)V

    iget-object v0, p0, LX/13DE;->LLILL:LX/13DG;
    ...
    iget-object v3, p0, LX/13DE;->LLILL:LX/13DG;

    iget-object v2, p0, LX/13DE;->LL:LX/13DC;
    ...
    iget-object v2, p0, LX/13DE;->LLILL:LX/13DG;
    ...
    invoke-virtual {p0, v2, v1}, LX/13DE;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    :cond_0
    new-instance v0, LX/13DI;

    invoke-direct {v0, p0}, LX/13DI;-><init>(LX/13DE;)V

    iput-object v0, p0, LX/13DE;->LLJI:LX/13DI;
...
.method public final LIZ(Landroid/view/MotionEvent;)V
    ...
    iput-boolean v1, p0, LX/13DE;->LLILZLL:Z
    ...
    iget-boolean v0, p0, LX/13DE;->LLIZ:Z

    if-eqz v0, :cond_2

    const/4 v0, 0x2

    invoke-virtual {p0, v0}, LX/13DE;->LIZIZ(I)V

    iget-object v0, p0, LX/13DE;->LLIZLLLIL:Ljava/util/ArrayList;
    ...
    check-cast v0, LX/13DK;

    invoke-interface {v0}, LX/13DK;->LJ()V
    ...
    iput-boolean v0, p0, LX/13DE;->LLIZ:Z

    iput-boolean v0, p0, LX/13DE;->LLILZLL:Z
...
.method public final LIZIZ(I)V
    ...
    invoke-interface {v0}, LX/13DK;->LIZ()V
...
.method public final addView(Landroid/view/View;)V
    ...
    iget-boolean v0, p0, LX/13DE;->LLILIL:Z
    ...
    iput-boolean v0, p0, LX/13DE;->LLILIL:Z
...
.method public final bindDrawChildHook(LX/13B0;)V
    ...
    iput-object p1, p0, LX/13DE;->LLJ:LX/13B0;
...
.method public final finalize()V
    ...
    iget-object v0, p0, LX/13DE;->LLJI:LX/13DI;
...
.method public final onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, LX/13DE;->LLILLL:Z
...
.method public final onScrollChanged(IIII)V
    ...
    iget v0, p0, LX/13DE;->LLILLIZIL:I
    ...
    :cond_0
    iget-boolean v0, p0, LX/13DE;->LLILZLL:Z
    ...
    invoke-interface {v0}, LX/13DK;->LIZJ()V

    goto :goto_0

    :cond_1
    iget v0, p0, LX/13DE;->LLJILLL:I
    ...
    invoke-interface {v0}, LX/13DK;->onScrollChanged()V

    goto :goto_1

    :cond_2
    iget v1, p0, LX/13DE;->LLILLIZIL:I
    ...
    iput v0, p0, LX/13DE;->LLILLIZIL:I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, p1}, LX/13DE;->LIZ(Landroid/view/MotionEvent;)V
    ...
    iput v0, p0, LX/13DE;->LLJILJIL:I

    iget-object v2, p0, LX/13DE;->LLJI:LX/13DI;

    iget v0, p0, LX/13DE;->LLJILJILJ:I
...
.method public setOnScrollListener(LX/13DK;)V
    .locals 1
...
.method public setOrientation(I)V
    ...
    iput-boolean v1, p0, LX/13DE;->LLILLL:Z
    ...
    iput-boolean v2, p0, LX/13DE;->LLILLL:Z
