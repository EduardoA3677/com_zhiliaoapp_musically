...
.method public final LIZ(Landroid/graphics/Canvas;Landroid/graphics/Paint;)V
    ...
    iget-boolean v0, p0, LX/13AS;->LIZLLL:Z

    if-eqz v0, :cond_0

    iget-object v3, p0, LX/13AS;->LIZ:Landroid/graphics/RectF;

    iget-object v2, p0, LX/13AS;->LIZIZ:[F
    ...
    :cond_0
    iget-object v0, p0, LX/13AS;->LIZJ:Landroid/graphics/Path;
...
.method public final LIZJ(Landroid/graphics/Rect;[FLandroid/graphics/RectF;FZ)V
    ...
    iget-object v0, p0, LX/13AS;->LIZ:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, LX/13AS;->LIZ:Landroid/graphics/RectF;

    :cond_0
    iget-object v2, p0, LX/13AS;->LIZ:Landroid/graphics/RectF;
    ...
    :goto_7
    iput-object v6, p0, LX/13AS;->LIZIZ:[F
    ...
    :cond_9
    invoke-static {p2, p3, p4}, LX/13AS;->LIZIZ([FLandroid/graphics/RectF;F)[F
    ...
    :cond_b
    iput-boolean v5, p0, LX/13AS;->LIZLLL:Z
    ...
    iput-object v0, p0, LX/13AS;->LIZJ:Landroid/graphics/Path;

    :goto_9
    iget-object v3, p0, LX/13AS;->LIZJ:Landroid/graphics/Path;

    iget-object v2, p0, LX/13AS;->LIZ:Landroid/graphics/RectF;

    iget-object v1, p0, LX/13AS;->LIZIZ:[F
