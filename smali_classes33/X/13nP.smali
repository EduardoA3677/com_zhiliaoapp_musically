...
.method public constructor <init>(Landroid/os/Handler;Z)V
    ...
    iput-object p1, p0, LX/13nP;->LL:Landroid/os/Handler;

    iput-boolean p2, p0, LX/13nP;->LLILIL:Z
...
.method public final LIZJ(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)LX/02SD;
    ...
    iget-boolean v0, p0, LX/13nP;->LLILL:Z
    ...
    new-instance v4, LX/0w9M;

    iget-object v0, p0, LX/13nP;->LL:Landroid/os/Handler;

    invoke-direct {v4, v0, p1, v1}, LX/0w9M;-><init>(Landroid/os/Handler;Ljava/lang/Runnable;Z)V

    if-eqz v1, :cond_1

    invoke-virtual {v4}, LX/0w9M;->run()V
    ...
    iget-boolean v0, p0, LX/13nP;->LLILIL:Z
    ...
    :cond_2
    iget-object v2, p0, LX/13nP;->LL:Landroid/os/Handler;
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, LX/13nP;->LLILL:Z
