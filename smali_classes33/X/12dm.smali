...
.method public constructor <init>(Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;Z)V
    ...
    iput-object p1, p0, LX/12dm;->LIZLLL:Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;

    invoke-direct {p0}, LX/12dk;-><init>()V

    iput-boolean p2, p0, LX/12dm;->LIZJ:Z
...
.method public final LIZ()V
    ...
    iget-object v0, p0, LX/12dm;->LIZLLL:Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;
...
.method public final LIZIZ()V
    ...
    iget-boolean v4, p0, LX/12dm;->LIZJ:Z

    if-eqz v4, :cond_0

    iget-object v3, p0, LX/12dm;->LIZLLL:Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;

    new-instance v2, LY/ALAdapterS23S0200000_32;

    iget-object v1, p0, LX/12dm;->LIZLLL:Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;

    const/4 v0, 0x3

    invoke-direct {v2, p0, v1, v0}, LY/ALAdapterS23S0200000_32;-><init>(LX/12dm;Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;I)V

    invoke-virtual {v3, v4, v2}, Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;->yn(ZLandroid/animation/Animator$AnimatorListener;)V
    ...
    const-string v0, "RetryAnimatorProcessor pauseAnimation() hashCode() = "
    ...
    invoke-direct {v1, v6, v0}, Lkotlin/jvm/internal/AwS41S0001000_32;-><init>(II)V

    invoke-static {v2, v1}, LX/0KkD;->LIZJ(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V

    iget-object v0, p0, LX/12dm;->LIZLLL:Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;

    invoke-virtual {v0, v6, v3, v4}, Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;->sn(IIZ)V
    ...
    invoke-virtual {v3, v5, v2}, Lcom/ss/android/ugc/aweme/search/pages/result/topsearch/botimage/core/ui/SearchBotAnswerImageCard;->yn(ZLandroid/animation/Animator$AnimatorListener;)V
