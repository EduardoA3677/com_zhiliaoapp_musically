...
.field public mHorizontalBoundCheck:LX/18RL;

.field public final mHorizontalBoundCheckCallback:LX/18RK;
...
.field public mSmoothScroller:LX/13MC;

.field public mVerticalBoundCheck:LX/18RL;

.field public final mVerticalBoundCheckCallback:LX/18RK;
...
.method public constructor <init>()V
    ...
    new-instance v2, LX/0m8C;

    invoke-direct {v2, p0}, LX/0m8C;-><init>(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mHorizontalBoundCheckCallback:LX/18RK;

    new-instance v1, LX/0m8D;

    invoke-direct {v1, p0}, LX/0m8D;-><init>(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mVerticalBoundCheckCallback:LX/18RK;

    new-instance v0, LX/18RL;

    invoke-direct {v0, v2}, LX/18RL;-><init>(LX/18RK;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mHorizontalBoundCheck:LX/18RL;

    new-instance v0, LX/18RL;

    invoke-direct {v0, v1}, LX/18RL;-><init>(LX/18RK;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mVerticalBoundCheck:LX/18RL;
...
.method private addViewInt(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, v3}, LX/13MB;->LIZJ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v0, v2, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->moveView(II)V

    :cond_1
    :goto_1
    iget-boolean v0, v5, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mPendingInvalidate:Z
    ...
    iput-boolean v4, v5, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mPendingInvalidate:Z
    ...
    invoke-virtual {v0, p1, p2, v4}, Landroidx/recyclerview/widget/ChildHelper;->addView(Landroid/view/View;IZ)V

    iput-boolean v2, v5, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mInsetsDirty:Z

    iget-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mSmoothScroller:LX/13MC;

    if-eqz v2, :cond_1

    iget-boolean v0, v2, LX/13MC;->LJ:Z

    if-eqz v0, :cond_1

    iget-object v0, v2, LX/13MC;->LIZIZ:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView;->getChildLayoutPosition(Landroid/view/View;)I

    move-result v1

    iget v0, v2, LX/13MC;->LIZ:I

    if-ne v1, v0, :cond_1

    iput-object p1, v2, LX/13MC;->LJFF:Landroid/view/View;
    ...
    invoke-virtual {v1, p1, p2, v0, v4}, Landroidx/recyclerview/widget/ChildHelper;->attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:LX/13MB;

    iget-object v0, v4, LX/13MB;->LIZ:LX/0yYU;
...
.method public static getProperties(Landroid/content/Context;Landroid/util/AttributeSet;II)LX/13Mf;
    .locals 4

    new-instance v3, LX/13Mf;

    invoke-direct {v3}, LX/13Mf;-><init>()V

    sget-object v0, Lcom/ss/android/ugc/aweme/app/R$styleable;->RecyclerView:[I

    invoke-virtual {p0, p1, v0, p2, p3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v2

    sget v0, Lcom/ss/android/ugc/aweme/app/R$styleable;->RecyclerView_android_orientation:I
    ...
    iput v0, v3, LX/13Mf;->LIZ:I

    sget v0, Lcom/ss/android/ugc/aweme/app/R$styleable;->RecyclerView_spanCount:I

    invoke-virtual {v2, v0, v1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v0

    iput v0, v3, LX/13Mf;->LIZIZ:I

    sget v0, Lcom/ss/android/ugc/aweme/app/R$styleable;->RecyclerView_reverseLayout:I
    ...
    iput-boolean v0, v3, LX/13Mf;->LIZJ:Z

    sget v0, Lcom/ss/android/ugc/aweme/app/R$styleable;->RecyclerView_stackFromEnd:I

    invoke-virtual {v2, v0, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    iput-boolean v0, v3, LX/13Mf;->LIZLLL:Z
...
.method private scrapOrRecycleView(LX/13M4;ILandroid/view/View;)V
    .locals 2
    ...
    invoke-virtual {p1, v1}, LX/13M4;->LJIIL(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p1, p3}, LX/13M4;->LJIILIIL(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:LX/13MB;

    invoke-virtual {v0, v1}, LX/13MB;->LIZJ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
...
.method public attachView(Landroid/view/View;ILandroidx/recyclerview/widget/RecyclerView$LayoutParams;)V
    ...
    iget-object v2, v0, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:LX/13MB;
...
.method public detachAndScrapAttachedViews(LX/13M4;)V
    .locals 2
    ...
    invoke-direct {p0, p1, v1, v0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->scrapOrRecycleView(LX/13M4;ILandroid/view/View;)V
...
.method public detachAndScrapView(Landroid/view/View;LX/13M4;)V
    .locals 1
    ...
    invoke-direct {p0, p2, v0, p1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->scrapOrRecycleView(LX/13M4;ILandroid/view/View;)V

    return-void
.end method

.method public detachAndScrapViewAt(ILX/13M4;)V
    .locals 1
    ...
    invoke-direct {p0, p2, p1, v0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->scrapOrRecycleView(LX/13M4;ILandroid/view/View;)V
...
.method public dispatchDetachedFromWindow(Landroidx/recyclerview/widget/RecyclerView;LX/13M4;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->onDetachedFromWindow(Landroidx/recyclerview/widget/RecyclerView;LX/13M4;)V
...
.method public endAnimation(Landroid/view/View;)V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->mItemAnimator:LX/13M9;
    ...
    invoke-virtual {v1, v0}, LX/13M9;->LJIIJ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
...
.method public getColumnCountForAccessibility(LX/13M4;LX/13MF;)I
    .locals 1
...
.method public getRowCountForAccessibility(LX/13M4;LX/13MF;)I
    .locals 1
...
.method public getSelectionModeForAccessibility(LX/13M4;LX/13MF;)I
    .locals 1
...
.method public getTransformedBoundingBox(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mDecorInsets:Landroid/graphics/Rect;
    ...
    iget-object v2, v0, Landroidx/recyclerview/widget/RecyclerView;->mTempRectF:Landroid/graphics/RectF;
...
.method public ignoreView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, LX/13MB;->LIZLLL(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
...
.method public isLayoutHierarchical(LX/13M4;LX/13MF;)Z
    .locals 1
...
.method public isSmoothScrolling()Z
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mSmoothScroller:LX/13MC;
...
.method public isViewPartiallyVisible(Landroid/view/View;ZZ)Z
    ...
    invoke-virtual {v0, p1}, LX/18RL;->LIZIZ(Landroid/view/View;)Z
...
.method public layoutDecoratedWithMargins(Landroid/view/View;IIII)V
    ...
    iget-object v1, v2, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mDecorInsets:Landroid/graphics/Rect;
...
.method public measureChild(Landroid/view/View;II)V
    ...
    invoke-static {v4, v3, v2, v1, v0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->getChildMeasureSpec(IIIIZ)I
    ...
    invoke-virtual {p0, p1, v5, v1, v6}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->shouldMeasureChild(Landroid/view/View;IILandroidx/recyclerview/widget/RecyclerView$LayoutParams;)Z
...
.method public onInitializeAccessibilityEvent(LX/13M4;LX/13MF;Landroid/view/accessibility/AccessibilityEvent;)V
    .locals 3
    ...
    :cond_0
    invoke-virtual {p3, v2}, Landroid/view/accessibility/AccessibilityRecord;->setScrollable(Z)V
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->mRecycler:LX/13M4;

    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mState:LX/13MF;

    invoke-virtual {p0, v1, v0, p1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->onInitializeAccessibilityEvent(LX/13M4;LX/13MF;Landroid/view/accessibility/AccessibilityEvent;)V

    return-void
.end method

.method public onInitializeAccessibilityNodeInfo(LX/13M4;LX/13MF;Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V
    .locals 4
    ...
    :cond_3
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->getRowCountForAccessibility(LX/13M4;LX/13MF;)I

    move-result v3

    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->getColumnCountForAccessibility(LX/13M4;LX/13MF;)I

    move-result v2

    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->isLayoutHierarchical(LX/13M4;LX/13MF;)Z

    move-result v1

    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->getSelectionModeForAccessibility(LX/13M4;LX/13MF;)I

    move-result v0

    invoke-static {v3, v2, v0, v1}, LX/133e;->LIZIZ(IIIZ)LX/133e;
...
.method public onInitializeAccessibilityNodeInfo(Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    invoke-virtual {p0, v1, v0, p1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->onInitializeAccessibilityNodeInfo(LX/13M4;LX/13MF;Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V

    return-void
.end method

.method public onInitializeAccessibilityNodeInfoForItem(LX/13M4;LX/13MF;Landroid/view/View;Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V
    .locals 0
...
.method public onInitializeAccessibilityNodeInfoForItem(Landroid/view/View;Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    invoke-virtual {p0, v1, v0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->onInitializeAccessibilityNodeInfoForItem(LX/13M4;LX/13MF;Landroid/view/View;Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;)V
...
.method public onMeasure(LX/13M4;LX/13MF;II)V
    .locals 1
...
.method public onRequestChildFocus(Landroidx/recyclerview/widget/RecyclerView;LX/13MF;Landroid/view/View;Landroid/view/View;)Z
    .locals 1
...
.method public onSmoothScrollerStopped(LX/13MC;)V
    .locals 1
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mSmoothScroller:LX/13MC;
...
.method public performAccessibilityAction(ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, v1, v0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->performAccessibilityAction(LX/13M4;LX/13MF;ILandroid/os/Bundle;)Z
...
.method public performAccessibilityAction(LX/13M4;LX/13MF;ILandroid/os/Bundle;)Z
    .locals 8
    ...
    invoke-virtual {v0, v7}, Landroid/view/View;->canScrollHorizontally(I)Z
...
.method public performAccessibilityActionForItem(LX/13M4;LX/13MF;Landroid/view/View;ILandroid/os/Bundle;)Z
    .locals 1
...
.method public performAccessibilityActionForItem(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    iget-object v2, v0, Landroidx/recyclerview/widget/RecyclerView;->mRecycler:LX/13M4;

    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView;->mState:LX/13MF;
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->performAccessibilityActionForItem(LX/13M4;LX/13MF;Landroid/view/View;ILandroid/os/Bundle;)Z
...
.method public removeAndRecycleAllViews(LX/13M4;)V
    .locals 2
    ...
    invoke-virtual {p0, v1, p1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->removeAndRecycleViewAt(ILX/13M4;)V
...
.method public removeAndRecycleScrapInt(LX/13M4;)V
    .locals 6

    iget-object v0, p1, LX/13M4;->LIZ:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v1}, LX/13M9;->LJIIJ(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iput-object v0, v1, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mScrapContainer:LX/13M4;

    iput-boolean v2, v1, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mInChangeScrap:Z
    ...
    iget-object v0, p1, LX/13M4;->LIZIZ:Ljava/util/ArrayList;
...
.method public removeAndRecycleView(Landroid/view/View;LX/13M4;)V
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->removeView(Landroid/view/View;)V

    invoke-virtual {p2, p1}, LX/13M4;->LJIIJJI(Landroid/view/View;)V

    return-void
.end method

.method public removeAndRecycleViewAt(ILX/13M4;)V
    .locals 1
    ...
    invoke-virtual {p2, v0}, LX/13M4;->LJIIJJI(Landroid/view/View;)V
...
.method public requestChildRectangleOnScreen(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/View;Landroid/graphics/Rect;ZZ)Z
    ...
    invoke-direct {p0, p1, v3, v1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->isFocusedChildVisibleAfterScrolling(Landroidx/recyclerview/widget/RecyclerView;II)Z
    ...
    invoke-virtual {p1, v3, v1}, Landroidx/recyclerview/widget/RecyclerView;->scrollBy(II)V
...
.method public setExactMeasureSpecsFrom(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->setMeasureSpecs(II)V
...
.method public setMeasuredDimensionFromChildren(II)V
    ...
    invoke-virtual {p0, v2, v1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->getDecoratedBoundsWithMargins(Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public shouldMeasureChild(Landroid/view/View;IILandroidx/recyclerview/widget/RecyclerView$LayoutParams;)Z
    ...
    invoke-static {v1, p2, v0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->isMeasurementUpToDate(III)Z
    ...
    invoke-static {v1, p3, v0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->isMeasurementUpToDate(III)Z
...
.method public startSmoothScroll(LX/13MC;)V
    .locals 3

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mSmoothScroller:LX/13MC;

    if-eqz v1, :cond_0

    if-eq p1, v1, :cond_0

    iget-boolean v0, v1, LX/13MC;->LJ:Z

    if-eqz v0, :cond_0

    invoke-virtual {v1}, LX/13MC;->LJII()V

    :cond_0
    iput-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mSmoothScroller:LX/13MC;

    iget-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, v2, Landroidx/recyclerview/widget/RecyclerView;->mViewFlinger:LX/13M7;
    ...
    iput-object v2, p1, LX/13MC;->LIZIZ:Landroidx/recyclerview/widget/RecyclerView;

    iput-object p0, p1, LX/13MC;->LIZJ:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    iget v1, p1, LX/13MC;->LIZ:I

    const/4 v0, -0x1

    if-eq v1, v0, :cond_1

    iget-object v0, v2, Landroidx/recyclerview/widget/RecyclerView;->mState:LX/13MF;

    iput v1, v0, LX/13MF;->LIZ:I

    const/4 v0, 0x1

    iput-boolean v0, p1, LX/13MC;->LJ:Z

    iput-boolean v0, p1, LX/13MC;->LIZLLL:Z
    ...
    iput-object v0, p1, LX/13MC;->LJFF:Landroid/view/View;

    invoke-virtual {p1}, LX/13MC;->LJ()V

    iget-object v0, p1, LX/13MC;->LIZIZ:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mViewFlinger:LX/13M7;
...
.method public stopSmoothScroller()V
    ...
    invoke-virtual {v0}, LX/13MC;->LJII()V
