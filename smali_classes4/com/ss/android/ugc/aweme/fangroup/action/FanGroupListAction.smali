.class public final Lcom/ss/android/ugc/aweme/fangroup/action/FanGroupListAction;
...
.method public open(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, LX/07Jc;->useSelectStyle()Z

    move-result v0

    const-string v4, "creator_uid"
    ...
    new-instance v4, Lcom/ss/android/ugc/aweme/fangroup/fragment/FanGroupListFragment;

    invoke-direct {v4}, Lcom/ss/android/ugc/aweme/fangroup/fragment/FanGroupListFragment;-><init>()V
    ...
    invoke-virtual {v3}, LX/07Jc;->useAnchorSelectStyle()Z
    ...
    const-string v0, "FanGroupListFragment"
    ...
    const-string v0, "//im/fan_group_list_inner"
    ...
    const-string v6, "show_group_list"
    ...
    invoke-virtual {v3}, LX/07Jc;->getDefaultGroupName()Ljava/lang/String;
    ...
    invoke-virtual {v3}, LX/07Jc;->getExcludeBusinessType()I
    ...
    invoke-virtual {v3}, LX/07Jc;->getPanelHeight()Ljava/lang/Integer;
    ...
    :cond_5
    invoke-virtual {v3}, LX/07Jc;->getCreateChatLandingPage()I
    ...
    invoke-virtual {v3}, LX/07Jc;->getScene()I
