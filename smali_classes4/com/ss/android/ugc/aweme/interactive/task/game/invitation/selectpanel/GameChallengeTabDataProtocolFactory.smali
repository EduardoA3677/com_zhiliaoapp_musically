.class public final Lcom/ss/android/ugc/aweme/interactive/task/game/invitation/selectpanel/GameChallengeTabDataProtocolFactory;
...
.method public final Kt2(LX/07Oa;LX/07SV;)LX/07KZ;
    ...
    instance-of v1, p2, LX/07Os;

    const/4 v0, 0x0

    if-eqz v1, :cond_0

    check-cast p2, LX/07Os;

    if-eqz p2, :cond_0

    new-instance v0, LX/07RM;

    invoke-direct {v0, p1, p2}, LX/07RM;-><init>(LX/07Oa;LX/07Os;)V
