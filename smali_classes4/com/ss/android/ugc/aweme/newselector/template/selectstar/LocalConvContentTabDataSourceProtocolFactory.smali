.class public final Lcom/ss/android/ugc/aweme/newselector/template/selectstar/LocalConvContentTabDataSourceProtocolFactory;
...
.method public final Kt2(LX/07Oa;LX/07SV;)LX/07KZ;
    ...
    instance-of v1, p2, LX/07LL;

    const/4 v0, 0x0

    if-eqz v1, :cond_0

    check-cast p2, LX/07LL;

    if-eqz p2, :cond_0

    new-instance v0, LX/07LK;

    invoke-direct {v0, p1, p2}, LX/07LK;-><init>(LX/07Oa;LX/07LL;)V
