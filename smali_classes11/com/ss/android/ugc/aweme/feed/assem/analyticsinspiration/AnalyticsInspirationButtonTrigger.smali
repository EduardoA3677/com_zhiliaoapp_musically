.class public final Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonTrigger;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonTrigger;",
        ">;",
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, LX/0Mha;-><init>(Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonTrigger;)V

    invoke-static {v0}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonTrigger;->LLJJJJJIL:LX/05ta;
...
.method public final H9()Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonTrigger;->dq()Landroid/view/View;
...
.method public final getType()LX/0mPL;
    ...
    const-class v0, Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonAssem;
...
.method public final ln(Lcom/ss/android/ugc/aweme/feed/model/VideoItemParams;)V
    ...
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonTrigger;->LLJJJJJIL:LX/05ta;
    ...
    invoke-direct {v0, p0}, LX/0Mi2;-><init>(Lcom/ss/android/ugc/aweme/feed/assem/analyticsinspiration/AnalyticsInspirationButtonTrigger;)V
...
.method public final on(Lcom/ss/android/ugc/aweme/feed/model/VideoItemParams;)Z
    ...
    const-string v0, "creator_series_outreach"
    ...
    :cond_0
    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/music/model/Music;->isCommercialMusic()Z
    ...
    :cond_2
    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/music/model/Music;->getMusicStatus()I

    move-result v0

    if-ne v0, v2, :cond_1

    invoke-virtual {v4}, Lcom/ss/android/ugc/aweme/music/model/Music;->isAuthorDeleted()Z
