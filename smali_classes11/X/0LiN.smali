...
# instance fields
.field public final synthetic LL:LX/0NmZ;


# direct methods
.method public constructor <init>(LX/0NmZ;)V
    .locals 0

    iput-object p1, p0, LX/0LiN;->LL:LX/0NmZ;
...
.method public final onPausePlay(Ljava/lang/String;)V
    ...
    iget-object v0, p0, LX/0LiN;->LL:LX/0NmZ;

    iget-object v0, v0, LX/0NmZ;->LIZ:LX/0LiO;

    if-eqz v0, :cond_0

    invoke-interface {v0}, LX/0LiO;->T60()V

    :cond_0
    iget-object v0, p0, LX/0LiN;->LL:LX/0NmZ;

    invoke-virtual {v0}, LX/0NmZ;->LIZJ()LX/0NhM;
...
.method public final onPlayFailed(Ljava/lang/String;LX/0gLg;)V
    ...
    invoke-interface {v0}, LX/0LiO;->vO()V
...
.method public final onRenderFirstFrame(Ljava/lang/String;LX/0gKu;)V
    ...
    invoke-interface {v0}, LX/0LiO;->LJL()V
