...
# instance fields
.field public final synthetic LL:LX/0NUb;


# direct methods
.method public constructor <init>(LX/0NUb;)V
    .locals 0

    iput-object p1, p0, LX/0LiF;->LL:LX/0NUb;
...
.method public final onPlayerInternalEvent(Ljava/lang/String;ILorg/json/JSONObject;)V
    ...
    iget-object v1, p0, LX/0LiF;->LL:LX/0NUb;

    iget-object v0, v1, LX/0NUb;->LLILL:Lcom/ss/android/ugc/aweme/offline/playeranalytics/IPlayerAnalyticsService;

    if-eqz v0, :cond_0

    new-instance v0, LY/ARunnableS66S0100000_10;
    ...
    invoke-direct/range {v0 .. v5}, LY/ARunnableS66S0100000_10;-><init>(LX/0NUb;Ljava/lang/String;ILorg/json/JSONObject;I)V

    invoke-virtual {v1, v0}, LX/0NUb;->LLJIJIL(Ljava/lang/Runnable;)V
