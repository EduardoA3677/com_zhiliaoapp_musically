.class public final Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;
...
.method public constructor <init>()V
    ...
    new-instance v1, LX/04Sa;

    const/4 v0, 0x0

    invoke-direct {v1, v0}, LX/04Sa;-><init>(Ljava/lang/String;)V

    iput-object v1, p0, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->LLILZ:LX/04Sa;
...
.method public final defaultState()LX/00sA;
    ...
    new-instance v1, LX/0IbU;

    const/4 v0, 0x0

    invoke-direct {v1, v0}, LX/0IbU;-><init>(I)V
...
.method public final ju2(ILX/12LU;IZ)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->LLILZ:LX/04Sa;

    return-object v0
.end method

.method public final mu2(LX/04Sa;LX/02wT;)Ljava/lang/Object;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput v2, v4, LX/0Igs;->LLILL:I

    :goto_0
    iget-object v3, v4, LX/0Igs;->LL:Ljava/lang/Object;

    invoke-static {}, LX/0PB2;->LJFF()Ljava/lang/Object;

    move-result-object v2

    iget v0, v4, LX/0Igs;->LLILL:I
    ...
    iput-boolean v1, p0, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->LLILZIL:Z

    check-cast v3, LX/0wrM;

    iget-object v0, v3, LX/0wrM;->LJ:LX/0wrb;

    check-cast v0, LX/0Igt;

    iget-object v7, v0, LX/0Igt;->LIZ:Lcom/ss/android/ugc/aweme/topic/movie/detail/api/MovieVideosResp;
    ...
    invoke-direct {v0, p0, p1, v6}, LX/0Ihm;-><init>(Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;LX/04Sa;LX/02wT;)V

    iput v5, v4, LX/0Igs;->LLILL:I
    ...
    invoke-direct {v4, p0, p2}, LX/0Igs;-><init>(Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;LX/02wT;)V
    ...
    iget-object v0, v7, Lcom/ss/android/ugc/aweme/topic/movie/detail/api/MovieVideosResp;->pageExtra:Ljava/lang/String;

    invoke-direct {v1, v0}, LX/04Sa;-><init>(Ljava/lang/String;)V

    iput-object v1, p0, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->LLILZ:LX/04Sa;

    iget-object v1, v7, Lcom/ss/android/ugc/aweme/topic/movie/detail/api/MovieVideosResp;->awemeList:Ljava/util/List;
    ...
    :cond_4
    iget-boolean v0, v7, Lcom/ss/android/ugc/aweme/topic/movie/detail/api/MovieVideosResp;->hasMore:Z
...
.method public final bridge synthetic onLoadMore(Ljava/lang/Object;LX/02wT;)Ljava/lang/Object;
    ...
    check-cast p1, LX/04Sa;

    invoke-virtual {p0, p1, p2}, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->mu2(LX/04Sa;LX/02wT;)Ljava/lang/Object;
...
.method public final onReceiveVideoEvent(LX/0Qtg;)V
    ...
    iget-object v2, p0, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->LLILLJJLI:Ljava/lang/String;

    if-eqz v2, :cond_0

    iget-object v0, p0, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->LLILLL:Ljava/lang/String;
...
.method public final onRefresh(LX/02wT;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1, p1}, Lcom/ss/android/ugc/aweme/topic/movie/detail/vm/MovieVideoListVM;->mu2(LX/04Sa;LX/02wT;)Ljava/lang/Object;
