...
.method public constructor <init>(LX/0jUJ;)V
    ...
    iput-object p1, p0, LX/0Jly;->LIZ:LX/0jUJ;
    ...
    const-class v0, Lcom/ss/android/ugc/aweme/relation/usercard/impl/cell/TitleAreaCell;

    aput-object v0, v2, v1

    iput-object v2, p0, LX/0Jly;->LIZIZ:[Ljava/lang/Class;
...
.method public final LIZ(LX/0jUG;)LX/0jBu;
    ...
    instance-of v0, p1, LX/0jT3;

    const/4 v3, 0x0

    if-eqz v0, :cond_0

    check-cast p1, LX/0jT3;

    if-eqz p1, :cond_0

    new-instance v3, LX/0Jm1;

    iget-object v0, p0, LX/0Jly;->LIZ:LX/0jUJ;
    ...
    invoke-direct {v3, p1, v2, v1, v0}, LX/0Jm1;-><init>(LX/0jT3;LX/0jSV;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final LIZIZ()[Ljava/lang/Class;
    ...
    iget-object v0, p0, LX/0Jly;->LIZIZ:[Ljava/lang/Class;
