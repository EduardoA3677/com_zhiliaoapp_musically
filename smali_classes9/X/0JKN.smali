...
.method public static LIZ(Landroid/net/Uri;Landroid/content/Intent;Z)V
    .locals 7
    ...
    const-string v6, "insert_feed"

    if-nez v0, :cond_0

    :try_start_1
    invoke-static {p0, v6}, Lcom/bytedance/mt/protector/impl/UriProtector;->com_bytedance_mt_protector_impl_UriProtector_com_ss_android_ugc_aweme_lancet_UriLancet_getQueryParameter(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1, p0}, LX/0JKN;->LIZIZ(Landroid/content/Intent;Landroid/net/Uri;)V
    ...
    invoke-static {p1, p0}, LX/0JKN;->LIZJ(Landroid/content/Intent;Landroid/net/Uri;)V
    ...
    :cond_5
    invoke-static {p1, v1}, LX/0JKN;->LIZIZ(Landroid/content/Intent;Landroid/net/Uri;)V
    ...
    invoke-static {p1, v1}, LX/0JKN;->LIZJ(Landroid/content/Intent;Landroid/net/Uri;)V
    :try_end_2
...
.method public static LIZIZ(Landroid/content/Intent;Landroid/net/Uri;)V
    .locals 4
    ...
    const-string v2, "share_expose_sharer"
...
.method public static LIZJ(Landroid/content/Intent;Landroid/net/Uri;)V
    .locals 2
