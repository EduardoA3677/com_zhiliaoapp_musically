...
# instance fields
.field public final synthetic LIZ:LX/0IVf;

.field public final synthetic LIZIZ:Ljava/lang/Boolean;

.field public final synthetic LIZJ:LX/0IVO;
...
.method public constructor <init>(LX/0IVO;LX/0IVf;Ljava/lang/Boolean;LX/01ej;LX/15BK;)V
    ...
    iput-object p2, p0, LX/0IVP;->LIZ:LX/0IVf;

    iput-object p3, p0, LX/0IVP;->LIZIZ:Ljava/lang/Boolean;

    iput-object p1, p0, LX/0IVP;->LIZJ:LX/0IVO;

    iput-object p4, p0, LX/0IVP;->LIZLLL:LX/01ej;

    iput-object p5, p0, LX/0IVP;->LJ:LX/0x07;
...
.method public final LIZ(Ljava/lang/Object;Z)V
    ...
    iget-object v0, p0, LX/0IVP;->LIZJ:LX/0IVO;

    iput-object p1, v0, LX/0IVO;->LIZLLL:Ljava/util/List;

    iget-object v0, p0, LX/0IVP;->LIZLLL:LX/01ej;

    iget-boolean v0, v0, LX/01ej;->element:Z

    if-nez v0, :cond_0

    iget-object v2, p0, LX/0IVP;->LJ:LX/0x07;
    ...
    iget-object v0, p0, LX/0IVP;->LIZ:LX/0IVf;

    invoke-virtual {v0, p2}, LX/0IVf;->LIZ(Z)V

    iget-object v1, p0, LX/0IVP;->LIZIZ:Ljava/lang/Boolean;
...
.method public final LIZIZ(Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, LX/0IVP;->LIZJ:LX/0IVO;

    const/4 v0, 0x0

    iput-object v0, v1, LX/0IVO;->LIZLLL:Ljava/util/List;
