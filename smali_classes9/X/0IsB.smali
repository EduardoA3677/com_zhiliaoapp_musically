...
# direct methods
.method public constructor <init>(Ljava/util/Map;Ljava/util/Map;Lcom/ss/android/ugc/aweme/feed/model/Aweme;J)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0IsB;->LIZ:Ljava/util/Map;

    iput-object p2, p0, LX/0IsB;->LIZIZ:Ljava/util/Map;

    iput-object p3, p0, LX/0IsB;->LIZJ:Lcom/ss/android/ugc/aweme/feed/model/Aweme;

    iput-wide p4, p0, LX/0IsB;->LIZLLL:J
...
.method public final LIZ(LX/0IsC;)V
    ...
    iget-object v0, p0, LX/0IsB;->LIZ:Ljava/util/Map;
    ...
    :cond_0
    iget-object v0, p0, LX/0IsB;->LIZIZ:Ljava/util/Map;
    ...
    :cond_1
    iget-object v0, p0, LX/0IsB;->LIZJ:Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    ...
    iget-wide v0, p0, LX/0IsB;->LIZLLL:J
