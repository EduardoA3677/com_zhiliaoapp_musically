...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.topic.book.detail.vm.BookDetailVM$toggleFavorite$1$1$2"
    f = "BookDetailVM.kt"
    l = {}
    m = "invokeSuspend"
.end annotation
...
# instance fields
.field public final synthetic LL:Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;
...
# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;ZLjava/lang/String;LX/0wrK;LX/02uK;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0JCM;->LL:Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;

    iput-boolean p2, p0, LX/0JCM;->LLILIL:Z

    iput-object p3, p0, LX/0JCM;->LLILL:Ljava/lang/String;

    iput-object p4, p0, LX/0JCM;->LLILLIZIL:LX/0wrK;

    iput-object p5, p0, LX/0JCM;->LLILLJJLI:LX/02uK;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0JCM;->LL:Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;

    iget-boolean v2, p0, LX/0JCM;->LLILIL:Z

    iget-object v3, p0, LX/0JCM;->LLILL:Ljava/lang/String;

    iget-object v4, p0, LX/0JCM;->LLILLIZIL:LX/0wrK;

    iget-object v5, p0, LX/0JCM;->LLILLJJLI:LX/02uK;

    move-object v6, p2

    invoke-direct/range {v0 .. v6}, LX/0JCM;-><init>(Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;ZLjava/lang/String;LX/0wrK;LX/02uK;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v8, "BookDetailVM@4059.toggleFavorite$1$1$2"
    ...
    iget-object v0, p0, LX/0JCM;->LL:Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;
    ...
    iget-boolean v3, v0, LX/0JCN;->LLILIL:Z

    iget-object v1, p0, LX/0JCM;->LL:Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;

    iget-boolean v0, v1, Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;->LLILIL:Z
    ...
    iget-boolean v0, p0, LX/0JCM;->LLILIL:Z
    ...
    iget-boolean v1, v0, Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;->LLILIL:Z

    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/topic/book/detail/vm/BookDetailVM;->hu2()Ljava/lang/String;

    move-result-object v7

    iget-object v6, p0, LX/0JCM;->LLILL:Ljava/lang/String;

    iget-object v0, p0, LX/0JCM;->LLILLIZIL:LX/0wrK;
    ...
    :cond_0
    iget-object v0, p0, LX/0JCM;->LLILLJJLI:LX/02uK;
