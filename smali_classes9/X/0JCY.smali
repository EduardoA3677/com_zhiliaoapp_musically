...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.topic.movie.anchor.MovieTokAnchorBusinessService$handleIconClick$1$1$2"
...
.method public constructor <init>(LX/0wrK;Lcom/ss/android/ugc/aweme/feed/model/AnchorCommonStruct;LX/0JD9;Ljava/lang/String;LX/02wT;LX/02uK;Z)V
    ...
    iput-boolean p7, p0, LX/0JCY;->LL:Z

    iput-object p3, p0, LX/0JCY;->LLILIL:LX/0JD9;

    iput-object p4, p0, LX/0JCY;->LLILL:Ljava/lang/String;

    iput-object p2, p0, LX/0JCY;->LLILLIZIL:Lcom/ss/android/ugc/aweme/feed/model/AnchorCommonStruct;

    iput-object p1, p0, LX/0JCY;->LLILLJJLI:LX/0wrK;

    iput-object p6, p0, LX/0JCY;->LLILLL:LX/02uK;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-boolean v7, p0, LX/0JCY;->LL:Z

    iget-object v3, p0, LX/0JCY;->LLILIL:LX/0JD9;

    iget-object v4, p0, LX/0JCY;->LLILL:Ljava/lang/String;

    iget-object v2, p0, LX/0JCY;->LLILLIZIL:Lcom/ss/android/ugc/aweme/feed/model/AnchorCommonStruct;

    iget-object v1, p0, LX/0JCY;->LLILLJJLI:LX/0wrK;

    iget-object v6, p0, LX/0JCY;->LLILLL:LX/02uK;

    move-object v5, p2

    invoke-direct/range {v0 .. v7}, LX/0JCY;-><init>(LX/0wrK;Lcom/ss/android/ugc/aweme/feed/model/AnchorCommonStruct;LX/0JD9;Ljava/lang/String;LX/02wT;LX/02uK;Z)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v8, "MovieTokAnchorBusinessService@ff9f.handleIconClick$1$1$2"
    ...
    iget-boolean v0, p0, LX/0JCY;->LL:Z

    invoke-static {v0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v1

    iget-object v0, p0, LX/0JCY;->LLILIL:LX/0JD9;

    iget-object v0, v0, LX/0JD9;->LIZIZ:Ljava/lang/Boolean;
    ...
    iget-object v1, p0, LX/0JCY;->LLILIL:LX/0JD9;
    ...
    iput-object v0, v1, LX/0JD9;->LIZIZ:Ljava/lang/Boolean;

    iget-object v3, p0, LX/0JCY;->LLILIL:LX/0JD9;

    iget-object v1, p0, LX/0JCY;->LLILL:Ljava/lang/String;

    iget-object v0, v3, LX/0JD9;->LIZIZ:Ljava/lang/Boolean;
    ...
    invoke-virtual {v3, v0, v1}, LX/0JD9;->LJIIL(Ljava/lang/Boolean;Ljava/lang/String;)V
    ...
    iget-object v7, p0, LX/0JCY;->LLILL:Ljava/lang/String;

    iget-object v0, p0, LX/0JCY;->LLILLIZIL:Lcom/ss/android/ugc/aweme/feed/model/AnchorCommonStruct;
    ...
    :cond_1
    iget-object v0, p0, LX/0JCY;->LLILLJJLI:LX/0wrK;
    ...
    :cond_2
    iget-object v0, p0, LX/0JCY;->LLILLL:LX/02uK;
