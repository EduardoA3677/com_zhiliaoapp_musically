...
# instance fields
.field public final synthetic LL:LX/02UG;
...
# direct methods
.method public constructor <init>(LX/02UG;LX/02Qy;Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;JZ)V
    .locals 0

    iput-object p1, p0, LX/02Pv;->LL:LX/02UG;

    iput-object p2, p0, LX/02Pv;->LLILIL:LX/02Qy;

    iput-object p3, p0, LX/02Pv;->LLILL:Ljava/lang/String;

    iput-wide p4, p0, LX/02Pv;->LLILLIZIL:J

    iput-object p6, p0, LX/02Pv;->LLILLJJLI:Ljava/lang/String;

    iput-object p7, p0, LX/02Pv;->LLILLL:Ljava/lang/String;

    iput-wide p8, p0, LX/02Pv;->LLILZ:J

    iput-boolean p10, p0, LX/02Pv;->LLILZIL:Z
...
.method public final accept(Ljava/lang/Object;)V
    ...
    const-string v11, "Linker@1743.replyInviteGroup$1$3"
    ...
    iget-object v2, v0, LX/02Pv;->LL:LX/02UG;

    iget v2, v2, LX/02UG;->LJ:I
    ...
    iget-object v2, v0, LX/02Pv;->LLILIL:LX/02Qy;
    ...
    iget-object v2, v2, LX/02Qy;->LLJILLL:LX/02Uh;

    iget v3, v2, LX/02Uh;->LIZ:I
    ...
    :cond_0
    iget-object v6, v0, LX/02Pv;->LLILIL:LX/02Qy;
    ...
    iget-object v9, v0, LX/02Pv;->LLILIL:LX/02Qy;

    iget-object v5, v0, LX/02Pv;->LL:LX/02UG;

    iget-wide v6, v0, LX/02Pv;->LLILZ:J
    ...
    iget-wide v2, v5, LX/02UG;->LIZIZ:J
    ...
    iget-object v2, v5, LX/02UG;->LJI:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    iget-object v13, v0, LX/02Pv;->LLILIL:LX/02Qy;
    ...
    iget-wide v2, v0, LX/02Pv;->LLILLIZIL:J
    ...
    iget-object v7, v0, LX/02Pv;->LLILIL:LX/02Qy;

    iget-object v2, v1, Lcom/bytedance/android/live/network/response/BaseResponse;->data:Ljava/lang/Object;

    check-cast v2, Ltikcast/linkmic/controller/PermitJoinGroupResp;

    iget-object v4, v2, Ltikcast/linkmic/controller/PermitJoinGroupResp;->groupUser:Ltikcast/linkmic/common/GroupChannelAllUser;

    iget-object v2, v0, LX/02Pv;->LL:LX/02UG;

    iget-wide v2, v2, LX/02UG;->LIZIZ:J

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4, v2, v3}, LX/02Qy;->LJJJJJL(Ltikcast/linkmic/common/GroupChannelAllUser;J)Ljava/lang/String;
    ...
    iget-object v3, v0, LX/02Pv;->LLILIL:LX/02Qy;
    ...
    iget-object v4, v0, LX/02Pv;->LLILLJJLI:Ljava/lang/String;

    :cond_3
    iget-object v8, v0, LX/02Pv;->LLILIL:LX/02Qy;
    ...
    iget-object v3, v0, LX/02Pv;->LLILLL:Ljava/lang/String;

    :cond_4
    iget-object v2, v0, LX/02Pv;->LL:LX/02UG;

    iget-object v2, v2, LX/02UG;->LJI:Ljava/lang/String;
    ...
    iget-boolean v6, v0, LX/02Pv;->LLILZIL:Z
    ...
    :cond_7
    invoke-interface {v2, v5, v0}, LX/02SV;->LJIIZILJ(LX/02UG;Ljava/lang/String;)V
    ...
    :cond_9
    invoke-interface {v2, v5, v0}, LX/02SV;->LJJI(LX/02UG;Ljava/lang/String;)V
    ...
    iget-object v2, v0, LX/02Pv;->LLILL:Ljava/lang/String;
