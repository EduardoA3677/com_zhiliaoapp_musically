...
.method public constructor <init>(LX/02Qy;LX/02UC;LX/02OU;)V
    ...
    iput-object p1, p0, LX/02RC;->LL:LX/02Qy;

    iput-object p2, p0, LX/02RC;->LLILIL:LX/02UC;

    iput-object p3, p0, LX/02RC;->LLILL:LX/02OU;
...
.method public final apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LX/02RC;->LLILIL:LX/02UC;
    ...
    iget-object v0, p0, LX/02RC;->LL:LX/02Qy;

    iget-object v0, v0, LX/02Qy;->LLLJL:Ljava/util/List;
    ...
    iget-object v2, v0, LX/02Qy;->LLLJL:Ljava/util/List;
    ...
    iget-object v1, v0, LX/02UC;->LJI:LX/02MJ;
    ...
    :cond_3
    iget-object v2, p0, LX/02RC;->LL:LX/02Qy;
    ...
    invoke-interface {v3, v2, v0, v1}, LX/02QI;->LJIJJLI(Ltikcast/linkmic/common/GroupChannelAllUser;J)V
    ...
    iget-object v3, p0, LX/02RC;->LL:LX/02Qy;
    ...
    :goto_3
    const-string v9, "business_multi_host_apply"
    ...
    iget-object v1, p0, LX/02RC;->LLILIL:LX/02UC;
    ...
    const-string v8, "apply_group"

    iget-wide v9, v1, LX/02UC;->LIZIZ:J
    ...
    iget-wide v3, v0, Lcom/bytedance/android/livesdk/livesetting/linkmic/LinkMicSDKForwardStreamProtectConf;->applyRechargeTimerInterval:J
    ...
    iget-wide v5, v0, LX/02UC;->LIZIZ:J
    ...
    new-instance v1, LX/02Nc;

    iget-object v0, p0, LX/02RC;->LLILL:LX/02OU;

    invoke-direct {v1, p1, v0}, LX/02Nc;-><init>(LX/02tp;LX/02OU;)V
