...
.method public static constructor <clinit>()V
    ...
    sput-object v1, LX/02X8;->LIZ:Landroid/util/LruCache;
...
.method public static LIZ(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    const-string v4, "linkmic_sdk_enable_b_frame"
...
.method public static LIZIZ(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    .locals 8

    const-string v7, "multi_guest"
    ...
    sget-object v0, Lcom/bytedance/android/livesdk/livesetting/linkmic/LinkMicCdidCompateDidParams;->INSTANCE:Lcom/bytedance/android/livesdk/livesetting/linkmic/LinkMicCdidCompateDidParams;

    invoke-virtual {v0}, Lcom/bytedance/android/livesdk/livesetting/linkmic/LinkMicCdidCompateDidParams;->getValue()Ljava/util/Map;
    ...
    invoke-static {v0}, LX/02X8;->LJFF(Ljava/lang/Object;)Ljava/util/Map;
    ...
    :cond_4
    :try_start_1
    invoke-static {v5, v1}, LX/02X8;->LIZJ(Ljava/util/Map;Ljava/util/Map;)V
    ...
    const-string v0, "getRtcParamMapByScene, e = "
    ...
    const-string v0, "rtc_channel_base"

    invoke-static {v0, v1, v4, v4}, LX/0wUC;->LJFF(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
...
.method public static LIZJ(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-static {v1, v2}, LX/02X8;->LIZJ(Ljava/util/Map;Ljava/util/Map;)V
...
.method public static LIZLLL(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_0
    sget-object v3, LX/02X8;->LIZ:Landroid/util/LruCache;
    ...
    const-string v0, "parse rtcAbParams error,"
...
.method public static LJ()V
    ...
    :cond_0
    const-string v2, "RtcAbUtil"

    const-string v0, "release all cache"
...
.method public static LJFF(Ljava/lang/Object;)Ljava/util/Map;
    ...
    const-string v0, "Any?.toMap() fail, "
