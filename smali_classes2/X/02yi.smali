...
# static fields
.field public static final LIZ:LX/02yi;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0}, LX/02yi;-><init>()V

    sput-object v0, LX/02yi;->LIZ:LX/02yi;
...
.method public final LIZ(JLjava/lang/String;LX/02wT;)Ljava/lang/Object;
    ...
    instance-of v0, v3, LX/02yk;

    if-eqz v0, :cond_c

    move-object v6, v3

    check-cast v6, LX/02yk;

    iget v2, v6, LX/02yk;->LLILLL:I
    ...
    iput v2, v6, LX/02yk;->LLILLL:I

    :goto_0
    iget-object v5, v6, LX/02yk;->LLILLIZIL:Ljava/lang/Object;

    invoke-static {}, LX/0PB2;->LJFF()Ljava/lang/Object;

    move-result-object v4

    iget v0, v6, LX/02yk;->LLILLL:I
    ...
    iget-object v7, v6, LX/02yk;->LL:Ljava/lang/Object;
    ...
    invoke-direct {v0, v7, v2}, LX/02yS;-><init>(Ljava/lang/String;Lcom/ss/android/ugc/aweme/ecommercebase/network/BaseResponse;)V
    ...
    sget-object v1, LX/02ym;->LIZ:LX/0IQp;
    ...
    invoke-static {p1, p2}, LX/032z;->LIZ(J)LX/030t;
    ...
    :cond_4
    iput-object p3, v6, LX/02yk;->LL:Ljava/lang/Object;

    iput-object v8, v6, LX/02yk;->LLILIL:LX/030t;

    iput-object v1, v6, LX/02yk;->LLILL:LX/030t;

    iput v7, v6, LX/02yk;->LLILLL:I
    ...
    new-instance v0, LX/02yU;

    invoke-direct {v0, v2}, LX/02yU;-><init>(LX/02wT;)V
    ...
    invoke-direct {v0, v2}, LX/02yV;-><init>(LX/02wT;)V
    ...
    :cond_8
    iget-object v1, v6, LX/02yk;->LLILL:LX/030t;

    iget-object p3, v6, LX/02yk;->LL:Ljava/lang/Object;

    invoke-static {v5}, LX/01jw;->LIZIZ(Ljava/lang/Object;)V

    :cond_9
    check-cast v5, LX/02yS;

    iget-object v7, v5, LX/02yS;->LIZ:Ljava/lang/String;
    ...
    iget-object v0, v5, LX/02yS;->LIZIZ:Lcom/ss/android/ugc/aweme/ecommercebase/network/BaseResponse;
    ...
    iput-object v7, v6, LX/02yk;->LL:Ljava/lang/Object;

    iput-object v2, v6, LX/02yk;->LLILIL:LX/030t;

    iput-object v2, v6, LX/02yk;->LLILL:LX/030t;

    iput v3, v6, LX/02yk;->LLILLL:I
    ...
    :cond_c
    new-instance v6, LX/02yk;

    invoke-direct {v6, p0, v3}, LX/02yk;-><init>(LX/02yi;LX/02wT;)V
