...
.method public constructor <init>(LX/0eKe;)V
    ...
    iput-object p1, p0, LX/02cy;->LL:LX/0eKe;
...
.method public final LLLIIIL(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/ReplyInviteMessage;)V
    ...
    iget-object v5, p0, LX/02cy;->LL:LX/0eKe;
    ...
    const-string v0, "handleReceiveReplyInviteMessage, message="
    ...
    invoke-virtual {p2}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/ReplyInviteMessage;->getCustomMessage()Lcom/bytedance/android/livesdk/comp/api/linkcore/model/CustomLinkMessage;
    ...
    iget v1, v0, Lcom/bytedance/android/livesdk/chatroom/model/multiguestv3/ReplyBizContent;->isTurnOffInvitation:I

    const/4 v0, 0x1

    if-ne v1, v0, :cond_0

    invoke-virtual {p2}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/ReplyInviteMessage;->getInviteOperator()Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;
    ...
    check-cast v1, LX/0eKD;

    if-eqz v1, :cond_0

    invoke-virtual {p2}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/ReplyInviteMessage;->getReplyUserInfo()Lcom/bytedance/android/live/base/model/user/User;
    ...
    invoke-interface {v1, v0}, LX/0eKD;->Fr(Ljava/lang/String;)V
