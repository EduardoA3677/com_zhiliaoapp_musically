...
.method public constructor <init>(LX/02Qy;LX/02OU;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkCoreError;Ljava/lang/Throwable;)V
    ...
    iput-object p1, p0, LX/02OS;->LL:LX/02Qy;

    iput-object p2, p0, LX/02OS;->LLILIL:LX/02OU;

    iput-object p3, p0, LX/02OS;->LLILL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkCoreError;

    iput-object p4, p0, LX/02OS;->LLILLIZIL:Ljava/lang/Throwable;
...
.method public final run()V
    ...
    const-string v3, "Linker@1743.moderatorInvite$1$onFailed$1"
    ...
    const-string v1, "moderatorInvite error"

    const/4 v0, 0x0

    invoke-static {v2, v1, v0, v0}, LX/0wUC;->LJFF(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V

    iget-object v2, p0, LX/02OS;->LLILIL:LX/02OU;

    if-eqz v2, :cond_0

    iget-object v1, p0, LX/02OS;->LLILL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkCoreError;

    iget-object v0, p0, LX/02OS;->LLILLIZIL:Ljava/lang/Throwable;
