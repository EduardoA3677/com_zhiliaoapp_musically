...
.method public constructor <init>(LX/02Vk;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;LX/02OU;J)V
    ...
    iput-object p1, p0, LX/02Vx;->LL:LX/02Vk;

    iput-object p2, p0, LX/02Vx;->LLILIL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;

    iput-object p3, p0, LX/02Vx;->LLILL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;

    iput-object p4, p0, LX/02Vx;->LLILLIZIL:LX/02OU;

    iput-wide p5, p0, LX/02Vx;->LLILLJJLI:J
...
.method public final accept(Ljava/lang/Object;)V
    ...
    const-string v5, "CoLinker@4057.cancelApply$4"

    invoke-static {v5}, LX/0Xz5;->LIZ(Ljava/lang/String;)V

    check-cast p1, LX/02X1;

    iget-object v0, p0, LX/02Vx;->LL:LX/02Vk;

    invoke-virtual {v0}, LX/02Vk;->LJJIJIIJIL()LX/02Vw;

    move-result-object v1

    iget-object v0, p0, LX/02Vx;->LLILIL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;
    ...
    iget-object v0, p0, LX/02Vx;->LLILL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;

    invoke-virtual {v1, v0}, LX/02Vw;->LJJLIIIJLJLI(Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;)V

    iget-object v4, p0, LX/02Vx;->LLILLIZIL:LX/02OU;

    if-eqz v4, :cond_3

    iget-object v0, p0, LX/02Vx;->LL:LX/02Vk;

    iget-wide v1, p0, LX/02Vx;->LLILLJJLI:J
    ...
    invoke-direct {v0, v2, v1}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/CancelApplyResult;-><init>(Ljava/util/Map;Ljava/lang/String;)V
