...
.method public constructor <init>(LX/040S;LX/03cj;LX/03zj;)V
    ...
    iput-object p1, p0, LX/03cl;->LIZ:LX/02ue;

    iput-object p2, p0, LX/03cl;->LIZIZ:LX/03cj;

    iput-object p3, p0, LX/03cl;->LIZJ:LX/03zj;
...
.method public final LIZ([BIIIF)I
    ...
    :try_start_0
    iget-object v3, p0, LX/03cl;->LIZ:LX/02ue;

    new-instance v2, LX/03cf;

    const-string v1, "seekWithResult returned null bytes"
    ...
    iget-object v2, p0, LX/03cl;->LIZ:LX/02ue;

    new-instance v1, LX/03cf;

    const-string v0, "Failed to process frame data from seekWithResult"
