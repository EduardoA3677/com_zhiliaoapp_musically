...
.method public constructor <init>(JLcom/bytedance/android/livesdk/model/message/ext/ECommerceMessage;LX/0v4t;Ljava/lang/Integer;ZZ)V
    ...
    iput-wide p1, p0, LX/02yN;->LL:J

    iput-object p4, p0, LX/02yN;->LLILIL:LX/0v4t;

    iput-object p3, p0, LX/02yN;->LLILL:Lcom/bytedance/android/livesdk/model/message/ext/ECommerceMessage;

    iput-boolean p6, p0, LX/02yN;->LLILLIZIL:Z

    iput-object p5, p0, LX/02yN;->LLILLJJLI:Ljava/lang/Integer;

    iput-boolean p7, p0, LX/02yN;->LLILLL:Z
...
.method public final onFailure(LX/0aSK;Ljava/lang/Throwable;)V
    ...
    iget-object v0, v3, LX/02yN;->LLILIL:LX/0v4t;
    ...
    :goto_1
    iget-object v0, v3, LX/02yN;->LLILL:Lcom/bytedance/android/livesdk/model/message/ext/ECommerceMessage;
    ...
    iget-boolean v1, v3, LX/02yN;->LLILLIZIL:Z

    iget-object v0, v3, LX/02yN;->LLILLJJLI:Ljava/lang/Integer;
...
.method public final onResponse(LX/0aSK;LX/0Zgf;)V
    ...
    iget-object v1, v0, LX/02yN;->LLILIL:LX/0v4t;
    ...
    iget-object v3, v0, LX/02yN;->LLILIL:LX/0v4t;
    ...
    iget-object v8, v0, LX/02yN;->LLILL:Lcom/bytedance/android/livesdk/model/message/ext/ECommerceMessage;

    iget-object v14, v0, LX/02yN;->LLILIL:LX/0v4t;

    iget-boolean v7, v0, LX/02yN;->LLILLL:Z

    iget-boolean v6, v0, LX/02yN;->LLILLIZIL:Z
    ...
    new-instance v3, LX/02xL;

    invoke-direct {v3, v15, v1, v14, v2}, LX/02xL;-><init>(Lcom/ss/android/ugc/aweme/ecommercelive/common/data/PopProductResp;LX/0Zgf;LX/0v4t;LX/02wT;)V
    ...
    invoke-direct/range {v12 .. v19}, LX/02xC;-><init>(ZLX/0v4t;Lcom/ss/android/ugc/aweme/ecommercelive/common/data/PopProductResp;ZLcom/bytedance/android/livesdk/model/message/ext/ECommerceMessage;ZLX/02wT;)V
    ...
    :goto_9
    iget-object v3, v0, LX/02yN;->LLILL:Lcom/bytedance/android/livesdk/model/message/ext/ECommerceMessage;
    ...
    iget-boolean v0, v0, LX/02yN;->LLILLIZIL:Z
