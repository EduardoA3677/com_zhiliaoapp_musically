...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;)V
    ...
    iput-object p1, p0, LX/0kAq;->LIZIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/0kAp;)Lorg/json/JSONObject;
    .locals 4
    ...
    invoke-interface {p0}, LX/0kAp;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/0kAp;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/0kAp;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, p0, LX/0kAq;->LIZIZ:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v1, p0, p2, p1, v0}, LY/ARunnableS65S0200000_22;-><init>(LX/0kAq;Lorg/json/JSONObject;Ljava/lang/Number;I)V
