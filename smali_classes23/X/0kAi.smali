...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;)V
    ...
    iput-object p1, p0, LX/0kAi;->LIZIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/0kAj;)Lorg/json/JSONObject;
    .locals 4
    ...
    invoke-interface {p0}, LX/0kAj;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/0kAj;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/0kAj;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, v4, LX/0kAi;->LIZIZ:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct/range {v3 .. v8}, LY/ARunnableS47S0300000_22;-><init>(LX/0kAi;Lorg/json/JSONObject;Landroid/app/Activity;Ljava/lang/Number;I)V
