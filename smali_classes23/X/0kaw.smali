...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.poi.anchor.chat.PoiChatAnchorMaker$onAnchorClicked$2"
...
.method public constructor <init>(Ljava/lang/String;Lcom/ss/android/ugc/aweme/im/message/template/component/AnchorInfoComponent;LX/0kav;Ljava/util/Map;LX/02wT;)V
    ...
    iput-object p1, p0, LX/0kaw;->LL:Ljava/lang/String;

    iput-object p2, p0, LX/0kaw;->LLILIL:Lcom/ss/android/ugc/aweme/im/message/template/component/AnchorInfoComponent;

    iput-object p3, p0, LX/0kaw;->LLILL:LX/0kav;

    iput-object p4, p0, LX/0kaw;->LLILLIZIL:Ljava/util/Map;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0kaw;->LL:Ljava/lang/String;

    iget-object v2, p0, LX/0kaw;->LLILIL:Lcom/ss/android/ugc/aweme/im/message/template/component/AnchorInfoComponent;

    iget-object v3, p0, LX/0kaw;->LLILL:LX/0kav;

    iget-object v4, p0, LX/0kaw;->LLILLIZIL:Ljava/util/Map;

    move-object v5, p2

    invoke-direct/range {v0 .. v5}, LX/0kaw;-><init>(Ljava/lang/String;Lcom/ss/android/ugc/aweme/im/message/template/component/AnchorInfoComponent;LX/0kav;Ljava/util/Map;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v7, "PoiChatAnchorMaker@bb8c.onAnchorClicked$2"
    ...
    iget-object v3, p0, LX/0kaw;->LLILIL:Lcom/ss/android/ugc/aweme/im/message/template/component/AnchorInfoComponent;

    iget-object v6, p0, LX/0kaw;->LLILL:LX/0kav;

    iget-object v5, p0, LX/0kaw;->LLILLIZIL:Ljava/util/Map;
    ...
    :goto_1
    iget-object v3, v6, LX/0kav;->LLILLIZIL:Ljava/lang/String;

    if-eqz v3, :cond_2

    iget-object v2, v6, LX/0kav;->LLILL:Lcom/bytedance/keva/Keva;

    invoke-static {}, LX/0Y9f;->LIZ()Ljava/lang/StringBuilder;

    move-result-object v1

    const-string v0, "show_index_"
    ...
    const-string v0, "poi_video_card_anchor_click"
