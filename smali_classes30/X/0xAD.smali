...
# direct methods
.method public constructor <init>(LX/0xAC;ZILjava/util/List;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;LX/0mvL;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0xAD;->LIZ:LX/0xAC;

    iput-boolean p2, p0, LX/0xAD;->LIZIZ:Z

    iput p3, p0, LX/0xAD;->LIZJ:I

    iput-object p4, p0, LX/0xAD;->LIZLLL:Ljava/util/List;

    iput-object p5, p0, LX/0xAD;->LJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;

    iput-object p6, p0, LX/0xAD;->LJFF:LX/0mvL;

    iput-boolean p7, p0, LX/0xAD;->LJI:Z
...
.method public final LIZ(II)V
    ...
    iget-object v0, p0, LX/0xAD;->LJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    iget-object v1, p0, LX/0xAD;->LIZ:LX/0xAC;

    iget-boolean v0, p0, LX/0xAD;->LIZIZ:Z

    invoke-virtual {v1, p2, v0}, LX/0xAC;->LLLZIL(IZ)V
...
.method public final LIZIZ(ILX/0js1;)V
    ...
    iget-object v0, p0, LX/0xAD;->LIZ:LX/0xAC;
    ...
    :cond_0
    iget-object v0, p0, LX/0xAD;->LJFF:LX/0mvL;
    ...
    iput-object v3, v1, LX/0xAC;->LLJZIJLIL:Ljava/lang/String;

    iget-boolean v0, p0, LX/0xAD;->LJI:Z

    if-nez v0, :cond_4

    iget-object v0, v1, LX/0xAC;->LLLIZZ:LX/0mvL;

    if-nez v0, :cond_2

    invoke-virtual {v1}, LX/0xAC;->LLLLLLL()LX/0x4w;
    ...
    :cond_2
    iget-object v5, p0, LX/0xAD;->LIZ:LX/0xAC;

    iget-object v4, p0, LX/0xAD;->LIZLLL:Ljava/util/List;

    iget v3, p0, LX/0xAD;->LIZJ:I

    iget-object v2, p0, LX/0xAD;->LJFF:LX/0mvL;
    ...
    :cond_3
    invoke-virtual {v5, v4, v3, v2, v6}, LX/0xAC;->LLLLZLLIL(Ljava/util/List;ILX/0mvL;Z)V
    ...
    iput-object v3, v0, LX/0xAC;->LLJZIJLIL:Ljava/lang/String;

    iget-object v0, p0, LX/0xAD;->LIZLLL:Ljava/util/List;
    ...
    invoke-virtual {v0}, LX/0xAC;->LLLLZI()Z
...
.method public final LIZJ(II)V
    ...
    iget-object v3, p0, LX/0xAD;->LIZ:LX/0xAC;

    iget-boolean v2, p0, LX/0xAD;->LIZIZ:Z
    ...
    invoke-virtual {v3, p2, v2}, LX/0xAC;->LLLZIL(IZ)V
...
.method public final LIZLLL(ILjava/util/List;)V
    ...
    iput-boolean v2, v0, LX/0xAC;->LLLLIIL:Z
    ...
    iget-boolean v0, v1, LX/0xAC;->LLLLIIL:Z
    ...
    iget-object v2, p0, LX/0xAD;->LIZ:LX/0xAC;

    iget-object v1, p0, LX/0xAD;->LJFF:LX/0mvL;

    const/4 v0, 0x3

    invoke-direct {v3, v5, v2, v1, v0}, Lkotlin/jvm/internal/AwS288S0300000_29;-><init>(LX/00zH;LX/0xAC;LX/0mvL;I)V
    ...
    invoke-virtual {v2, v1, v0}, LX/0xAC;->LLLIZZ(Landroidx/lifecycle/LifecycleOwner;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;)V
    ...
    invoke-direct {v3, v2, v1, v0}, Lkotlin/jvm/internal/AwS419S0200000_29;-><init>(LX/0xAC;LX/0mvL;I)V
    ...
    iput-boolean v8, v0, LX/0xAC;->LLLLIIL:Z
    ...
    iget-object v1, v2, LX/0xAC;->LLLIIII:Lcom/bytedance/tux/input/TuxTextView;
    ...
    :cond_b
    iget-object v0, v2, LX/0xAC;->LLLLILI:Ljava/lang/String;
    ...
    iput-object v7, v0, LX/0xAC;->LLJZIJLIL:Ljava/lang/String;
...
.method public final onCancel()V
    ...
    iget-object v0, v0, LX/0xAC;->LLLJL:LX/0mvL;
...
.method public final onStart(I)V
    ...
    invoke-virtual {v1, v0}, LX/0xAC;->LLLZL(Z)V
