...
.method public constructor <init>(ILX/0wYA;LX/0wY8;Ljava/util/List;ZLX/01ej;LX/0eyj;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/Layout;)V
    ...
    iput p1, p0, LX/0wYF;->LL:I

    iput-object p2, p0, LX/0wYF;->LLILIL:LX/0wYA;

    iput-object p3, p0, LX/0wYF;->LLILL:LX/0wY8;

    iput-object p4, p0, LX/0wYF;->LLILLIZIL:Ljava/util/List;

    iput-boolean p5, p0, LX/0wYF;->LLILLJJLI:Z

    iput-object p6, p0, LX/0wYF;->LLILLL:LX/01ej;

    iput-object p7, p0, LX/0wYF;->LLILZ:LX/0eyj;

    iput-object p8, p0, LX/0wYF;->LLILZIL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/Layout;
...
.method public final run()V
    ...
    const-string v4, "LayoutView@2fe4.drawWindow$3"
    ...
    iget v5, p0, LX/0wYF;->LL:I

    iget-object v6, p0, LX/0wYF;->LLILIL:LX/0wYA;

    iget-object v7, p0, LX/0wYF;->LLILL:LX/0wY8;

    iget-object v8, p0, LX/0wYF;->LLILLIZIL:Ljava/util/List;

    iget-boolean v9, p0, LX/0wYF;->LLILLJJLI:Z

    iget-object v10, p0, LX/0wYF;->LLILLL:LX/01ej;

    iget-object v11, p0, LX/0wYF;->LLILZ:LX/0eyj;

    iget-object v12, p0, LX/0wYF;->LLILZIL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/Layout;
