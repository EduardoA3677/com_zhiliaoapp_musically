...
.field public final LLJLILLLLZIIL:LX/0mwW;
...
.field public final LLL:LX/0SxV;
...
.field public LLLIIIIL:Landroid/widget/RelativeLayout;

.field public LLLIIIL:LX/0mwS;

.field public LLLIIL:LX/0xD8;
...
.field public LLLILZLLLI:LX/0mvL;

.field public LLLIZZ:LX/0D84;

.field public LLLJ:LX/0xD8;

.field public LLLJIL:LX/0mvL;
...
.method public static constructor <clinit>()V
    ...
    sput-object v4, LX/0xAB;->LLLLILI:[LX/10fb;
...
.method public constructor <init>(LX/0scK;)V
    ...
    iput-object p1, p0, LX/0xAB;->LLJJIJIIJIL:LX/0scK;
    ...
    iput-object v0, p0, LX/0xAB;->LLJJIJIL:LX/05ta;
    ...
    iput-object v0, p0, LX/0xAB;->LLJJJ:LX/0SxV;

    const/4 v2, 0x1

    iput-boolean v2, p0, LX/0xAB;->LLJL:Z

    new-instance v0, LX/0mwW;

    invoke-direct {v0}, LX/0mwW;-><init>()V

    iput-object v0, p0, LX/0xAB;->LLJLILLLLZIIL:LX/0mwW;
    ...
    iput-object v0, p0, LX/0xAB;->LLJLL:LX/0SxV;
    ...
    iput-object v0, p0, LX/0xAB;->LLJLLIL:LX/0SxV;
    ...
    iput-object v0, p0, LX/0xAB;->LLJLLL:LX/05ta;
    ...
    iput-object v0, p0, LX/0xAB;->LLL:LX/0SxV;

    new-instance v1, Lkotlin/jvm/internal/AwS505S0100000_29;

    const/16 v0, 0x6b0

    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS505S0100000_29;-><init>(LX/0xAB;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, LX/0xAB;->LLLF:LX/05ta;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LX/0xAB;->LLLILZ:Ljava/util/List;
    ...
    iput-object v0, p0, LX/0xAB;->LLLJL:LX/05ta;

    iput-boolean v2, p0, LX/0xAB;->LLLL:Z
    ...
    iput-object v0, p0, LX/0xAB;->LLLLIILL:LX/05ta;

    sget-object v0, LX/0Pgk;->INSTANCE:LX/0Pgk;

    iput-object v0, p0, LX/0xAB;->LLLLIILLL:Ljava/util/List;

    return-void
.end method

.method public static final LLLLZIL(Lcom/ss/android/ugc/effectmanager/effect/model/Effect;LX/0mwI;Z)Z
    .locals 3
...
.method public final LLJILJIL(Z)V
    ...
    iget-object v1, p0, LX/0xAB;->LLJLILLLLZIIL:LX/0mwW;
...
.method public final LLLIZZ(Landroidx/lifecycle/LifecycleOwner;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;)V
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLLJLJLL()Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;
...
.method public final LLLJ()V
    ...
    iget-boolean v0, p0, LX/0xAB;->LLJL:Z

    if-nez v0, :cond_2

    iget v0, p0, LX/0xAB;->LLJLIL:F
    ...
    iget-object v0, p0, LX/0xAB;->LLLII:Landroid/widget/LinearLayout;
...
.method public final LLLJIL()V
    ...
    sget-object v0, LX/0xAL;->LL:LX/0xAL;
    ...
    sget-object v0, LX/0xAK;->LL:LX/0xAK;
    ...
    invoke-virtual {p0, v0}, LX/0xAB;->LLLLIL(Lcom/ss/android/ugc/aweme/audiorecord/AudioRecorderParam;)Z
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLLLLLLL()Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLLILLIL()Lcom/bytedance/ies/nle/editor_jni/NLEEditor;
    ...
    iget-object v0, p0, LX/0xAB;->LLLIIIL:LX/0mwS;
    ...
    invoke-direct {v2, p0, v6, v0}, Lkotlin/jvm/internal/AwS154S0110000_23;-><init>(LX/0xAB;ZI)V

    new-instance v1, Lkotlin/jvm/internal/AwS353S0200000_29;

    const/16 v0, 0x1f

    invoke-direct {v1, p0, v4, v0}, Lkotlin/jvm/internal/AwS353S0200000_29;-><init>(LX/0xAB;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;I)V
    ...
    :cond_4
    invoke-virtual {p0}, LX/0xAB;->LLLLILI()LX/0mwG;
    ...
    invoke-direct {v0, p0, v5, v6}, LX/0mZE;-><init>(LX/0xAB;LX/0mwI;Z)V
...
.method public final LLLL()V
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLL()LX/0SrW;
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLLLIL()LX/0x4w;
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLZI()V
    ...
    :goto_0
    iget-object v0, p0, LX/0xAB;->LLJJJJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    invoke-virtual {p0, v0, v2}, LX/0xAB;->LLLIZZ(Landroidx/lifecycle/LifecycleOwner;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;)V
    ...
    :cond_8
    invoke-virtual {p0}, LX/0xAB;->LLLLLZIL()V
...
.method public final LLLLII()V
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLLJIL()LX/0xAf;
    ...
    iget-object v1, p0, LX/0xAB;->LLJZ:Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, LX/0xAB;->LLJZIJLIL:Ljava/lang/String;
    ...
    iput-object v0, p0, LX/0xAB;->LLJZ:Ljava/lang/String;

    iput-object v0, p0, LX/0xAB;->LLJZIJLIL:Ljava/lang/String;
...
.method public final LLLLIIL(Lcom/ss/android/ugc/effectmanager/effect/model/Effect;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, LX/0xAB;->LLLZIL(Z)V
...
.method public final LLLLIILL(ILX/0mvL;)V
    ...
    :cond_4
    iget-object v0, p0, LX/0xAB;->LLLLIILLL:Ljava/util/List;
    ...
    invoke-virtual {p0, v3, p1, p2, v0}, LX/0xAB;->LLLLZLL(Ljava/util/List;ILX/0mvL;Z)V
...
.method public final LLLLIILLL(ILX/0mvL;)V
    ...
    invoke-virtual {v4}, LX/0xAB;->LLLLLILLIL()Lcom/bytedance/ies/nle/editor_jni/NLEEditor;
    ...
    invoke-virtual {v4}, LX/0xAB;->LLLLLJLJLL()Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;
    ...
    invoke-virtual {v4}, LX/0xAB;->LLLLJ()F
    ...
    invoke-virtual {v4, v9}, LX/0xAB;->LLLLIIIILLL(Ljava/util/List;)V

    invoke-virtual {v4, v8, v9}, LX/0xAB;->LLLLIIL(Lcom/ss/android/ugc/effectmanager/effect/model/Effect;Ljava/util/List;)V

    invoke-virtual {v4}, LX/0xAB;->LLLLILI()LX/0mwG;
    ...
    invoke-virtual {v4, v0, v9}, LX/0xAB;->LLLLLLLLL(Ljava/lang/String;Ljava/util/List;)Z

    move-result v5

    invoke-virtual {v4}, LX/0xAB;->LLLLLLIL()LX/0x4w;

    move-result-object v0

    new-instance v3, LX/0xAG;

    move v6, p1

    invoke-direct/range {v3 .. v9}, LX/0xAG;-><init>(LX/0xAB;ZILX/0mvL;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;Ljava/util/List;)V

    invoke-interface {v0, v9, v3}, LX/0x4w;->k72(Ljava/util/List;LX/0js6;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v4, LX/0xAB;->LLJZIJLIL:Ljava/lang/String;
...
.method public final LLLLIL(Lcom/ss/android/ugc/aweme/audiorecord/AudioRecorderParam;)Z
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLLL()I
...
.method public final LLLLILI()LX/0mwG;
    .locals 1
    ...
    iget-object v0, p0, LX/0xAB;->LLJJIJIL:LX/05ta;
...
.method public final LLLLJ()F
    ...
    iget-object v2, p0, LX/0xAB;->LLJLLIL:LX/0SxV;

    sget-object v1, LX/0xAB;->LLLLILI:[LX/10fb;
...
.method public final LLLLL()LX/0SrW;
    .locals 3

    iget-object v2, p0, LX/0xAB;->LLJLL:LX/0SxV;
...
.method public final LLLLLIL()Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    .locals 77

    invoke-virtual/range {p0 .. p0}, LX/0xAB;->LLLLLILLIL()Lcom/bytedance/ies/nle/editor_jni/NLEEditor;
    ...
    invoke-virtual/range {p0 .. p0}, LX/0xAB;->LLLLLLIL()LX/0x4w;
...
.method public final LLLLLILLIL()Lcom/bytedance/ies/nle/editor_jni/NLEEditor;
    .locals 1

    iget-object v0, p0, LX/0xAB;->LLLF:LX/05ta;
...
.method public final LLLLLJIL()LX/0xAf;
    .locals 1

    iget-object v0, p0, LX/0xAB;->LLLJL:LX/05ta;
...
.method public final LLLLLJLJLL()Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;
    .locals 3

    iget-object v2, p0, LX/0xAB;->LLJJJ:LX/0SxV;
...
.method public final LLLLLLIL()LX/0x4w;
    .locals 3

    iget-object v2, p0, LX/0xAB;->LLL:LX/0SxV;
...
.method public final LLLLLLLLL(Ljava/lang/String;Ljava/util/List;)Z
    .locals 3
...
.method public final LLLLLLLLLL()Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    .locals 78
    ...
    invoke-virtual {v2}, LX/0xAB;->LLLLL()LX/0SrW;
    ...
    invoke-interface {v4}, LX/0I43;->LJII()Ljava/util/List;
    ...
    :goto_0
    iget-object v4, v2, LX/0xAB;->LLJJL:LX/0Su1;
    ...
    invoke-static {v4}, LX/0Fz4;->LJFF(Lcom/bytedance/ies/nle/editor_jni/NLEModel;)Z
    ...
    iput-object v9, v2, LX/0xAB;->LLLILZLLLI:LX/0mvL;
    ...
    :cond_1
    invoke-virtual {v2}, LX/0xAB;->LLLLLJLJLL()Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;
    ...
    iget-object v4, v4, Lcom/ss/android/ugc/aweme/creative/model/StreamVoiceConversionModel;->vcEffectId:Ljava/lang/String;
    ...
    invoke-static {v4}, LX/0SfT;->LJJJJL(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;)Z

    move-result v4

    if-nez v4, :cond_7

    invoke-virtual {v2}, LX/0xAB;->LLLLLIL()Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    new-instance v5, LX/0mvL;

    const/16 v4, 0x7fe

    invoke-direct {v5, v6, v3, v4}, LX/0mvL;-><init>(Lcom/ss/android/ugc/effectmanager/effect/model/Effect;II)V

    iput-object v5, v2, LX/0xAB;->LLLILZLLLI:LX/0mvL;
    ...
    invoke-virtual {v6, v4}, Lcom/ss/android/ugc/effectmanager/effect/model/Effect;->setUnzipPath(Ljava/lang/String;)V

    invoke-virtual {v5}, Lcom/ss/android/ugc/aweme/shortvideo/edit/audioeffect/AudioEffectParam;->getUploadId()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v6, v4}, Lcom/ss/android/ugc/effectmanager/effect/model/Effect;->setEffectId(Ljava/lang/String;)V
...
.method public final LLLLLLLZIL(II)V
    .locals 5
    ...
    iget-object v0, p0, LX/0xAB;->LLLIILIL:Landroid/view/View;
    ...
    iget-boolean v0, p0, LX/0xAB;->LLJJLIIIJLLLLLLLZ:Z
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLJ()V
...
.method public final LLLLLZ()V
    ...
    iget-boolean v0, p0, LX/0xAB;->LLLL:Z
    ...
    :goto_0
    iput-boolean v0, p0, LX/0xAB;->LLLLII:Z
...
.method public final LLLLLZIL()V
    ...
    :goto_0
    iget-object v4, p0, LX/0xAB;->LLJJJJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    invoke-virtual {p0}, LX/0xAB;->LLLLJ()F
    ...
    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS572S0100000_29;-><init>(LX/0xAB;I)V
...
.method public final LLLLLZL()Z
    ...
    iget-object v0, p0, LX/0xAB;->LLLILZLLLI:LX/0mvL;
    ...
    invoke-virtual {p0, v1, v0}, LX/0xAB;->LLLLIILLL(ILX/0mvL;)V
    ...
    invoke-virtual {p0, v1, v0}, LX/0xAB;->LLLLIILL(ILX/0mvL;)V
...
.method public final LLLLZLL(Ljava/util/List;ILX/0mvL;Z)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2, v5}, LX/0xAB;->LLLLIIIILLL(Ljava/util/List;)V

    invoke-virtual {v2, v6, v5}, LX/0xAB;->LLLLIIL(Lcom/ss/android/ugc/effectmanager/effect/model/Effect;Ljava/util/List;)V

    invoke-virtual {v2}, LX/0xAB;->LLLLILI()LX/0mwG;
    ...
    invoke-virtual {v2, v0, v5}, LX/0xAB;->LLLLLLLLL(Ljava/lang/String;Ljava/util/List;)Z
    ...
    new-instance v1, LX/0xAE;

    move v8, p4

    move v4, p2

    invoke-direct/range {v1 .. v8}, LX/0xAE;-><init>(LX/0xAB;ZILjava/util/List;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;LX/0mvL;Z)V

    invoke-interface {v0, v5, v1}, LX/0x4w;->k72(Ljava/util/List;LX/0js6;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v2, LX/0xAB;->LLJZ:Ljava/lang/String;

    return-void
.end method

.method public final LLLLZLLIL(Lcom/ss/android/ugc/aweme/audiorecord/AudioRecorderParam;Z)V
    .locals 7
    ...
    iput-object v0, p0, LX/0xAB;->LLJJJJJIL:Landroid/view/View;

    invoke-virtual {p0, p1}, LX/0xAB;->LLLLIL(Lcom/ss/android/ugc/aweme/audiorecord/AudioRecorderParam;)Z
    ...
    iget-object v0, p0, LX/0xAB;->LLJJJJJIL:Landroid/view/View;
    ...
    :cond_2
    iget-object v0, p0, LX/0xAB;->LLLFZ:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iget-object v2, p0, LX/0xAB;->LLLII:Landroid/widget/LinearLayout;
...
.method public final LLLLZLLLI(Landroid/view/View;Z)V
    .locals 6
    ...
    iget-object v0, p0, LX/0xAB;->LLLI:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iput-object v0, p0, LX/0xAB;->LLLLIL:Ljava/lang/String;
...
.method public final LLLZ()V
    ...
    iget-object v0, p0, LX/0xAB;->LLLFFI:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iget-object v0, p0, LX/0xAB;->LLLFF:Landroid/view/View;
    ...
    iget-object v1, p0, LX/0xAB;->LLLFFI:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iget-object v5, p0, LX/0xAB;->LLLFFI:Lcom/bytedance/tux/input/TuxTextView;
...
.method public final LLLZI()V
    ...
    iget-object v3, p0, LX/0xAB;->LLLII:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, LX/0xAB;->LLLIIIIL:Landroid/widget/RelativeLayout;
...
.method public final LLLZIIL(IZ)V
    .locals 4
    ...
    iget-object v0, p0, LX/0xAB;->LLLJIL:LX/0mvL;
...
.method public final getDiContainer()LX/0scK;
    ...
    iget-object v0, p0, LX/0xAB;->LLJJIJIIJIL:LX/0scK;
...
.method public final onPause()V
    ...
    iput-boolean v0, p0, LX/0xAB;->LLLL:Z
...
.method public final onResume()V
    ...
    iget-boolean v0, p0, LX/0xAB;->LLLLII:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, LX/0xAB;->LLLLLZ()V
...
.method public final onShow()V
    ...
    iput-object v1, v0, LX/0xAB;->LLJJL:LX/0Su1;
    ...
    iput-boolean v6, v0, LX/0xAB;->LLJL:Z

    iget-boolean v1, v0, LX/0xAB;->LLJJJIL:Z

    if-eqz v1, :cond_1

    invoke-virtual {v0}, LX/0xAB;->LLLLZI()V
    ...
    invoke-virtual {v0}, LX/0xAB;->LLLJIL()V

    invoke-virtual {v0}, LX/0mt5;->LLLIIIL()LX/0mt0;

    move-result-object v2

    sget-object v1, LX/0xAQ;->LL:LX/0xAQ;
    ...
    invoke-virtual {v0, v1, v6}, LX/0xAB;->LLLLZLLIL(Lcom/ss/android/ugc/aweme/audiorecord/AudioRecorderParam;Z)V
    ...
    iput-object v1, v0, LX/0xAB;->LLLLIILLL:Ljava/util/List;
    ...
    iget-object v3, v0, LX/0xAB;->LLLLIILLL:Ljava/util/List;
    ...
    iput-boolean v5, v0, LX/0xAB;->LLJJJIL:Z
    ...
    iput-object v1, v0, LX/0xAB;->LLLIIIL:LX/0mwS;
    ...
    iput-object v1, v0, LX/0xAB;->LLLFF:Landroid/view/View;

    iget-object v2, v0, LX/0xAB;->LLLIIIL:LX/0mwS;
    ...
    :cond_4
    iget-object v1, v0, LX/0xAB;->LLLLIILL:LX/05ta;
    ...
    iget-object v9, v0, LX/0xAB;->LLLIIIL:LX/0mwS;
    ...
    invoke-direct {v8, v0, v1}, Lkotlin/jvm/internal/AwS604S0100000_29;-><init>(LX/0xAB;I)V
    ...
    iput-object v1, v0, LX/0xAB;->LLLFFI:Lcom/bytedance/tux/input/TuxTextView;

    iget-object v7, v0, LX/0xAB;->LLLIIIL:LX/0mwS;
    ...
    iput-object v1, v0, LX/0xAB;->LLLII:Landroid/widget/LinearLayout;
    ...
    iget-object v2, v0, LX/0xAB;->LLLII:Landroid/widget/LinearLayout;
    ...
    iget-object v7, v0, LX/0xAB;->LLLII:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v2, v0, v1}, Lkotlin/jvm/internal/AwS505S0100000_29;-><init>(LX/0xAB;I)V
    ...
    iput-object v1, v0, LX/0xAB;->LLLI:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iput-object v1, v0, LX/0xAB;->LLLIIII:Lcom/bytedance/tux/icon/TuxIconView;
    ...
    iput-object v1, v0, LX/0xAB;->LLLILZJ:Lcom/bytedance/tux/icon/TuxIconView;
    ...
    iput-object v1, v0, LX/0xAB;->LLLFZ:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iput-object v1, v0, LX/0xAB;->LLLIZZ:LX/0D84;
    ...
    iput-object v1, v0, LX/0xAB;->LLLJ:LX/0xD8;
    ...
    iput-object v3, v0, LX/0xAB;->LLLIIIIL:Landroid/widget/RelativeLayout;
    ...
    sget-object v3, LX/0x8a;->LL:LX/0x8a;

    new-instance v2, Lkotlin/jvm/internal/AwS539S0100000_29;

    const/16 v1, 0x9e

    invoke-direct {v2, v0, v1}, Lkotlin/jvm/internal/AwS539S0100000_29;-><init>(LX/0xAB;I)V
    ...
    sget-object v3, LX/0xAS;->LL:LX/0xAS;
    ...
    sget-object v1, LX/0xAT;->LL:LX/0xAT;
    ...
    iget-object v2, v0, LX/0xAB;->LLLIIIIL:Landroid/widget/RelativeLayout;
    ...
    invoke-virtual {v0, v2, v5}, LX/0xAB;->LLLLZLLLI(Landroid/view/View;Z)V

    invoke-virtual {v0, v4}, Lcom/bytedance/scene/Scene;->requireViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, LX/0xD8;

    iput-object v2, v0, LX/0xAB;->LLLIIL:LX/0xD8;
    ...
    :cond_10
    new-instance v1, LX/0xAa;

    invoke-direct {v1, v0}, LX/0xAa;-><init>(LX/0xAB;)V

    invoke-virtual {v2, v1}, LX/0xD8;->setOnSliderListener(LX/0xD9;)V

    iget-object v2, v0, LX/0xAB;->LLLIIL:LX/0xD8;
    ...
    :goto_4
    invoke-virtual {v2, v1}, LX/0xD8;->setMax(I)V
    ...
    :cond_12
    invoke-virtual {v1, v6}, LX/0xD8;->setMin(I)V
    ...
    :cond_13
    invoke-virtual {v1, v6}, LX/0xD8;->setIndicator(I)V

    invoke-virtual {v0}, LX/0mt5;->LLLIIIL()LX/0mt0;

    move-result-object v4

    sget-object v3, LX/0x8d;->LL:LX/0x8d;
    ...
    iget-object v1, v0, LX/0xAB;->LLJLLL:LX/05ta;
    ...
    iget-object v3, v0, LX/0xAB;->LLLFF:Landroid/view/View;
    ...
    sget-object v3, LX/0x8i;->LL:LX/0x8i;
    ...
    sget-object v3, LX/0x8k;->LL:LX/0x8k;
    ...
    sget-object v3, LX/0x8b;->LL:LX/0x8b;

    new-instance v2, Lkotlin/jvm/internal/AwS512S0100000_2;

    const/16 v1, 0xe4

    invoke-direct {v2, v0, v1}, Lkotlin/jvm/internal/AwS512S0100000_2;-><init>(LX/0xAB;I)V
    ...
    sget-object v3, LX/0x8c;->LL:LX/0x8c;
    ...
    invoke-direct {v1}, LX/0mZH;-><init>()V
    ...
    :cond_17
    iget-object v1, v0, LX/0xAB;->LLJLILLLLZIIL:LX/0mwW;
    ...
    iget-object v2, v0, LX/0xAB;->LLJLILLLLZIIL:LX/0mwW;

    new-instance v1, LX/0mZD;

    invoke-direct {v1, v0, v7}, LX/0mZD;-><init>(LX/0xAB;LX/0mZB;)V
    ...
    iput-object v1, v0, LX/0xAB;->LLLIILIL:Landroid/view/View;
    ...
    iget-object v1, v0, LX/0xAB;->LLLIILIL:Landroid/view/View;
    ...
    new-instance v2, LX/0wwg;

    invoke-direct {v2, v1}, LX/0wwg;-><init>(Ljava/util/List;)V
    ...
    :goto_6
    iput-object v14, v0, LX/0xAB;->LLJJJJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    iput-object v5, v0, LX/0xAB;->LLJJJJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    invoke-virtual {v0}, LX/0xAB;->LLLLJ()F
    ...
    invoke-direct {v2, v0, v1}, Lkotlin/jvm/internal/AwS572S0100000_29;-><init>(LX/0xAB;I)V
