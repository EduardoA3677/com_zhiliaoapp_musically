...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.choosemusic.model.CollectUnlimitedMusicDataRepo$loadMoreCollectUnlimitedMusic$1"
...
# direct methods
.method public constructor <init>(ILcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iput p1, p0, LX/0xqN;->LLILIL:I

    iput-object p2, p0, LX/0xqN;->LLILL:Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v2, LX/0xqN;

    iget v1, p0, LX/0xqN;->LLILIL:I

    iget-object v0, p0, LX/0xqN;->LLILL:Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;

    invoke-direct {v2, v1, v0, p2}, LX/0xqN;-><init>(ILcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v16, "CollectUnlimitedMusicDataRepo@2cb4.loadMoreCollectUnlimitedMusic$1"
    ...
    :cond_2
    sput-boolean v14, LX/0xpM;->LIZ:Z

    :try_start_0
    sget-object v2, Lcom/ss/android/ugc/aweme/choosemusic/api/UnlimitedMusicApi;->LIZ:Lcom/ss/android/ugc/aweme/choosemusic/api/UnlimitedMusicApi;

    iget v1, v6, LX/0xqN;->LLILIL:I

    iput v14, v6, LX/0xqN;->LL:I

    const/16 v0, 0x14

    invoke-virtual {v2, v1, v0, v6}, Lcom/ss/android/ugc/aweme/choosemusic/api/UnlimitedMusicApi;->LIZ(IILX/02wT;)Ljava/lang/Object;
    ...
    sput-boolean v10, LX/0xpM;->LIZ:Z
    ...
    iget-object v0, v6, LX/0xqN;->LLILL:Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;

    invoke-direct {v1, v0, v3}, LX/0QFL;-><init>(Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;LX/02wT;)V

    iput v9, v6, LX/0xqN;->LL:I
    ...
    :cond_7
    iget-object v1, v6, LX/0xqN;->LLILL:Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;
    ...
    check-cast v13, LX/0xsf;

    invoke-static {v13}, LX/0xpu;->LIZJ(LX/0xsf;)Ljava/util/List;
    ...
    invoke-static {v2, v3, v1, v0}, LX/0xqi;->LIZJ(Ljava/util/List;Ljava/util/List;Lcom/ss/android/ugc/aweme/base/api/BaseResponse$ServerTimeExtra;Ljava/lang/Boolean;)Ljava/util/List;
    ...
    :cond_9
    invoke-static {v13}, LX/0xpu;->LIZ(LX/0xsf;)Ljava/util/List;
    ...
    new-instance v1, LX/0QFP;

    iget-object v0, v6, LX/0xqN;->LLILL:Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;

    invoke-direct {v1, v0, v7, v3}, LX/0QFP;-><init>(Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;LX/0xsf;LX/02wT;)V

    iput v8, v6, LX/0xqN;->LL:I
    ...
    invoke-direct {v1, v0, v3}, LX/0QFM;-><init>(Lcom/ss/android/ugc/aweme/arch/widgets/base/DataCenter;LX/02wT;)V

    iput v4, v6, LX/0xqN;->LL:I
