...
# direct methods
.method public constructor <init>(ILX/0wdy;LX/0wOM;Z)V
    .locals 1

    iput p1, p0, LX/0wOO;->LL:I

    iput-object p2, p0, LX/0wOO;->LLILIL:LX/0wdy;

    iput-object p3, p0, LX/0wOO;->LLILL:LX/0wOM;

    iput-boolean p4, p0, LX/0wOO;->LLILLIZIL:Z
...
.method public final invoke()Ljava/lang/Object;
    ...
    const-string v0, "onUserListChanged"
    ...
    iget-object v0, p0, LX/0wOO;->LLILIL:LX/0wdy;
    ...
    iget-object v0, p0, LX/0wOO;->LLILL:LX/0wOM;
    ...
    invoke-interface {v0, v3, v8}, LX/02V7;->l(Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object v0, v0, LX/0wOM;->LJIILL:LX/0wOR;
    ...
    iget-boolean v0, v0, LX/0wOM;->LIZIZ:Z
    ...
    iget-object v0, v0, LX/0wOM;->LJIILLIIL:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v0}, Ljava/util/concurrent/ConcurrentHashMap;->clear()V

    iget-object v6, p0, LX/0wOO;->LLILL:LX/0wOM;
    ...
    iget-object v3, v6, LX/0wOM;->LJIILLIIL:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-static {v4, v5}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v2

    iget-object v0, v6, LX/0wOM;->LIZLLL:LX/0wO0;

    if-eqz v0, :cond_2

    invoke-interface {v0, v4, v5}, LX/0wO0;->LJJJJZ(J)Ljava/lang/Long;
    ...
    iget-object v5, p0, LX/0wOO;->LLILIL:LX/0wdy;
    ...
    :cond_5
    invoke-virtual {v6, v5, v3}, LX/0wOM;->LIZIZ(LX/0wdy;Ljava/util/List;)V

    :cond_6
    iget v1, p0, LX/0wOO;->LL:I

    if-nez v1, :cond_7

    iget-boolean v0, p0, LX/0wOO;->LLILLIZIL:Z

    if-eqz v0, :cond_7

    iget-object v1, p0, LX/0wOO;->LLILL:LX/0wOM;
