...
# instance fields
.field public LJIJ:Ltikcast/api/anchor_data/FinishEncourageLiveGoal;
...
.method public final LIZIZ(IILjava/lang/Object;)V
    ...
    instance-of v0, p3, Ltikcast/api/anchor_data/FinishEncourageLiveGoal;

    if-eqz v0, :cond_7

    check-cast p3, Ltikcast/api/anchor_data/FinishEncourageLiveGoal;

    if-eqz p3, :cond_7

    iput-object p3, p0, LX/0x6s;->LJIJ:Ltikcast/api/anchor_data/FinishEncourageLiveGoal;

    iget-object v4, p0, LX/0x6s;->LJIJJ:LX/13dw;

    if-eqz v4, :cond_0

    new-instance v3, LX/0y3e;

    const/4 v0, 0x5

    invoke-direct {v3, p0, v0}, LX/0y3e;-><init>(Ljava/lang/Object;I)V

    const/4 v2, 0x0

    const-string v1, "tiktok_live_broadcast_demand_12"

    const-string v0, "ttlive_finish_encourage_live_goal_weak.zip"

    invoke-static {v4, v1, v0, v2, v3}, LX/0fmy;->LJIILJJIL(LX/13dw;Ljava/lang/String;Ljava/lang/String;ZLX/0fn0;)V

    :cond_0
    iget-object v0, p0, LX/0x6s;->LJIJ:Ltikcast/api/anchor_data/FinishEncourageLiveGoal;

    if-eqz v0, :cond_1

    iget-object v3, v0, Ltikcast/api/anchor_data/FinishEncourageLiveGoal;->finishTitle:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, p0, LX/0x6s;->LJIJI:LX/12nN;
    ...
    :cond_3
    iget-object v2, p0, LX/0x6s;->LJIJI:LX/12nN;
    ...
    iget-object v0, p0, LX/0x6s;->LJIJI:LX/12nN;
...
.method public final LJFF()V
    ...
    :try_start_0
    iget-object v0, p0, LX/0x6s;->LJIJJ:LX/13dw;
...
.method public final LJIIIIZZ(Landroid/content/Context;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iput-object v0, p0, LX/0x6s;->LJIJI:LX/12nN;
    ...
    iput-object v0, p0, LX/0x6s;->LJIJJ:LX/13dw;
