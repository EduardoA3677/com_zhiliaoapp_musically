...
# direct methods
.method public constructor <init>(LX/01ej;LX/0xmv;Ljava/util/concurrent/ConcurrentHashMap;Lcom/ss/android/ugc/aweme/shortvideo/model/MusicModel;Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/List;Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/concurrent/ConcurrentHashMap;LX/01ej;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0xmu;->LIZ:LX/01ej;

    iput-object p2, p0, LX/0xmu;->LIZIZ:LX/0xmv;

    iput-object p3, p0, LX/0xmu;->LIZJ:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p4, p0, LX/0xmu;->LIZLLL:Lcom/ss/android/ugc/aweme/shortvideo/model/MusicModel;

    iput-object p5, p0, LX/0xmu;->LJ:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p6, p0, LX/0xmu;->LJFF:Ljava/util/List;

    iput-object p7, p0, LX/0xmu;->LJI:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p8, p0, LX/0xmu;->LJII:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p9, p0, LX/0xmu;->LJIIIIZZ:LX/01ej;
...
.method public final LIZ(Ljava/lang/String;Lcom/ss/android/ugc/aweme/shortvideo/model/MusicWaveBean;Ljava/lang/Boolean;)V
    ...
    iget-object v1, p0, LX/0xmu;->LIZJ:Ljava/util/concurrent/ConcurrentHashMap;

    iget-object v0, p0, LX/0xmu;->LIZLLL:Lcom/ss/android/ugc/aweme/shortvideo/model/MusicModel;
    ...
    iget-object v1, p0, LX/0xmu;->LJI:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v2, p0, LX/0xmu;->LJII:Ljava/util/concurrent/ConcurrentHashMap;

    iget-object v1, p0, LX/0xmu;->LIZLLL:Lcom/ss/android/ugc/aweme/shortvideo/model/MusicModel;
    ...
    :cond_1
    iget-object v2, p0, LX/0xmu;->LIZIZ:LX/0xmv;

    iget-object v0, p0, LX/0xmu;->LIZJ:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v0}, Ljava/util/concurrent/ConcurrentHashMap;->size()I

    move-result v1

    iget-object v0, p0, LX/0xmu;->LJ:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, LX/0xmu;->LJI:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_3
    iget-object v1, p0, LX/0xmu;->LIZIZ:LX/0xmv;
...
.method public final LIZJ(LX/0xn8;)V
    ...
    iget-object v1, p0, LX/0xmu;->LJ:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, LX/0xmu;->LIZIZ:LX/0xmv;
...
.method public final onCancel()V
    ...
    iget-object v1, p0, LX/0xmu;->LJIIIIZZ:LX/01ej;
...
.method public final onStart()V
    ...
    iget-object v1, p0, LX/0xmu;->LIZ:LX/01ej;
