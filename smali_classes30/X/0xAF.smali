...
# direct methods
.method public constructor <init>(LX/0xAC;ZILX/0mvL;Lcom/ss/android/ugc/effectmanager/effect/model/Effect;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0xAF;->LIZ:LX/0xAC;

    iput-boolean p2, p0, LX/0xAF;->LIZIZ:Z

    iput p3, p0, LX/0xAF;->LIZJ:I

    iput-object p4, p0, LX/0xAF;->LIZLLL:LX/0mvL;

    iput-object p5, p0, LX/0xAF;->LJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;

    iput-object p6, p0, LX/0xAF;->LJFF:Ljava/util/List;
...
.method public final LIZIZ(ILX/0js1;)V
    ...
    iget-object v0, p0, LX/0xAF;->LIZ:LX/0xAC;
    ...
    :cond_0
    iget-object v0, p0, LX/0xAF;->LIZLLL:LX/0mvL;
    ...
    iget-object v1, p0, LX/0xAF;->LIZ:LX/0xAC;

    const/4 v0, 0x0

    iput-object v0, v1, LX/0xAC;->LLL:Ljava/lang/String;

    iget-object v0, p0, LX/0xAF;->LJFF:Ljava/util/List;
...
.method public final LIZJ(II)V
    ...
    iget-boolean v0, p0, LX/0xAF;->LIZIZ:Z
...
.method public final LIZLLL(ILjava/util/List;)V
    ...
    iput v0, v1, LX/0xAC;->LLLLIILL:I

    invoke-virtual {v1}, LX/0xAC;->LLLZIIL()V
    ...
    iget-object v2, p0, LX/0xAF;->LIZ:LX/0xAC;

    iget-object v0, p0, LX/0xAF;->LJ:Lcom/ss/android/ugc/effectmanager/effect/model/Effect;
    ...
    iget-object v1, p0, LX/0xAF;->LIZLLL:LX/0mvL;

    const/4 v0, 0x2

    invoke-direct {v3, v6, v2, v1, v0}, Lkotlin/jvm/internal/AwS288S0300000_29;-><init>(LX/00zH;LX/0xAC;LX/0mvL;I)V
    ...
    iget-object v2, v1, LX/0xAC;->LLLIIII:Lcom/bytedance/tux/input/TuxTextView;
    ...
    iput-object v3, v0, LX/0xAC;->LLL:Ljava/lang/String;
