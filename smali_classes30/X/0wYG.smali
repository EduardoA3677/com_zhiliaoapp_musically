...
.method public constructor <init>(ILX/0wYA;LX/0wY8;Ljava/util/List;ZLX/01ej;LX/0eyj;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/Layout;)V
    ...
    iput p1, p0, LX/0wYG;->LL:I

    iput-object p2, p0, LX/0wYG;->LLILIL:LX/0wYA;

    iput-object p3, p0, LX/0wYG;->LLILL:LX/0wY8;

    iput-object p4, p0, LX/0wYG;->LLILLIZIL:Ljava/util/List;

    iput-boolean p5, p0, LX/0wYG;->LLILLJJLI:Z

    iput-object p6, p0, LX/0wYG;->LLILLL:LX/01ej;

    iput-object p7, p0, LX/0wYG;->LLILZ:LX/0eyj;

    iput-object p8, p0, LX/0wYG;->LLILZIL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/Layout;
...
.method public final run()V
    ...
    const-string v4, "LayoutView@2fe4.drawWindow$4"
    ...
    const-string v1, "LayoutView, post"
    ...
    iget v5, p0, LX/0wYG;->LL:I

    iget-object v6, p0, LX/0wYG;->LLILIL:LX/0wYA;

    iget-object v7, p0, LX/0wYG;->LLILL:LX/0wY8;

    iget-object v8, p0, LX/0wYG;->LLILLIZIL:Ljava/util/List;

    iget-boolean v9, p0, LX/0wYG;->LLILLJJLI:Z

    iget-object v10, p0, LX/0wYG;->LLILLL:LX/01ej;

    iget-object v11, p0, LX/0wYG;->LLILZ:LX/0eyj;

    iget-object v12, p0, LX/0wYG;->LLILZIL:Lcom/bytedance/android/livesdk/comp/api/linkcore/model/Layout;
