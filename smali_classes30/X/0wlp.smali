...
# instance fields
.field public final LJ:Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;
...
# direct methods
.method public constructor <init>(Landroid/view/View;Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;)V
    .locals 3

    sget-object v2, LX/0wlz;->ANCHOR_CUE:LX/0wlz;
    ...
    iput-object p2, p0, LX/0wlp;->LJ:Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;
    ...
    iput-object v0, p0, LX/0wlp;->LJIIJ:LX/05ta;
    ...
    iput-object v0, p0, LX/0wlp;->LJFF:LX/0d3Z;
    ...
    iput-object v0, p0, LX/0wlp;->LJI:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, LX/0wlp;->LJII:Landroid/widget/TextView;
    ...
    iput-object v0, p0, LX/0wlp;->LJIIIIZZ:Landroid/widget/TextView;
    ...
    iput-object v1, p0, LX/0wlp;->LJIIJJI:LY/ARunnableS85S0100000_29;
...
.method public final LIZIZ()Landroid/view/View;
    ...
    iget-object v0, p0, LX/0wlp;->LJI:Landroid/view/ViewGroup;
...
.method public final LJIIIZ(Lkotlin/jvm/internal/AwS139S0201000_29;)V
    ...
    iget-boolean v0, p0, LX/0wlp;->LJIIIZ:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/0wlp;->LJIIIZ:Z

    invoke-virtual {p0}, LX/0wlr;->LIZLLL()Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    move-result-object v5

    iget-object v0, p0, LX/0wlp;->LJ:Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;

    iget-object v6, v0, Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;->messageKey:Ljava/lang/String;
    ...
    iget-wide v0, p0, LX/0wlp;->LJIIL:J
    ...
    iget-object v8, v0, Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;->suggestionTemplateId:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, LX/0wlp;->LJIIJJI:LY/ARunnableS85S0100000_29;
    ...
    invoke-virtual {p0, v0}, LX/0wlp;->LJIIZILJ(Z)V
    ...
    iget-object v0, p0, LX/0wlp;->LJIIJ:LX/05ta;
...
.method public final LJIIJJI()V
    ...
    iput-wide v0, p0, LX/0wlp;->LJIIL:J

    iget-object v2, p0, LX/0wlp;->LJI:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, LX/0wlp;->LJIIJJI:LY/ARunnableS85S0100000_29;
...
.method public final LJIILIIL(LX/12vQ;)V
    ...
    iget-object v2, p0, LX/0wlp;->LJII:Landroid/widget/TextView;

    if-eqz v2, :cond_2

    iget-object v0, p0, LX/0wlp;->LJ:Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;

    iget-object v1, v0, Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;->title:Lcom/bytedance/android/livesdk/model/message/common/Text;
    ...
    :cond_2
    iget-object v1, p0, LX/0wlp;->LJIIIIZZ:Landroid/widget/TextView;

    if-eqz v1, :cond_3

    iget-object v0, p0, LX/0wlp;->LJ:Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;

    iget-object v0, v0, Lcom/bytedance/android/livesdk/model/message/AnchorReminderWordInfoMsg;->content:Ljava/lang/String;
...
.method public final LJIIZILJ(Z)V
    ...
    iget-object v0, p0, LX/0wlp;->LJFF:LX/0d3Z;
