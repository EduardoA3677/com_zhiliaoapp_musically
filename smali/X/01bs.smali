...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.ecommerce.base.osp.module.payment.PaymentInfoCell2$onBindItemView$9$orderSubmitPaymentItemView$1$4$1"
...
# direct methods
.method public constructor <init>(LX/01qf;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentMethod;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/module/payment/PaymentInfoCell2;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri$Builder;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/CommuteType;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/01bs;->LLILIL:LX/01qf;

    iput-object p2, p0, LX/01bs;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentMethod;

    iput-object p3, p0, LX/01bs;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/module/payment/PaymentInfoCell2;

    iput-object p4, p0, LX/01bs;->LLILLJJLI:Ljava/lang/String;

    iput-object p5, p0, LX/01bs;->LLILLL:Ljava/lang/String;

    iput-object p6, p0, LX/01bs;->LLILZ:Landroid/net/Uri$Builder;

    iput-object p7, p0, LX/01bs;->LLILZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/CommuteType;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v0, LX/01bs;

    iget-object v1, p0, LX/01bs;->LLILIL:LX/01qf;

    iget-object v2, p0, LX/01bs;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentMethod;

    iget-object v3, p0, LX/01bs;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/module/payment/PaymentInfoCell2;

    iget-object v4, p0, LX/01bs;->LLILLJJLI:Ljava/lang/String;

    iget-object v5, p0, LX/01bs;->LLILLL:Ljava/lang/String;

    iget-object v6, p0, LX/01bs;->LLILZ:Landroid/net/Uri$Builder;

    iget-object v7, p0, LX/01bs;->LLILZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/CommuteType;

    move-object v8, p2

    invoke-direct/range {v0 .. v8}, LX/01bs;-><init>(LX/01qf;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentMethod;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/module/payment/PaymentInfoCell2;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri$Builder;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/CommuteType;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v8, "PaymentInfoCell2@839a.onBindItemView$9$orderSubmitPaymentItemView$1$4$1"
    ...
    iget-object v2, v1, LX/01bs;->LLILIL:LX/01qf;

    invoke-virtual {v2}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v10

    iget-object v11, v1, LX/01bs;->LLILLJJLI:Ljava/lang/String;

    iget-object v12, v1, LX/01bs;->LLILLL:Ljava/lang/String;

    iget-object v2, v1, LX/01bs;->LLILZ:Landroid/net/Uri$Builder;

    invoke-virtual {v2}, Landroid/net/Uri$Builder;->toString()Ljava/lang/String;

    move-result-object v13

    iget-object v14, v1, LX/01bs;->LLILZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/CommuteType;

    const-string v15, "ordersubmit"

    iget-object v2, v1, LX/01bs;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentMethod;

    iget-object v3, v2, Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentMethod;->id:Ljava/lang/String;

    iget-object v2, v1, LX/01bs;->LLILLIZIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/module/payment/PaymentInfoCell2;
    ...
    iget-object v1, v1, LX/01bs;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentMethod;
    ...
    iget-object v3, v2, Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;->LLZLLLL:Ljava/lang/String;
