...
.method public constructor <init>(Landroid/content/Context;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;Ljava/lang/String;JLjava/lang/String;J)V
    ...
    iput-object p1, p0, LX/01bc;->LL:Landroid/content/Context;

    iput-object p2, p0, LX/01bc;->LLILIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;

    iput-object p3, p0, LX/01bc;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;

    iput-object p4, p0, LX/01bc;->LLILLIZIL:Ljava/lang/String;

    iput-wide p5, p0, LX/01bc;->LLILLJJLI:J

    iput-object p7, p0, LX/01bc;->LLILLL:Ljava/lang/String;

    iput-wide p8, p0, LX/01bc;->LLILZ:J
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, v0, LX/01bc;->LL:Landroid/content/Context;
    ...
    :cond_0
    iget-object v3, v0, LX/01bc;->LLILIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;
    ...
    iget-object v1, v0, LX/01bc;->LLILIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;
    ...
    iget-object v6, v0, LX/01bc;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;

    sget-object v1, LX/0vka;->LIZJ:LX/15Bj;

    new-instance v3, LX/01XT;

    iget-object v7, v0, LX/01bc;->LL:Landroid/content/Context;

    iget-object v8, v0, LX/01bc;->LLILIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;

    const/4 v9, 0x0

    invoke-direct/range {v3 .. v9}, LX/01XT;-><init>(JLcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;Landroid/content/Context;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;LX/02wT;)V
    ...
    :cond_2
    iget-object v3, v0, LX/01bc;->LL:Landroid/content/Context;
    ...
    iget-object v3, v0, LX/01bc;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;
    ...
    iget-object v9, v0, LX/01bc;->LLILIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;

    iget-object v8, v0, LX/01bc;->LLILLIZIL:Ljava/lang/String;

    iget-wide v3, v0, LX/01bc;->LLILLJJLI:J
    ...
    iget-object v6, v0, LX/01bc;->LL:Landroid/content/Context;
    ...
    iget-object v12, v0, LX/01bc;->LLILLIZIL:Ljava/lang/String;
    ...
    iget-object v7, v0, LX/01bc;->LLILLIZIL:Ljava/lang/String;
    ...
    :cond_8
    iget-object v4, v0, LX/01bc;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;
    ...
    iget-object v7, v0, LX/01bc;->LLILIL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/CreateOrderData;

    iget-object v8, v1, LX/01sM;->LLILLL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentInfo;

    iget-object v10, v0, LX/01bc;->LLILLIZIL:Ljava/lang/String;

    iget-object v11, v0, LX/01bc;->LLILLL:Ljava/lang/String;

    iget-wide v12, v0, LX/01bc;->LLILZ:J

    iget-wide v14, v0, LX/01bc;->LLILLJJLI:J
