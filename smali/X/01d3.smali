...
.method public constructor <init>(JLandroid/content/Context;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentInfo;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/Summary;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    iput-object p6, p0, LX/01d3;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;

    iput-object p3, p0, LX/01d3;->LLILIL:Landroid/content/Context;

    iput-object p4, p0, LX/01d3;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentInfo;

    iput-wide p1, p0, LX/01d3;->LLILLIZIL:J

    iput-object p5, p0, LX/01d3;->LLILLJJLI:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/Summary;

    iput-object p7, p0, LX/01d3;->LLILLL:Ljava/lang/Boolean;

    iput-object p9, p0, LX/01d3;->LLILZ:Ljava/lang/String;

    iput-object p8, p0, LX/01d3;->LLILZIL:Ljava/lang/Integer;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, v0, LX/01d3;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;

    iget-object v1, v0, LX/01d3;->LLILIL:Landroid/content/Context;
    ...
    invoke-virtual {v3, v1}, Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;->Rw2(Ljava/lang/String;)V

    iget-object v2, v0, LX/01d3;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;
    ...
    iget-object v5, v0, LX/01d3;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;

    const-string v6, "sdk_done"

    iget-object v7, v0, LX/01d3;->LLILL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentInfo;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v3

    iget-wide v1, v0, LX/01d3;->LLILLIZIL:J
    ...
    iget-object v10, v0, LX/01d3;->LLILLJJLI:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/repository/dto/Summary;

    iget-object v0, v0, LX/01d3;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;
    ...
    iget-object v1, v0, LX/01d3;->LL:Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;

    const/4 v3, 0x0

    const-string v5, "paypal process"
    ...
    invoke-static/range {v1 .. v8}, Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;->Lw2(Lcom/ss/android/ugc/aweme/ecommerce/base/osp/vm/OrderSubmitAssemViewModel;Lcom/ss/android/ugc/aweme/ecommerce/base/osp/payment/dto/PaymentInfo;ZZLjava/lang/String;ZZI)V
    ...
    iget-object v0, v0, LX/01d3;->LLILLL:Ljava/lang/Boolean;
    ...
    :cond_4
    iget-object v3, v0, LX/01d3;->LLILIL:Landroid/content/Context;

    iget-object v4, v0, LX/01d3;->LLILZ:Ljava/lang/String;

    iget-object v5, v0, LX/01d3;->LLILLL:Ljava/lang/Boolean;

    iget-object v6, v0, LX/01d3;->LLILZIL:Ljava/lang/Integer;

    iget-wide v0, v0, LX/01d3;->LLILLIZIL:J
