...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0ymN;->LLILLL:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, LX/0ymN;->LLILZ:Ljava/util/List;

    const-string v0, ""

    iput-object v0, p0, LX/0ymN;->LLILZIL:Ljava/lang/Object;

    iput-object v0, p0, LX/0ymN;->LLILZLL:Ljava/lang/Object;

    sget-object v0, LX/0yby;->LLILL:LX/0yby;

    iput-object v0, p0, LX/0ymN;->LLIZ:LX/0ycI;
...
.method public final bridge synthetic LIZJ(LX/0yk0;LX/0ycZ;)LX/0yl5;
    ...
    invoke-virtual {p0, p1, p2}, LX/0ymN;->LJIJJ(LX/0yk0;LX/0ycZ;)V
...
.method public final LIZLLL(LX/0ylL;)LX/0yl5;
    ...
    invoke-virtual {p0, p1}, LX/0ymN;->LJIJ(LX/0ymM;)V
...
.method public final LJIIZILJ()LX/0ymM;
    .locals 5

    new-instance v3, LX/0ymM;

    invoke-direct {v3, p0}, LX/0ymM;-><init>(LX/0ylR;)V

    iget v4, p0, LX/0ymN;->LLILLJJLI:I
    ...
    iget-object v0, p0, LX/0ymN;->LLILLL:Ljava/util/List;
    ...
    iget v0, p0, LX/0ymN;->LLILLJJLI:I

    and-int/lit8 v0, v0, -0x2

    iput v0, p0, LX/0ymN;->LLILLJJLI:I

    :cond_0
    iget-object v0, p0, LX/0ymN;->LLILLL:Ljava/util/List;

    iput-object v0, v3, LX/0ymM;->path_:Ljava/util/List;
    ...
    iget-object v0, p0, LX/0ymN;->LLILZ:Ljava/util/List;
    ...
    iput-object v0, v3, LX/0ymM;->span_:Ljava/util/List;
    ...
    :cond_2
    iget-object v0, p0, LX/0ymN;->LLILZIL:Ljava/lang/Object;

    iput-object v0, v3, LX/0ymM;->leadingComments_:Ljava/lang/Object;
    ...
    :cond_3
    iget-object v0, p0, LX/0ymN;->LLILZLL:Ljava/lang/Object;

    iput-object v0, v3, LX/0ymM;->trailingComments_:Ljava/lang/Object;
    ...
    iget-object v0, p0, LX/0ymN;->LLIZ:LX/0ycI;
    ...
    iput-object v0, v3, LX/0ymM;->leadingDetachedComments_:LX/0ycI;

    iput v2, v3, LX/0ymM;->bitField0_:I
...
.method public final LJIJ(LX/0ymM;)V
    .locals 2

    invoke-static {}, LX/0ymM;->getDefaultInstance()LX/0ymM;
    ...
    :cond_0
    iget-object v0, p1, LX/0ymM;->path_:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p1, LX/0ymM;->span_:Ljava/util/List;
    ...
    iget-object v0, p1, LX/0ymM;->leadingComments_:Ljava/lang/Object;
    ...
    iget-object v0, p1, LX/0ymM;->trailingComments_:Ljava/lang/Object;
    ...
    :cond_4
    iget-object v0, p1, LX/0ymM;->leadingDetachedComments_:LX/0ycI;
    ...
    iput-object v1, p0, LX/0ymN;->LLIZ:LX/0ycI;
    ...
    :cond_7
    iget-object v1, p0, LX/0ymN;->LLIZ:LX/0ycI;
    ...
    iput-object v1, p0, LX/0ymN;->LLILZ:Ljava/util/List;
    ...
    :cond_9
    iget-object v1, p0, LX/0ymN;->LLILZ:Ljava/util/List;
    ...
    iput-object v1, p0, LX/0ymN;->LLILLL:Ljava/util/List;
    ...
    :cond_b
    iget-object v1, p0, LX/0ymN;->LLILLL:Ljava/util/List;
...
.method public final LJIJJ(LX/0yk0;LX/0ycZ;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, LX/0ymN;->LJIJ(LX/0ymM;)V
    ...
    invoke-virtual {p0, v1}, LX/0ymN;->LJIJ(LX/0ymM;)V
...
.method public final build()LX/0ylL;
    ...
    invoke-virtual {p0}, LX/0ymN;->LJIIZILJ()LX/0ymM;
