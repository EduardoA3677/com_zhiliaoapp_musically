...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0yms;->LLJI:Ljava/util/List;

    sget-boolean v0, LX/0ylO;->alwaysUseFieldBuilders:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, LX/0yms;->LJJ()LX/0ymI;
...
.method public final bridge synthetic LIZJ(LX/0yk0;LX/0ycZ;)LX/0yl5;
    ...
    invoke-virtual {p0, p1, p2}, LX/0yms;->LJJIFFI(LX/0yk0;LX/0ycZ;)V
...
.method public final LIZLLL(LX/0ylL;)LX/0yl5;
    ...
    invoke-virtual {p0, p1}, LX/0yms;->LJJI(LX/0ymr;)V
...
.method public final LJIL()LX/0ymr;
    .locals 5

    new-instance v3, LX/0ymr;

    invoke-direct {v3, p0}, LX/0ymr;-><init>(LX/0ylQ;)V

    iget v4, p0, LX/0yms;->LLILLL:I
    ...
    :cond_0
    iget v0, p0, LX/0yms;->LLILZ:I

    iput v0, v3, LX/0ymr;->ctype_:I
    ...
    :cond_1
    iget-boolean v0, p0, LX/0yms;->LLILZIL:Z

    iput-boolean v0, v3, LX/0ymr;->packed_:Z
    ...
    :cond_2
    iget v0, p0, LX/0yms;->LLILZLL:I

    iput v0, v3, LX/0ymr;->jstype_:I
    ...
    :cond_3
    iget-boolean v0, p0, LX/0yms;->LLIZ:Z

    iput-boolean v0, v3, LX/0ymr;->lazy_:Z
    ...
    :cond_4
    iget-boolean v0, p0, LX/0yms;->LLIZLLLIL:Z

    iput-boolean v0, v3, LX/0ymr;->deprecated_:Z
    ...
    :cond_5
    iget-boolean v0, p0, LX/0yms;->LLJ:Z

    iput-boolean v0, v3, LX/0ymr;->weak_:Z

    iget-object v0, p0, LX/0yms;->LLJIJIL:LX/0ymI;
    ...
    iget-object v0, p0, LX/0yms;->LLJI:Ljava/util/List;
    ...
    iget v0, p0, LX/0yms;->LLILLL:I

    and-int/lit8 v0, v0, -0x41

    iput v0, p0, LX/0yms;->LLILLL:I

    :cond_6
    iget-object v0, p0, LX/0yms;->LLJI:Ljava/util/List;

    iput-object v0, v3, LX/0ymr;->uninterpretedOption_:Ljava/util/List;

    :goto_0
    iput v2, v3, LX/0ymr;->bitField0_:I
...
.method public final LJJ()LX/0ymI;
    ...
    iget-object v3, p0, LX/0yms;->LLJI:Ljava/util/List;
    ...
    iput-object v4, p0, LX/0yms;->LLJIJIL:LX/0ymI;
...
.method public final LJJI(LX/0ymr;)V
    .locals 2
    ...
    invoke-virtual {p1}, LX/0ymr;->getCtype()LX/0ymp;
    ...
    invoke-virtual {v1}, LX/0ymp;->getNumber()I

    move-result v0

    iput v0, p0, LX/0yms;->LLILZ:I
    ...
    iput-boolean v1, p0, LX/0yms;->LLILZIL:Z
    ...
    invoke-virtual {p1}, LX/0ymr;->getJstype()LX/0ymq;
    ...
    invoke-virtual {v1}, LX/0ymq;->getNumber()I

    move-result v0

    iput v0, p0, LX/0yms;->LLILZLL:I
    ...
    iput-boolean v1, p0, LX/0yms;->LLIZ:Z
    ...
    iput-boolean v1, p0, LX/0yms;->LLIZLLLIL:Z
    ...
    iput-boolean v1, p0, LX/0yms;->LLJ:Z
    ...
    iget-object v0, p1, LX/0ymr;->uninterpretedOption_:Ljava/util/List;
    ...
    iput-object v1, p0, LX/0yms;->LLJI:Ljava/util/List;
    ...
    :cond_9
    iget-object v1, p0, LX/0yms;->LLJI:Ljava/util/List;
    ...
    iput-object v1, p0, LX/0yms;->LLJIJIL:LX/0ymI;
    ...
    :cond_c
    iget-object v1, p0, LX/0yms;->LLJIJIL:LX/0ymI;
...
.method public final LJJIFFI(LX/0yk0;LX/0ycZ;)V
    ...
    invoke-virtual {p0, v0}, LX/0yms;->LJJI(LX/0ymr;)V
    ...
    invoke-virtual {p0, v1}, LX/0yms;->LJJI(LX/0ymr;)V
...
.method public final build()LX/0ylL;
    ...
    invoke-virtual {p0}, LX/0yms;->LJIL()LX/0ymr;
