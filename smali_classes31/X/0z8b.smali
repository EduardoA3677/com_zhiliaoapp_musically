...
# instance fields
.field public final synthetic LL:LX/0z8Y;


# direct methods
.method public constructor <init>(LX/0z8Y;)V
    .locals 0

    iput-object p1, p0, LX/0z8b;->LL:LX/0z8Y;
...
.method public final LIZ()J
    ...
    iget-object v0, p0, LX/0z8b;->LL:LX/0z8Y;

    iget-wide v0, v0, LX/0z8Y;->LLILLL:J
...
.method public final LIZIZ(Lcom/ttnet/org/chromium/net/n0;Ljava/nio/ByteBuffer;)V
    ...
    iget-object v0, v0, LX/0z8Y;->LLILZ:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, LX/0z8b;->LL:LX/0z8Y;

    iget-boolean v0, v1, LX/0z8Y;->LLIZLLLIL:Z

    if-nez v0, :cond_0

    iget-object v0, v1, LX/0z8Y;->LLILLJJLI:LX/0z0P;
    ...
    iget-object v2, v0, LX/0z8Y;->LLILZ:Ljava/nio/ByteBuffer;
...
.method public final LIZLLL(Lcom/ttnet/org/chromium/net/n0;)V
    ...
    iget-boolean v0, v1, LX/0z8Y;->LLIZ:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, v1, LX/0z8Y;->LLIZLLLIL:Z

    iget-object v0, v1, LX/0z8Y;->LLILZ:Ljava/nio/ByteBuffer;
