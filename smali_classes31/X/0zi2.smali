...
# interfaces
.implements Lcom/bef/effectsdk/GeneralParam$GetNetWorkInfo;
...
# virtual methods
.method public final checkUrl(Ljava/lang/String;)I
    .locals 3
    ...
    invoke-interface {v0, p1}, Lcom/ss/android/ugc/aweme/services/external/ability/IAVEffectService;->checkUrlValid(Ljava/lang/String;)I
...
.method public final getHeader(Ljava/lang/String;)Ljava/util/HashMap;
    .locals 6
    ...
    invoke-interface {v0}, LX/0SrJ;->LJI()V
    ...
    :cond_1
    invoke-interface {v3}, Lcom/ss/android/ugc/aweme/local_test/LocalTestApi;->enablePpe()Z
    ...
    invoke-interface {v3}, Lcom/ss/android/ugc/aweme/local_test/LocalTestApi;->getPPELane()Ljava/lang/String;
    ...
    :cond_4
    invoke-interface {v3}, Lcom/ss/android/ugc/aweme/local_test/LocalTestApi;->enableBoe()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-interface {v3}, Lcom/ss/android/ugc/aweme/local_test/LocalTestApi;->getBoeLane()Ljava/lang/String;
...
.method public final getParam(Ljava/lang/String;)Ljava/util/HashMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
