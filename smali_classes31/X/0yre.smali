...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILX/0yrh;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0yre;->LIZ:Ljava/lang/reflect/Method;

    iput p2, p0, LX/0yre;->LIZIZ:I

    iput-object p3, p0, LX/0yre;->LIZJ:LX/0yrh;
...
.method public final apply(Lcom/bytedance/retrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, LX/0yre;->LIZJ:LX/0yrh;
    ...
    invoke-virtual {p1, v5, v0}, Lcom/bytedance/retrofit2/RequestBuilder;->LIZ(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    iget-object v3, p0, LX/0yre;->LIZ:Ljava/lang/reflect/Method;

    iget v2, p0, LX/0yre;->LIZIZ:I
