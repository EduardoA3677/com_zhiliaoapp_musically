...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0ynH;->LLILZLL:Ljava/util/List;

    sget-boolean v0, LX/0ylO;->alwaysUseFieldBuilders:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, LX/0ynH;->LJJ()LX/0ymI;
...
.method public final bridge synthetic LIZJ(LX/0yk0;LX/0ycZ;)LX/0yl5;
    ...
    invoke-virtual {p0, p1, p2}, LX/0ynH;->LJJIFFI(LX/0yk0;LX/0ycZ;)V
...
.method public final LIZLLL(LX/0ylL;)LX/0yl5;
    ...
    invoke-virtual {p0, p1}, LX/0ynH;->LJJI(LX/0ynF;)V
...
.method public final LJIL()LX/0ynF;
    .locals 5

    new-instance v3, LX/0ynF;

    invoke-direct {v3, p0}, LX/0ynF;-><init>(LX/0ylQ;)V

    iget v4, p0, LX/0ynH;->LLILLL:I
    ...
    :cond_0
    iget-boolean v0, p0, LX/0ynH;->LLILZ:Z

    iput-boolean v0, v3, LX/0ynF;->allowAlias_:Z
    ...
    :cond_1
    iget-boolean v0, p0, LX/0ynH;->LLILZIL:Z

    iput-boolean v0, v3, LX/0ynF;->deprecated_:Z

    iget-object v0, p0, LX/0ynH;->LLIZ:LX/0ymI;
    ...
    iget-object v0, p0, LX/0ynH;->LLILZLL:Ljava/util/List;
    ...
    iget v0, p0, LX/0ynH;->LLILLL:I

    and-int/lit8 v0, v0, -0x5

    iput v0, p0, LX/0ynH;->LLILLL:I

    :cond_2
    iget-object v0, p0, LX/0ynH;->LLILZLL:Ljava/util/List;

    iput-object v0, v3, LX/0ynF;->uninterpretedOption_:Ljava/util/List;

    :goto_0
    iput v2, v3, LX/0ynF;->bitField0_:I
...
.method public final LJJ()LX/0ymI;
    ...
    iget-object v3, p0, LX/0ynH;->LLILZLL:Ljava/util/List;
    ...
    iput-object v4, p0, LX/0ynH;->LLIZ:LX/0ymI;
...
.method public final LJJI(LX/0ynF;)V
    .locals 2
    ...
    iput-boolean v1, p0, LX/0ynH;->LLILZ:Z
    ...
    iput-boolean v1, p0, LX/0ynH;->LLILZIL:Z
    ...
    iget-object v0, p1, LX/0ynF;->uninterpretedOption_:Ljava/util/List;
    ...
    iput-object v1, p0, LX/0ynH;->LLILZLL:Ljava/util/List;
    ...
    :cond_5
    iget-object v1, p0, LX/0ynH;->LLILZLL:Ljava/util/List;
    ...
    iput-object v1, p0, LX/0ynH;->LLIZ:LX/0ymI;
    ...
    :cond_8
    iget-object v1, p0, LX/0ynH;->LLIZ:LX/0ymI;
...
.method public final LJJIFFI(LX/0yk0;LX/0ycZ;)V
    ...
    invoke-virtual {p0, v0}, LX/0ynH;->LJJI(LX/0ynF;)V
    ...
    invoke-virtual {p0, v1}, LX/0ynH;->LJJI(LX/0ynF;)V
...
.method public final build()LX/0ylL;
    ...
    invoke-virtual {p0}, LX/0ynH;->LJIL()LX/0ynF;
