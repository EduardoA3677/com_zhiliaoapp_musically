...
# interfaces
.implements Lcom/bytedance/ies/xbridge/base/runtime/depend/IHostOpenDepend;
...
.method public static LIZIZ(Ljava/lang/String;Ljava/lang/String;ZLX/0Ur5;Z)V
    .locals 4
    ...
    invoke-direct {v0, p3, p0, p4, p1}, LX/0Ur3;-><init>(LX/0Ur5;Ljava/lang/String;ZLjava/lang/String;)V
...
# virtual methods
.method public final getGeckoInfo(Ljava/lang/String;Ljava/lang/String;LX/0zWi;)Lkotlin/Unit;
    .locals 8
    ...
    new-instance v6, LX/0zWg;

    invoke-virtual {v0}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v0

    invoke-direct {v6, v0}, LX/0zWg;-><init>(Z)V
    ...
    sget-object v0, LX/0z0Q;->OFFLINED:LX/0z0Q;

    iput-object v0, v6, LX/0zWg;->LJ:LX/0z0Q;

    iput-object v5, v6, LX/0zWg;->LIZLLL:Ljava/lang/Long;
    ...
    iput-object v0, v6, LX/0zWg;->LIZIZ:Ljava/lang/Long;
    ...
    iput-object v0, v6, LX/0zWg;->LIZJ:Ljava/lang/String;

    :cond_1
    invoke-interface {p3, v6}, LX/0zWi;->LIZ(LX/0zWg;)V
...
.method public final scanCode(LX/0WCV;ZLX/0zjj;)V
    .locals 4
    ...
    invoke-interface {p3}, LX/0zjj;->onFailure()V
    ...
    new-instance v1, LX/0zoR;

    invoke-direct {v1, p3}, LX/0zoR;-><init>(LX/0zjj;)V
    ...
    invoke-static {v3}, LX/0wAZ;->LIZ(Landroid/content/Context;)Landroid/app/Activity;
...
.method public final updateGecko(Ljava/lang/String;Ljava/lang/String;ZLX/0Ur5;Z)Lkotlin/Unit;
    .locals 7
    ...
    :try_start_0
    invoke-static {p2, p1, p5, p4, v5}, LX/0zoQ;->LIZIZ(Ljava/lang/String;Ljava/lang/String;ZLX/0Ur5;Z)V
    ...
    invoke-static {v0}, LX/0zoQ;->LIZ(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_2
    invoke-interface {p4}, LX/0Ur5;->LIZLLL()V
    ...
    invoke-interface {p4}, LX/0Ur5;->LIZJ()V
    ...
    :cond_5
    invoke-interface {p4}, LX/0Ur5;->LIZIZ()V
    ...
    :cond_6
    invoke-static {p2, p1, p5, p4, v6}, LX/0zoQ;->LIZIZ(Ljava/lang/String;Ljava/lang/String;ZLX/0Ur5;Z)V
    ...
    invoke-interface {p4, v0}, LX/0Ur5;->LIZ(Ljava/lang/Exception;)V
