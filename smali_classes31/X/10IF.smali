...
.field public LIZIZ:Lcom/lynx/tasm/service/ILynxImageService;
...
.method public constructor <init>(Ljava/lang/ref/WeakReference;)V
    ...
    iput-object p1, p0, LX/10IF;->LIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJFF(Ljava/lang/String;Ljava/io/InputStream;ILX/10IB;)V
    .locals 6
    ...
    invoke-virtual {p3, v4}, LX/10IB;->LIZIZ([B)V
    ...
    invoke-virtual {p3, v0}, LX/10IB;->LIZ(Ljava/lang/String;)V
...
.method public static LJII(Ljava/lang/String;Ljava/io/InputStream;ILX/10IB;)V
    .locals 4
    ...
    :cond_0
    :try_start_0
    iget-object v0, p3, LX/10IB;->LIZIZ:LX/10IE;
    ...
    :catch_0
    iget-object v1, p3, LX/10IB;->LIZIZ:LX/10IE;
...
.method public final LIZIZ(Ljava/lang/String;LX/0zEv;)V
    ...
    new-instance v5, LX/10IB;

    const/4 v0, 0x0

    invoke-direct {v5, p2, v0}, LX/10IB;-><init>(LX/0zEv;LX/10IA;)V
    ...
    const-string v0, "Load base64 type data url: "
    ...
    :cond_1
    invoke-static {p1}, LX/10IF;->LJI(Ljava/lang/String;)Ljava/lang/String;
...
.method public final LIZJ(Ljava/lang/String;LX/10I9;)V
    ...
    iget-object v0, p0, LX/10IF;->LIZIZ:Lcom/lynx/tasm/service/ILynxImageService;
    ...
    iput-object v0, p0, LX/10IF;->LIZIZ:Lcom/lynx/tasm/service/ILynxImageService;
    ...
    :cond_2
    new-instance v2, LX/10IL;

    invoke-direct {v2, v4, p2}, LX/10IL;-><init>(Ljava/lang/String;LX/10I9;)V
    ...
    new-instance v3, LX/10IB;

    const/4 v0, 0x0

    invoke-direct {v3, v2, v0}, LX/10IB;-><init>(LX/0zEv;LX/10IA;)V
...
.method public final LIZLLL(Ljava/lang/String;LX/10IA;)V
    ...
    new-instance v1, LX/10IB;

    const/4 v0, 0x0

    invoke-direct {v1, v0, p2}, LX/10IB;-><init>(LX/0zEv;LX/10IA;)V

    new-instance v0, LX/10Ca;

    invoke-direct {v0, v1}, LX/10Ca;-><init>(LX/10IB;)V
...
.method public final LJ(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, LX/10IF;->LIZ:Ljava/lang/ref/WeakReference;
    ...
    iget-object v2, v0, LX/109i;->LLJZIJLIL:LX/10Dp;
    ...
    const-string v0, "Redirect URL with LynxMediaResourceFetcher, the original url: "
    ...
    const-string v0, "Redirect URL with LynxMediaResourceFetcher return null url,  redirected url: "
    ...
    const-string v0, " failed because there is no LynxMediaResourceFetcher existed."
