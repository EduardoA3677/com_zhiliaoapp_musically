...
.method public getDynamic(Ljava/lang/String;)LX/104a;
    .locals 1

    sget-object v0, LX/104Y;->LIZJ:LX/0nje;

    invoke-virtual {v0}, LX/0nje;->acquire()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, LX/104Y;

    if-nez v0, :cond_0

    new-instance v0, LX/104Y;

    invoke-direct {v0}, LX/104Y;-><init>()V

    :cond_0
    iput-object p0, v0, LX/104Y;->LIZ:Lcom/bytedance/vmsdk/jsbridge/utils/ReadableMap;

    iput-object p1, v0, LX/104Y;->LIZIZ:Ljava/lang/String;
...
.method public getType(Ljava/lang/String;)Lcom/bytedance/vmsdk/jsbridge/utils/ReadableType;
    ...
    :cond_7
    instance-of v0, v3, LX/104a;

    if-eqz v0, :cond_8

    check-cast v3, LX/104a;

    invoke-interface {v3}, LX/104a;->getType()Lcom/bytedance/vmsdk/jsbridge/utils/ReadableType;
...
.method public keySetIterator()Lcom/bytedance/vmsdk/jsbridge/utils/ReadableMapKeySetIterator;
    ...
    new-instance v0, LX/104V;

    invoke-direct {v0, p0}, LX/104V;-><init>(Lcom/bytedance/vmsdk/jsbridge/utils/JavaOnlyMap;)V
...
.method public toArrayMap()LX/0yYT;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0, p0}, LX/0yYT;->putAll(Ljava/util/Map;)V
