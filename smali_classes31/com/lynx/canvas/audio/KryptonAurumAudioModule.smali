...
.field public static mLoadAurumSuccess:Z
...
.method public static onAudioStatusChange(Lcom/lynx/canvas/KryptonApp;I)V
    ...
    instance-of v0, v1, Lcom/lynx/canvas/audio/KryptonAurumAudioModule;

    if-eqz v0, :cond_5

    check-cast v1, Lcom/lynx/canvas/audio/KryptonAurumAudioModule;

    invoke-direct {v1}, Lcom/lynx/canvas/audio/KryptonAurumAudioModule;->getStatusListener()LX/10Hb;
...
.method public loadAudioEffectModule(Ljava/lang/String;)Z
    ...
    const-string v0, "Audio-effect module has already been loaded"
    ...
    const-string v0, "Load audio-effect module from plugin path "
    ...
    const-string v0, "kryptonaudioeffect"
    ...
    const-string v0, "Load audio-effect module failed. You can try to call load() after related plugin being loaded."
    ...
    const-string v0, "Load audio-effect from plugin success"
...
.method public loadAudioModule()Z
    ...
    const-string v0, "Load aurum audio module result "
...
.method public startAudioEngine(Lcom/lynx/canvas/KryptonApp;)Z
    ...
    const-string v0, "Aurum audio module has not been loaded"
    ...
    invoke-static {v0, v1}, Lcom/lynx/canvas/audio/KryptonAurumAudioModule;->nativeStartAudioEngine(J)Z
