...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0THU;->LIZ:Lcom/google/gson/Gson;
...
.method public static final LIZIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;LX/0Enn;)V
    ...
    invoke-static {p0, v2}, LX/0THU;->LJIIIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)I
    ...
    invoke-static {v0, v2}, LX/0THT;->LJIIJJI(Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;Ljava/lang/Boolean;)I
    ...
    invoke-static {v1, v0}, LX/0THT;->LJIIJJI(Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;Ljava/lang/Boolean;)I
    ...
    :goto_0
    const-string v0, "is_panel_sticker"

    invoke-virtual {p1, v0, v1}, LX/0Enn;->LJ(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "panel_sticker_interactive"

    invoke-virtual {p1, v4, v0}, LX/0Enn;->LIZ(ILjava/lang/String;)V

    const-string v0, "panel_sticker_info"

    invoke-virtual {p1, v3, v0}, LX/0Enn;->LIZ(ILjava/lang/String;)V

    const-string v1, "panel_sticker_type"

    invoke-static {p0, v2}, LX/0THU;->LJIIL(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v1, v0}, LX/0Enn;->LJ(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "panel_sticker_subtype"

    invoke-static {p0, v2}, LX/0THU;->LJIIJJI(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)Ljava/lang/String;
    ...
    iget v7, v8, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->infoStickerSubtype:I
    ...
    iget-object v1, v8, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->stickerId:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, LX/0THU;->LIZ(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    :cond_3
    iget v1, v8, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->type:I
    ...
    :cond_f
    invoke-static {v6, v2}, Lcom/bytedance/mt/protector/impl/GsonProtectorUtils;->toJson(Lcom/google/gson/Gson;Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    const-string v0, "panel_sticker_detail"
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->addYoursStickerModels:Ljava/util/List;

    invoke-direct {v1, v0}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    invoke-static {v1}, LX/0THU;->LJFF(Ljava/util/List;)Lkotlin/Pair;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->donationStickers:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->liveCountDownStickerModel:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->liveEventCountDownStickerModel:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->pollStickers:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->locationStickerModels:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->interactiveEmojiStickerModels:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->emojiSliderStickerModels:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->linkStickerModels:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->mentionStickerModel:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->hashtagStickerModel:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->musicStickerModels:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->commentStickerModels:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->aiCaptionTagStickers:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->textStickerModels:Ljava/util/List;
    ...
    invoke-static {v0}, LX/0THU;->LJFF(Ljava/util/List;)Lkotlin/Pair;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->socialAvatarStickerModels:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->articleStickers:Ljava/util/List;
    ...
    iget-object v2, v2, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->extra:Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lcom/ss/android/ugc/aweme/editSticker/text/bean/TextStickerData;->getEditCenterPoint()Landroid/graphics/Point;
    ...
    invoke-static {v0}, LX/0THU;->LJIIJ(Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;)Z
    ...
    invoke-static {v8, v1, v0}, Lcom/bytedance/mt/protector/impl/GsonProtectorUtils;->fromJson(Lcom/google/gson/Gson;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    const-string v0, "sticker_locations"
    ...
    invoke-static {p0}, LX/0SfX;->LLIIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/ss/android/ugc/aweme/creative/model/CreativeModel;->mixStickerInfo:Lcom/ss/android/ugc/aweme/feed/model/im/MixStickerInfo;
    ...
    :goto_9
    const-string v0, "is_studio_post"
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/feed/model/im/MixStickerInfo;->getType()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/feed/model/im/MixStickerInfo;->getData()Ljava/lang/String;
    ...
    const-string v0, "studio_text"

    invoke-virtual {p1, v0, v1}, LX/0Enn;->LJ(Ljava/lang/String;Ljava/lang/String;)V

    sget-object v9, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-static {p0, v9}, LX/0THU;->LJIIIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)I
    ...
    invoke-static {v0, v9}, LX/0THT;->LJIIJJI(Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;Ljava/lang/Boolean;)I
    ...
    const-string v0, "editor_pro_sticker_cnt"

    invoke-virtual {p1, v6, v0}, LX/0Enn;->LIZ(ILjava/lang/String;)V

    const-string v1, "editor_pro_sticker_info"
    ...
    iget v0, v1, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->infoStickerSubtype:I

    if-ne v0, v10, :cond_34

    invoke-static {v1, v9}, LX/0THU;->LJ(Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;Ljava/lang/Boolean;)Z
    ...
    :goto_10
    const-string v0, "editor_pro_sticker_diy_sticker_cnt"
    ...
    const-string v0, "editor_pro_sticker_type"

    invoke-virtual {p1, v0, v1}, LX/0Enn;->LJ(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "editor_pro_panel_sticker_subtype"
    ...
    :cond_38
    const-string v0, "is_edit_sticker"

    invoke-virtual {p1, v0, v5}, LX/0Enn;->LJ(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "edit_sticker_interactive"

    invoke-virtual {p1, v4, v0}, LX/0Enn;->LIZ(ILjava/lang/String;)V

    const-string v0, "edit_sticker_info"
    ...
    const-string v0, "edit_sticker_type"
    ...
    const-string v0, "edit_sticker_subtype"
...
.method public static final LIZJ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;LX/0Enn;)V
    ...
    invoke-static {p0}, LX/0THU;->LJI(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;)I

    move-result v1

    const-string v0, "at_prop_cnt"
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/tools/sticker/core/text/model/TextHashtagModel;->getText()Ljava/lang/String;
    ...
    :cond_2
    const-string v0, "under_edit_text_hashtag"
...
.method public static final LIZLLL(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;LX/0Enn;)V
    ...
    invoke-static {p0}, LX/0SfX;->LJIIIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;)Ljava/util/List;
    ...
    const-string v0, "(?i)(?<![a-zA-Z])pov(?![a-zA-Z])"
    ...
    :goto_1
    const-string v0, "add_edit_page_pov"
    ...
    iget-object v0, v0, LX/10iE;->LIZJ:Ljava/lang/String;
    ...
    :cond_9
    sget-object v0, LX/0THU;->LIZ:Lcom/google/gson/Gson;
...
.method public static final LJ(Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;Ljava/lang/Boolean;)Z
    .locals 3

    iget-object v1, p0, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->stickerSource:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->isFromEditorPro()Z
...
.method public static final LJFF(Ljava/util/List;)Lkotlin/Pair;
    .locals 4
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;->getLocationInfo()Ljava/lang/String;
...
.method public static final LJII(Ljava/util/List;)Ljava/lang/String;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v0, "interactive_emoji"
...
.method public static final LJIIIIZZ(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    .locals 2
    ...
    :cond_1
    sget-object v0, LX/0THW;->LIZ:Ljava/util/List;
...
.method public static final LJIIIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)I
    .locals 4
    ...
    invoke-static {v1, p1}, LX/0THU;->LJ(Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;Ljava/lang/Boolean;)Z
...
.method public static final LJIIJ(Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;)Z
    .locals 3
...
.method public static final LJIIJJI(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)Ljava/lang/String;
    .locals 14
    ...
    invoke-static {v1}, LX/0THU;->LJIIJ(Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;)Z
    ...
    iget v0, v0, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->infoStickerSubtype:I
    ...
    iget v1, v0, Lcom/ss/android/ugc/aweme/editSticker/model/StickerItemModel;->infoStickerSubtype:I
    ...
    iget-object v6, v0, Lcom/ss/android/ugc/aweme/creative/model/CreativeModel;->stickerModel:Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;
    ...
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->addYoursStickerModels:Ljava/util/List;
    ...
    :cond_14
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->donationStickers:Ljava/util/List;
    ...
    :cond_16
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->liveCountDownStickerModel:Ljava/util/List;
    ...
    :cond_18
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->liveEventCountDownStickerModel:Ljava/util/List;
    ...
    :cond_1b
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->pollStickers:Ljava/util/List;
    ...
    :cond_1d
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->locationStickerModels:Ljava/util/List;
    ...
    :cond_1f
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->interactiveEmojiStickerModels:Ljava/util/List;
    ...
    :cond_21
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->emojiSliderStickerModels:Ljava/util/List;
    ...
    :cond_23
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->linkStickerModels:Ljava/util/List;
    ...
    :cond_25
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->mentionStickerModel:Ljava/util/List;
    ...
    :cond_27
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->hashtagStickerModel:Ljava/util/List;
    ...
    :cond_29
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->musicStickerModels:Ljava/util/List;
    ...
    :cond_2b
    iget-object v0, v6, Lcom/ss/android/ugc/aweme/creative/model/stickers/StickerNewEngineModel;->socialAvatarStickerModels:Ljava/util/List;
    ...
    invoke-interface {v0, p0}, LX/0TE7;->LJFF(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;)Z
...
.method public static final LJIIL(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)Ljava/lang/String;
    .locals 5
    ...
    :cond_1
    invoke-static {p0, p1}, LX/0THU;->LJIIIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/Boolean;)I
