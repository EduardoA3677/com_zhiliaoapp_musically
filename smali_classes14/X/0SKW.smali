...
# instance fields
.field public final synthetic LIZ:Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;
...
.method public constructor <init>(Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;)V
    ...
    iput-object p1, p0, LX/0SKW;->LIZ:Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;
...
.method public final LIZ()V
    ...
    iget-object v0, p0, LX/0SKW;->LIZ:Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;

    iget-boolean v5, v0, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->LLIZLLLIL:Z
    ...
    invoke-direct {v2, v0, v5, v4, v1}, LX/0SKV;-><init>(Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;ZZLX/02wT;)V
...
.method public final LIZIZ(Lkotlin/jvm/internal/AwS489S0100000_13;)V
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->M2()LX/0Sr5;
...
.method public final LIZJ(Z)V
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->H3()LX/0Sq9;
...
.method public final LIZLLL()V
    ...
    iput-boolean v1, v0, Lcom/ss/android/ugc/aweme/creative/model/edit/EditSaveLocalModel;->isFromDMPanel:Z

    iget-object v0, p0, LX/0SKW;->LIZ:Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;

    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->U3()LX/0I5L;
    ...
    iget-boolean v0, v0, LX/0I5L;->LIZ:Z

    if-ne v0, v1, :cond_1

    iget-object v0, p0, LX/0SKW;->LIZ:Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;

    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->F3()LX/0Snr;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-interface {v0}, LX/0Snr;->rt0()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->y3()LX/0Sn0;
...
.method public final LJ(Z)V
    ...
    iput-boolean v5, v0, Lcom/ss/android/ugc/aweme/creative/model/edit/EditSaveLocalModel;->isFromQuickPublish:Z

    iput-boolean v5, v0, Lcom/ss/android/ugc/aweme/creative/model/edit/EditSaveLocalModel;->isFromDMPanel:Z
    ...
    invoke-virtual {v0}, LX/0Sn0;->LLLIIL()V

    iget-object v0, p0, LX/0SKW;->LIZ:Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;

    iget-boolean v4, v0, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->LLIZLLLIL:Z
    ...
    invoke-direct {v2, v0, v4, v5, v1}, LX/0SKU;-><init>(Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;ZZLX/02wT;)V
    ...
    :goto_1
    invoke-interface {v2, v4, v5, v1, v0}, Lcom/ss/android/ugc/gamora/editor/services/IDMCreativeEditService;->LJFF(IILcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Ljava/lang/String;)V
...
.method public final LJFF(Lcom/bytedance/tux/sheet/sheet/TuxSheet;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;->g4(Lcom/bytedance/tux/sheet/sheet/TuxSheet;)V
