...
.method public constructor <init>(Landroid/content/Context;LX/07Ge;LX/0mjC;Ljava/lang/String;)V
    ...
    iput-object p1, p0, LX/0TJT;->LIZJ:Landroid/content/Context;

    iput-object p4, p0, LX/0TJT;->LIZLLL:Ljava/lang/String;

    iput-object p3, p0, LX/0TJT;->LJ:LX/0mjC;
...
.method public final LIZ(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;)Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0TJT;->LIZLLL:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/location/LocationStickerModel;->getId()I
...
.method public final LIZIZ(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;)Landroid/view/View;
    ...
    iget-object v1, p0, LX/0TJT;->LIZJ:Landroid/content/Context;

    const/4 v0, 0x0

    invoke-direct {v2, v1, v0}, LX/0TJb;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/location/LocationStickerModel;->getUseCapsuleStyle()Z
    ...
    invoke-direct {v1, p0, v0}, Lkotlin/jvm/internal/AwS523S0100000_13;-><init>(LX/0TJT;I)V

    invoke-virtual {v2, v1}, LX/0TJb;->LJJJI(Lkotlin/jvm/functions/Function1;)V

    :cond_0
    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/location/LocationStickerModel;->getInteractStickerStruct()Lcom/ss/android/ugc/aweme/sticker/data/InteractStickerStruct;

    sget-object v0, LX/0NiA;->COMPILE:LX/0NiA;

    iput-object v0, v2, LX/0TJb;->LLJJJJJIL:LX/0NiA;
    ...
    iput-boolean v0, v2, LX/0TJb;->LLJJJJLIIL:Z

    invoke-virtual {v2}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/location/LocationStickerModel;->getTextSize()F
    ...
    invoke-virtual {v2, v0}, LX/0TJb;->LJJJJIZL(LX/0TJV;)V
...
.method public final LIZLLL(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;II)Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;
    ...
    invoke-virtual {v1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/location/LocationStickerModel;->getBaseStickerModel()Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;
