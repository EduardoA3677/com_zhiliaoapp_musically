...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v0, "sug_history.db"
...
.method public final onConfigure(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v0, "SELECT COUNT(*) FROM sug_history"
    ...
    const-string v0, "Database initialized. Total count: "
...
.method public final onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v0, "CREATE TABLE sug_history (\n    id INTEGER PRIMARY KEY AUTOINCREMENT,\n    content TEXT UNIQUE,\n    entity TEXT,\n    timestamp INTEGER\n)"
...
.method public final onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    const-string v0, "DROP TABLE IF EXISTS sug_history"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    :cond_0
    invoke-virtual {p0, p1}, LX/0Sax;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
