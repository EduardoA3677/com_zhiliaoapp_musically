.class public final Lcom/ss/android/ugc/aweme/storage/impl/AVMusicCacheStorage;
.super LX/0SbG;
.source "SourceFile"
...
.method public final LJIIIIZZ()Ljava/io/File;
    ...
    invoke-interface {v0}, LX/0lGe;->getCacheDir()Ljava/lang/String;
...
.method public final LJIIJ(Z)J
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/storage/impl/AVMusicCacheStorage;->LJIILLIIL()J

    move-result-wide v0

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/storage/impl/AVMusicCacheStorage;->LJIILL()Z
...
.method public final LJIILL()Z
    ...
    :cond_0
    new-instance v3, LX/0SKf;

    const/4 v2, 0x0

    const/4 v0, 0x3

    invoke-direct {v3, v2, v0}, LX/0SKf;-><init>(Ljava/util/Set;I)V

    new-instance v1, LX/0Sbd;

    invoke-direct {v1}, LX/0Sbd;-><init>()V

    invoke-virtual {v1, v3}, LX/0Sbd;->LIZ(LX/0Sbe;)V
    ...
    invoke-virtual {v3, v2}, LX/0SKf;->LIZIZ(Lkotlin/jvm/functions/Function0;)V
