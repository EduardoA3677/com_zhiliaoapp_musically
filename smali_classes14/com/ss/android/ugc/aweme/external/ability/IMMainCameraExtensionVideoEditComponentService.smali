.class public final Lcom/ss/android/ugc/aweme/external/ability/IMMainCameraExtensionVideoEditComponentService;
...
.method public final LIZ(LX/0Hfd;LX/0Snn;LX/0Ggd;LX/0GCM;)V
    ...
    invoke-interface {v0}, LX/0SUX;->isEnable()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v4, p3, LX/0Ggd;->LIZ:LX/0SoN;

    iget-object v5, p4, LX/0GCM;->LIZIZ:LX/0HpB;

    const-class v6, LX/0SUW;

    const-class v7, Lcom/ss/android/ugc/aweme/social/sendtodm/SendToDMComponent;
