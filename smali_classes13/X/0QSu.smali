...
.method public static constructor <clinit>()V
    ...
    const-string v1, "click_push_newvideo"

    const-string v2, "click_push_commentvideo"

    const-string v3, "click_push_commentvideo_reply"

    const-string v4, "click_push_videoat"

    const-string v5, "click_push_comment"

    const-string v6, "click_push_duet"
    ...
    sput-object v0, LX/0QSu;->LIZ:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    sput-object v0, LX/0QSu;->LIZJ:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, LX/0QSu;->LJ:Ljava/lang/Object;
...
.method public static LIZJ(Ljava/lang/String;)Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    .locals 8

    invoke-static {p0}, LX/0QSu;->LIZ(Ljava/lang/String;)LX/0XgT;
    ...
    new-instance v4, LX/0B92;

    new-instance v0, LX/0XgN;

    invoke-direct {v0, v3}, LX/0XgN;-><init>(Ljava/io/File;)V

    invoke-direct {v4, v0}, LX/0B92;-><init>(Ljava/io/Reader;)V
    :try_end_0
    ...
    invoke-virtual {v1, v4, v0}, Lcom/google/gson/Gson;->LJIIIIZZ(LX/0B92;Ljava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    const-string v0, "get aweme from cache succeed, awemeId: "
    ...
    const-string v0, "aweme cache is expired, awemeId: "
    ...
    invoke-virtual {v0, v5}, LX/0YCK;->LIZ(Ljava/io/Closeable;)V
