...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.share.improve.action.BaseCopyAction$copyToClipBoard$1$2$1$1"
    f = "BaseCopyAction.kt"
    l = {
        0xab
    }
...
.field public final synthetic LLILIL:LX/0h2y;
...
# direct methods
.method public constructor <init>(LX/0h2y;Landroid/content/Context;Landroid/app/Activity;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0QIk;->LLILIL:LX/0h2y;

    iput-object p2, p0, LX/0QIk;->LLILL:Landroid/content/Context;

    iput-object p3, p0, LX/0QIk;->LLILLIZIL:Landroid/app/Activity;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v3, LX/0QIk;

    iget-object v2, p0, LX/0QIk;->LLILIL:LX/0h2y;

    iget-object v1, p0, LX/0QIk;->LLILL:Landroid/content/Context;

    iget-object v0, p0, LX/0QIk;->LLILLIZIL:Landroid/app/Activity;

    invoke-direct {v3, v2, v1, v0, p2}, LX/0QIk;-><init>(LX/0h2y;Landroid/content/Context;Landroid/app/Activity;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v6, "BaseCopyAction@bb2c.copyToClipBoard$1$2$1$1"
    ...
    const-string v5, "share_outapp_finish"
    ...
    const-string v0, "copy_link_finish_profile"
    ...
    const-string v0, "copy_link_finish_not_story_not_transform"
    ...
    iget-object v0, p0, LX/0QIk;->LLILIL:LX/0h2y;

    iget-object v0, v0, LX/0h2y;->LL:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lcom/ss/android/ugc/aweme/unifiedauthapi/model/PopupFiltersConfig;->setLoginStatusCheck(I)V
    ...
    iget-object v0, p0, LX/0QIk;->LLILL:Landroid/content/Context;

    invoke-interface {v1, v0, v3, v4}, Lcom/ss/android/ugc/aweme/unifiedauthapi/push/IUniAuthGuidePopupApi;->LIZLLL(Landroid/content/Context;LX/11YQ;Lcom/ss/android/ugc/aweme/unifiedauthapi/model/UnifiedAuthPopupConfig;)Ljava/lang/Class;
    ...
    iget-object v3, p0, LX/0QIk;->LLILLIZIL:Landroid/app/Activity;
    ...
    invoke-direct {v2, v1, v0}, LX/0QIl;-><init>(Landroid/content/Context;LX/0h2y;)V

    invoke-interface {v4, v3, v5, v2}, Lcom/ss/android/ugc/awemepushapi/IPushPermissionApi;->LJIIIZ(Landroid/app/Activity;Ljava/lang/String;LX/0ZHQ;)V
