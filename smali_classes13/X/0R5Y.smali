...
.method public final LIZ(IILjava/lang/String;Z)LX/0R5P;
    ...
    sget-object v2, LX/0R65;->STORY:LX/0R65;
    ...
    new-instance v3, LX/0R5b;

    sget v4, LX/0R5Y;->LIZJ:I
    ...
    invoke-direct/range {v3 .. v8}, LX/0R5b;-><init>(IIIII)V
    ...
    invoke-virtual {v4, v3}, LX/0R5b;->LIZ(LX/0R5b;)LX/0R5b;
...
.method public final LIZIZ(Z)LX/0R5P;
    ...
    new-instance v7, LX/0R5P;

    new-instance v6, Landroid/view/ViewGroup$LayoutParams;

    sget v0, LX/0R5Y;->LIZ:I
    ...
    invoke-direct {v4, v3, v2, v1, v0}, LX/0R5b;-><init>(IIII)V

    const/4 v0, 0x0

    invoke-direct {v7, v6, v5, v4, v0}, LX/0R5P;-><init>(Landroid/view/ViewGroup$LayoutParams;Landroid/view/ViewGroup$LayoutParams;LX/0R5b;LX/0R5b;)V
