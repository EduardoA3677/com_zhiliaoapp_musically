...
# direct methods
.method public static LIZ(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Ljava/util/Collection;)I
    .locals 9

    const/4 v2, -0x1

    const-string v4, "DeleteAweme"
    ...
    invoke-static {p0}, Lcom/ss/android/ugc/aweme/feed/model/AwemeExtKt;->isLiveNoDeduplicate(Lcom/ss/android/ugc/aweme/feed/model/Aweme;)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-static {p0}, Lcom/ss/android/ugc/aweme/feed/model/AwemeExtKt;->isLiveNoDeduplicateClient(Lcom/ss/android/ugc/aweme/feed/model/Aweme;)Z
    ...
    invoke-static {v5}, Lcom/ss/android/ugc/aweme/feed/model/AwemeExtKt;->getUniqueId(Lcom/ss/android/ugc/aweme/feed/model/Aweme;)Ljava/lang/String;
    ...
    :cond_4
    const-string v0, "aweme is null or items is null, delete failed"
...
.method public static LIZIZ(Ljava/util/Collection;Lcom/ss/android/ugc/aweme/feed/model/Aweme;Ljava/util/List;)Z
    .locals 0
    ...
    invoke-static {p1, p0}, LX/0R0Q;->LIZ(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Ljava/util/Collection;)I

    move-result p0

    invoke-static {p1, p2, p0}, LX/0R0Q;->LJIILIIL(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Ljava/util/List;I)V
...
.method public static LIZLLL(Lcom/ss/android/ugc/aweme/feed/model/Aweme;)Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    .locals 1
...
.method public static LJ(Ljava/lang/String;)Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    ...
    invoke-interface {v0, p0}, Lcom/ss/android/ugc/aweme/awemeservice/api/IAwemeService;->Yn(Ljava/lang/String;)Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    ...
    const-string v0, "getAweme "

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, " is null, mock one"
...
.method public static LJFF(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Ljava/util/List;)I
    .locals 4
...
.method public static LJIIIIZZ(Lcom/ss/android/ugc/aweme/feed/model/Aweme;)V
    .locals 1

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/feed/model/DTOAweme;->getHotListStruct()Lcom/ss/android/ugc/aweme/profile/model/HotListStruct;
...
.method public static LJIIJJI(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Ljava/util/List;)I
    .locals 4
...
.method public static LJIILIIL(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Ljava/util/List;I)V
    .locals 3
    ...
    invoke-interface {v1, p2}, LX/0Qik;->w1(I)V

    invoke-interface {v1, p2, p0}, LX/0Qik;->t1(ILjava/lang/Object;)V
...
.method public static LJIILJJIL(Ljava/util/List;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1, p1}, LX/0Qik;->m3(Ljava/util/List;)V
