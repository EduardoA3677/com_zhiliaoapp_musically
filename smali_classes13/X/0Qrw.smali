...
.field public static LJIJJLI:Lcom/ss/android/ugc/aweme/feed/model/Aweme;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0Qrw;->LIZ:Ljava/util/HashMap;

    const-wide/16 v0, -0x1

    sput-wide v0, LX/0Qrw;->LJ:J

    sput-wide v0, LX/0Qrw;->LJFF:J
    ...
    sput-wide v0, LX/0Qrw;->LJIIIZ:J

    sput-wide v0, LX/0Qrw;->LJIIJ:J
...
.method public static LIZ(JJJZ)V
    .locals 3
    ...
    const-string v1, "start_time_from_open_app"
    ...
    const-string v0, "friends_tab_cold_start_delete_db_record"
...
.method public static LIZIZ(LX/0Qrz;)V
    .locals 4
    ...
    :goto_0
    const-string v0, "last_request_source"
    ...
    const-string v0, "is_number_count_changed"
    ...
    const-string v0, "is_avatar_response_changed"

    invoke-virtual {v3, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v0, "friends_tab_fetch_red_dot"
...
.method public static LIZJ(LX/0Qs0;)V
    .locals 3
    ...
    const-string v1, "last_view_item_id"
    ...
    const-string v0, "friends_feed_resp_monitor"
...
.method public static LIZLLL(LX/0Qs1;)V
    .locals 4
...
.method public static LJ(Z)V
    ...
    invoke-direct {v0, p0, v1, v2}, LX/0Qry;-><init>(ZJ)V
...
.method public static LJFF(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Lcom/ss/android/ugc/aweme/feed/model/Aweme;)V
    .locals 3
    ...
    invoke-direct {v0, p0, p1, v1, v2}, LX/0Qrx;-><init>(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Lcom/ss/android/ugc/aweme/feed/model/Aweme;J)V
...
.method public static LJI(LX/0MoP;ZLjava/lang/String;I)V
    .locals 2
    ...
    :cond_1
    sget-object v0, LX/0MoP;->FEED_LIST:LX/0MoP;

    const/4 v1, 0x1

    if-ne p0, v0, :cond_2

    sput-boolean v1, LX/0Qrw;->LJIIZILJ:Z

    :cond_2
    sget-object v0, LX/0MoP;->SKY_LIGHT:LX/0MoP;

    if-ne p0, v0, :cond_3

    sput-boolean v1, LX/0Qrw;->LJIJ:Z

    :cond_3
    sget-object v0, LX/0MoP;->EMPTY_PAGE:LX/0MoP;

    if-ne p0, v0, :cond_4

    sput-boolean v1, LX/0Qrw;->LJIJI:Z

    :cond_4
    sget-object v0, LX/0MoP;->ERROR_PAGE:LX/0MoP;

    if-ne p0, v0, :cond_5

    sput-boolean v1, LX/0Qrw;->LJIJJ:Z

    :cond_5
    sget-boolean v0, LX/0Qrw;->LJIJ:Z

    if-eqz v0, :cond_6

    sget-boolean v0, LX/0Qrw;->LJIIZILJ:Z

    if-eqz v0, :cond_6

    sget-object v0, LX/0Qrw;->LJIJJLI:Lcom/ss/android/ugc/aweme/feed/model/Aweme;

    invoke-static {v0, v0}, LX/0Qrw;->LJFF(Lcom/ss/android/ugc/aweme/feed/model/Aweme;Lcom/ss/android/ugc/aweme/feed/model/Aweme;)V
    ...
    sget-boolean v0, LX/0Qrw;->LJIJI:Z

    if-eqz v0, :cond_7

    invoke-static {p1}, LX/0Qrw;->LJ(Z)V
    ...
    sget-boolean v0, LX/0Qrw;->LJIJJ:Z
    ...
    sput-boolean v1, LX/0Qrw;->LJIILLIIL:Z

    new-instance v1, LY/ACallableS21S1000000_12;

    const/4 v0, 0x1

    invoke-direct {v1, p2, v0}, LY/ACallableS21S1000000_12;-><init>(Ljava/lang/String;I)V
