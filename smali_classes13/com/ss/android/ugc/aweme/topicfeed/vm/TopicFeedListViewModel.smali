.class public final Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LL:Z

    iput v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILIL:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILL:J

    const-string v0, "tiktok/feed/topic/v2"

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILLIZIL:Ljava/lang/String;

    const/4 v0, -0x1

    iput v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILLJJLI:I

    const-string v0, ""

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILLL:Ljava/lang/String;

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILZ:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILZLL:LX/02g4;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLIZ:Ljava/util/List;
...
.method public final defaultState()LX/00sA;
    ...
    invoke-direct {v1, v2, v0}, LX/0QeQ;-><init>(LX/0IqL;Z)V
...
.method public final hu2()Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    ...
    const-class v0, Lcom/ss/android/ugc/aweme/topicfeed/settings/TopicFeedConfig;

    sget-object v1, LX/0JUJ;->LIZ:Lcom/ss/android/ugc/aweme/topicfeed/settings/TopicFeedConfig;
    ...
    check-cast v0, Lcom/ss/android/ugc/aweme/topicfeed/settings/TopicFeedConfig;
    ...
    :cond_0
    iget-object v11, v1, Lcom/ss/android/ugc/aweme/topicfeed/settings/TopicFeedConfig;->bkgdVideo:Lcom/ss/android/ugc/aweme/topicfeed/settings/UrlStruct;
    ...
    iget-object v10, v11, Lcom/ss/android/ugc/aweme/topicfeed/settings/UrlStruct;->urlList:[Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Lcom/ss/android/ugc/aweme/base/model/UrlModel;->setUrlList(Ljava/util/List;)V

    iget-object v0, v11, Lcom/ss/android/ugc/aweme/topicfeed/settings/UrlStruct;->uri:Ljava/lang/String;
    ...
    :cond_3
    iget-object v4, v1, Lcom/ss/android/ugc/aweme/topicfeed/settings/TopicFeedConfig;->bkgdVideoCover:Lcom/ss/android/ugc/aweme/topicfeed/settings/UrlStruct;

    if-eqz v4, :cond_5

    iget-object v3, v4, Lcom/ss/android/ugc/aweme/topicfeed/settings/UrlStruct;->urlList:[Ljava/lang/String;
    ...
    iget-object v0, v4, Lcom/ss/android/ugc/aweme/topicfeed/settings/UrlStruct;->uri:Ljava/lang/String;
...
.method public final iu2(Lcom/ss/android/ugc/aweme/feed/model/FeedItemList;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLIZ:Ljava/util/List;
    ...
    :cond_1
    iget-object v1, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLIZ:Ljava/util/List;
...
.method public final ju2(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1}, Lcom/ss/android/ugc/aweme/feed/model/LogPbBean;->setImprId(Ljava/lang/String;)V
...
.method public final whenLoadMore(Ljava/lang/Object;LX/02wT;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILZLL:LX/02g4;
    ...
    :goto_0
    invoke-direct {v3, v2, v1, v5}, LX/0QrR;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Z)V

    iget v1, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILLJJLI:I

    iget-object v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LLILLIZIL:Ljava/lang/String;

    invoke-interface {v4, v3, v1, v0}, LX/0Qqg;->LJJ(LX/0QrR;ILjava/lang/String;)Lcom/ss/android/ugc/aweme/feed/model/FeedItemList;
    ...
    :cond_2
    invoke-virtual {p0, v4}, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->ku2(Lcom/ss/android/ugc/aweme/feed/model/FeedItemList;)V

    invoke-virtual {p0, v4}, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->iu2(Lcom/ss/android/ugc/aweme/feed/model/FeedItemList;)Ljava/util/List;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->ju2(Ljava/lang/String;Ljava/util/List;)V
...
.method public final whenRefresh(LX/02wT;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LL:Z
    ...
    invoke-virtual {p0}, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->hu2()Lcom/ss/android/ugc/aweme/feed/model/Aweme;
    ...
    invoke-interface {v3, v2, v1, v0}, LX/0Qqg;->LJJ(LX/0QrR;ILjava/lang/String;)Lcom/ss/android/ugc/aweme/feed/model/FeedItemList;

    move-result-object v4

    iput-boolean v5, p0, Lcom/ss/android/ugc/aweme/topicfeed/vm/TopicFeedListViewModel;->LL:Z
