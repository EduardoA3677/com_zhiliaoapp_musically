.class public final Lcom/ss/android/ugc/aweme/setting/ui/SettingContainerActivity;
...
# static fields
.field public static final _pnsPageId:Ljava/lang/String; = "KyohZzwgZiQiLT08ISFiPCgwZiQ7LCI2ZjYpPTs6HELIOSJiJiPCZ9GyA4PSY9LwYjJzsyISspOw4wPCw6IDsq"
...
.method public final onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {v0, p0}, Lcom/bytedance/router/fragment/NavigationUtils;->findTopFragment(LX/0t7j;)Landroidx/fragment/app/Fragment;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    const-string v5, "com.ss.android.ugc.aweme.setting.ui.SettingContainerActivity"
    ...
    invoke-virtual {p0, v0}, Lcom/ss/android/ugc/aweme/setting/ui/SettingContainerActivity;->setTheme(I)V
    ...
    invoke-static {p0}, Lcom/bytedance/router/SmartRouter;->fragmentNavigation(LX/0t7j;)Lcom/bytedance/router/fragment/FragmentRoute;

    move-result-object v1

    const-string v0, "//setting_scoped_compose_fragment"

    invoke-virtual {v1, v0, v3, v3}, Lcom/bytedance/router/fragment/FragmentRoute;->push(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;)Lcom/bytedance/router/fragment/FragmentRoute;
    ...
    invoke-virtual {v1, v0}, Lcom/bytedance/router/fragment/FragmentRoute;->withNavArg(Landroid/os/Parcelable;)Lcom/bytedance/router/fragment/FragmentRoute;

    invoke-virtual {p0}, Lcom/bytedance/ies/foundation/activity/BaseActivity;->getIntent()Landroid/content/Intent;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/bytedance/router/fragment/FragmentRoute;->withParam(Landroid/content/Intent;)Lcom/bytedance/router/fragment/FragmentRoute;
    ...
    invoke-direct {v2, v6}, LX/0PYI;-><init>(Z)V

    const-class v1, LX/0PYI;
    ...
    invoke-virtual {v1, v0}, LX/0uFV;->LIZ(Landroid/content/Intent;)V
...
.method public final onDestroy()V
    ...
    const-string v2, "enable_settings_consumption_track"
    ...
    sget-object v1, LX/0RjL;->LIZ:Ljava/util/Map;
    ...
    check-cast v3, LX/0RjM;

    new-instance v2, Lorg/json/JSONObject;

    invoke-direct {v2}, Lorg/json/JSONObject;-><init>()V

    iget v0, v3, LX/0RjM;->LIZ:I
    ...
    const-string v0, "consumptions"

    invoke-virtual {v1, v0, v2}, LX/0LPF;->LJIIIZ(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v1, LX/0LPF;->LIZ:Ljava/util/Map;

    const-string v0, "settings_consumption_report"
...
.method public final onResume()V
    ...
    const-string v2, "com.ss.android.ugc.aweme.setting.ui.SettingContainerActivity"
...
.method public final setTheme(I)V
    ...
    invoke-virtual {p0, v5}, Lcom/ss/android/ugc/aweme/setting/ui/SettingContainerActivity;->setTheme(I)V

    :goto_1
    if-eqz v7, :cond_5

    invoke-virtual {p0, v4}, Lcom/ss/android/ugc/aweme/setting/ui/SettingContainerActivity;->setTheme(I)V
    ...
    :cond_5
    invoke-virtual {p0, v3}, Lcom/ss/android/ugc/aweme/setting/ui/SettingContainerActivity;->setTheme(I)V

    goto :goto_2

    :cond_6
    invoke-virtual {p0, v6}, Lcom/ss/android/ugc/aweme/setting/ui/SettingContainerActivity;->setTheme(I)V
