...
.method public constructor <init>(LX/0TbB;)V
    ...
    iput-object p1, p0, LX/0TbO;->LL:LX/0TbB;
...
.method public final onAdaptiveResult(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/ss/ttlivestreamer/livestreamv2/ILiveStream$IAdaptiveResultReportCallBack;)V
    ...
    const-string v0, "onAdaptiveResult: "
    ...
    iget-object v0, p0, LX/0TbO;->LL:LX/0TbB;

    iget-object v0, v0, LX/0TbB;->LIZLLL:Lcom/ss/ttlivestreamer/livestreamv2/ILiveStream$ILiveStreamInfoListener;
...
.method public final onInfo(III)V
    ...
    new-instance v1, LX/0TrD;

    iget-object v0, p0, LX/0TbO;->LL:LX/0TbB;

    invoke-direct {v1, p1, v0, p2, p3}, LX/0TrD;-><init>(ILX/0TbB;II)V

    iget-object v0, v0, LX/0TbB;->LJIILL:Lm83/a;
    ...
    :goto_0
    invoke-interface {v2, v0}, LX/0TbK;->i(Ljava/lang/String;)V
    ...
    :cond_0
    const-string v0, "livesdk_live_push_stream_info"
    ...
    const-string v0, "starting_publish"
    ...
    const-string v0, "started_publish"
    ...
    const-string v0, "stoped_publish"
    ...
    const-string v0, "video_starting_capture"
    ...
    const-string v0, "video_started_capture"
    ...
    const-string v0, "video_stoped_capture"
    ...
    const-string v0, "audio_starting_capture"
    ...
    const-string v0, "audio_started_capture"
    ...
    const-string v0, "audio_stoped_capture"
    ...
    const-string v0, "rtmp_connecting"
    ...
    const-string v0, "rtmp_connect_fail"
    ...
    const-string v0, "network too weak"
    ...
    const-string v0, "rtmp_disconnected"
    ...
    const-string v0, "rtmp_reconnecting"
    ...
    const-string v0, "video_encoder_format_changed"
...
.method public final onInfo(IILjava/lang/String;)V
    ...
    iget-object v5, p0, LX/0TbO;->LL:LX/0TbB;

    iget-object v0, v5, LX/0TbB;->LJIILL:Lm83/a;
...
.method public final onInfo(ILjava/util/Map;)V
    ...
    iget-object v4, p0, LX/0TbO;->LL:LX/0TbB;
    ...
    iget-object v0, v4, LX/0TbB;->LIZ:LX/0TbC;

    iget-object v1, v0, LX/0TbC;->LJJJLIIL:Ljava/lang/String;
