.class public abstract Lcom/ss/ttlivestreamer/core/engine/Transport;
...
# instance fields
.field public mObserver:Lcom/ss/ttlivestreamer/core/engine/Transport$EventObserver;
...
.method public static EnableVideoFrameStatistics(Z)V
    ...
    invoke-static {p0}, Lcom/ss/ttlivestreamer/core/engine/Transport;->nativeEnableVideoFrameStatistics(Z)V
...
.method public static ResetSeiMgr()V
    ...
    invoke-static {}, Lcom/ss/ttlivestreamer/core/engine/Transport;->nativeResetSeiMgr()V
...
.method public static SetSeiSourceAble(Z)V
    ...
    invoke-static {p0}, Lcom/ss/ttlivestreamer/core/engine/Transport;->nativeSetSeiSourceAble(Z)V
...
.method public getParameter()Lcom/ss/ttlivestreamer/core/utils/TEBundle;
    ...
    invoke-direct {p0}, Lcom/ss/ttlivestreamer/core/engine/Transport;->nativeGetParameter()Lcom/ss/ttlivestreamer/core/utils/TEBundle;
...
.method public onEvent(IIJLjava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/ss/ttlivestreamer/core/engine/Transport;->mObserver:Lcom/ss/ttlivestreamer/core/engine/Transport$EventObserver;
    ...
    invoke-interface/range {v0 .. v5}, Lcom/ss/ttlivestreamer/core/engine/Transport$EventObserver;->onTransportEvent(IIJLjava/lang/String;)V

    :cond_0
    return-void
.end method

.method public abstract registerFeedbackObserber(Lcom/ss/ttlivestreamer/core/engine/Transport$FeedbackObserver;)V
.end method
...
.method public setEventObserver(Lcom/ss/ttlivestreamer/core/engine/Transport$EventObserver;)V
    .locals 0

    iput-object p1, p0, Lcom/ss/ttlivestreamer/core/engine/Transport;->mObserver:Lcom/ss/ttlivestreamer/core/engine/Transport$EventObserver;
...
.method public setParameter(Lcom/ss/ttlivestreamer/core/utils/TEBundle;)V
    ...
    invoke-direct {p0, p1}, Lcom/ss/ttlivestreamer/core/engine/Transport;->nativeSetParameter(Lcom/ss/ttlivestreamer/core/utils/TEBundle;)V
...
.method public setVysncModule(Lcom/ss/ttlivestreamer/core/engine/VsyncModule;)V
    .locals 0
...
.method public abstract unRegisterFeedbackObserber(Lcom/ss/ttlivestreamer/core/engine/Transport$FeedbackObserver;)V
.end method
