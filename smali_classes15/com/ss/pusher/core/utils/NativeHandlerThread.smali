.class public Lcom/ss/pusher/core/utils/NativeHandlerThread;
.super Lm83/b;
.source "SourceFile"
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lm83/b;-><init>(Ljava/lang/String;)V

    const/4 v0, 0x1

    iput v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mPriority:I

    const/4 v0, -0x1

    iput v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mTid:I

    iput-object p1, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mName:Ljava/lang/String;

    sget-object v0, Ljava/lang/Thread$State;->NEW:Ljava/lang/Thread$State;

    iput-object v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mState:Ljava/lang/Thread$State;

    invoke-static {}, Lcom/ss/pusher/core/utils/SafeHandlerThreadPoolExecutor;->usingNativeThread()Z

    move-result v0

    iput-boolean v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mIsNative:Z

    invoke-static {p1}, Lcom/ss/pusher/core/utils/ThreadUtils;->getPriorityByName(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    iget v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mPriority:I
...
.method public static com_ss_pusher_core_utils_NativeHandlerThread_com_ss_android_ugc_aweme_lancet_RunnableGuardLancet_run(Lcom/ss/pusher/core/utils/NativeHandlerThread;)V
    .locals 1

    :try_start_0
    invoke-virtual {p0}, Lcom/ss/pusher/core/utils/NativeHandlerThread;->com_ss_pusher_core_utils_NativeHandlerThread__run$___twin___()V
...
# virtual methods
.method public com_ss_pusher_core_utils_NativeHandlerThread__run$___twin___()V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mIsAlive:Z
    ...
    iput-object v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mLooper:Landroid/os/Looper;
...
.method public getLooper()Landroid/os/Looper;
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mLooper:Landroid/os/Looper;
...
.method public getState()Ljava/lang/Thread$State;
    ...
    iget-object v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mState:Ljava/lang/Thread$State;
...
.method public getThreadId()I
    ...
    iget v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mTid:I
...
.method public isThreadAlive()Z
    ...
    iget-boolean v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mIsAlive:Z
...
.method public run()V
    ...
    const-string v0, "NativeHandlerThread@a135.run"

    invoke-static {v0}, LX/0Xz5;->LIZ(Ljava/lang/String;)V

    invoke-static {p0}, Lcom/ss/pusher/core/utils/NativeHandlerThread;->com_ss_pusher_core_utils_NativeHandlerThread_com_ss_android_ugc_aweme_lancet_RunnableGuardLancet_run(Lcom/ss/pusher/core/utils/NativeHandlerThread;)V
...
.method public setThreadName(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/ss/pusher/core/utils/NativeHandlerThread;->getState()Ljava/lang/Thread$State;
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/ss/pusher/core/utils/NativeHandlerThread;->getThreadId()I
    ...
    const-string v0, "set priority for "
    ...
    const-string v0, "set priority failed for "
...
.method public declared-synchronized start()V
    ...
    iget-object v0, p0, Lcom/ss/pusher/core/utils/NativeHandlerThread;->mName:Ljava/lang/String;

    invoke-static {v0, p0}, Lcom/ss/pusher/core/utils/NativeHandlerThread;->nativeCreatePThread(Ljava/lang/String;Ljava/lang/Runnable;)I
