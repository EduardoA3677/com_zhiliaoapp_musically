.class public final Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase_Impl;
.super Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase;
.source "SourceFile"


# instance fields
.field public volatile LLILIL:LX/11te;

.field public volatile LLILL:LX/11td;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase;-><init>()V
...
# virtual methods
.method public final LIZ()LX/0j8q;
    .locals 1

    iget-object v0, p0, Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase_Impl;->LLILL:LX/11td;
    ...
    invoke-direct {v0, p0}, LX/11td;-><init>(Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase;)V

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase_Impl;->LLILL:LX/11td;
...
.method public final LIZJ()LX/0j8p;
    .locals 1

    iget-object v0, p0, Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase_Impl;->LLILIL:LX/11te;
    ...
    invoke-direct {v0, p0}, LX/11te;-><init>(Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase;)V

    iput-object v0, p0, Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase_Impl;->LLILIL:LX/11te;
...
.method public final clearAllTables()V
    ...
    const-string v0, "DELETE FROM `maf_info`"

    invoke-interface {v2, v0}, LX/11sF;->LJIILJJIL(Ljava/lang/String;)V

    const-string v0, "DELETE FROM `user_info`"

    invoke-interface {v2, v0}, LX/11sF;->LJIILJJIL(Ljava/lang/String;)V

    const-string v0, "DELETE FROM `user_status`"
...
.method public final createOpenHelper(LX/11sK;)LX/11sB;
    ...
    invoke-direct {v2, p0}, LX/11rB;-><init>(Lcom/ss/android/ugc/aweme/relation/storage/db/RelationDatabase_Impl;)V

    const-string v1, "f75f2d2e74b409761abba7970ba9bb1b"

    const-string v0, "3cf942b7b80d0268cb3398705318a429"
