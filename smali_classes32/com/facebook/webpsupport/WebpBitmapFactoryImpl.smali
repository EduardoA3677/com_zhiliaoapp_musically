...
# static fields
.field public static final IN_BITMAP_SUPPORTED:Z = true

.field public static mBitmapCreator:LX/12HD;

.field public static mWebpErrorLogger:LX/12GK;
...
.method public static hookDecodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    const-string p0, "webp_direct_decode_array_failed_on_no_webp"

    invoke-static {p0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->sendWebpErrorLog(Ljava/lang/String;)V
...
.method public static hookDecodeFile(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v0, v3, p1}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->hookDecodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public static hookDecodeFileDescriptor(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p0}, LX/0XgU;-><init>(Ljava/io/FileDescriptor;)V
...
.method public static hookDecodeResource(Landroid/content/res/Resources;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {p0, v1, v0, v3, p2}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->hookDecodeResourceStream(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public static hookDecodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, v0}, LX/12IW;->LIZJ([BI)Z
...
.method public static sendWebpErrorLog(Ljava/lang/String;)V
    .locals 0
...
.method public setBitmapCreator(LX/12HD;)V
    ...
    sput-object p1, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->mBitmapCreator:LX/12HD;

    return-void
.end method

.method public setWebpErrorLogger(LX/12GK;)V
    .locals 0
