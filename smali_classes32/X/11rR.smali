...
# instance fields
.field public final synthetic LIZ:Lcom/ss/android/ugc/trill/share/data/ShareDatabase_Impl;


# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/trill/share/data/ShareDatabase_Impl;)V
    .locals 1

    iput-object p1, p0, LX/11rR;->LIZ:Lcom/ss/android/ugc/trill/share/data/ShareDatabase_Impl;
...
.method public final createAllTables(LX/11sF;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `Record` (`rid` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `time` INTEGER, `channel` TEXT, `share_type` INTEGER)"
    ...
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'4e670bbb58b1cec9bfaaeb409ecedc0d\')"
...
.method public final dropAllTables(LX/11sF;)V
    ...
    iget-object v0, p0, LX/11rR;->LIZ:Lcom/ss/android/ugc/trill/share/data/ShareDatabase_Impl;
...
.method public final onValidateSchema(LX/11sF;)LX/11sS;
    ...
    const-string v0, "Record(com.ss.android.ugc.trill.share.data.Record).\n Expected:\n"
