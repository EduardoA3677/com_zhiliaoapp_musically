...
.method public final createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `IM_USER_BIZ_INFO` SET `UID` = ?,`SHARE_FILTER_TYPE` = ?,`AFFINITY_SCORE` = ?,`UPDATE_TIME` = ?,`USER_B2C_ACCOUNT_INFO` = ?,`CHAT_BOT_INFO` = ?,`CAMERA_INFO` = ?,`ALLOW_SINGLE_CHAT_SCREENSHOT` = ?,`GROUP_CHAT_PERMISSION_INFO` = ?,`ACTIVITY_STATUS_SETTING` = ? WHERE `UID` = ?"
