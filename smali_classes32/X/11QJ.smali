...
.method public final LIZIZ(ILjava/lang/String;)Z
    ...
    const-string v0, "aweme://reactnative/"
    ...
    invoke-static {v0}, LX/0zM5;->LIZJ(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p2}, LX/0zM5;->LIZIZ(Ljava/lang/String;)V
    ...
    :catch_0
    :cond_1
    invoke-static {v2, p2}, Lcom/bytedance/router/SmartRouter;->buildRoute(Landroid/content/Context;Ljava/lang/String;)Lcom/bytedance/router/SmartRoute;
    ...
    const-string v0, "402669568"

    invoke-interface {v3, v2, v0}, Lcom/ss/android/ugc/aweme/compliance/sandbox/api/services/ISandboxService;->appendDataFlowId(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    :cond_4
    invoke-interface {v3, v2, p2}, Lcom/ss/android/ugc/aweme/qrcode/presenter/QrCodeScanService;->LJIIIIZZ(Landroid/content/Context;Ljava/lang/String;)V
...
.method public final getName()Ljava/lang/String;
    ...
    const-string v0, "schema_parse_handler"
