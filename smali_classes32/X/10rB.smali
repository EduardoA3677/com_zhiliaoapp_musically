.class public final LX/10rB;
.super LX/121R;
.source "SourceFile"


# instance fields
.field public final LIZJ:LX/10rD;

.field public LIZLLL:Z


# direct methods
.method public constructor <init>(LX/10rD;)V
    .locals 0

    invoke-direct {p0}, LX/121R;-><init>()V

    iput-object p1, p0, LX/10rB;->LIZJ:LX/10rD;
...
.method public final LIZJ(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v4, p0, LX/10rB;->LIZJ:LX/10rD;

    iget v0, v4, LX/10rD;->LLILIL:I
    ...
    check-cast v2, LX/10rC;

    iget-object v0, v2, LX/10rC;->LLILLIZIL:Landroid/widget/FrameLayout;
    ...
    iget v1, v4, LX/10rD;->LLILIL:I

    if-eq v2, v1, :cond_1

    iget-object v0, v4, LX/10rD;->LLILLIZIL:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/preview/PreviewImageDialogFragment;

    if-eqz v0, :cond_1

    invoke-virtual {v0, v1, v2}, Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/preview/PreviewImageDialogFragment;->ON(II)V

    :cond_1
    iput v3, v4, LX/10rD;->LLILIL:I
...
.method public final LJIIJ(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;FFIZ)V
    ...
    iget-boolean v0, p0, LX/10rB;->LIZLLL:Z

    if-eqz v0, :cond_1

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/10rB;->LIZLLL:Z

    iget-object v0, p0, LX/10rB;->LIZJ:LX/10rD;
...
.method public final LJIIL(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Z
    ...
    iget-object v0, v4, LX/10rD;->LL:Ljava/util/ArrayList;
    ...
    invoke-virtual {v4, v1, v3}, LX/13M6;->notifyItemMoved(II)V
...
.method public final LJIILJJIL(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    :cond_1
    :goto_0
    iget-object v3, p0, LX/10rB;->LIZJ:LX/10rD;
