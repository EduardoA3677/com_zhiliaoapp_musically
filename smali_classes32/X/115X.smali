...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;)V
    ...
    iput-object p1, p0, LX/115X;->LIZIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/115Y;)Lorg/json/JSONObject;
    .locals 4
    ...
    invoke-interface {p0}, LX/115Y;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/115Y;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/115Y;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, p0, LX/115X;->LIZIZ:Ljava/lang/ref/WeakReference;
