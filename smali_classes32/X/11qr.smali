...
# instance fields
.field public final synthetic LIZ:Lcom/bytedance/effectcreatormobile/infrastructure/storage/dao/AMEBaseDB_Impl;


# direct methods
.method public constructor <init>(Lcom/bytedance/effectcreatormobile/infrastructure/storage/dao/AMEBaseDB_Impl;)V
    .locals 1

    iput-object p1, p0, LX/11qr;->LIZ:Lcom/bytedance/effectcreatormobile/infrastructure/storage/dao/AMEBaseDB_Impl;
...
.method public final createAllTables(LX/11sF;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `user_status_published` (`uid` TEXT NOT NULL, `user_status_published` INTEGER NOT NULL, PRIMARY KEY(`uid`))"
    ...
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'4dc84a07d232b09844423bc74034e503\')"
...
.method public final dropAllTables(LX/11sF;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `user_status_published`"

    invoke-interface {p1, v0}, LX/11sF;->LJIILJJIL(Ljava/lang/String;)V

    iget-object v0, p0, LX/11qr;->LIZ:Lcom/bytedance/effectcreatormobile/infrastructure/storage/dao/AMEBaseDB_Impl;
...
.method public final onValidateSchema(LX/11sF;)LX/11sS;
    ...
    const-string v8, "user_status_published"
    ...
    const-string v3, "user_status_published"
    ...
    invoke-direct {v4, v3, v1, v2, v0}, LX/11rA;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V

    invoke-static {p1, v3}, LX/11rA;->LIZ(LX/11sF;Ljava/lang/String;)LX/11rA;
    ...
    const-string v0, "user_status_published(com.bytedance.effectcreatormobile.infrastructure.storage.dao.UserStatusPublishedEntity).\n Expected:\n"
