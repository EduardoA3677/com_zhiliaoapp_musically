...
# instance fields
.field public final synthetic LIZ:Lcom/ss/android/ugc/aweme/runtime/behavior/RuntimeBehaviorDataBase_Impl;


# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/runtime/behavior/RuntimeBehaviorDataBase_Impl;)V
    .locals 1

    iput-object p1, p0, LX/11qm;->LIZ:Lcom/ss/android/ugc/aweme/runtime/behavior/RuntimeBehaviorDataBase_Impl;
...
.method public final createAllTables(LX/11sF;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `runtimeBehaviorEntity` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `type` TEXT NOT NULL, `time` INTEGER NOT NULL, `msg` TEXT NOT NULL)"
    ...
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'977ffca18b985d80d9f488e58c9d7da9\')"
...
.method public final dropAllTables(LX/11sF;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `runtimeBehaviorEntity`"

    invoke-interface {p1, v0}, LX/11sF;->LJIILJJIL(Ljava/lang/String;)V

    iget-object v0, p0, LX/11qm;->LIZ:Lcom/ss/android/ugc/aweme/runtime/behavior/RuntimeBehaviorDataBase_Impl;
...
.method public final onValidateSchema(LX/11sF;)LX/11sS;
    ...
    const-string v1, "runtimeBehaviorEntity"
    ...
    const-string v0, "runtimeBehaviorEntity(com.ss.android.ugc.aweme.runtime.behavior.RuntimeBehaviorEntity).\n Expected:\n"
