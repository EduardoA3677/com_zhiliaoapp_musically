...
.method public constructor <init>(Landroid/content/Context;LX/11Xb;)V
    ...
    iput-object p1, p0, LX/11Xs;->LIZ:Landroid/content/Context;

    iput-object p2, p0, LX/11Xs;->LIZIZ:LX/11Xb;
...
.method public final LIZ(ILX/0o9n;)V
    ...
    iget-object v0, p0, LX/11Xs;->LIZ:Landroid/content/Context;
    ...
    iget-object v3, p0, LX/11Xs;->LIZIZ:LX/11Xb;

    iget-object v2, v3, LX/11Xb;->LIZ:LX/02sS;

    new-instance v1, LX/11Xt;

    iget-object v0, p0, LX/11Xs;->LIZ:Landroid/content/Context;

    invoke-direct {v1, v3, v0, v4}, LX/11Xt;-><init>(LX/11Xb;Landroid/content/Context;LX/02wT;)V
    ...
    :cond_2
    iget-object v2, p0, LX/11Xs;->LIZIZ:LX/11Xb;

    iget-object v1, v2, LX/11Xb;->LIZ:LX/02sS;

    new-instance v0, LX/11Xv;

    invoke-direct {v0, v2, v4}, LX/11Xv;-><init>(LX/11Xb;LX/02wT;)V
    ...
    iget-object v1, p0, LX/11Xs;->LIZIZ:LX/11Xb;
