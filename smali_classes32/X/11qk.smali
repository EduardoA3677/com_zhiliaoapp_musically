...
# instance fields
.field public final synthetic LIZ:Lcom/ss/android/ugc/feed/platform/componentmanager/outreach/repository/FcpComponentDatabase_Impl;


# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/feed/platform/componentmanager/outreach/repository/FcpComponentDatabase_Impl;)V
    .locals 1

    iput-object p1, p0, LX/11qk;->LIZ:Lcom/ss/android/ugc/feed/platform/componentmanager/outreach/repository/FcpComponentDatabase_Impl;
...
.method public final createAllTables(LX/11sF;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `rule_hit_cache` (`unique_key` TEXT NOT NULL, `outreach_key` TEXT NOT NULL, `is_hit` INTEGER, `hit_rule_ids` TEXT, `rule_strategy` TEXT, `create_time` INTEGER NOT NULL, PRIMARY KEY(`unique_key`))"
    ...
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'43350a367b57b2e4b27171c61b85e19c\')"
...
.method public final dropAllTables(LX/11sF;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `rule_hit_cache`"

    invoke-interface {p1, v0}, LX/11sF;->LJIILJJIL(Ljava/lang/String;)V

    iget-object v0, p0, LX/11qk;->LIZ:Lcom/ss/android/ugc/feed/platform/componentmanager/outreach/repository/FcpComponentDatabase_Impl;
...
.method public final onValidateSchema(LX/11sF;)LX/11sS;
    ...
    const-string v1, "hit_rule_ids"

    invoke-virtual {v0, v1, v9}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v9, LX/11rQ;

    const-string v12, "rule_strategy"
    ...
    const-string v1, "rule_hit_cache"
    ...
    const-string v0, "rule_hit_cache(com.ss.android.ugc.feed.platform.componentmanager.outreach.repository.RuleHitCacheEntity).\n Expected:\n"
    ...
    invoke-direct {v0, v6, v8}, LX/11sS;-><init>(ZLjava/lang/String;)V
