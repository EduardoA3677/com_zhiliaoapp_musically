...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;)V
    ...
    iput-object p1, p0, LX/115M;->LIZIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/115L;)Lorg/json/JSONObject;
    .locals 4
    ...
    invoke-interface {p0}, LX/115L;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/115L;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/115L;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, p0, LX/115M;->LIZIZ:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v1, p0, p2, p1, v0}, LY/ARunnableS74S0200000_31;-><init>(LX/115M;Lorg/json/JSONObject;Ljava/lang/Number;I)V
