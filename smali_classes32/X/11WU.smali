...
.field public final LJII:LX/11Tb;
...
.method public constructor <init>(LX/0obU;LX/11Tb;)V
    ...
    iput-object p1, p0, LX/11WU;->LJI:LX/0obU;

    iput-object p2, p0, LX/11WU;->LJII:LX/11Tb;
...
.method public final LJ(Landroid/content/Context;)Ljava/util/List;
    ...
    iget-object v2, v0, LX/11WU;->LJII:LX/11Tb;
    ...
    invoke-virtual {v0}, LX/11WT;->LJIJJLI()Lcom/ss/android/ugc/tiktok/tpsc/privacy/business/components/data/BaseSettingDataViewModel;
    ...
    invoke-virtual {v0, v6, v2}, LX/11WT;->LJIILJJIL(Landroid/content/Context;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-virtual {v0, v6, v2}, LX/11WT;->LJIILIIL(Landroid/content/Context;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v11, v0, v2}, Lkotlin/jvm/internal/AwS573S0100000_31;-><init>(LX/11WU;I)V

    new-instance v12, Lkotlin/jvm/internal/AwS541S0100000_31;

    const/16 v2, 0x114

    invoke-direct {v12, v0, v2}, Lkotlin/jvm/internal/AwS541S0100000_31;-><init>(LX/11WU;I)V

    new-instance v13, Lkotlin/jvm/internal/AwS573S0100000_31;

    const/16 v2, 0x48

    invoke-direct {v13, v0, v2}, Lkotlin/jvm/internal/AwS573S0100000_31;-><init>(LX/11WU;I)V
    ...
    :goto_3
    invoke-virtual {v0, v3}, LX/11WT;->LJIIL(Z)Z
    ...
    invoke-direct {v2, v0, v14, v3}, Lkotlin/jvm/internal/AwS146S0110000_31;-><init>(LX/11WU;ZI)V
...
.method public LJIIZILJ()Ljava/lang/Integer;
    .locals 3

    iget-object v0, p0, LX/11WU;->LJII:LX/11Tb;
