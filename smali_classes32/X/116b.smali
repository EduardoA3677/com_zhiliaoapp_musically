...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lcom/bytedance/amg/minigameruntime/api/IMiniGameRuntimeAPI;)V
    ...
    iput-object p1, p0, LX/116b;->LIZIZ:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static LJI(LX/116c;)Lorg/json/JSONObject;
    .locals 5
    ...
    invoke-interface {p0}, LX/116c;->getErrorCode()Ljava/lang/Number;
    ...
    invoke-interface {p0}, LX/116c;->getErrorMsg()Ljava/lang/String;
    ...
    invoke-interface {p0}, LX/116c;->getData()LX/116f;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-interface {v0}, LX/116f;->isSufficient()Ljava/lang/Boolean;

    move-result-object v1

    :goto_2
    const-string v0, "is_sufficient"
    ...
    invoke-interface {p0}, LX/116c;->isSuccess()Ljava/lang/Boolean;
...
.method public final LIZLLL(Ljava/lang/Number;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, p0, LX/116b;->LIZIZ:Ljava/lang/ref/WeakReference;
