...
# direct methods
.method public constructor <init>(LX/0e9Q;Lcom/bytedance/android/livesdkapi/depend/model/live/Room;)V
    .locals 0

    iput-object p1, p0, LX/0e9D;->LL:LX/0e9Q;

    iput-object p2, p0, LX/0e9D;->LLILIL:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;
...
.method public final LJJJJLL(Ljava/lang/String;J)V
    ...
    iget-object v2, p0, LX/0e9D;->LL:LX/0e9Q;
    ...
    invoke-virtual {v2}, LX/0e9Q;->LJJJLIIL()Lcom/bytedance/android/live/liveinteract/gamelink/model/GameLinkDataHolder;
...
.method public final LJLJJL(Ljava/lang/String;)V
    ...
    iget-object v0, p0, LX/0e9D;->LL:LX/0e9Q;
...
.method public final LJLJJLL()V
    ...
    iget-object v3, p0, LX/0e9D;->LL:LX/0e9Q;
    ...
    iput-boolean v0, v3, LX/0e9Q;->LLILZIL:Z
...
.method public final LJLLLLLL(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/KickOutMessage;)V
    ...
    invoke-virtual {v3, v0}, LX/0e8m;->isKickOutReasonable(Ljava/lang/Integer;)Z

    move-result v0

    if-nez v0, :cond_1

    iget-object v2, v3, LX/05xg;->mView:LX/02cz;
    ...
    invoke-virtual {v3, v0}, LX/0e8m;->isFromModeratorKickOut(Ljava/lang/Integer;)Z
    ...
    invoke-virtual {v3, v0, v2, v2, v2}, LX/0e9Q;->stopInteract(Ljava/lang/String;ZZI)V
...
.method public final LJZ(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/JoinChannelMessage;)V
    ...
    iget-object v1, p0, LX/0e9D;->LL:LX/0e9Q;
...
.method public final LJZL(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/InviteMessage;)V
    ...
    iget-object v0, v1, LX/0e9D;->LL:LX/0e9Q;

    iget-object v0, v0, LX/0e9Q;->LLJJI:LX/0eCD;
    ...
    invoke-static {v0, v2, v10}, LX/0eac;->LIZ(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-boolean v10, v0, LX/0e8m;->isNeedLeaveChannelWhenEnterRoom:Z
    ...
    const-class v2, Lcom/bytedance/android/live/liveinteract/multiguestv3/main/common/channel/MultiGuestReceiveInviteMeFromModeratorChannel;
    ...
    iget-object v9, v2, Lcom/bytedance/android/livesdk/chatroom/model/multiguestv3/InviteBizContent;->multiLiveAnchorPanelSettings:Lcom/bytedance/android/livesdk/chatroom/model/multilive/MultiLiveAnchorPanelSettings;

    :goto_4
    invoke-static {v10}, LX/0eD6;->LIZLLL(Z)Z
    ...
    invoke-direct/range {v6 .. v20}, LX/0e8C;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/bytedance/android/livesdk/chatroom/model/multilive/MultiLiveAnchorPanelSettings;ZZLjava/lang/String;Lcom/bytedance/android/live/base/model/ImageModel;JJILjava/lang/Integer;I)V

    iget-object v3, v0, LX/0e9Q;->LLJJJJ:LX/0e9F;

    if-eqz v3, :cond_9

    invoke-virtual {v3}, LX/0e9F;->LJII()Lcom/bytedance/android/live/liveinteract/multiguestv3/main/link/BeInvitedDialogUICtrlCmd;

    move-result-object v4

    :goto_6
    iget-object v3, v2, LX/0e8C;->LJ:Ljava/lang/String;

    iput-object v3, v0, LX/0e9Q;->LLJJIJIL:Ljava/lang/String;

    iget-object v3, v2, LX/0e8C;->LJFF:Ljava/lang/String;

    iput-object v3, v0, LX/0e9Q;->LLJJIJIIJIL:Ljava/lang/String;

    invoke-static {v0, v10, v10, v4}, LX/0e9Q;->LJJL(LX/0e9Q;ZZLcom/bytedance/android/live/liveinteract/multiguestv3/main/link/BeInvitedDialogUICtrlCmd;)V

    invoke-static {}, LX/0eIm;->LJ()LX/0eIm;

    move-result-object v3

    iget-object v0, v2, LX/0e8C;->LIZ:Ljava/lang/String;

    iput-object v0, v3, LX/0eIm;->LJIILL:Ljava/lang/String;
    ...
    iget-object v0, v2, LX/0e8C;->LIZIZ:Ljava/lang/String;
    ...
    :cond_6
    iput-object v0, v3, LX/0eEx;->LJFF:Ljava/lang/String;

    :cond_7
    iget-object v1, v1, LX/0e9D;->LL:LX/0e9Q;

    const-string v0, "anchor_invite_guest"

    iput-object v0, v1, LX/0e9Q;->LLJJJ:Ljava/lang/String;

    sput-object v0, LX/0eDU;->LIZIZ:Ljava/lang/String;

    invoke-virtual {v1}, LX/0e9Q;->LJJJLIIL()Lcom/bytedance/android/live/liveinteract/gamelink/model/GameLinkDataHolder;
    ...
    :cond_f
    iget-object v0, v1, LX/0e9D;->LLILIL:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;
...
.method public final LLF(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkCoreError;)V
    ...
    invoke-virtual {v3, v1, v4, v4, v0}, LX/0e9Q;->stopInteract(Ljava/lang/String;ZZI)V
...
.method public final LLFZ(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/RtcStartResultMessage;)V
    ...
    iput-boolean v5, v0, LX/0eIm;->LJJIJIIJI:Z

    iget-object v3, v3, LX/0e9D;->LL:LX/0e9Q;
    ...
    invoke-virtual {v3}, LX/0e9Q;->getInteractId()Ljava/lang/String;
    ...
    new-instance v7, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkLayerRTCMessageUser;

    invoke-virtual {v3}, LX/0e9Q;->LJJJLIIL()Lcom/bytedance/android/live/liveinteract/gamelink/model/GameLinkDataHolder;

    move-result-object v0

    invoke-virtual {v0, v1}, Lcom/bytedance/android/live/liveinteract/multiguestv3/main/common/MultiGuestDataHolder;->LIZLLL(Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    invoke-direct {v7, v1, v0, v6, v5}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkLayerRTCMessageUser;-><init>(Ljava/lang/String;III)V
    ...
    invoke-virtual {v4, v11}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkLayerRTCMessage;->setParam(Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkLayerRTCMessageParam;)V

    const-string v0, "linkMicSDKVideoMute"

    invoke-virtual {v4, v0}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkLayerRTCMessage;->setMethod(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v7, v3, LX/0e9Q;->LLJJJ:Ljava/lang/String;
    ...
    iget-object v0, v3, LX/0e9Q;->LLJJJ:Ljava/lang/String;
    ...
    iget-object v1, v3, LX/0e9Q;->LLJILLL:LX/0Nig;

    sget-object v0, LX/0Nig;->FAILED:LX/0Nig;
    ...
    invoke-virtual {v3, v1, v2, v2, v0}, LX/0e9Q;->stopInteract(Ljava/lang/String;ZZI)V
    ...
    invoke-virtual {v3}, LX/0e9Q;->pushStreamForPreviewAhead()V
    ...
    iget-object v4, v3, LX/0e9D;->LL:LX/0e9Q;

    invoke-static {}, LX/0eIm;->LJ()LX/0eIm;

    move-result-object v0

    iput-boolean v2, v0, LX/0eIm;->LJJIJIIJI:Z
...
.method public final LLIIJI(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LeaveMessage;)V
    ...
    invoke-interface {v0, v4, v4}, LX/0e7s;->showKickOutDialog(ZI)V

    :cond_0
    const-string v0, "leave_normally"

    invoke-virtual {v3, v0, v4, v4, v4}, LX/0e9Q;->stopInteract(Ljava/lang/String;ZZI)V
...
.method public final LLJJLIIIJLLLLLLLZ(LX/0f5E;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, LX/0e9D;->LL:LX/0e9Q;
    ...
    invoke-virtual {v4}, LX/0e9Q;->getInteractId()Ljava/lang/String;
    ...
    invoke-virtual {v4}, LX/0e9Q;->getUserId()J
    ...
    invoke-virtual {v4}, LX/0e9Q;->LJJJLIIL()Lcom/bytedance/android/live/liveinteract/gamelink/model/GameLinkDataHolder;
    ...
    iget-object v2, v4, LX/0e9Q;->LLILIL:Lcom/bytedance/ies/sdk/datachannel/DataChannel;
...
.method public final LLLI(LX/0f5E;LX/0ezU;)V
    ...
    iget-object v2, v0, LX/0e9D;->LL:LX/0e9Q;

    iget-boolean v0, v2, LX/0e9Q;->LLJIJIL:Z
    ...
    invoke-virtual {v2}, LX/0e9Q;->LJJJJZI()LX/0e7m;

    move-result-object v1

    new-instance v6, LX/0e9J;

    invoke-direct {v6, v1}, LX/0e9J;-><init>(LX/0e7m;)V
    ...
    iget-object v0, v2, LX/0e9Q;->LL:LX/0eBj;

    invoke-interface {v0, v3}, LX/0eBj;->LJJLIIIJLLLLLLLZ(LX/0ezU;)V

    iput-object v1, v2, LX/0e9Q;->LLILLL:LX/0e7m;
...
.method public final LLLIZZ(LX/0f5E;II)V
    ...
    invoke-virtual {v2, v1, v0}, LX/0e9Q;->LJJJJLL(Ltikcast/linkmic/controller/ChangeStateReq;Lkotlin/jvm/functions/Function1;)V
...
.method public final LLLLII(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/PermitApplyMessage;)V
    ...
    iget-object v3, v3, LX/0e9Q;->LL:LX/0eBj;

    invoke-interface {v3}, LX/0eBj;->LIZ()LX/0e9L;

    move-result-object v3

    if-eqz v3, :cond_10

    invoke-interface {v3}, LX/0e9L;->LIZ()LX/0eMX;

    move-result-object v3

    if-eqz v3, :cond_10

    invoke-static {v3}, LX/0eA3;->LIZ(LX/0eA4;)I
    ...
    iget-object v8, v3, LX/0e9Q;->LLJJIJIIJIL:Ljava/lang/String;
    ...
    :cond_1
    iget-object v9, v3, LX/0e9Q;->LLJJIJIL:Ljava/lang/String;
    ...
    invoke-static {v3}, LX/0eA3;->LJ(LX/0eA4;)Z
    ...
    iget-object v11, v3, LX/0d61;->dataChannel:Lcom/bytedance/ies/sdk/datachannel/DataChannel;
    ...
    iget-object v5, p0, LX/0e9D;->LL:LX/0e9Q;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, LX/0YZB;->QUIC:LX/0YZB;

    const-string v3, "other"

    invoke-static {v6, v3}, Lcom/bytedance/android/livesdk/utils/LiveAppBundleUtils;->isPluginAvailable(LX/0YZB;Ljava/lang/String;)Z

    move-result v10

    sget-object v6, LX/0YZB;->RTMGLOBAL:LX/0YZB;
    ...
    sget-object v6, LX/0YZB;->P2P:LX/0YZB;
    ...
    sget-object v6, LX/0YZB;->CMAF:LX/0YZB;
    ...
    const-string v3, "handlePermitMessage QUIC = "
    ...
    iget-object v6, v5, LX/0d61;->dataChannel:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    if-eqz v6, :cond_e

    const-class v3, Lcom/bytedance/android/livesdk/dataChannel/PIPStatusData;

    invoke-virtual {v6, v3}, Lcom/bytedance/ies/sdk/datachannel/DataChannel;->e90(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :goto_2
    iget-boolean v3, v5, LX/0e9Q;->LLJIJIL:Z
    ...
    iget-boolean v3, v3, LX/0eIm;->LJJIJIL:Z
    ...
    iput-object v3, v6, LX/0eIm;->LJIILJJIL:Ljava/lang/String;
    ...
    iget-object v7, v5, LX/0e9Q;->LL:LX/0eBj;

    invoke-interface {v7}, LX/0eBj;->A0()LX/0f5E;

    move-result-object v7

    if-eqz v7, :cond_c

    invoke-interface {v7, v3, v4}, LX/0f5E;->LLLILZLLLI(J)Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;
    ...
    :goto_4
    iput-object v3, v6, LX/0eIm;->LJIILL:Ljava/lang/String;

    sget-object v4, LX/0eEx;->LJIIJ:LX/0eEx;
    ...
    iput-object v3, v4, LX/0eEx;->LJI:Ljava/lang/String;
    ...
    :cond_6
    iput-object v2, v4, LX/0eEx;->LJFF:Ljava/lang/String;

    :cond_7
    iget-object v2, v5, LX/0e8m;->room:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;
    ...
    iget-object v4, v5, LX/0e9Q;->LLJJJJJIL:LX/0e99;

    if-eqz v4, :cond_b

    invoke-virtual {v5}, LX/0e9Q;->LJJJLIIL()Lcom/bytedance/android/live/liveinteract/gamelink/model/GameLinkDataHolder;

    move-result-object v2

    iget v2, v2, Lcom/bytedance/android/live/liveinteract/multiguestv3/main/common/MultiGuestDataHolder;->LJJJLZIJ:I

    int-to-long v2, v2

    invoke-virtual {v4, v2, v3, v12, v12}, LX/0e99;->LJJIJIIJI(JZZ)Lcom/bytedance/android/live/liveinteract/multiguestv3/main/link/IMultiGuestDialogUiCtrlCmd;
    ...
    invoke-interface {v2}, LX/0e7s;->isApplyDialogShowing()Z
    ...
    invoke-interface {v2}, LX/0e7s;->forceDismissApplyDialog()V

    :cond_8
    instance-of v2, v3, Lcom/bytedance/android/live/liveinteract/multiguestv3/main/link/PreviewDialogUICtrlCmd;
    ...
    check-cast v3, Lcom/bytedance/android/live/liveinteract/multiguestv3/main/link/PreviewDialogUICtrlCmd;

    invoke-interface {v1, v3}, LX/0e7s;->showPreviewDialogWhenAnchorOrModeratorPermit(Lcom/bytedance/android/live/liveinteract/multiguestv3/main/link/PreviewDialogUICtrlCmd;)V
    ...
    iput-boolean v0, v1, Lcom/bytedance/android/live/liveinteract/gamelink/model/GameLinkDataHolder;->LJJLIIIJLLLLLLLZ:Z
    ...
    iput-boolean v0, v1, Lcom/bytedance/android/live/liveinteract/gamelink/model/GameLinkDataHolder;->LJJLJLI:Z

    const-string v0, "guest_apply_anchor"

    iput-object v0, v5, LX/0e9Q;->LLJJJ:Ljava/lang/String;
    ...
    invoke-interface {v2, v1}, LX/0e7s;->showPreviewDialogWhenAnchorOrModeratorPermit(Lcom/bytedance/android/live/liveinteract/multiguestv3/main/link/PreviewDialogUICtrlCmd;)V
    ...
    invoke-virtual {v5, v1, v12, v0, v12}, LX/0e9Q;->stopInteract(Ljava/lang/String;ZZI)V

    invoke-virtual {v5, v12}, LX/0e9Q;->leaveAction(Z)V
    ...
    const-string v3, "receive host refuse apply"

    invoke-static {v4, v3, v12}, LX/0eac;->LIZ(Ljava/lang/String;Ljava/lang/String;Z)V

    iget-object v3, p0, LX/0e9D;->LL:LX/0e9Q;

    iget-object v4, v3, LX/0e9Q;->LLJJI:LX/0eCD;

    iget-object v4, v4, LX/0E28;->LIZIZ:Ljava/lang/Object;
    ...
    iget-object v0, v3, LX/0e9Q;->LLJJ:LX/0e8J;
    ...
    invoke-virtual {v3}, LX/0e9Q;->getUserId()J
    ...
    invoke-static {v4, v0, v12}, LX/0eac;->LIZ(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public final LLLLJ(LX/0f5E;Lcom/bytedance/android/livesdk/comp/api/linkcore/model/CancelInviteMessage;)V
    ...
    invoke-virtual {v1}, LX/0e9Q;->dismissGuestBeInvitedDialog()V

    iget-object v0, v1, LX/0e9Q;->LLJJIJI:Lcom/bytedance/android/live/liveinteract/multiguestv3/main/link/invite/guest/MultiGuestV3GuestBeInvitedDialog;
...
.method public final LLLLZIL(LX/0f5E;Ljava/lang/String;)V
    ...
    iget-object v0, v2, LX/0e8m;->room:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;
    ...
    iget-object v3, v2, LX/0e9Q;->LLILIL:Lcom/bytedance/ies/sdk/datachannel/DataChannel;
