...
.method public static LIZ()Z
    ...
    :goto_0
    invoke-static {v0}, LX/0eR8;->LIZIZ(Ljava/util/List;)Z
...
.method public static LIZIZ(Ljava/util/List;)Z
    ...
    invoke-virtual {v0, v3}, Ltikcast/linkmic/common/PosIdentity;->LIZJ(Ljava/lang/String;)Z
...
.method public static LIZLLL(Ljava/util/List;ZZ)V
    .locals 18
    ...
    const-string v0, "expand_guest_id_list"
    ...
    invoke-static {v1}, LX/0eQb;->LJIL(Ljava/lang/String;)Z
    ...
    const-string v0, "expand_guest_link_id_list"
    ...
    invoke-static/range {p0 .. p0}, LX/0eR8;->LIZJ(Ljava/util/List;)Z
    ...
    :goto_7
    const-string v0, "is_notice_board"
    ...
    :cond_d
    const-string v0, "is_anchor_expand"

    invoke-virtual {v4, v0, v3}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sput-wide v10, LX/0eR8;->LIZ:J

    const-string v0, "livesdk_multi_anchor_expand_both_duration"
...
.method public static LJ(Ljava/lang/String;JLjava/lang/String;ZZ)V
    .locals 5
    ...
    :cond_0
    const-string v1, "expand_user_num"
    ...
    :goto_3
    const-string v0, "is_from_notice_board"
    ...
    :cond_2
    invoke-static {v1, v4}, LX/0eQy;->LJ(II)LX/0c0V;
    ...
    const-string v0, "livesdk_multi_anchor_expand_both_entrance"
...
.method public static LJI(Ljava/util/List;Z)V
    ...
    invoke-static/range {p0 .. p0}, LX/0eR8;->LIZIZ(Ljava/util/List;)Z
    ...
    const-string v0, "livesdk_multi_anchor_expand_both_success"
...
.method public static LJII()V
    ...
    const-string v0, "livesdk_multi_guest_expand_both_success"
...
.method public static LJIIIIZZ()V
    ...
    const-string v0, "livesdk_multi_guest_expand_both_over"
...
.method public static LJIIIZ(JZZLjava/lang/String;)V
    .locals 5
    ...
    const-string v1, "button_action_type"
    ...
    :cond_1
    const-string v0, "expand_user_num"
    ...
    :goto_1
    const-string v0, "is_replace_notice_board"
    ...
    const-string v0, "livesdk_multi_anchor_replace_expand_both_entrance"
    ...
    const-string v1, "replace_user_id"
    ...
    invoke-interface {v0, p4}, LX/0f5E;->LLJ(Ljava/lang/String;)Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;
...
.method public static LJIIJ(Ljava/lang/String;Z)V
    ...
    invoke-interface {v0, p0}, LX/0f5E;->LLJ(Ljava/lang/String;)Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkUser;
...
.method public static LJIIJJI(IJLjava/lang/String;Ljava/lang/String;Z)V
    .locals 6
    ...
    invoke-static {v2}, LX/0eCU;->LIZ(Ljava/util/Map;)V

    const-string v0, "livesdk_multi_anchor_shrink_entrance"
