...
.field public final synthetic LIZIZ:LX/0fim;


# direct methods
.method public constructor <init>(LX/0fim;)V
    .locals 0

    iput-object p1, p0, LX/0fin;->LIZIZ:LX/0fim;
...
.method public final LIZIZ(FF)V
    ...
    invoke-virtual {p0}, LX/0fin;->LJFF()Z
    ...
    invoke-virtual {p0, v2}, LX/0fin;->LJ(Z)V

    iget-object v0, p0, LX/0fin;->LIZIZ:LX/0fim;

    invoke-virtual {v0}, LX/0fim;->LJLI()V

    iget-object v4, p0, LX/0fin;->LIZIZ:LX/0fim;

    iget-object v10, v4, LX/0fim;->LLJLLIL:LX/0fih;
    ...
    iget-object v5, v4, LX/0fim;->LLJJIJIIJIL:Landroid/view/SurfaceView;
    ...
    invoke-virtual {v0, v4}, LX/0fiZ;->LJIIJ(LX/0fia;)V
    ...
    iget-object v1, v0, LX/0fim;->LLJJIJIL:LX/16oV;
...
.method public final LIZJ()V
    ...
    invoke-virtual {p0, v3}, LX/0fin;->LJ(Z)V

    iget-object v1, p0, LX/0fin;->LIZIZ:LX/0fim;

    iget-object v0, v1, LX/0fim;->LLJLLIL:LX/0fih;

    if-nez v0, :cond_1

    iget-object v1, v1, LX/0fim;->LLJLLL:Landroidx/lifecycle/MutableLiveData;
    ...
    invoke-virtual {v0, v3}, LX/0fiZ;->LJIIIIZZ(Z)V
    ...
    iget-object v0, v1, LX/0fim;->LLJLL:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v1, v0}, LX/0fim;->LJLILLLLZI(LX/0fih;)V
...
.method public final LJ(Z)V
    ...
    iget-boolean v0, p0, LX/0fin;->LIZ:Z
    ...
    :cond_1
    :goto_0
    iput-boolean p1, p0, LX/0fin;->LIZ:Z

    iget-object v0, p0, LX/0fin;->LIZIZ:LX/0fim;

    iget-object v1, v0, LX/0fim;->LLJZIJLIL:LX/0CJ4;
...
.method public final LJJL(F)V
    ...
    invoke-virtual {p0, v0}, LX/0fin;->LJ(Z)V
    ...
    invoke-virtual {v0, p1}, LX/0fim;->LJLIIL(F)V
...
.method public final LJJLI(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v3, p0, LX/0fin;->LIZIZ:LX/0fim;

    invoke-virtual {v3}, LX/0fim;->LJJZZIII()Z

    move-result v0

    if-nez v0, :cond_3

    iget-object v0, v3, LX/0fim;->LLJLILLLLZIIL:LX/0fiZ;

    invoke-virtual {v0, p1}, LX/0fiZ;->LJ(Landroid/view/MotionEvent;)LX/0fih;

    move-result-object v2

    if-eqz v2, :cond_4

    iget-object v0, v3, LX/0fim;->LLJLLIL:LX/0fih;
    ...
    :cond_1
    invoke-virtual {v3, v2}, LX/0fim;->LJLILLLLZI(LX/0fih;)V

    :cond_2
    iget-object v1, v3, LX/0fim;->LLJLLL:Landroidx/lifecycle/MutableLiveData;
    ...
    invoke-virtual {v3, v0}, LX/0fim;->LJLILLLLZI(LX/0fih;)V
...
.method public final onDown(Landroid/view/MotionEvent;)V
    ...
    iget-object v0, v0, LX/0fim;->LLJJIJIL:LX/16oV;
    ...
    invoke-virtual {v0, v2}, LX/0fim;->LJLILLLLZI(LX/0fih;)V
    ...
    invoke-virtual {v0}, LX/0fim;->LJJZZIII()Z
    ...
    invoke-virtual {v0, v4}, LX/0fim;->LJLILLLLZI(LX/0fih;)V
...
.method public final onScale(F)V
    ...
    invoke-virtual {v0, p1}, LX/0fim;->LJLIL(F)V
