...
.method public static final LIZJ(Ljava/lang/String;)I
    ...
    const-string v0, "getScene: scene "
    ...
    const-string v0, "catch-bean-invite-guide"
...
.method public final LJ(LX/0cnj;Lcom/bytedance/android/livesdk/model/message/CapsuleMessage;)Z
    ...
    const-string v2, "LinkCompetitionGuideCapsuleHandler"
    ...
    :try_start_0
    iget-object v0, p2, Lcom/bytedance/android/livesdk/model/message/CapsuleMessage;->desc:Lcom/bytedance/android/livesdk/model/message/common/Text;
    :try_end_0
    ...
    :try_start_1
    iget-object v0, p2, Lcom/bytedance/android/livesdk/model/message/CapsuleMessage;->buttonText:Lcom/bytedance/android/livesdk/model/message/common/Text;

    if-eqz v0, :cond_1

    iget-object v0, p2, Lcom/bytedance/android/livesdk/model/message/CapsuleMessage;->icon:Lcom/bytedance/android/live/base/model/ImageModel;
    ...
    const-string v0, "filter, message.desc = "
    ...
    const-string v0, ", message.buttonText = "
...
.method public final LJII(LX/0cmQ;)V
    ...
    const-string v0, "onFirstBind: isAnchor "
    ...
    invoke-static {v0}, LX/0eul;->LIZJ(Ljava/lang/String;)I
    ...
    invoke-virtual {v4, v3, v1, v2, v0}, LX/0fKU;->LJJZ(ILcom/bytedance/ies/sdk/datachannel/DataChannel;Ljava/lang/String;Z)V
...
.method public final LJIILL(LX/0cmQ;)Z
    ...
    const-string v0, "handleClick, scene: "
    ...
    invoke-virtual {v7, v6, v0, v1, v3}, LX/0fKU;->LJJZ(ILcom/bytedance/ies/sdk/datachannel/DataChannel;Ljava/lang/String;Z)V
    ...
    new-instance v1, LX/0CDn;

    const/4 v0, 0x7

    invoke-direct {v1, v0}, LX/0CDn;-><init>(I)V
    ...
    const-string v0, "handleClick: no scene "
    ...
    invoke-direct {v2, v4, v1, v0}, Lkotlin/jvm/internal/AwS161S1100000_19;-><init>(LX/0cnj;Ljava/lang/String;I)V

    sget-object v0, LX/0emC;->AVAILABLE:LX/0emC;

    sget-object v1, LX/0emG;->LIZ:[I
