...
.field public final LIZIZ:Lcom/bytedance/android/live/liveinteract/multiguestv3/main/common/MultiGuestDataHolder;
...
.field public final LJI:LX/0fFe;
...
.method public constructor <init>(Lcom/bytedance/ies/sdk/datachannel/DataChannel;Lcom/bytedance/android/live/liveinteract/multiguestv3/main/common/MultiGuestDataHolder;Lcom/bytedance/ies/sdk/widgets/LiveWidget;Lcom/bytedance/android/livesdkapi/depend/model/live/Room;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/0fFg;->LIZ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    iput-object p2, p0, LX/0fFg;->LIZIZ:Lcom/bytedance/android/live/liveinteract/multiguestv3/main/common/MultiGuestDataHolder;

    iput-object p3, p0, LX/0fFg;->LIZJ:Landroidx/lifecycle/LifecycleOwner;

    iput-object p4, p0, LX/0fFg;->LIZLLL:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LX/0fFg;->LJ:Ljava/util/List;

    new-instance v0, LX/0fFe;

    invoke-direct {v0, p0}, LX/0fFe;-><init>(LX/0fFg;)V

    iput-object v0, p0, LX/0fFg;->LJI:LX/0fFe;
...
.method public final LIZ(LX/0c53;)V
    ...
    iget-object v0, p0, LX/0fFg;->LIZ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;
    ...
    iget-object v4, p0, LX/0fFg;->LJ:Ljava/util/List;
...
.method public final LIZJ(LX/0c53;LX/0c5K;)V
    .locals 1

    iget-object v0, p0, LX/0fFg;->LIZ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    invoke-virtual {p1, v0, p2}, LX/0c53;->load(Lcom/bytedance/ies/sdk/datachannel/DataChannel;LX/0c5K;)Lkotlin/Unit;

    iget-object v0, p0, LX/0fFg;->LIZ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    invoke-virtual {p1, v0}, LX/0c53;->hide(Lcom/bytedance/ies/sdk/datachannel/DataChannel;)Lkotlin/Unit;

    invoke-virtual {p0, p1}, LX/0fFg;->LIZ(LX/0c53;)V
...
.method public final LIZLLL()V
    ...
    iget-object v0, p0, LX/0fFg;->LJI:LX/0fFe;
    ...
    iget-object v4, p0, LX/0fFg;->LIZ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    iget-object v3, p0, LX/0fFg;->LIZJ:Landroidx/lifecycle/LifecycleOwner;

    const-class v2, Lcom/bytedance/android/live/slot/BottomLeftSlotVisibilityChannel;
    ...
    const-class v2, Lcom/bytedance/android/live/liveinteract/multiguestv3/main/guest/LeftSlotToolbarVisibilityChannel;
...
.method public final LJ()V
    ...
    invoke-virtual {p0}, LX/0fFg;->LJFF()V

    :cond_0
    iget-object v0, p0, LX/0fFg;->LJ:Ljava/util/List;
...
.method public final LJFF()V
    ...
    sput-boolean v0, LX/0fFg;->LJII:Z
    ...
    invoke-virtual {p0, v2, v1}, LX/0fFg;->LIZIZ(LX/0c53;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, v0}, LX/0fFg;->LIZ(LX/0c53;)V
    ...
    iget-object v0, p0, LX/0fFg;->LIZLLL:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;
    ...
    :cond_0
    iget-object v2, p0, LX/0fFg;->LIZ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;
