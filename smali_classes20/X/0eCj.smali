...
# instance fields
.field public final synthetic LL:Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;
...
.method public constructor <init>(Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;)V
    ...
    iput-object p1, p0, LX/0eCj;->LL:Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;
...
.method public final LJJ(Ljava/lang/String;Landroid/view/SurfaceView;)V
    ...
    const-string v0, ", isCDNVideoLand="

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v0, p0, LX/0eCj;->LL:Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;

    iget-object v0, v0, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->LLJ:LX/05ta;
    ...
    const-string v2, "GameLinkMicViewMaskWidget"
    ...
    iget-object v0, v0, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->LLILIL:LX/0e9L;
    ...
    invoke-static {v0, p1}, LX/0eA3;->LIZLLL(LX/0eA4;Ljava/lang/String;)Lcom/bytedance/android/livesdk/model/message/linker/listchangemessage/LinkListUser;

    move-result-object v1

    :goto_0
    iget-object v3, p0, LX/0eCj;->LL:Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;
    ...
    invoke-virtual {v0, v5}, Landroid/view/ViewGroup;->setLayoutTransition(Landroid/animation/LayoutTransition;)V

    invoke-static {p2}, LX/0cTD;->LJJJJZI(Landroid/view/View;)V
    ...
    invoke-virtual {v3}, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->Q0()I
    ...
    invoke-virtual {v3}, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->P0()I
    ...
    invoke-virtual {v3}, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->R0()Z
    ...
    invoke-direct {v2, v4, v1}, Landroid/view/ViewGroup$MarginLayoutParams;-><init>(II)V
    ...
    :cond_4
    iput-object v2, v3, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->LLILLL:Landroid/view/ViewGroup$MarginLayoutParams;

    const/4 v0, 0x1

    invoke-virtual {p2, v0}, Landroid/view/SurfaceView;->setZOrderMediaOverlay(Z)V

    iget-object v2, v3, Lcom/bytedance/android/widget/Widget;->contentView:Landroid/view/View;

    check-cast v2, Landroid/view/ViewGroup;

    iget-object v1, v3, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->LLILLL:Landroid/view/ViewGroup$MarginLayoutParams;

    const/4 v0, 0x0

    invoke-virtual {v2, p2, v0, v1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V

    iget-object v0, v3, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->LLJILJILJ:Ljava/util/Map;
...
.method public final LLLIZZ(LX/0f5E;II)V
    ...
    iget-object v1, v0, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->LLILL:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, p2}, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicMaskGuestItemWidget;->O0(I)V
...
.method public final LLLLLLZ(Ljava/util/List;)V
    ...
    :cond_2
    iget-object v5, p0, LX/0eCj;->LL:Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;
    ...
    iget-object v0, v5, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicViewMaskWidget;->LLILL:Ljava/util/HashMap;

    invoke-virtual {v0, v1}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicMaskGuestItemWidget;
    ...
    invoke-virtual {v1, v0, v3}, Lcom/bytedance/android/live/liveinteract/gamelink/widget/GameLinkMicMaskGuestItemWidget;->N0(IZ)V
