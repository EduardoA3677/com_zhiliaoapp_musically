...
.method public constructor <init>(LX/0eb8;)V
    ...
    iput-object p1, p0, LX/0eAV;->LL:LX/0eb8;
...
.method public final LL(LX/0f5E;Ljava/lang/String;)V
    ...
    iget-object v1, p0, LX/0eAV;->LL:LX/0eb8;

    const/4 v0, 0x0

    invoke-virtual {v1, p2, v0, v0}, LX/0eb8;->LIZ(Ljava/lang/String;ZZ)LX/0ebK;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, v0, LX/0ebK;->LJIILIIL:LX/0aJv;
    ...
    :cond_0
    iget-object v0, p0, LX/0eAV;->LL:LX/0eb8;

    iget-object v1, v0, LX/0eb8;->LL:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    const-class v0, Lcom/bytedance/android/live/liveinteract/platform/common/datachannel/LinkInGuestCountDownFinishChannel;
...
.method public final LLLLZIL(LX/0f5E;Ljava/lang/String;)V
    ...
    const-string v0, "onRemoteRender linkMicId="
