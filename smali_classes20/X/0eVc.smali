...
# direct methods
.method public constructor <init>(LX/0eV7;Landroid/content/Context;)V
    .locals 0

    iput-object p1, p0, LX/0eVc;->LIZ:LX/0eV7;

    iput-object p2, p0, LX/0eVc;->LIZIZ:Landroid/content/Context;
...
.method public final LIZ(Lcom/bytedance/android/live/design/view/sheet/action/LiveActionSheetDialog;)V
    ...
    sget-object v4, Lcom/bytedance/android/livesdk/livesetting/linkmic/MultiguestNoticeboardV2Setting;->INSTANCE:Lcom/bytedance/android/livesdk/livesetting/linkmic/MultiguestNoticeboardV2Setting;

    invoke-virtual {v4}, Lcom/bytedance/android/livesdk/livesetting/linkmic/MultiguestNoticeboardV2Setting;->templateEnable()Z
    ...
    iget-object v0, p0, LX/0eVc;->LIZ:LX/0eV7;

    iget-object v7, p0, LX/0eVc;->LIZIZ:Landroid/content/Context;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v4}, Lcom/bytedance/android/livesdk/livesetting/linkmic/MultiguestNoticeboardV2Setting;->isPreviewEnable()Z
    ...
    sget-object v10, LX/0enV;->LJJI:Ljava/lang/String;
    ...
    invoke-virtual {v0, v10}, LX/0fi8;->LJFF(Ljava/lang/String;)LX/0fi7;
    ...
    sget-object v10, LX/0evw;->LIZ:LX/0evw;
    ...
    invoke-static {v0}, LX/0eV7;->LJIIIIZZ(LX/0fi7;)V
    ...
    iput-boolean v8, v4, LX/0UTa;->LJIILLIIL:Z

    iput-boolean v8, v4, LX/0UTa;->LJIILL:Z

    iput-object v9, v4, LX/0UTa;->LIZJ:Ljava/lang/CharSequence;

    invoke-virtual {v4, v2}, LX/0UTa;->LJIIIZ(Ljava/lang/CharSequence;)V

    new-instance v2, LY/AcS182S0300000_19;

    const/16 v0, 0xb

    invoke-direct {v2, v3, v5, v7, v0}, LY/AcS182S0300000_19;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {v4, v1, v2}, LX/0UTa;->LJIILJJIL(Ljava/lang/CharSequence;LX/0c2I;)V

    sget-object v0, LX/0eVf;->LIZ:LX/0eVf;
    ...
    :cond_7
    iget-object v7, p0, LX/0eVc;->LIZ:LX/0eV7;

    iget-object v6, p0, LX/0eVc;->LIZIZ:Landroid/content/Context;
    ...
    sget-object v0, LX/0eVg;->LIZ:LX/0eVg;
