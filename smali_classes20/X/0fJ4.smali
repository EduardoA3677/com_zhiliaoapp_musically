...
.method public static final LIZ(Landroid/content/Context;Ljava/lang/Long;Ljava/lang/String;Lcom/bytedance/ies/sdk/datachannel/DataChannel;)Lcom/bytedance/hybrid/spark/SparkContext;
    ...
    iget-object v5, v0, LX/0fW9;->LJJIJIIJI:LX/0fWC;

    if-eqz v5, :cond_4

    invoke-virtual {v5}, LX/0fWC;->LJFF()Z
    ...
    invoke-virtual {v5, v0, v1}, LX/0fWC;->LIZJ(J)J

    move-result-wide v0

    long-to-int v5, v0

    invoke-static {v5}, LX/0fl4;->LJ(I)Ljava/lang/String;
    ...
    invoke-static {v6}, LX/0fKV;->LJIILL(Z)Ljava/lang/String;
    ...
    :cond_5
    invoke-interface {v0, p0, v1, v10}, Lcom/bytedance/android/live/browser/IHybridContainerService;->Dn1(Landroid/content/Context;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)Lcom/bytedance/hybrid/spark/SparkContext;
