.class public final synthetic LX/0fmE;
.super LX/10fa;
.source "SourceFile"
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v6, LX/0fmD;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v5}, LX/0fmD;->LJFF(LX/0fms;)Z
    ...
    invoke-direct {v1, v5, v6, v0}, LY/ARunnableS62S0200000_19;-><init>(LX/0fms;LX/0fmD;I)V

    invoke-interface {v2, v1}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;

    move-result-object v0

    iput-object v0, v6, LX/0fmD;->LJ:Ljava/util/concurrent/Future;
    ...
    const-string v4, "GiftExpressionHelperV2"
    ...
    invoke-virtual {v6}, LX/0fmD;->LJIIIZ()Ljava/lang/String;
    ...
    const-string v0, "current window not match the linkMicId = "

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, ",windowLinkmicId = "
    ...
    iget-object v9, v6, LX/0fmD;->LIZJ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;

    if-eqz v9, :cond_8

    const-class v8, LX/0bxq;

    invoke-virtual {v9, v8}, Lcom/bytedance/ies/sdk/datachannel/DataChannel;->e90(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :cond_8
    iget-object v0, v6, LX/0fmD;->LIZIZ:LX/0f6r;
    ...
    invoke-direct {v2, v5, v6, v0}, LY/ARunnableS62S0200000_19;-><init>(LX/0fms;LX/0fmD;I)V
    ...
    iget-object v4, v6, LX/0fmD;->LIZJ:Lcom/bytedance/ies/sdk/datachannel/DataChannel;
    ...
    invoke-direct {v0, v5, v6}, LX/0fmi;-><init>(LX/0fms;LX/0fmD;)V
    ...
    invoke-virtual {v6, v5, v0}, LX/0fmD;->LJIIIIZZ(LX/0fms;Lcom/bytedance/android/live/base/model/ImageModel;)V
