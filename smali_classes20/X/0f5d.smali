...
.method public constructor <init>(LX/0ewl;Lcom/bytedance/android/live/liveinteract/multihost/core/adapter/MultiHostCrossAdapterImpl;LX/0etj;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "LX/04kF;",
            ">;",
            "Lcom/bytedance/android/live/liveinteract/multihost/core/adapter/MultiHostCrossAdapterImpl;",
            "LX/0etj;",
            ")V"
        }
    .end annotation

    iput-object p1, p0, LX/0f5d;->LIZ:LX/0ewl;

    iput-object p2, p0, LX/0f5d;->LIZIZ:Lcom/bytedance/android/live/liveinteract/multihost/core/adapter/MultiHostCrossAdapterImpl;

    iput-object p3, p0, LX/0f5d;->LIZJ:LX/0etj;
...
.method public final LIZ(Lcom/bytedance/android/livesdk/comp/api/linkcore/model/LinkCoreError;Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, LX/0f5d;->LIZIZ:Lcom/bytedance/android/live/liveinteract/multihost/core/adapter/MultiHostCrossAdapterImpl;
    ...
    iget-object v1, p0, LX/0f5d;->LIZJ:LX/0etj;
    ...
    :cond_0
    iget-object v3, p0, LX/0f5d;->LIZ:LX/0ewl;
...
.method public final onSuccess(Ljava/lang/Object;)V
    ...
    invoke-direct {v2, p1, v0}, Lkotlin/jvm/internal/AwS529S0100000_19;-><init>(Lcom/bytedance/android/livesdk/comp/api/linkcore/model/ApplyGroupResult;I)V

    const-string v1, "apply_on_success"

    const-string v0, "apply"

    invoke-interface {v3, v1, v0, v2}, LX/0f1b;->LIZJ(Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V

    iget-object v4, p0, LX/0f5d;->LIZ:LX/0ewl;

    if-eqz v4, :cond_1

    new-instance v3, LX/04kF;

    invoke-virtual {p1}, Lcom/bytedance/android/livesdk/comp/api/linkcore/model/ApplyGroupResult;->getLogId()Ljava/lang/String;
