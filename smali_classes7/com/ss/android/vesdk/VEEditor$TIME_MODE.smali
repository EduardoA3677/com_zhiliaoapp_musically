...
# static fields
.field public static final synthetic $VALUES:[Lcom/ss/android/vesdk/VEEditor$TIME_MODE;
...
# direct methods
.method public static synthetic $values()[Lcom/ss/android/vesdk/VEEditor$TIME_MODE;
    .locals 3

    const/4 v0, 0x2

    new-array v2, v0, [Lcom/ss/android/vesdk/VEEditor$TIME_MODE;

    const/4 v1, 0x0

    sget-object v0, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;->EDITOR_NORMAl_MODE:Lcom/ss/android/vesdk/VEEditor$TIME_MODE;
...
.method public static constructor <clinit>()V
    ...
    new-instance v2, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;

    const-string v1, "EDITOR_NORMAl_MODE"

    const/4 v0, 0x0

    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;->EDITOR_NORMAl_MODE:Lcom/ss/android/vesdk/VEEditor$TIME_MODE;

    new-instance v2, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;

    const-string v1, "EDITOR_SLOMO_MODE"

    const/4 v0, 0x1

    invoke-direct {v2, v1, v0}, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;->EDITOR_SLOMO_MODE:Lcom/ss/android/vesdk/VEEditor$TIME_MODE;

    invoke-static {}, Lcom/ss/android/vesdk/VEEditor$TIME_MODE;->$values()[Lcom/ss/android/vesdk/VEEditor$TIME_MODE;
