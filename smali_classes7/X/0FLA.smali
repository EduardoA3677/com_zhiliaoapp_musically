...
.field public final synthetic LIZLLL:LX/0FLC;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LX/0FLC<",
...
.field public final synthetic LJFF:LX/0FLD;
...
# direct methods
.method public constructor <init>(LX/01rK;Ljava/util/List;Ljava/util/List;LX/0FLC;Ljava/lang/String;LX/0FLD;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0FLA;->LIZ:LX/01rK;

    iput-object p2, p0, LX/0FLA;->LIZIZ:Ljava/util/List;

    iput-object p3, p0, LX/0FLA;->LIZJ:Ljava/util/List;

    iput-object p4, p0, LX/0FLA;->LIZLLL:LX/0FLC;

    iput-object p5, p0, LX/0FLA;->LJ:Ljava/lang/String;

    iput-object p6, p0, LX/0FLA;->LJFF:LX/0FLD;

    iput-object p7, p0, LX/0FLA;->LJI:Ljava/util/List;
...
.method public final onFail(Ljava/lang/Object;LX/0lyF;)V
    ...
    iget-object v2, v0, LX/0FLA;->LIZ:LX/01rK;
    ...
    iget-object v1, v0, LX/0FLA;->LIZIZ:Ljava/util/List;
    ...
    iget-object v1, v0, LX/0FLA;->LIZ:LX/01rK;

    iget v2, v1, LX/01rK;->element:I

    iget-object v1, v0, LX/0FLA;->LIZJ:Ljava/util/List;
    ...
    iget-object v3, v0, LX/0FLA;->LIZLLL:LX/0FLC;
...
.method public final onSuccess(Ljava/lang/Object;)V
    ...
    :cond_0
    iget-object v3, v0, LX/0FLA;->LIZ:LX/01rK;
    ...
    :cond_2
    iget-object v3, v0, LX/0FLA;->LJ:Ljava/lang/String;

    iget-object v2, v0, LX/0FLA;->LJFF:LX/0FLD;

    iget-object v1, v0, LX/0FLA;->LJI:Ljava/util/List;

    invoke-virtual {v2, v1}, LX/0FLD;->LJIIL(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    invoke-static {v3, v1}, LX/0FLL;->LIZIZ(Ljava/lang/String;Ljava/util/List;)V

    iget-object v2, v0, LX/0FLA;->LIZLLL:LX/0FLC;

    if-eqz v2, :cond_1

    sget-object v1, LX/0FH1;->LIZ:LX/0FH1;

    iget-object v0, v0, LX/0FLA;->LJI:Ljava/util/List;
