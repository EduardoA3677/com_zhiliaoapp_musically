...
.field public static final LJ:Ljava/util/concurrent/Semaphore;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0EIg;->LIZ:LX/05ta;
    ...
    sput-object v0, LX/0EIg;->LIZIZ:LX/05ta;

    new-instance v0, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    sput-object v0, LX/0EIg;->LIZJ:Ljava/util/concurrent/ConcurrentLinkedQueue;

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    sput-object v0, LX/0EIg;->LIZLLL:Ljava/util/Set;
    ...
    sput-object v1, LX/0EIg;->LJ:Ljava/util/concurrent/Semaphore;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, LX/0EIg;->LJFF:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static LIZ(Ljava/lang/String;Ljava/util/List;)V
    ...
    :cond_0
    sget-object v1, LX/0EIg;->LJFF:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static LIZIZ()V
    ...
    const-string v1, "GlobalAsyncTaskHandler"
    ...
    new-instance v2, LX/0EId;

    const/4 v1, 0x0

    invoke-direct {v2, v4, v1}, LX/0EId;-><init>(Ljava/lang/String;LX/02wT;)V
