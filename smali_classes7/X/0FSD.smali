...
.method public static LIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Lcom/bytedance/ies/nle/editor_jni/NLEModel;)V
    .locals 10
    ...
    iput-object v0, v1, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->effectFromPaths:Ljava/util/List;
    ...
    iget-object v3, v0, Lcom/ss/android/ugc/aweme/creative/model/CreativeModel;->editEffectModel:Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;

    iget-object v0, v3, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->editingEffectSearchFrom:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, v3, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->searchId:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, v3, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->searchKeyword:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, v3, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->searchResultId:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, v3, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->searchUniversalRank:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, v3, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->creatorSearchInfo:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    invoke-static {p1}, LX/0FTl;->LJJJ(Lcom/bytedance/ies/nle/editor_jni/NLEModel;)Ljava/util/List;
    ...
    const-string v6, "effect_entrance"
    ...
    const-string v6, "multi_track"

    goto :goto_5

    :cond_8
    invoke-static {p1}, LX/0FTl;->LJJLIIIJLLLLLLLZ(Lcom/bytedance/ies/nle/editor_jni/NLEModel;)Ljava/util/List;
    ...
    :cond_10
    invoke-static {v4, v7}, LX/0zFB;->LJLI(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-static {v0, v3}, LX/0FSC;->LIZ(Lcom/bytedance/ies/nle/editor_jni/NLESegment;Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;)V
    ...
    iput v0, v3, Lcom/ss/android/ugc/aweme/creative/model/edit/EditEffectModel;->countSearchSession:I
...
.method public static LIZIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;LX/0Sps;)V
    ...
    :goto_0
    invoke-static {p0, v0}, LX/0FSD;->LIZ(Lcom/ss/android/ugc/aweme/shortvideo/edit/VideoPublishEditModel;Lcom/bytedance/ies/nle/editor_jni/NLEModel;)V
