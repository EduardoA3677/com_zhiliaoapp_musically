...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.aigc.offline.draft.AIGCOfflineDraftServiceImpl$editDraftWithResult$2"
...
# direct methods
.method public constructor <init>(Lcom/ss/android/ugc/aweme/draft/model/AwemeDraft;Landroid/app/Activity;LX/0EjK;JLX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0EKQ;->LL:Lcom/ss/android/ugc/aweme/draft/model/AwemeDraft;

    iput-object p2, p0, LX/0EKQ;->LLILIL:Landroid/app/Activity;

    iput-object p3, p0, LX/0EKQ;->LLILL:LX/0EjK;

    iput-wide p4, p0, LX/0EKQ;->LLILLIZIL:J
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v1, p0, LX/0EKQ;->LL:Lcom/ss/android/ugc/aweme/draft/model/AwemeDraft;

    iget-object v2, p0, LX/0EKQ;->LLILIL:Landroid/app/Activity;

    iget-object v3, p0, LX/0EKQ;->LLILL:LX/0EjK;

    iget-wide v4, p0, LX/0EKQ;->LLILLIZIL:J

    move-object v6, p2

    invoke-direct/range {v0 .. v6}, LX/0EKQ;-><init>(Lcom/ss/android/ugc/aweme/draft/model/AwemeDraft;Landroid/app/Activity;LX/0EjK;JLX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v3, "AIGCOfflineDraftServiceImpl@cc6a.editDraftWithResult$2"
    ...
    iget-object v2, p0, LX/0EKQ;->LL:Lcom/ss/android/ugc/aweme/draft/model/AwemeDraft;
    ...
    iget-object v4, p0, LX/0EKQ;->LLILIL:Landroid/app/Activity;

    iget-object v1, p0, LX/0EKQ;->LLILL:LX/0EjK;

    iget-wide v8, p0, LX/0EKQ;->LLILLIZIL:J
