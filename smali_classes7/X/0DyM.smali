...
.method public static final LIZ(Lcom/bytedance/android/livesdkapi/session/EnterRoomConfig;LX/0DxZ;Ljava/lang/String;)V
    .locals 5

    const/4 v4, 0x1

    sput-boolean v4, LX/0DyM;->LIZJ:Z
    ...
    invoke-static {v1, p1, v0, p2}, LX/0DyM;->LJ(Ljava/util/Map;LX/0DxZ;ILjava/lang/String;)V
...
.method public static final LIZIZ(Ljava/lang/String;)V
    ...
    sget-boolean v0, LX/0DyM;->LIZ:Z

    if-nez v0, :cond_1

    sget-boolean v0, LX/0DyM;->LIZIZ:Z

    if-nez v0, :cond_1

    sget-boolean v0, LX/0DyM;->LIZJ:Z
    ...
    :cond_0
    sget-object v1, LX/0DxZ;->ENTER_ROOM_FAIL_OTHER:LX/0DxZ;

    const/16 v0, 0x191

    invoke-static {v3, v1, v0, p0}, LX/0DyM;->LJ(Ljava/util/Map;LX/0DxZ;ILjava/lang/String;)V
...
.method public static final LIZJ(Lcom/bytedance/android/livesdkapi/session/EnterRoomConfig;LX/0DxZ;)V
    .locals 2
    ...
    invoke-static {p0, p1, v0, v1}, LX/0DyM;->LIZLLL(Lcom/bytedance/android/livesdkapi/session/EnterRoomConfig;LX/0DxZ;Ljava/lang/String;Ljava/lang/Integer;)V

    return-void
.end method

.method public static final LIZLLL(Lcom/bytedance/android/livesdkapi/session/EnterRoomConfig;LX/0DxZ;Ljava/lang/String;Ljava/lang/Integer;)V
    .locals 5
    ...
    invoke-static {v2, p1, v0, p2}, LX/0DyM;->LJ(Ljava/util/Map;LX/0DxZ;ILjava/lang/String;)V

    :cond_1
    return-void
.end method

.method public static final LJ(Ljava/util/Map;LX/0DxZ;ILjava/lang/String;)V
    .locals 2
    ...
    invoke-virtual {p1}, LX/0DxZ;->getDetailCode()I
    ...
    const-string v0, "livesdk_abnormal_live_play"
