...
.field public final synthetic LLJILJILJ:LX/0dDP;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Landroid/net/Uri;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/bytedance/android/livesdkapi/depend/model/live/Room;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;LX/0dDP;LX/00zH;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0dDL;->LL:Ljava/lang/String;

    iput-object p2, p0, LX/0dDL;->LLILIL:Ljava/lang/String;

    iput-object p3, p0, LX/0dDL;->LLILL:Ljava/lang/String;

    iput p4, p0, LX/0dDL;->LLILLIZIL:I

    iput-object p5, p0, LX/0dDL;->LLILLJJLI:Ljava/lang/String;

    iput-object p6, p0, LX/0dDL;->LLILLL:Landroid/net/Uri;

    iput-object p7, p0, LX/0dDL;->LLILZ:Landroid/content/Context;

    iput-object p8, p0, LX/0dDL;->LLILZIL:Ljava/lang/String;

    iput-object p9, p0, LX/0dDL;->LLILZLL:Ljava/lang/String;

    iput-object p10, p0, LX/0dDL;->LLIZ:Ljava/lang/String;

    iput-object p11, p0, LX/0dDL;->LLIZLLLIL:Ljava/lang/String;

    iput-object p12, p0, LX/0dDL;->LLJ:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;

    iput-object p13, p0, LX/0dDL;->LLJI:Ljava/lang/String;

    iput-object p14, p0, LX/0dDL;->LLJIJIL:Ljava/lang/String;

    move-object/from16 v0, p15

    iput-object v0, p0, LX/0dDL;->LLJILJIL:Ljava/lang/String;

    move-object/from16 v0, p16

    iput-object v0, p0, LX/0dDL;->LLJILJILJ:LX/0dDP;

    move-object/from16 v0, p17

    iput-object v0, p0, LX/0dDL;->LLJILLL:LX/00zH;
...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object v1, v0, LX/0dDL;->LL:Ljava/lang/String;
    ...
    iget-object v1, v0, LX/0dDL;->LLILIL:Ljava/lang/String;

    invoke-virtual {v3, v1, v2}, LX/0qns;->LJJI(Ljava/lang/Object;Ljava/lang/String;)V

    const-string v2, "new_price"

    iget-object v1, v0, LX/0dDL;->LLILL:Ljava/lang/String;

    invoke-virtual {v3, v1, v2}, LX/0qns;->LJJI(Ljava/lang/Object;Ljava/lang/String;)V

    iget v1, v0, LX/0dDL;->LLILLIZIL:I
    ...
    iget-object v1, v0, LX/0dDL;->LLILLJJLI:Ljava/lang/String;
    ...
    iget-object v1, v0, LX/0dDL;->LLILLL:Landroid/net/Uri;
    ...
    iget-object v6, v0, LX/0dDL;->LLILLL:Landroid/net/Uri;
    ...
    :cond_1
    iget-object v3, v0, LX/0dDL;->LLILLL:Landroid/net/Uri;
    ...
    :cond_2
    iget-object v3, v0, LX/0dDL;->LLILZ:Landroid/content/Context;
    ...
    iget-object v11, v0, LX/0dDL;->LLILZIL:Ljava/lang/String;

    iget-object v13, v0, LX/0dDL;->LLILZLL:Ljava/lang/String;

    iget-object v6, v0, LX/0dDL;->LLIZ:Ljava/lang/String;

    iget-object v1, v0, LX/0dDL;->LLIZLLLIL:Ljava/lang/String;

    iget-object v4, v0, LX/0dDL;->LLJ:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;

    iget-object v9, v0, LX/0dDL;->LLJI:Ljava/lang/String;

    iget-object v8, v0, LX/0dDL;->LLJIJIL:Ljava/lang/String;

    iget-object v7, v0, LX/0dDL;->LLJILJIL:Ljava/lang/String;
    ...
    invoke-interface {v10}, Lcom/bytedance/android/livesdk/comp/api/subscription/ISubscribeService;->nc()LX/0dDG;
    ...
    invoke-static {v3, v10, v2}, LX/0dDG;->LIZJ(Landroidx/fragment/app/FragmentManager;LX/0dg0;Ljava/util/Map;)V

    :cond_6
    iget-object v1, v0, LX/0dDL;->LLILZ:Landroid/content/Context;
    ...
    iget-object v3, v0, LX/0dDL;->LLJILJILJ:LX/0dDP;

    iget-object v1, v0, LX/0dDL;->LLILZ:Landroid/content/Context;

    iget-object v2, v0, LX/0dDL;->LLJILLL:LX/00zH;

    iget-object v0, v3, LX/0dDP;->LIZ:LX/05ta;
    ...
    invoke-direct {v0, v2}, LX/0cPv;-><init>(LX/00zH;)V
