...
# instance fields
.field public final synthetic LIZ:LX/0cdb;


# direct methods
.method public constructor <init>(LX/0cdb;)V
    .locals 0

    iput-object p1, p0, LX/0cde;->LIZ:LX/0cdb;
...
.method public final LJJLIIIJLLLLLLLZ(Landroid/view/View;Ljava/lang/String;)V
    ...
    iget-object v0, p0, LX/0cde;->LIZ:LX/0cdb;

    iget-object v0, v0, LX/0cdb;->LLILLIZIL:LX/0cbl;
    ...
    :goto_0
    iget-object v6, p0, LX/0cde;->LIZ:LX/0cdb;

    if-nez v7, :cond_1

    const-string v0, "slotGate\'s context is not FragmentActivity during live"
    ...
    const-string v1, "live_ba_leads_gen_schema"
    ...
    iget-object v0, v6, LX/0cdb;->LLILL:Lcom/bytedance/android/livesdkapi/depend/model/live/Room;
    ...
    invoke-static {v4, v3, v2, v0, p2}, LX/0W4A;->LIZIZ(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    const-string v0, "Leads gen\'s schema is null during live"
