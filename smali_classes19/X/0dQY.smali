...
.method public constructor <init>(Landroid/view/View;Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/feed/vm/SubSpaceFeedVM;)V
    ...
    iput-object p1, p0, LX/0dQY;->LL:Landroid/view/View;

    iput-object p2, p0, LX/0dQY;->LLILIL:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/feed/vm/SubSpaceFeedVM;
    ...
    iput-object v0, p0, LX/0dQY;->LLILL:LX/12nN;
    ...
    iput-object v0, p0, LX/0dQY;->LLILLIZIL:LX/12nN;
    ...
    iput-object v0, p0, LX/0dQY;->LLILLJJLI:LX/12nN;
    ...
    iput-object v0, p0, LX/0dQY;->LLILLL:LX/0D0r;
    ...
    iput-object v0, p0, LX/0dQY;->LLILZ:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    iput-object v0, p0, LX/0dQY;->LLILZIL:Landroid/view/View;
    ...
    iput-object v0, p0, LX/0dQY;->LLILZLL:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
...
.method public final y6(LX/0dS3;LX/02Ee;)V
    ...
    :cond_3
    iget-object v4, p1, LX/0dQe;->LIZ:Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;

    iget-object v2, p0, LX/0dQY;->LLILLIZIL:LX/12nN;
    ...
    invoke-static {v5, v6}, LX/0guq;->LIZ(J)Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0dQY;->LLILZ:Lcom/bytedance/android/live/design/view/icon/LiveIconView;

    invoke-static {v0}, LX/0cTD;->LJZI(Landroid/view/View;)V

    iget-object v0, p0, LX/0dQY;->LLILZIL:Landroid/view/View;

    invoke-static {v0}, LX/0cTD;->LJZI(Landroid/view/View;)V

    iget-object v5, p0, LX/0dQY;->LLILZIL:Landroid/view/View;

    if-eqz v5, :cond_4

    iget-object v0, p0, LX/0dQY;->LL:Landroid/view/View;
    ...
    invoke-static {v1, v2, v0, v0}, LX/0d83;->LIZ(FIII)Landroid/graphics/drawable/GradientDrawable;
    ...
    :cond_4
    iget-object v0, p0, LX/0dQY;->LLILZLL:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    :cond_5
    iget-object v1, p0, LX/0dQY;->LL:Landroid/view/View;

    new-instance v0, LX/0dQX;

    invoke-direct {v0, v4, v3, p0}, LX/0dQX;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;LX/0dMp;LX/0dQY;)V

    invoke-static {v0, v1}, LX/0X3I;->y3(Landroid/view/View$OnClickListener;Landroid/view/View;)V

    iget-object v1, p0, LX/0dQY;->LLILLL:LX/0D0r;

    new-instance v0, LX/0dQb;

    invoke-direct {v0, v4, v3, p0, p1}, LX/0dQb;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;LX/0dMp;LX/0dQY;LX/0dQe;)V

    invoke-static {v0, v1}, LX/0X3I;->y3(Landroid/view/View$OnClickListener;Landroid/view/View;)V

    iget-object v1, p1, LX/0dQe;->LIZ:Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;

    iget-object v3, p0, LX/0dQY;->LLILL:LX/12nN;

    iget-object v0, p0, LX/0dQY;->LLILIL:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/feed/vm/SubSpaceFeedVM;
    ...
    iget-object v0, p1, LX/0dQe;->LIZ:Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;
    ...
    iget-object v1, p0, LX/0dQY;->LLILLJJLI:LX/12nN;
    ...
    iget-object v0, p0, LX/0dQY;->LLILLL:LX/0D0r;
