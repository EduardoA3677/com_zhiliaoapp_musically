...
# instance fields
.field public final LL:LX/0XC5;

.field public final synthetic LLILIL:LX/05dO;


# direct methods
.method public constructor <init>(LX/05dO;Landroid/view/ViewGroup;)V
    .locals 2
    ...
    iput-object p1, p0, LX/0d0d;->LLILIL:LX/05dO;

    new-instance v1, LX/0XC5;

    invoke-virtual {p2}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {v1, v0}, LX/0XC5;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v1}, LX/05dP;-><init>(Landroid/view/View;)V

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    instance-of v0, v1, LX/0XC5;

    if-eqz v0, :cond_0

    check-cast v1, LX/0XC5;

    :goto_0
    iput-object v1, p0, LX/0d0d;->LL:LX/0XC5;
...
.method public final y6(I)V
    ...
    iget-object v0, p0, LX/0d0d;->LLILIL:LX/05dO;

    iget-object v0, v0, LX/05dO;->LL:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, LX/0d0d;->LL:LX/0XC5;

    const/4 v2, 0x0

    if-eqz v0, :cond_12

    invoke-virtual {v0}, LX/0XC5;->getBadgeStr()LX/12nN;
    ...
    invoke-virtual {v0}, LX/0XC5;->getBadgeLine()Landroid/view/View;
    ...
    iget-object v1, p0, LX/0d0d;->LL:LX/0XC5;

    if-eqz v1, :cond_2

    const/high16 v0, 0x3f800000    # 1.0f

    invoke-virtual {v1, v0}, LX/0XC5;->setItemScale(F)V

    :cond_2
    :goto_2
    sget-object v6, LX/18Pb;->LIZ:Ljava/util/List;

    invoke-static {p1, v6}, LX/0zFB;->LJJJLZIJ(ILjava/util/List;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LX/0d0f;
    ...
    :cond_3
    iget-object v0, v1, LX/0d0f;->LIZ:Ljava/lang/String;

    invoke-static {v0}, LX/0dJD;->LIZJ(Ljava/lang/String;)I

    move-result v10

    iget-object v0, v1, LX/0d0f;->LIZIZ:Ljava/lang/String;

    invoke-static {v0}, LX/0dJD;->LIZJ(Ljava/lang/String;)I

    move-result v9

    iget-object v0, v1, LX/0d0f;->LIZJ:Ljava/lang/String;
    ...
    invoke-virtual {v0}, LX/0XC5;->getBadgeContainer()Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v0}, LX/0XC5;->getDes()LX/12nN;
    ...
    invoke-virtual {v0}, LX/0XC5;->getBadgeIcon()LX/0D0r;
