...
.annotation runtime LX/0PaH;
    c = "com.bytedance.android.livesdk.gift.base.platform.business.panel.portrait.leaf.GiftPanelBottomLeaf$tryShowPanelBottom$1"
    f = "GiftPanelBottomLeaf.kt"
    l = {
        0x576
    }
    m = "invokeSuspend"
...
.field public final synthetic LLILIL:LX/0e5A;


# direct methods
.method public constructor <init>(LX/0e5A;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LX/0e5C;->LLILIL:LX/0e5A;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    iget-object v0, p0, LX/0e5C;->LLILIL:LX/0e5A;

    invoke-direct {v1, v0, p2}, LX/0e5C;-><init>(LX/0e5A;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v20, "GiftPanelBottomLeaf@1211.tryShowPanelBottom$1"
    ...
    :cond_0
    iget-object v7, v3, LX/0e5C;->LLILIL:LX/0e5A;

    iget-object v0, v7, LX/0e5A;->LLJILJIL:Landroid/widget/TextView;
    ...
    :cond_1
    iget-object v0, v7, LX/0e5A;->LLJILJILJ:Landroid/widget/TextView;
    ...
    iput-boolean v11, v7, LX/0e5A;->LLJLLL:Z
    ...
    invoke-static {v1, v1}, LX/0e5A;->LJJJJL(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v6, v3, v0}, Lcom/bytedance/mt/protector/impl/collections/ListProtector;->set(Ljava/util/List;ILjava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {v8, v6}, LX/0U9d;->LJ(Ljava/lang/Object;)V

    invoke-virtual {v7}, LX/0e5A;->LJJIJL()Landroid/animation/AnimatorSet;
    ...
    iget-object v0, v7, LX/0e5Y;->LLILLIZIL:Landroid/view/View;
    ...
    invoke-static {v1, v0}, LX/0e5A;->LJJJJL(Ljava/lang/String;Ljava/util/Map;)V
    ...
    iput-boolean v3, v7, LX/0e5A;->LLJLLL:Z
    ...
    invoke-virtual {v7, v0}, LX/0e5A;->LJJJJJ(Lkotlin/jvm/functions/Function0;)V
    ...
    :goto_2
    iget-boolean v0, v7, LX/0e5A;->LLJLLL:Z
    ...
    :goto_3
    invoke-static {v0, v1}, LX/0e5A;->LJJJJL(Ljava/lang/String;Ljava/util/Map;)V
