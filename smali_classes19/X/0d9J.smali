...
.method public constructor <init>(Landroid/view/View;Lkotlin/jvm/functions/Function0;)V
    ...
    iput-object p2, p0, LX/0d9J;->LLILIL:Lkotlin/jvm/functions/Function0;

    const v0, 0x3f3a06d4

    iput v0, p0, LX/0d9J;->LLILL:F
    ...
    iput-object v0, p0, LX/0d9J;->LLILLIZIL:LX/12nN;
    ...
    iput-object v0, p0, LX/0d9J;->LLILLJJLI:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    iput-object v0, p0, LX/0d9J;->LLILLL:LX/12nN;
    ...
    iput-object v0, p0, LX/0d9J;->LLILZ:LX/12nN;
    ...
    iput-object v0, p0, LX/0d9J;->LLILZIL:Landroid/view/View;
    ...
    iput-object v0, p0, LX/0d9J;->LLILZLL:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, LX/0d9J;->LLIZ:LX/0D0r;
    ...
    iput-object v0, p0, LX/0d9J;->LLIZLLLIL:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, LX/0d9J;->LLJ:LX/0D0r;
    ...
    iput-object v0, p0, LX/0d9J;->LLJI:LX/0D0r;
    ...
    iput-object v0, p0, LX/0d9J;->LLJIJIL:LX/0D0r;
    ...
    iput-object v0, p0, LX/0d9J;->LLJILJIL:LX/0d3Z;
    ...
    iput-object v0, p0, LX/0d9J;->LLJILJILJ:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    iput-object v0, p0, LX/0d9J;->LLJILLL:Lcom/bytedance/tux/icon/TuxIconView;
    ...
    iput-object v0, p0, LX/0d9J;->LLJJ:Lcom/bytedance/tux/tag/TuxTag;
    ...
    iput-object v0, p0, LX/0d9J;->LLJJI:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    iput-object v0, p0, LX/0d9J;->LLJJIII:Lcom/bytedance/tux/icon/TuxIconView;
    ...
    iput-object v0, p0, LX/0d9J;->LLJJIJI:Lcom/bytedance/tux/tag/TuxTag;
    ...
    iput-object v0, p0, LX/0d9J;->LLJJIJIIJIL:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    iput-object v0, p0, LX/0d9J;->LLJJIJIL:Lcom/bytedance/tux/icon/TuxIconView;
    ...
    iput-object v0, p0, LX/0d9J;->LLJJJ:Lcom/bytedance/tux/tag/TuxTag;
...
.method public final F6(Lcom/bytedance/android/livesdk/chatroom/api/SOVBriefInfo;Ljava/lang/Long;Ljava/lang/String;LX/0D0r;Landroidx/constraintlayout/widget/ConstraintLayout;Lcom/bytedance/tux/icon/TuxIconView;Lcom/bytedance/tux/tag/TuxTag;)V
    ...
    invoke-direct {v0, p4, p1, p2, p3}, LX/0d9L;-><init>(LX/0D0r;Lcom/bytedance/android/livesdk/chatroom/api/SOVBriefInfo;Ljava/lang/Long;Ljava/lang/String;)V
    ...
    :cond_b
    iget-object v0, p0, LX/0d9J;->LLJILJILJ:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public final y6(LX/0dna;)V
    ...
    check-cast v4, LX/0d7e;

    move-object/from16 v11, p0

    invoke-virtual {v11, v4}, LX/0d9P;->E6(LX/0d7e;)V

    iget-object v3, v4, LX/0d7e;->LLILLIZIL:Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;

    iget-object v8, v4, LX/0d7e;->LLILLJJLI:Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;

    if-eqz v8, :cond_5

    iget-object v1, v3, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->subOnlyVideosBriefInfo:Lcom/bytedance/android/livesdk/chatroom/api/SubOnlyVideosBriefInfo;
    ...
    :goto_0
    iget-object v6, v11, LX/0d9J;->LLILLIZIL:LX/12nN;
    ...
    :cond_2
    iget-object v5, v8, Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/AbsPrivilegeDetailBaseFragment;->LLIZLLLIL:Ljava/lang/String;
    ...
    iget-object v0, v11, LX/0d9J;->LLILLIZIL:LX/12nN;
    ...
    :cond_3
    iget-object v2, v11, LX/0d9J;->LLIZ:LX/0D0r;
    ...
    iget-object v0, v11, LX/0d9J;->LLIZ:LX/0D0r;
    ...
    :cond_4
    iget-object v0, v11, LX/0d9J;->LLIZLLLIL:Landroid/view/ViewGroup;
    ...
    :cond_6
    iget-object v6, v3, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->subOnlyVideosBriefInfo:Lcom/bytedance/android/livesdk/chatroom/api/SubOnlyVideosBriefInfo;
    ...
    iget-object v6, v11, LX/0d9J;->LLILLL:LX/12nN;
    ...
    :cond_8
    iget-object v6, v11, LX/0d9J;->LLILZ:LX/12nN;
    ...
    :cond_a
    iget-object v5, v11, LX/0d9J;->LLIZLLLIL:Landroid/view/ViewGroup;
    ...
    :cond_b
    iget-object v9, v11, LX/0d9J;->LLILZIL:Landroid/view/View;

    if-eqz v9, :cond_c

    iget-object v5, v3, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->subOnlyVideosBriefInfo:Lcom/bytedance/android/livesdk/chatroom/api/SubOnlyVideosBriefInfo;
    ...
    :cond_c
    iget-object v6, v11, LX/0d9J;->LLIZLLLIL:Landroid/view/ViewGroup;
    ...
    :cond_d
    iget-object v5, v11, LX/0d9J;->LLIZ:LX/0D0r;
    ...
    iget-object v5, v11, LX/0d9J;->LLJILJIL:LX/0d3Z;

    invoke-static {v5}, LX/0cTD;->LJIIL(Landroid/view/View;)V

    :cond_f
    :goto_7
    iget-object v6, v11, LX/0d9J;->LLJ:LX/0D0r;

    if-eqz v6, :cond_10

    iget v5, v11, LX/0d9J;->LLILL:F

    invoke-virtual {v6, v5}, LX/128p;->setAspectRatio(F)V

    :cond_10
    iget-object v6, v11, LX/0d9J;->LLJI:LX/0D0r;
    ...
    :cond_11
    iget-object v6, v11, LX/0d9J;->LLJIJIL:LX/0D0r;
    ...
    :goto_8
    iget-object v5, v3, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->anchorDetail:Lcom/bytedance/android/live/base/model/user/User;
    ...
    :goto_a
    iget-object v15, v11, LX/0d9J;->LLJ:LX/0D0r;

    iget-object v8, v11, LX/0d9J;->LLJILJILJ:Landroidx/constraintlayout/widget/ConstraintLayout;

    iget-object v6, v11, LX/0d9J;->LLJILLL:Lcom/bytedance/tux/icon/TuxIconView;

    iget-object v5, v11, LX/0d9J;->LLJJ:Lcom/bytedance/tux/tag/TuxTag;
    ...
    invoke-virtual/range {v11 .. v18}, LX/0d9J;->F6(Lcom/bytedance/android/livesdk/chatroom/api/SOVBriefInfo;Ljava/lang/Long;Ljava/lang/String;LX/0D0r;Landroidx/constraintlayout/widget/ConstraintLayout;Lcom/bytedance/tux/icon/TuxIconView;Lcom/bytedance/tux/tag/TuxTag;)V
    ...
    :goto_d
    iget-object v15, v11, LX/0d9J;->LLJI:LX/0D0r;

    iget-object v7, v11, LX/0d9J;->LLJJI:Landroidx/constraintlayout/widget/ConstraintLayout;

    iget-object v6, v11, LX/0d9J;->LLJJIII:Lcom/bytedance/tux/icon/TuxIconView;

    iget-object v5, v11, LX/0d9J;->LLJJIJI:Lcom/bytedance/tux/tag/TuxTag;
    ...
    :goto_f
    iget-object v3, v3, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->anchorDetail:Lcom/bytedance/android/live/base/model/user/User;
    ...
    :cond_13
    iget-object v7, v11, LX/0d9J;->LLJIJIL:LX/0D0r;

    iget-object v6, v11, LX/0d9J;->LLJJIJIIJIL:Landroidx/constraintlayout/widget/ConstraintLayout;

    iget-object v5, v11, LX/0d9J;->LLJJIJIL:Lcom/bytedance/tux/icon/TuxIconView;

    iget-object v3, v11, LX/0d9J;->LLJJJ:Lcom/bytedance/tux/tag/TuxTag;
    ...
    invoke-virtual/range {v16 .. v23}, LX/0d9J;->F6(Lcom/bytedance/android/livesdk/chatroom/api/SOVBriefInfo;Ljava/lang/Long;Ljava/lang/String;LX/0D0r;Landroidx/constraintlayout/widget/ConstraintLayout;Lcom/bytedance/tux/icon/TuxIconView;Lcom/bytedance/tux/tag/TuxTag;)V
    ...
    iget-object v1, v11, LX/0d9J;->LLILLJJLI:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    :cond_14
    iget-object v1, v4, LX/0d7e;->LLILLIZIL:Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;

    iget-object v3, v1, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->anchorDetail:Lcom/bytedance/android/live/base/model/user/User;

    iget-object v2, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    new-instance v1, LX/0dCG;

    invoke-direct {v1, v3, v0, v11}, LX/0dCG;-><init>(Lcom/bytedance/android/live/base/model/user/User;ILX/0d9J;)V
    ...
    iget-object v6, v11, LX/0d9J;->LLJILJIL:LX/0d3Z;
    ...
    iget-object v0, v11, LX/0d9J;->LLILZLL:Landroid/view/ViewGroup;
    ...
    :cond_25
    iget-object v0, v11, LX/0d9J;->LLILLJJLI:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
