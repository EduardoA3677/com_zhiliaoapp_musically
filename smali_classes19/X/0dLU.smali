...
.method public constructor <init>(Landroid/view/View;Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/feed/vm/SubSpaceFeedVM;)V
    ...
    iput-object p1, p0, LX/0dLU;->LL:Landroid/view/View;

    iput-object p2, p0, LX/0dLU;->LLILIL:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/feed/vm/SubSpaceFeedVM;
    ...
    iput-object v0, p0, LX/0dLU;->LLILL:LX/12nN;
    ...
    iput-object v0, p0, LX/0dLU;->LLILLIZIL:LX/0D0r;
...
.method public final y6(LX/0dS3;LX/02Ee;)V
    ...
    :goto_0
    iget-object v0, p0, LX/0dLU;->LL:Landroid/view/View;
    ...
    iget-object v0, p0, LX/0dLU;->LLILIL:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/feed/vm/SubSpaceFeedVM;
    ...
    iget-object v5, p0, LX/0dLU;->LLILL:LX/12nN;

    const/4 v9, 0x0

    if-eqz p2, :cond_1

    iget-boolean v1, p2, LX/0dMp;->LLILLJJLI:Z
    ...
    :catchall_0
    :try_start_2
    new-instance v1, LX/0dLT;

    invoke-direct {v1, p0}, LX/0dLT;-><init>(LX/0dLU;)V
    ...
    :cond_3
    iget-object v1, p0, LX/0dLU;->LLILL:LX/12nN;
    ...
    :goto_7
    iget-object v3, p0, LX/0dLU;->LLILLIZIL:LX/0D0r;
