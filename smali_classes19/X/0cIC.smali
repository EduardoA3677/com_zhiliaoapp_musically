...
# static fields
.field public static final LIZ:LX/0cIC;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0}, LX/0cIC;-><init>()V

    sput-object v0, LX/0cIC;->LIZ:LX/0cIC;
...
# virtual methods
.method public final LIZ(Landroid/content/Context;Lorg/json/JSONObject;LX/0cIG;)V
    .locals 9
    ...
    sget-object v6, LX/0cFB;->FromClient:LX/0cFB;

    iput-object v6, v4, Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;->LIZLLL:LX/0cFB;
    ...
    :cond_0
    iput-wide v2, v4, Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;->LIZ:J

    iput-wide v0, v4, Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;->LIZIZ:J

    iput-boolean v7, v4, Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;->LJ:Z
    ...
    :cond_2
    iput-object v3, v4, Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;->LJFF:Ljava/util/HashMap;

    if-eqz v3, :cond_4

    const-string v2, "click_user_position"
    ...
    :cond_3
    iput-boolean v5, v4, Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;->LJI:Z

    :cond_4
    invoke-virtual {p0, p1, v4, p3}, LX/0cIC;->LIZIZ(Landroid/content/Context;Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;LX/0cIG;)V

    return-void
.end method

.method public final LIZIZ(Landroid/content/Context;Lcom/bytedance/android/livesdkapi/depend/model/follow/FollowPair;LX/0cIG;)V
    .locals 9
    ...
    invoke-direct {v2, v7, v0}, LY/AfS140S0100000_18;-><init>(Ljava/lang/Object;I)V
