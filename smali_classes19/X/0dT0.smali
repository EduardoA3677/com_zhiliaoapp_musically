...
.field public final synthetic LLILL:LX/0dSz;


# direct methods
.method public constructor <init>(LX/0dTm;LX/0dSq;LX/0dSz;)V
    .locals 0

    iput-object p1, p0, LX/0dT0;->LL:Lkotlin/jvm/functions/Function0;

    iput-object p2, p0, LX/0dT0;->LLILIL:LX/0dSq;

    iput-object p3, p0, LX/0dT0;->LLILL:LX/0dSz;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    const-string v17, "DetailFeedManager@b45b.loadNextReply$1"
    ...
    iget-object v0, v2, LX/0dT0;->LL:Lkotlin/jvm/functions/Function0;

    invoke-interface {v0}, Lkotlin/jvm/functions/Function0;->invoke()Ljava/lang/Object;

    iget-object v11, v1, Lcom/bytedance/android/live/network/response/BaseResponse;->data:Ljava/lang/Object;

    check-cast v11, Lwebcast/api/pgc_sub/PGCCommentPageResponse$ResponseData;

    if-eqz v11, :cond_8

    iget-object v9, v2, LX/0dT0;->LLILIL:LX/0dSq;

    iget-object v8, v2, LX/0dT0;->LLILL:LX/0dSz;

    iget-object v12, v8, LX/0dSz;->LIZ:Lcom/bytedance/android/livesdk/chatroom/api/SpaceCommentItem;

    invoke-virtual {v9}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-wide v0, v11, Lwebcast/api/pgc_sub/PGCCommentPageResponse$ResponseData;->offset:J

    iput-wide v0, v8, LX/0dSz;->LIZJ:J

    iget-object v0, v9, LX/0dSq;->LLILL:LX/0dSk;
    ...
    invoke-virtual {v8}, LX/0dSz;->LIZLLL()J
    ...
    iget-object v1, v11, Lwebcast/api/pgc_sub/PGCCommentPageResponse$ResponseData;->commentList:Ljava/util/List;
    ...
    iget-object v10, v0, LX/0dOs;->LL:Ljava/util/ArrayList;
    ...
    iget-object v0, v1, LX/0dSx;->LIZ:Lcom/bytedance/android/livesdk/chatroom/api/SpaceCommentItem;
    ...
    iget-object v0, v9, LX/0dSq;->LLILIL:LX/0dSX;
    ...
    :goto_2
    invoke-direct {v1, v5, v0}, LX/0dSx;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpaceCommentItem;Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;)V
    ...
    iget-wide v4, v11, Lwebcast/api/pgc_sub/PGCCommentPageResponse$ResponseData;->totalCount:J

    int-to-long v2, v0

    sub-long v0, v4, v2

    iput-wide v0, v8, LX/0dSz;->LIZIZ:J

    iput-wide v4, v8, LX/0dSz;->LIZLLL:J
    ...
    iget-object v1, v9, LX/0dSq;->LLILL:LX/0dSk;
