...
.method public static LIZ(Lcom/bytedance/android/livesdk/chatroom/api/UpdateTips;Landroid/content/Context;Z)Landroid/text/SpannableStringBuilder;
    .locals 8
    ...
    iget-object v0, p0, Lcom/bytedance/android/livesdk/chatroom/api/UpdateTips;->desc:Ljava/lang/String;

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v0, p0, Lcom/bytedance/android/livesdk/chatroom/api/UpdateTips;->btnText:Ljava/lang/String;
    ...
    new-instance v3, LX/0cvi;

    move-object v4, p1

    invoke-direct {v3, v0, p0, v4, p2}, LX/0cvi;-><init>(LX/01lt;Lcom/bytedance/android/livesdk/chatroom/api/UpdateTips;Landroid/content/Context;Z)V

    iget-object v2, p0, Lcom/bytedance/android/livesdk/chatroom/api/UpdateTips;->btnText:Ljava/lang/String;

    const/4 v1, 0x6

    const/4 v0, 0x0

    invoke-static {v5, v2, v0, v0, v1}, Lkotlin/text/b0;->LJJIL(Ljava/lang/CharSequence;Ljava/lang/String;IZI)I
    ...
    :goto_1
    :try_start_3
    invoke-virtual {v5, v0, v6, v7, p0}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
...
.method public static LIZIZ(Landroid/content/Context;Landroid/content/Context;Lkotlin/jvm/functions/Function0;)Landroid/text/SpannableStringBuilder;
    ...
    new-instance v0, LX/16n5;

    invoke-direct {v0, p1}, LX/16n5;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p2}, LX/0dgA;-><init>(Lkotlin/jvm/functions/Function0;)V
...
.method public static LIZJ(LX/0dg0;Ljava/lang/Boolean;)LX/0dkh;
    .locals 15
    ...
    :goto_0
    iget v3, p0, LX/0dg0;->LJ:I

    iget-object v4, p0, LX/0dg0;->LJFF:Ljava/lang/String;

    iget-wide v5, p0, LX/0dg0;->LJJIIJZLJL:J

    iget-wide v7, p0, LX/0dg0;->LJJIIZ:J

    new-instance v13, LX/0dg8;

    invoke-direct {v13}, LX/0dg8;-><init>()V

    iget-object v11, p0, LX/0dg0;->LJI:Ljava/lang/String;

    iget-boolean p0, p0, LX/0dg0;->LJJIIZI:Z
    ...
    invoke-direct/range {v0 .. v16}, LX/0dkh;-><init>(Ljava/lang/String;ZILjava/lang/String;JJZLX/0ddj;Ljava/lang/String;Landroid/content/Context;LX/0dl6;Ljava/util/Map;ZI)V

    return-object v0

    :cond_0
    iget-boolean v2, p0, LX/0dg0;->LIZLLL:Z
...
.method public static LJFF(Ljava/lang/Integer;ILX/0deu;LX/0dfb;)V
    .locals 4
    ...
    iget v0, p3, LX/0dfb;->LIZJ:I

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-object v0, p3, LX/0dfb;->LJ:Lcom/bytedance/android/livesdk/subscribe/model/PreCheckResult;
    ...
    iget-boolean v0, p3, LX/0dfb;->LJII:Z
    ...
    :cond_a
    iget-boolean v0, p3, LX/0dfb;->LJIIIIZZ:Z
