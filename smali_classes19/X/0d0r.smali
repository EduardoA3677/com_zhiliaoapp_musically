...
.field public final synthetic LIZIZ:Lwebcast/api/sub/GetSubPrivilegeDetailResponse$Data;

.field public final synthetic LIZJ:LX/0d0M;

.field public final synthetic LIZLLL:LX/0d80;


# direct methods
.method public constructor <init>(Lcom/bytedance/android/livesdk/comp/impl/subscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;Lwebcast/api/sub/GetSubPrivilegeDetailResponse$Data;LX/0d0M;LX/0d80;)V
    .locals 0

    iput-object p1, p0, LX/0d0r;->LIZ:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;

    iput-object p2, p0, LX/0d0r;->LIZIZ:Lwebcast/api/sub/GetSubPrivilegeDetailResponse$Data;

    iput-object p3, p0, LX/0d0r;->LIZJ:LX/0d0M;

    iput-object p4, p0, LX/0d0r;->LIZLLL:LX/0d80;
...
.method public final subscribe(LX/03he;)V
    ...
    const-string v20, "CustomizedPerksItemViewHolder@91f2.onBindViewHolder$3"
    ...
    iget-object v0, v8, LX/0d0r;->LIZ:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;
    ...
    iget-object v0, v8, LX/0d0r;->LIZIZ:Lwebcast/api/sub/GetSubPrivilegeDetailResponse$Data;

    iget-object v0, v0, Lwebcast/api/sub/GetSubPrivilegeDetailResponse$Data;->customizedBenefits:Ljava/util/List;
    ...
    iget-object v3, v8, LX/0d0r;->LIZJ:LX/0d0M;

    iget-object v2, v8, LX/0d0r;->LIZLLL:LX/0d80;

    iget-object v1, v8, LX/0d0r;->LIZ:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;
    ...
    new-instance v9, LX/0d1B;

    const/4 v0, 0x6

    invoke-direct {v9, v4, v11, v0, v10}, LX/0d1B;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iget-object v0, v2, LX/0d7a;->LLILLJJLI:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;
    ...
    :cond_6
    new-instance v3, LX/0d0S;

    invoke-direct {v3, v1}, LX/0d0S;-><init>(Lcom/bytedance/android/livesdk/comp/impl/subscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;)V
    ...
    new-instance v14, LX/0d0t;

    move-object/from16 v0, v16

    invoke-direct {v14, v3, v11, v0}, LX/0d0t;-><init>(LX/0d0S;Landroidx/fragment/app/FragmentManager;Lcom/bytedance/android/livesdk/chatroom/api/PerkTag;)V
    ...
    invoke-virtual {v9}, LX/0d1B;->getTitle()LX/12nN;
    ...
    invoke-virtual {v9}, LX/0d1B;->getSubtitle()LX/12nN;
    ...
    invoke-virtual {v9}, LX/0d1B;->getIcon()LX/0D0r;
