...
# direct methods
.method public static final LIZ(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/functions/Function2;)V
    .locals 3
    ...
    iput-object p2, v1, LX/0c7m;->LJ:Ljava/lang/String;

    iput-object p3, v1, LX/0c7m;->LIZLLL:Ljava/lang/String;
    ...
    new-instance v1, LX/00zR;

    invoke-direct {v1, p4}, LX/00zR;-><init>(Lkotlin/jvm/functions/Function2;)V

    new-instance v0, LX/00zS;

    invoke-direct {v0, p4}, LX/00zS;-><init>(Lkotlin/jvm/functions/Function2;)V
...
.method public static final LIZIZ(Landroid/view/View;Ljava/lang/Runnable;J)V
    .locals 1

    new-instance v0, LX/053J;

    invoke-direct {v0, p0, p1}, LX/053J;-><init>(Landroid/view/View;Ljava/lang/Runnable;)V

    invoke-static {p0, v0, p2, p3}, Lcom/bytedance/bpea/transmit/hook/HandlerHook;->viewPostDelay(Landroid/view/View;Ljava/lang/Runnable;J)Z
...
.method public static final LIZJ(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    invoke-direct {v0, p0, p1}, LX/0XCF;-><init>(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static final LJFF(Ljava/util/Map;)Ljava/util/Map;
    .locals 4
