...
# static fields
.field public static final LIZ:LX/0ddi;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0}, LX/0ddi;-><init>()V

    sput-object v0, LX/0ddi;->LIZ:LX/0ddi;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    sput-object v0, LX/0ddi;->LIZIZ:Ljava/util/Map;
    ...
    sput-object v0, LX/0ddi;->LIZLLL:Ljava/util/List;
...
.method public static final LJ()V
    ...
    sput-object v2, LX/0ddi;->LIZJ:LX/0drm;
    ...
    iput-object v2, v0, Lwebcast/api/sub/TemplateListData;->preCheckResult:Lcom/bytedance/android/livesdk/subscribe/model/PreCheckResult;
...
.method public final LIZ(Ljava/lang/String;Ljava/lang/String;Z)LX/0deG;
    ...
    invoke-virtual {p0, p1, v3, v1}, LX/0ddi;->LIZJ(Ljava/lang/String;ILX/0ddj;)LX/0ddn;
    ...
    :cond_0
    invoke-virtual {p0, p1, v2, v1}, LX/0ddi;->LIZJ(Ljava/lang/String;ILX/0ddj;)LX/0ddn;
    ...
    :cond_1
    invoke-virtual {p0, p1, v4, v1}, LX/0ddi;->LIZJ(Ljava/lang/String;ILX/0ddj;)LX/0ddn;
    ...
    sget-object v1, LX/0ddi;->LIZ:LX/0ddi;

    sget-object v0, LX/0ddj;->NORMAL_SUBSCRIPTION:LX/0ddj;

    invoke-virtual {v1, p1, v3, v0}, LX/0ddi;->LIZJ(Ljava/lang/String;ILX/0ddj;)LX/0ddn;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v0, v0, LX/0ddn;->LIZIZ:Ljava/util/Map;
    ...
    :cond_4
    invoke-static {p2, v0}, LX/0dgj;->LIZIZ(Ljava/lang/String;Ljava/util/List;)Z
...
.method public final LIZIZ(Ljava/lang/String;ILX/0ddj;)V
    ...
    invoke-static {p2, p1}, LX/0ddi;->LIZLLL(ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, LX/0ddn;->LIZJ:Ljava/util/Set;
...
.method public final LIZJ(Ljava/lang/String;ILX/0ddj;)LX/0ddn;
    .locals 3
    ...
    iget-object v0, v1, LX/0ddn;->LIZJ:Ljava/util/Set;
...
.method public final LJFF(Ljava/lang/String;ILX/0ddj;Ljava/util/Map;)V
    ...
    sget-object v3, LX/0ddi;->LIZIZ:Ljava/util/Map;
    ...
    invoke-direct {v2, v0}, LX/0ddn;-><init>(Ljava/lang/Object;)V

    :cond_0
    iput-object p4, v2, LX/0ddn;->LIZIZ:Ljava/util/Map;
