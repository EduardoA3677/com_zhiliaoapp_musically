...
.field public final LLILZIL:Landroidx/recyclerview/widget/RecyclerView;
...
.method public constructor <init>(Landroid/view/View;Z)V
    ...
    iput-boolean p2, p0, LX/0d08;->LLILIL:Z

    const/high16 v0, 0x41000000    # 8.0f

    iput v0, p0, LX/0d08;->LLILL:F

    const/4 v0, 0x5

    iput v0, p0, LX/0d08;->LLILLJJLI:I
    ...
    iput-object v0, p0, LX/0d08;->LLILZ:LX/12nN;
    ...
    iput-object v1, p0, LX/0d08;->LLILZIL:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object v0, p0, LX/0d08;->LLILZLL:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, LX/0d08;->LLIZ:LX/12nN;
    ...
    iput-object v0, p0, LX/0d08;->LLIZLLLIL:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    iput-object v0, p0, LX/0d08;->LLJ:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
...
.method public final A6()V
    ...
    iget-object v1, p0, LX/0d08;->LLJI:LX/0CKR;

    if-eqz v1, :cond_0

    iget-object v0, p0, LX/0d08;->LLILZIL:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final y6(LX/0dna;)V
    ...
    iget-object v5, p1, LX/0d7e;->LLILLIZIL:Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;

    iget-object v4, p1, LX/0d7e;->LLILLJJLI:Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;
    ...
    :goto_0
    iget v1, p0, LX/0d08;->LLILL:F

    iget v0, p0, LX/0d08;->LLILLJJLI:I
    ...
    :cond_1
    new-instance v7, LX/0d0A;

    invoke-direct {v7, p0, v3, v8, v4}, LX/0d0A;-><init>(LX/0d08;Landroid/content/Context;ILcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;)V

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {v4}, Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;->yO()Lcom/bytedance/android/livesdk/chatroom/api/SubPackagePrivilege;
    ...
    :cond_2
    :goto_1
    iget-object v0, v5, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->emoteConfig:Lcom/bytedance/android/live/base/model/emoji/EmoteConfig;
    ...
    :cond_3
    iget-object v0, v5, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->subWaveStrikeEmotes:Ljava/util/List;
    ...
    :cond_4
    iget-object v6, p0, LX/0d08;->LLILZIL:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_7
    iget-object v1, p0, LX/0d08;->LLILZIL:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget v9, p0, LX/0d08;->LLILLJJLI:I

    iget v0, p0, LX/0d08;->LLILL:F
    ...
    iput-object v6, p0, LX/0d08;->LLJI:LX/0CKR;
    ...
    :cond_9
    iget-object v0, v7, LX/0d0A;->LLILLL:Ljava/util/List;
    ...
    iget-boolean v0, p0, LX/0d08;->LLILIL:Z
    ...
    iget-object v0, p0, LX/0d08;->LLILZ:LX/12nN;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    :cond_c
    iget-object v6, p0, LX/0d08;->LLILZLL:Landroid/view/ViewGroup;
    ...
    :cond_d
    new-instance v6, LX/0d09;

    invoke-direct {v6, p0, v7, v3}, LX/0d09;-><init>(LX/0d08;LX/0d0A;Landroid/content/Context;)V

    iget-object v7, p0, LX/0d08;->LLIZ:LX/12nN;
    ...
    :cond_e
    iget-object v0, p0, LX/0d08;->LLIZ:LX/12nN;
    ...
    :cond_f
    iget-object v0, p0, LX/0d08;->LLIZLLLIL:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    :cond_10
    iget v0, v5, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->suggestEmotesSwitch:I

    if-ne v0, v2, :cond_16

    iget-object v1, v4, Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/AbsPrivilegeDetailBaseFragment;->LL:Ljava/lang/Boolean;
    ...
    :goto_4
    iget-object v0, p0, LX/0d08;->LLJ:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    :goto_5
    iget-object v1, p0, LX/0d08;->LLJ:Lcom/bytedance/android/live/design/view/icon/LiveIconView;

    if-eqz v1, :cond_11

    new-instance v0, LX/0ck5;

    invoke-direct {v0, v4, v5, v6, v3}, LX/0ck5;-><init>(Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;Ljava/lang/String;Landroid/content/Context;)V
    ...
    iget-boolean v0, p0, LX/0d08;->LLILLL:Z

    if-nez v0, :cond_13

    iput-boolean v2, p0, LX/0d08;->LLILLL:Z
    ...
    :cond_19
    iget-object v0, v5, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->emoteDetail:Lemotes/model/EmoteListResult;
