...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, LX/0dR1;->LLILIL:LX/12nN;
    ...
    iput-object v0, p0, LX/0dR1;->LLILL:Landroidx/recyclerview/widget/RecyclerView;

    new-instance v0, LX/0dR7;

    invoke-direct {v0, p1}, LX/0dR7;-><init>(Landroid/view/View;)V

    invoke-static {v0}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, LX/0dR1;->LLILLIZIL:LX/05ta;
...
.method public final y6(LX/0dna;)V
    ...
    iget-object v0, v1, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->spaceInfo:Lwebcast/api/pgc_sub/PGCSubSpaceInfo;

    const/4 v8, 0x1

    if-eqz v0, :cond_0

    iget-object v0, v0, Lwebcast/api/pgc_sub/PGCSubSpaceInfo;->pinPost:Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;
    ...
    iget-object v0, p0, LX/0dR1;->LLILIL:LX/12nN;

    invoke-static {v0}, LX/0cTD;->LJIIL(Landroid/view/View;)V

    iget-object v0, p0, LX/0dR1;->LLILL:Landroidx/recyclerview/widget/RecyclerView;

    invoke-static {v0}, LX/0cTD;->LJZI(Landroid/view/View;)V

    :goto_0
    iget-object v0, p0, LX/0dR1;->LLILLIZIL:LX/05ta;

    invoke-interface {v0}, LX/05ta;->getValue()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, LX/0dR9;

    iget-object v0, v1, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->spaceInfo:Lwebcast/api/pgc_sub/PGCSubSpaceInfo;

    if-eqz v0, :cond_8

    iget-object v4, v0, Lwebcast/api/pgc_sub/PGCSubSpaceInfo;->pinPost:Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;

    if-eqz v4, :cond_8

    iget-object v1, v2, LX/0dR9;->LIZIZ:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, LX/0dRB;->LL:LX/0dRB;

    invoke-virtual {v1, v0}, Landroid/view/View;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    iget-object v5, v2, LX/0dR9;->LIZIZ:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {v0, v4}, LX/0dR5;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;)V
    ...
    invoke-direct {v0, v1, v4}, LX/0dSx;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpaceCommentItem;Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;)V
    ...
    invoke-direct {v0, v4}, LX/0dQz;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;)V
    ...
    invoke-direct {v0, v4}, LX/0dQj;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;)V
    ...
    :goto_3
    invoke-direct {v1, v4, v2, v0}, LX/0dRL;-><init>(Lcom/bytedance/android/livesdk/chatroom/api/SpacePost;Lcom/bytedance/android/livesdk/chatroom/api/SpacePollOption;Ljava/lang/String;)V
    ...
    :goto_4
    new-instance v2, LX/0dQA;

    invoke-direct {v2, v7}, LX/0dQA;-><init>(Ljava/util/ArrayList;)V
