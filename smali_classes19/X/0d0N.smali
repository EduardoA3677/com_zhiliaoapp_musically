...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, LX/0d0N;->LLILIL:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, LX/0d0N;->LLILL:LX/12nN;
    ...
    iput-object v0, p0, LX/0d0N;->LLILLIZIL:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    iput-object v0, p0, LX/0d0N;->LLILLJJLI:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    iput-object v0, p0, LX/0d0N;->LLILLL:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, LX/0d0N;->LLILZ:LX/12nN;
...
.method public final y6(LX/0dna;)V
    ...
    iget-object v1, p0, LX/0d0N;->LLILLJJLI:Lcom/bytedance/android/live/design/view/icon/LiveIconView;

    if-eqz v1, :cond_0

    new-instance v0, LX/0d0Q;

    invoke-direct {v0, v3}, LX/0d0Q;-><init>(Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;)V
    ...
    :cond_0
    iget-object v0, v4, Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;->adminPermission:Lcom/bytedance/android/livesdk/chatroom/api/SubAdminPermission;
    ...
    iget-object v1, p1, LX/0d81;->LLILZLL:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0d0N;->LLILLIZIL:Lcom/bytedance/android/live/design/view/icon/LiveIconView;
    ...
    :cond_1
    iget-object v0, p0, LX/0d0N;->LLILL:LX/12nN;
    ...
    :cond_2
    iget-object v1, p0, LX/0d0N;->LLILL:LX/12nN;

    if-eqz v1, :cond_3

    new-instance v0, LX/0cjt;

    invoke-direct {v0, p0, v3}, LX/0cjt;-><init>(LX/0d0N;Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;)V

    invoke-static {v1, v0}, LX/0X3I;->W3(LX/12nN;Landroid/view/View$OnClickListener;)V

    :cond_3
    new-instance v0, LX/0d0s;

    invoke-direct {v0, v3, v4, p0, p1}, LX/0d0s;-><init>(Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;Lwebcast/api/pgc_sub/PGCGetSubPrivilegeDetailResponse$Data;LX/0d0N;LX/0d81;)V
    ...
    new-instance v1, LX/0ck3;

    invoke-direct {v1, p0, v3}, LX/0ck3;-><init>(LX/0d0N;Lcom/bytedance/android/livesdk/comp/impl/pgcsubscription/business/foundation/privilegepage/fragment/SubscriptionPrivilegeDetailFragment;)V

    sget-object v0, LX/01Gt;->LL:LX/01Gt;
