...
.field public final LLILLJJLI:LX/0dr2;
...
.method public constructor <init>(LX/0dd5;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/0dqW;->LL:LX/0dd5;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LX/0dqW;->LLILL:Ljava/util/List;

    new-instance v0, LX/0dr3;

    invoke-direct {v0}, LX/0dr3;-><init>()V

    invoke-static {v0}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, p0, LX/0dqW;->LLILLIZIL:LX/05ta;

    new-instance v0, LX/0dr2;

    invoke-direct {v0, p0}, LX/0dr2;-><init>(LX/0dqW;)V

    iput-object v0, p0, LX/0dqW;->LLILLJJLI:LX/0dr2;

    return-void
.end method

.method public static LIZJ(LX/0dqW;LX/0dd5;Ljava/lang/String;JILjava/lang/String;Ljava/lang/String;ZI)LX/0dqp;
    .locals 10
    ...
    invoke-direct/range {v0 .. v9}, LX/0dqp;-><init>(LX/0dq3;JLjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;Z)V
...
.method public final LIZ(Lcom/bytedance/android/livesdk/model/message/PushContractStatusResult;)V
    ...
    iget-object v0, p0, LX/0dqW;->LL:LX/0dd5;
    ...
    :cond_0
    iget-object v2, p0, LX/0dqW;->LLILL:Ljava/util/List;
    ...
    iget-object v0, v0, LX/0dd5;->LJJIIJ:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v0}, LX/0dqW;->LIZIZ(Ljava/lang/Object;LX/0dd5;)V
    ...
    iget-boolean v4, v0, LX/0dd5;->LJIIIIZZ:Z
    ...
    iget-object v0, p0, LX/0dqW;->LLILLIZIL:LX/05ta;
    ...
    invoke-static {v0, v1}, LX/0dpK;->LIZIZ(Ljava/lang/Integer;Ljava/lang/String;)LX/0dpL;
    ...
    :goto_1
    iget-object v14, p0, LX/0dqW;->LL:LX/0dd5;
    ...
    invoke-static/range {v4 .. v14}, LX/0dqI;->LJIIZILJ(ZLjava/lang/String;JILjava/lang/String;Ljava/lang/String;LX/0dr1;Ljava/lang/String;Ljava/util/Map;LX/0dq3;)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    sput-wide v0, LX/0dqI;->LIZJ:J
...
.method public final LIZIZ(Ljava/lang/Object;LX/0dd5;)V
    .locals 10
    ...
    iget-object v0, v0, LX/0dd5;->LJI:Ljava/lang/String;
    ...
    new-instance v5, LX/0dd7;

    const/4 v9, 0x0

    invoke-direct {v5, v9}, LX/0dd7;-><init>(I)V

    instance-of v0, p1, Lcom/bytedance/android/live/wallet/model/CheckSubOrderResultStruct;

    if-eqz v0, :cond_4

    iget-object v1, p0, LX/0dqW;->LLILL:Ljava/util/List;
    ...
    :goto_2
    iput-object v0, v5, LX/0dd7;->LIZ:Lcom/bytedance/android/live/base/model/user/SubscribeBadge;

    iget-object v0, p1, Lcom/bytedance/android/live/wallet/model/CheckSubOrderResultStruct;->toast:Ljava/lang/String;

    iput-object v0, v5, LX/0dd7;->LIZIZ:Ljava/lang/String;
    ...
    :goto_4
    iput-object v1, v5, LX/0dd7;->LIZ:Lcom/bytedance/android/live/base/model/user/SubscribeBadge;
    ...
    iget-boolean v1, p2, LX/0dd5;->LJJIII:Z
    ...
    :goto_6
    iget-object v0, v5, LX/0dd7;->LIZ:Lcom/bytedance/android/live/base/model/user/SubscribeBadge;
    ...
    iget-object v0, p2, LX/0dd5;->LJI:Ljava/lang/String;
    ...
    iget-object v7, p2, LX/0dd5;->LJI:Ljava/lang/String;
    ...
    iget-object v2, p0, LX/0dqW;->LL:LX/0dd5;

    if-eqz v2, :cond_9

    iget-object v1, v2, LX/0dd5;->LJJII:LX/0doY;

    if-eqz v1, :cond_9

    const-string v0, "success"

    invoke-interface {v1, v2, v0, v0, v5}, LX/0doY;->LIZ(LX/0dd5;Ljava/lang/String;Ljava/lang/String;LX/0dd7;)V
    ...
    iget-object v1, p2, LX/0dd5;->LJIIJJI:Ljava/lang/String;
    ...
    invoke-static {v2}, LX/0dh1;->LIZ(LX/0qns;)V
...
.method public final LIZLLL(Ljava/lang/String;LX/0dd5;ZLjava/lang/String;Lkotlin/jvm/functions/Function2;LX/02wT;)Ljava/lang/Object;
    .locals 32
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v5, LX/0dqr;

    iget v4, v5, LX/0dqr;->LLIZLLLIL:I
    ...
    iput v4, v5, LX/0dqr;->LLIZLLLIL:I

    :goto_0
    iget-object v13, v5, LX/0dqr;->LLILZLL:Ljava/lang/Object;

    invoke-static {}, LX/0PB2;->LJFF()Ljava/lang/Object;

    move-result-object v4

    iget v7, v5, LX/0dqr;->LLIZLLLIL:I
    ...
    iget-object v9, v6, LX/0dd5;->LJIIIZ:Ljava/lang/String;
    ...
    :cond_3
    :goto_3
    iget-object v12, v11, LX/0dqW;->LLILLIZIL:LX/05ta;

    invoke-interface {v12}, LX/05ta;->getValue()Ljava/lang/Object;

    move-result-object v14

    iget v12, v6, LX/0dd5;->LJIIZILJ:I

    invoke-static {v12}, LX/0yoW;->LJ(I)Ljava/lang/Integer;

    move-result-object v13

    sget-object v12, LX/0dpJ;->QUERY_ORDER_STARTED:LX/0dpJ;

    invoke-virtual {v14}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v1, v13, v12}, LX/0dpK;->LIZJ(Ljava/lang/String;Ljava/lang/Integer;LX/0dpJ;)V
    ...
    invoke-static/range {v11 .. v20}, LX/0dqW;->LIZJ(LX/0dqW;LX/0dd5;Ljava/lang/String;JILjava/lang/String;Ljava/lang/String;ZI)LX/0dqp;

    move-result-object v12

    iget-object v13, v11, LX/0dqW;->LLILLJJLI:LX/0dr2;

    invoke-virtual {v13}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v16, LX/0dqI;->LIZ:LX/0dqI;

    iget-object v13, v12, LX/0dqp;->LIZ:LX/0dq3;

    invoke-virtual {v13}, LX/0dq3;->LIZ()Z

    move-result v24

    iget-object v13, v12, LX/0dqp;->LIZJ:Ljava/lang/String;

    move-object/from16 v17, v13

    iget-object v13, v12, LX/0dqp;->LIZ:LX/0dq3;

    iget-object v15, v13, LX/0dq3;->LIZLLL:Ljava/lang/String;

    iget-object v14, v13, LX/0dq3;->LIZIZ:Ljava/lang/String;

    iget-object v13, v13, LX/0dq3;->LIZJ:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v13}, LX/0sDp;->LIZ(Landroid/content/Context;)LX/0dr1;

    move-result-object v28

    iget-object v12, v12, LX/0dqp;->LIZ:LX/0dq3;

    iget-object v13, v12, LX/0dq3;->LJFF:Ljava/util/Map;
    ...
    invoke-static/range {v24 .. v30}, LX/0dqI;->LJIILLIIL(ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;LX/0dr1;Ljava/util/Map;LX/0dq3;)V

    sget-object v12, LX/0vka;->LIZJ:LX/15Bj;

    new-instance v13, LX/0dqZ;
    ...
    invoke-direct/range {v13 .. v23}, LX/0dqZ;-><init>(LX/0dqW;LX/0dd5;Ljava/lang/String;LX/01rK;LX/01rK;[JJZLX/02wT;)V

    iput-object v1, v5, LX/0dqr;->LL:Ljava/lang/Object;

    iput-object v6, v5, LX/0dqr;->LLILIL:LX/0dd5;

    iput-object v2, v5, LX/0dqr;->LLILL:Ljava/lang/Object;

    move-object/from16 v9, v31

    iput-object v9, v5, LX/0dqr;->LLILLIZIL:Lkotlin/jvm/functions/Function2;

    iput-object v10, v5, LX/0dqr;->LLILLJJLI:LX/01rK;

    iput-object v3, v5, LX/0dqr;->LLILLL:Ljava/lang/Object;

    iput-object v0, v5, LX/0dqr;->LLILZ:LX/01rK;

    iput-wide v7, v5, LX/0dqr;->LLILZIL:J

    const/4 v9, 0x1

    iput v9, v5, LX/0dqr;->LLIZLLLIL:I

    invoke-static {v5, v12, v13}, LX/15Ap;->LJI(LX/02wT;Lkotlin/coroutines/CoroutineContext;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
    ...
    :cond_4
    iget-wide v7, v5, LX/0dqr;->LLILZIL:J

    iget-object v0, v5, LX/0dqr;->LLILZ:LX/01rK;

    iget-object v3, v5, LX/0dqr;->LLILLL:Ljava/lang/Object;

    check-cast v3, Ljava/util/HashMap;

    iget-object v10, v5, LX/0dqr;->LLILLJJLI:LX/01rK;

    iget-object v1, v5, LX/0dqr;->LLILLIZIL:Lkotlin/jvm/functions/Function2;

    move-object/from16 v31, v1

    iget-object v2, v5, LX/0dqr;->LLILL:Ljava/lang/Object;

    check-cast v2, Ljava/lang/String;

    iget-object v6, v5, LX/0dqr;->LLILIL:LX/0dd5;

    iget-object v1, v5, LX/0dqr;->LL:Ljava/lang/Object;
    ...
    invoke-direct/range {v15 .. v27}, LX/0dqY;-><init>(LX/0dqu;LX/0dqW;Ljava/lang/String;LX/01rK;LX/0dd5;Ljava/lang/String;Ljava/util/HashMap;JLX/01rK;Lkotlin/jvm/functions/Function2;LX/02wT;)V

    iput-object v14, v5, LX/0dqr;->LL:Ljava/lang/Object;

    iput-object v14, v5, LX/0dqr;->LLILIL:LX/0dd5;

    iput-object v14, v5, LX/0dqr;->LLILL:Ljava/lang/Object;

    iput-object v14, v5, LX/0dqr;->LLILLIZIL:Lkotlin/jvm/functions/Function2;

    iput-object v14, v5, LX/0dqr;->LLILLJJLI:LX/01rK;

    iput-object v14, v5, LX/0dqr;->LLILLL:Ljava/lang/Object;

    iput-object v14, v5, LX/0dqr;->LLILZ:LX/01rK;

    const/4 v0, 0x2

    iput v0, v5, LX/0dqr;->LLIZLLLIL:I

    invoke-static {v5, v12, v9}, LX/15Ap;->LJI(LX/02wT;Lkotlin/coroutines/CoroutineContext;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
    ...
    :cond_6
    new-instance v5, LX/0dqr;

    invoke-direct {v5, v11, v7}, LX/0dqr;-><init>(LX/0dqW;LX/02wT;)V
...
.method public final onMessage(Lcom/ss/ugc/live/sdk/message/data/IMessage;)V
    ...
    iget-object v1, v4, LX/0dqW;->LL:LX/0dd5;
    ...
    :cond_0
    iget-object v0, v4, LX/0dqW;->LLILL:Ljava/util/List;
    ...
    iget-object v0, v4, LX/0dqW;->LL:LX/0dd5;

    invoke-virtual {v4, v1, v0}, LX/0dqW;->LIZIZ(Ljava/lang/Object;LX/0dd5;)V
    ...
    invoke-static {v0, v2}, LX/0dpK;->LIZIZ(Ljava/lang/Integer;Ljava/lang/String;)LX/0dpL;
    ...
    invoke-static/range {v4 .. v13}, LX/0dqW;->LIZJ(LX/0dqW;LX/0dd5;Ljava/lang/String;JILjava/lang/String;Ljava/lang/String;ZI)LX/0dqp;

    move-result-object v1

    iget-object v0, v4, LX/0dqW;->LLILLJJLI:LX/0dr2;

    invoke-virtual {v0, v1}, LX/0dqd;->LIZIZ(LX/0dqp;)V
