...
.method public constructor <init>(Landroid/view/View;Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/detail/vm/SubSpaceDetailVM;)V
    ...
    iput-object p1, p0, LX/0dWV;->LL:Landroid/view/View;

    iput-object p2, p0, LX/0dWV;->LLILIL:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/detail/vm/SubSpaceDetailVM;
    ...
    iput-object v0, p0, LX/0dWV;->LLILL:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, LX/0dWV;->LLILLIZIL:LX/12nN;
    ...
    iput-object v0, p0, LX/0dWV;->LLILLJJLI:LX/12nN;
    ...
    iput-object v0, p0, LX/0dWV;->LLILLL:Landroid/view/View;
...
# virtual methods
.method public final J6(LX/0dWj;)V
    .locals 9

    iget-object v0, p0, LX/0dWV;->LLILIL:Lcom/bytedance/android/livesdk/comp/impl/subscription/business/perks/subspace/detail/vm/SubSpaceDetailVM;
    ...
    invoke-virtual {p1}, LX/0dWj;->LIZLLL()J
    ...
    iget-object v0, p0, LX/0dWV;->LLILLJJLI:LX/12nN;

    invoke-static {v0, v7}, LX/0X3I;->LLIIIJ(LX/12nN;I)V

    iget-object v1, p0, LX/0dWV;->LLILLJJLI:LX/12nN;

    new-instance v0, LX/0dWY;

    invoke-direct {v0, p0, p1}, LX/0dWY;-><init>(LX/0dWV;LX/0dWj;)V

    invoke-static {v1, v0}, LX/0X3I;->W3(LX/12nN;Landroid/view/View$OnClickListener;)V

    :goto_2
    iget-wide v1, p1, LX/0dWj;->LIZIZ:J
    ...
    iget-object v4, p0, LX/0dWV;->LLILLIZIL:LX/12nN;
    ...
    iget-wide v0, p1, LX/0dWj;->LIZIZ:J
    ...
    iget-object v0, p0, LX/0dWV;->LLILLIZIL:LX/12nN;

    invoke-static {v0, v7}, LX/0X3I;->LLIIIJ(LX/12nN;I)V

    iget-object v0, p0, LX/0dWV;->LLILLL:Landroid/view/View;

    invoke-static {v7, v0}, LX/0X3I;->LJL(ILandroid/view/View;)V

    :goto_3
    iget-object v0, p0, LX/0dWV;->LLILL:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object v1, p0, LX/0dWV;->LLILLIZIL:LX/12nN;
...
.method public final y6(LX/0dS3;LX/02Ee;)V
    ...
    instance-of v0, p1, LX/0dWj;

    if-eqz v0, :cond_0

    check-cast p1, LX/0dWj;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, LX/0dWV;->J6(LX/0dWj;)V

    iget-object v1, p0, LX/0dWV;->LLILLIZIL:LX/12nN;

    new-instance v0, LX/0dWT;

    invoke-direct {v0, p0, p1}, LX/0dWT;-><init>(LX/0dWV;LX/0dWj;)V
