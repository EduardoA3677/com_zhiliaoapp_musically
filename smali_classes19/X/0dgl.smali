...
.method public static LIZ(Ljava/util/List;)Z
    ...
    invoke-static {v0}, LX/0dgl;->LJIILIIL(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Z
...
.method public static LIZJ(Ljava/util/List;LX/0dh9;)V
    .locals 2

    new-instance v1, LX/0dj1;

    invoke-direct {v1}, LX/0dj1;-><init>()V

    const/4 v0, 0x0

    invoke-static {p0, v1, v0}, LX/0mTH;->LJJIIJ(Ljava/util/List;Lkotlin/jvm/functions/Function1;Z)Z

    new-instance v1, LX/0dF2;

    invoke-direct {v1}, LX/0dF2;-><init>()V
    ...
    :cond_0
    sget-object v0, LX/0di3;->LL:LX/0di3;
...
.method public static LIZLLL(Lwebcast/api/sub/TemplateInfo;)Ljava/lang/String;
    ...
    invoke-static {p0}, LX/0dgl;->LJIILJJIL(Lwebcast/api/sub/TemplateInfo;)Z
...
.method public static LJ(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail$PricePhase;I)Ljava/lang/String;
    .locals 3

    iget-object v2, p0, Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail$PricePhase;->price:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail$PricePhase;->priceAmountMicros:Ljava/lang/Long;
    ...
    :goto_0
    invoke-static {p1, v0, v1, v2}, LX/0ddO;->LJ(IJLjava/lang/String;)Ljava/lang/String;
...
.method public static LJFF(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;Z)Ljava/lang/String;
    .locals 5

    invoke-virtual {p0}, Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;->getSubscriptionProductDetail()Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v4, v0, Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail;->pricePhaseList:Ljava/util/List;

    :goto_0
    invoke-static {p0}, LX/0dgl;->LJIIJJI(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Z
    ...
    invoke-static {p0, v1, p1}, LX/0dgl;->LJI(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;ZZ)Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;->getTemplateInfo()Lwebcast/api/sub/TemplateInfo;
    ...
    invoke-static {p0, v2, p1}, LX/0dgl;->LJI(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;ZZ)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p0}, LX/0dgl;->LJIILIIL(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Z
...
.method public static LJI(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;ZZ)Ljava/lang/String;
    .locals 3
    ...
    iget-object v2, v0, Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail;->pricePhaseList:Ljava/util/List;
    ...
    invoke-static {v0, v1}, LX/0dgl;->LJ(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail$PricePhase;I)Ljava/lang/String;
...
.method public static LJII(Ljava/util/List;)Lwebcast/api/sub/OfferInfo;
    ...
    invoke-static {v1}, LX/0dgl;->LJIILIIL(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Z
...
.method public static LJIIIIZZ(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Ljava/lang/String;
    .locals 3
    ...
    iget-object v1, v0, Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetail;->pricePhaseList:Ljava/util/List;
...
.method public static LJIIJJI(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Z
    .locals 5
...
.method public static LJIIL(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Z
    .locals 2
...
.method public static LJIILIIL(Lcom/bytedance/android/livesdk/comp/api/pgcsubscription/PGCSubscriptionProductDetailWithTemplateInfo;)Z
    .locals 0
    ...
    :goto_0
    invoke-static {p0}, LX/0dgl;->LJIIIZ(Lwebcast/api/sub/OfferInfo;)Z
