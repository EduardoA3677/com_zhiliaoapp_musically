...
# instance fields
.field public final LIZIZ:LX/0dhZ;


# direct methods
.method public constructor <init>(LX/0dhZ;)V
    .locals 0

    invoke-direct {p0}, LX/0dbc;-><init>()V

    iput-object p1, p0, LX/0dhN;->LIZIZ:LX/0dhZ;
...
.method public final bridge synthetic LJII(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p0, p1, p2}, LX/0dhN;->LJIILJJIL(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)LX/0dkd;
...
.method public final LJIIJJI(Landroid/view/View;)LX/0dbd;
    ...
    invoke-direct {v0, p1}, LX/0dkd;-><init>(Landroid/view/View;)V
...
.method public final LJIILJJIL(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)LX/0dkd;
    .locals 6
    ...
    iget-object v0, p0, LX/0dhN;->LIZIZ:LX/0dhZ;
    ...
    sget v0, Lcom/bytedance/android/livesdk/comp/impl/subscription/business/foundation/packagepage/ui/SubPackageMultiMonthFragment;->LLJJJJJIL:I
    ...
    invoke-direct {v0, v4}, LX/0dkd;-><init>(Landroid/view/View;)V
