.class public final Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;
...
.field public final errScenes:Ljava/util/List;
    .annotation runtime LX/0B9U;
        value = "err_scenes"
    .end annotation
...
.field public final sceneMap:Ljava/util/Map;
    .annotation runtime LX/0B9U;
        value = "scene_map"
    .end annotation
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "LX/0blf;",
            "Lcom/ss/android/ugc/aweme/im/strategy/scene/SceneConfigData;",
            ">;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Ljava/util/Map;Ljava/util/List;Ljava/util/List;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;->decisionTree:Ljava/util/Map;

    iput-object p2, p0, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;->resourceScenes:Ljava/util/List;

    iput-object p3, p0, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;->errScenes:Ljava/util/List;

    iput-object p4, p0, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;->sceneMap:Ljava/util/Map;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v0, p1, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;
    ...
    :cond_1
    check-cast p1, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;
    ...
    :cond_3
    iget-object v1, p0, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;->errScenes:Ljava/util/List;
...
.method public final hashCode()I
    ...
    iget-object v0, p0, Lcom/ss/android/ugc/aweme/im/strategy/scene/StrategyPlatformData;->resourceScenes:Ljava/util/List;
...
.method public final toString()Ljava/lang/String;
    ...
    const-string v0, "StrategyPlatformData(decisionTree="
