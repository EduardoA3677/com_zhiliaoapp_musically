...
.method public constructor <init>(ZLandroid/view/ViewGroup;Landroid/view/View;Lcom/ss/android/ugc/aweme/ecommerce/ug/backbutton/service/EcUgBackButtonServiceOfficial;Ljava/lang/String;Ljava/util/Map;LX/0sDt;)V
    ...
    iput-boolean p1, p0, LX/0sDs;->LLILIL:Z

    iput-object p2, p0, LX/0sDs;->LLILL:Landroid/view/ViewGroup;

    iput-object p3, p0, LX/0sDs;->LLILLIZIL:Landroid/view/View;

    iput-object p4, p0, LX/0sDs;->LLILLJJLI:Lcom/ss/android/ugc/aweme/ecommerce/ug/backbutton/service/EcUgBackButtonServiceOfficial;

    iput-object p5, p0, LX/0sDs;->LLILLL:Ljava/lang/String;

    iput-object p6, p0, LX/0sDs;->LLILZ:Ljava/util/Map;

    iput-object p7, p0, LX/0sDs;->LLILZIL:LX/0sDt;
...
.method public final LIZ(Landroidx/fragment/app/FragmentManager;)V
    ...
    iput-object v0, p0, LX/0sDs;->LL:Landroidx/fragment/app/Fragment;

    iget-object v0, p0, LX/0sDs;->LLILZIL:LX/0sDt;
    ...
    :cond_0
    iget-object v0, p0, LX/0sDs;->LLILLIZIL:Landroid/view/View;
    ...
    :cond_1
    iget-object v1, p0, LX/0sDs;->LLILL:Landroid/view/ViewGroup;

    iget-object v0, p0, LX/0sDs;->LLILLIZIL:Landroid/view/View;

    invoke-virtual {v1, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object v2, p0, LX/0sDs;->LLILLJJLI:Lcom/ss/android/ugc/aweme/ecommerce/ug/backbutton/service/EcUgBackButtonServiceOfficial;

    iget-object v1, p0, LX/0sDs;->LLILLIZIL:Landroid/view/View;

    iget-object v0, p0, LX/0sDs;->LLILLL:Ljava/lang/String;
...
.method public final onFragmentDetached(Landroidx/fragment/app/FragmentManager;Landroidx/fragment/app/Fragment;)V
    ...
    iget-object v0, p0, LX/0sDs;->LL:Landroidx/fragment/app/Fragment;
    ...
    invoke-virtual {p0, p1}, LX/0sDs;->LIZ(Landroidx/fragment/app/FragmentManager;)V
...
.method public final onFragmentResumed(Landroidx/fragment/app/FragmentManager;Landroidx/fragment/app/Fragment;)V
    ...
    iput-object p2, p0, LX/0sDs;->LL:Landroidx/fragment/app/Fragment;
    ...
    iget-object v4, p0, LX/0sDs;->LLILLJJLI:Lcom/ss/android/ugc/aweme/ecommerce/ug/backbutton/service/EcUgBackButtonServiceOfficial;

    iget-object v3, p0, LX/0sDs;->LLILLIZIL:Landroid/view/View;

    iget-object v2, p0, LX/0sDs;->LLILLL:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0sDs;->LLILLJJLI:Lcom/ss/android/ugc/aweme/ecommerce/ug/backbutton/service/EcUgBackButtonServiceOfficial;

    iget-object v1, p0, LX/0sDs;->LLILZ:Ljava/util/Map;
    ...
    :cond_3
    iget-boolean v0, p0, LX/0sDs;->LLILIL:Z
