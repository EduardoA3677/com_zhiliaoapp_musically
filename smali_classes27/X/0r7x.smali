...
# static fields
.field public static final LIZ:LX/0r7x;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0r7x;->LIZ:LX/0r7x;

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    sput-object v0, LX/0r7x;->LIZIZ:Ljava/util/Set;

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    sput-object v0, LX/0r7x;->LIZJ:Ljava/util/Set;

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    sput-object v0, LX/0r7x;->LJ:Ljava/util/Set;
...
.method public final LIZ()V
    ...
    const-string v3, "fyp_aweme_set_since_last_full_screen_survey"
    ...
    const-string v3, "fyp_live_card_set_since_last_full_screen_survey"
    ...
    :cond_2
    const-string v7, "fyp_live_card_duration_since_last_full_screen_survey"
...
.method public final LIZJ(JZ)V
    ...
    const-string v6, "fyp_live_card_duration_since_last_full_screen_survey"
...
.method public final LJFF(J)V
    ...
    sget-object v1, LX/0r7x;->LJ:Ljava/util/Set;
...
.method public final LJI()V
    ...
    const-string v4, "live_room_set_since_last_full_screen_survey"
    ...
    :cond_1
    const-string v7, "live_room_watch_duration_since_last_full_screen_survey"
    ...
    sget-wide v0, LX/0r7x;->LJFF:J

    add-long/2addr v3, v0

    invoke-virtual {v8, v7, v3, v4}, Lcom/bytedance/keva/Keva;->storeLong(Ljava/lang/String;J)V

    sput-wide v5, LX/0r7x;->LJFF:J
...
.method public final getFeature(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :sswitch_0
    const-string v0, "app_inner_watch_count_since_last_full_screen_survey"
    ...
    :sswitch_1
    const-string v0, "app_fyp_watch_duration_since_last_full_screen_survey"
    ...
    :sswitch_2
    const-string v0, "app_fyp_live_card_count_since_last_full_screen_survey"
    ...
    :sswitch_3
    const-string v0, "app_fyp_card_count_since_last_full_screen_survey"
    ...
    :sswitch_4
    const-string v0, "app_last_full_screen_survey_show_time"
    ...
    :sswitch_5
    const-string v0, "app_inner_watch_duration_since_last_full_screen_survey"
    ...
    :sswitch_data_0
    .sparse-switch
        -0x243a1446 -> :sswitch_0
        0x10706c86 -> :sswitch_1
        0x236612d5 -> :sswitch_2
        0x49dff3a2 -> :sswitch_3
        0x5772f458 -> :sswitch_4
        0x6322c94d -> :sswitch_5
    .end sparse-switch
.end method
