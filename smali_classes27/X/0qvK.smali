...
.method public constructor <init>()V
    ...
    iput v0, p0, LX/0qvK;->LIZ:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, LX/0qvK;->LIZIZ:J

    return-void
.end method

.method public static LJIIJ(Landroid/content/Context;ZLjava/lang/String;Z)V
    .locals 7
    ...
    invoke-interface {v0, p0, p2}, LX/0qxa;->LIZLLL(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static LJIIJJI(Ljava/util/HashMap;)V
    .locals 3
    ...
    invoke-virtual {v0, v2}, LX/0qjY;->LIZ(Ljava/util/Map;)Z

    :cond_3
    return-void
.end method

.method public static LJIIL(Ljava/util/HashMap;)V
    .locals 7
...
.method public final LIZLLL(Landroid/app/Activity;Landroid/net/Uri;Z)V
    ...
    const-string v0, "webcast_feed_activity"
    ...
    const-string v1, "deeplink_webcast_webview_use_sec_link_enable"

    sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-interface {v3, v0, v1}, LX/0qxa;->LIZJ(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p1, p3, v0, v3}, LX/0qvK;->LJIIJ(Landroid/content/Context;ZLjava/lang/String;Z)V
    ...
    const-string v1, "deeplink_webcast_webview_enable"
    ...
    const-string v1, "deeplink_webcast_webview_allowed_list"
    ...
    invoke-direct {v3, v6}, LX/05te;-><init>([Ljava/lang/Object;)V
    ...
    const-string v0, "webcast_game_universal_link"
    ...
    invoke-static {p1, p3, v0, v2}, LX/0qvK;->LJIIJ(Landroid/content/Context;ZLjava/lang/String;Z)V
    ...
    :cond_f
    :try_start_1
    invoke-virtual {p0}, LX/0qvK;->LJIIIZ()Z

    move-result v0

    if-eqz v0, :cond_10

    invoke-static {v3}, LX/0qvK;->LJIIL(Ljava/util/HashMap;)V

    invoke-static {v3}, LX/0qvK;->LJIIJJI(Ljava/util/HashMap;)V
...
.method public final LJIIIZ()Z
    ...
    iget-boolean v0, p0, LX/0qvK;->LIZJ:Z

    if-nez v0, :cond_2

    iput-boolean v3, p0, LX/0qvK;->LIZJ:Z
    ...
    iget-wide v0, p0, LX/0qvK;->LIZIZ:J

    invoke-interface {v4, v0, v1}, LX/0qxa;->q6(J)Ljava/util/Map;
