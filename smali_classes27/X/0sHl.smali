...
.field public final LJIILJJIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/single/SingleHashTagStickerModel;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/single/SingleHashTagStickerModel;Landroid/widget/FrameLayout;LX/0mnc;Landroidx/lifecycle/LifecycleOwner;LX/0mUE;)V
    .locals 8

    invoke-virtual {p2}, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/single/SingleHashTagStickerModel;->getBaseStickerModel()Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;
    ...
    iput-object v3, v2, LX/0sHl;->LJIILIIL:Landroid/content/Context;

    iput-object p2, v2, LX/0sHl;->LJIILJJIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/single/SingleHashTagStickerModel;

    iput-object p3, v2, LX/0sHl;->LJIILL:Landroid/widget/FrameLayout;

    iput-object v5, v2, LX/0sHl;->LJIILLIIL:LX/0mnc;

    iput-object v6, v2, LX/0sHl;->LJIIZILJ:Landroidx/lifecycle/LifecycleOwner;

    new-instance v1, Lkotlin/jvm/internal/AwS502S0100000_26;

    const/16 v0, 0x3f2

    invoke-direct {v1, v2, v0}, Lkotlin/jvm/internal/AwS502S0100000_26;-><init>(LX/0sHl;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, v2, LX/0sHl;->LJIJ:LX/05ta;
    ...
    iput-object v0, v2, LX/0sHl;->LJIJI:LX/05ta;
...
.method public final LJIIJJI(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;)V
    ...
    check-cast v3, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/single/SingleHashTagStickerModel;

    if-eqz v3, :cond_0

    iget-object v0, p0, LX/0sHl;->LJIJ:LX/05ta;
    ...
    invoke-direct {v1, v3, v0}, Lkotlin/jvm/internal/AwS536S0100000_26;-><init>(Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/single/SingleHashTagStickerModel;I)V
    ...
    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/single/SingleHashTagStickerModel;->getBaseStickerModel()Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;
...
.method public final LJJIJLIJ()Landroidx/lifecycle/LifecycleOwner;
    ...
    iget-object v0, p0, LX/0sHl;->LJIIZILJ:Landroidx/lifecycle/LifecycleOwner;
...
.method public final LJJIZ()LX/0mnc;
    ...
    iget-object v0, p0, LX/0sHl;->LJIILLIIL:LX/0mnc;
...
.method public final LJJJJL()Landroid/view/View;
    ...
    iget-object v0, p0, LX/0sHl;->LJIJI:LX/05ta;
