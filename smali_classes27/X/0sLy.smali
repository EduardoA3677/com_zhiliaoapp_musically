...
.field public final LJIILJJIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;Landroid/widget/FrameLayout;LX/0mnc;Landroidx/lifecycle/LifecycleOwner;LX/0mUE;)V
    .locals 8

    invoke-virtual {p2}, Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;->getBaseStickerModel()Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;
    ...
    iput-object v3, v2, LX/0sLy;->LJIILIIL:Landroid/content/Context;

    iput-object p2, v2, LX/0sLy;->LJIILJJIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;

    iput-object p3, v2, LX/0sLy;->LJIILL:Landroid/widget/FrameLayout;

    iput-object v5, v2, LX/0sLy;->LJIILLIIL:LX/0mnc;

    iput-object v6, v2, LX/0sLy;->LJIIZILJ:Landroidx/lifecycle/LifecycleOwner;

    new-instance v1, Lkotlin/jvm/internal/AwS502S0100000_26;

    const/16 v0, 0x35b

    invoke-direct {v1, v2, v0}, Lkotlin/jvm/internal/AwS502S0100000_26;-><init>(LX/0sLy;I)V

    invoke-static {v1}, LX/03L8;->LIZIZ(Lkotlin/jvm/functions/Function0;)LX/05ta;

    move-result-object v0

    iput-object v0, v2, LX/0sLy;->LJIJ:LX/05ta;
    ...
    iput-object v0, v2, LX/0sLy;->LJIJI:LX/05ta;
...
.method public final LJIIJJI(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;)V
    ...
    invoke-virtual {p0}, LX/0sLy;->LJJJZ()LX/0mt1;
    ...
    invoke-virtual {p1}, Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;->getBaseStickerModel()Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;
...
.method public final LJJIJLIJ()Landroidx/lifecycle/LifecycleOwner;
    ...
    iget-object v0, p0, LX/0sLy;->LJIIZILJ:Landroidx/lifecycle/LifecycleOwner;
...
.method public final LJJIZ()LX/0mnc;
    ...
    iget-object v0, p0, LX/0sLy;->LJIILLIIL:LX/0mnc;
...
.method public final LJJJJL()Landroid/view/View;
    ...
    iget-object v0, p0, LX/0sLy;->LJIJI:LX/05ta;
...
.method public final LJJJZ()LX/0mt1;
    ...
    iget-object v0, p0, LX/0sLy;->LJIJ:LX/05ta;
...
.method public final setAlpha(F)V
    ...
    invoke-virtual/range {v53 .. v53}, LX/0sLy;->LJJJZ()LX/0mt1;

    move-result-object v0

    iget-object v2, v0, LX/0mt0;->LIZ:Ljava/lang/Object;

    check-cast v2, Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;
    ...
    iget-boolean v3, v2, Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;->visible:Z

    iget-object v1, v2, Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;->questionText:Ljava/lang/String;

    iget-boolean v0, v2, Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;->editable:Z

    invoke-virtual {v2, v4, v3, v1, v0}, Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;->copy(Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;ZLjava/lang/String;Z)Lcom/ss/android/ugc/aweme/tools/sticker/core/secretreplies/SecretRepliesStickerModel;
