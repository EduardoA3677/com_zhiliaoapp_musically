...
.method public constructor <init>(LX/0rfX;Ljava/lang/String;LX/0d65;)V
    ...
    iput-object p1, p0, LX/0rfd;->LIZ:LX/0rfY;

    iput-object p2, p0, LX/0rfd;->LIZIZ:Ljava/lang/String;

    iput-object p3, p0, LX/0rfd;->LIZJ:LX/0d65;
...
.method public final LIZ(LX/0rkj;LX/0rrO;)V
    ...
    iget-object v0, p0, LX/0rfd;->LIZ:LX/0rfY;
...
.method public final LIZJ(LX/0cQn;)V
    ...
    iget-object v1, p0, LX/0rfd;->LIZ:LX/0rfY;

    if-eqz v1, :cond_0

    iget-object v0, p0, LX/0rfd;->LIZIZ:Ljava/lang/String;
...
.method public final LIZLLL(LX/028t;)V
    ...
    iget-object v8, p0, LX/0rfd;->LIZ:LX/0rfY;

    if-eqz v8, :cond_1

    new-instance v7, LX/0cX4;

    iget-object v6, p0, LX/0rfd;->LIZIZ:Ljava/lang/String;

    new-instance v5, LX/0cQh;

    iget-object v4, p1, LX/028t;->LIZIZ:Ljava/lang/Object;

    iget-object v3, p0, LX/0rfd;->LIZJ:LX/0d65;
