...
.annotation runtime LX/0PaH;
    c = "com.ss.android.ugc.aweme.localservice.live.widget.LSLiveProductCardWidget$silenceUpdatePinedProduct$2"
...
# direct methods
.method public constructor <init>(JLX/0r9V;LX/02wT;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    iput-wide p1, p0, LX/0r8Y;->LLILIL:J

    iput-object p3, p0, LX/0r8Y;->LLILL:LX/0r9V;
...
.method public final create(Ljava/lang/Object;LX/02wT;)LX/02wT;
    ...
    new-instance v3, LX/0r8Y;

    iget-wide v1, p0, LX/0r8Y;->LLILIL:J

    iget-object v0, p0, LX/0r8Y;->LLILL:LX/0r9V;

    invoke-direct {v3, v1, v2, v0, p2}, LX/0r8Y;-><init>(JLX/0r9V;LX/02wT;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v20, "LSLiveProductCardWidget@bae5.silenceUpdatePinedProduct$2"
    ...
    :try_start_2
    iget-wide v0, v13, LX/0r8Y;->LLILIL:J
    ...
    new-instance v3, LX/0r8V;

    iget-object v1, v13, LX/0r8Y;->LLILL:LX/0r9V;
    ...
    :try_start_5
    invoke-direct {v3, v1, v0}, LX/0r8V;-><init>(LX/0r9V;LX/02wT;)V

    const/4 v0, 0x2

    iput v0, v13, LX/0r8Y;->LL:I

    invoke-static {v13, v12, v3}, LX/15Ap;->LJI(LX/02wT;Lkotlin/coroutines/CoroutineContext;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
    ...
    :goto_1
    :try_start_6
    check-cast v14, Lcom/ss/android/ugc/aweme/localservice/live/common/api/model/PinedProductsResponse;

    iget-object v0, v13, LX/0r8Y;->LLILL:LX/0r9V;
    ...
    iget-object v15, v13, LX/0r8Y;->LLILL:LX/0r9V;
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_6} :catch_6

    :try_start_7
    iget-wide v2, v13, LX/0r8Y;->LLILIL:J
    ...
    invoke-virtual {v12, v11, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    :try_end_8
    .catch Ljava/lang/Exception; {:try_start_8 .. :try_end_8} :catch_4

    :try_start_9
    iget-wide v0, v15, LX/0r9V;->LLILLIZIL:J
    ...
    iget-object v0, v14, Lcom/ss/android/ugc/aweme/localservice/live/common/api/model/PinedProductsResponse;->pinedProduct:Lcom/google/gson/k;
    ...
    iget-object v0, v14, Lcom/ss/android/ugc/aweme/base/api/BaseResponse;->message:Ljava/lang/String;
    ...
    iget-object v0, v15, LX/0r9V;->LLILLL:Lcom/bytedance/android/live/slot/IFrameSlot$SlotViewModel;
    ...
    iget-object v0, v14, Lcom/ss/android/ugc/aweme/localservice/live/common/api/model/PinedProductsResponse;->bizStatusMsg:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v12}, LX/0r9V;->LJIJ(Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    iget-object v2, v0, LX/0r9V;->LLILZ:LX/0r9S;

    if-eqz v2, :cond_a

    iget-object v1, v14, Lcom/ss/android/ugc/aweme/localservice/live/common/api/model/PinedProductsResponse;->pinedProduct:Lcom/google/gson/k;
    ...
    iget-object v12, v13, LX/0r8Y;->LLILL:LX/0r9V;
    ...
    iget-wide v0, v12, LX/0r9V;->LLILLIZIL:J
    ...
    iget-object v0, v12, LX/0r9V;->LLILLL:Lcom/bytedance/android/live/slot/IFrameSlot$SlotViewModel;
    ...
    invoke-virtual {v1, v0, v14}, LX/0r9V;->LJIJ(Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v3, v1, v15, v0, v2}, LX/14Id;->LIZJ(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
