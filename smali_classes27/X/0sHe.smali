...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/FrameLayout;Landroid/widget/FrameLayout;Landroidx/lifecycle/LifecycleOwner;LX/0mod;LX/0mUE;)V
    ...
    iput-object v0, p0, LX/0sHe;->LJIIIIZZ:LX/0mo3;
...
.method public final LIZ(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;LX/0mnc;Landroidx/lifecycle/LifecycleOwner;)LX/0mna;
    ...
    check-cast v12, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;

    new-instance v20, LX/0sHk;
    ...
    iget-object v13, v12, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->baseStickerModel:Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;

    iget-wide v14, v12, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->hashtagId:J

    iget-object v4, v12, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->contentText:Ljava/lang/String;

    iget-boolean v1, v12, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->editable:Z

    iget-boolean v0, v12, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->clickable:Z
    ...
    invoke-virtual/range {v12 .. v19}, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->copy(Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;JLjava/lang/String;ZZZ)Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;
    ...
    invoke-direct/range {v20 .. v26}, LX/0sHk;-><init>(Landroid/content/Context;Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;Landroid/widget/FrameLayout;LX/0mnc;Landroidx/lifecycle/LifecycleOwner;LX/0mUE;)V
...
.method public final LIZJ(Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;I)Lcom/ss/android/ugc/aweme/tools/sticker/core/StickerModel;
    ...
    iget-object v0, v0, LX/0sHe;->LJIIIIZZ:LX/0mo3;
    ...
    iget-wide v3, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->hashtagId:J

    iget-object v5, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->contentText:Ljava/lang/String;

    iget-boolean v2, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->editable:Z

    iget-boolean v0, v1, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->clickable:Z
    ...
    invoke-virtual/range {v6 .. v13}, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->copy(Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;JLjava/lang/String;ZZZ)Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;
...
.method public final LJI(LX/0mob;LX/0mke;LX/0TL5;Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    iget-object v3, v2, LX/0sHe;->LJII:LX/0sHi;

    if-nez v3, :cond_13

    new-instance v3, LX/0sHi;

    iget-object v1, v2, LX/0mmc;->LIZ:Landroid/content/Context;

    invoke-direct {v3, v1}, LX/0sHi;-><init>(Landroid/content/Context;)V

    iput-object v3, v2, LX/0sHe;->LJII:LX/0sHi;
    ...
    iget-object v1, v2, LX/0sHe;->LJII:LX/0sHi;
    ...
    iget-object v7, v2, LX/0sHe;->LJII:LX/0sHi;
    ...
    iget-wide v3, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->hashtagId:J

    iget-object v11, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->contentText:Ljava/lang/String;

    iget-boolean v10, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->editable:Z

    iget-boolean v9, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->clickable:Z

    iget-boolean v8, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->visible:Z
    ...
    invoke-virtual/range {v18 .. v25}, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->copy(Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;JLjava/lang/String;ZZZ)Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;

    move-result-object v3

    iput-object v3, v7, LX/0sHi;->LLILLIZIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;

    new-instance v10, LX/0mt1;

    iget-object v9, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->baseStickerModel:Lcom/ss/android/ugc/aweme/tools/sticker/core/BaseStickerModel;

    iget-wide v3, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->hashtagId:J

    iget-object v8, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->contentText:Ljava/lang/String;
    ...
    iput-object v10, v7, LX/0sHi;->LLILLJJLI:LX/0mt1;
    ...
    iput-object v10, v7, LX/0sHi;->LLILLL:LX/0mt1;

    iput-object v6, v7, LX/0sHi;->LLILZLL:Landroidx/lifecycle/LifecycleOwner;
    ...
    iput-object v0, v7, LX/0sHi;->LLIZ:Landroid/view/ViewGroup;
    ...
    iput-object v0, v7, LX/0sHi;->LLJ:Landroid/view/View;
    ...
    iput-object v0, v7, LX/0sHi;->LLIZLLLIL:Landroid/widget/FrameLayout;

    new-instance v4, LX/0sDW;
    ...
    invoke-direct {v4, v9, v0, v5}, LX/0sDW;-><init>(ILandroid/content/Context;LX/0TMw;)V

    iget-object v3, v7, LX/0sHi;->LLILLJJLI:LX/0mt1;
    ...
    :cond_5
    iget-object v0, v7, LX/0sHi;->LLILZLL:Landroidx/lifecycle/LifecycleOwner;
    ...
    :cond_6
    invoke-virtual {v4, v0, v3}, LX/0sDW;->LIZIZ(Landroidx/lifecycle/LifecycleOwner;LX/0mt1;)V

    iput-object v4, v7, LX/0sHi;->LLILZ:LX/0sDW;
    ...
    iget-object v3, v7, LX/0sHi;->LLIZLLLIL:Landroid/widget/FrameLayout;
    ...
    :cond_7
    iget-object v0, v7, LX/0sHi;->LLILZ:LX/0sDW;
    ...
    iget-object v3, v7, LX/0sHi;->LLILLL:LX/0mt1;
    ...
    iput-object v4, v7, LX/0sHi;->LLILZIL:LX/0sDW;
    ...
    iget-object v0, v7, LX/0sHi;->LLILZIL:LX/0sDW;
    ...
    iget-object v4, v7, LX/0sHi;->LLIZ:Landroid/view/ViewGroup;
    ...
    :goto_0
    iget-object v5, v2, LX/0sHe;->LJII:LX/0sHi;
    ...
    sget-object v3, LX/0TGA;->PICTURE_HASHTAG_GLOBAL:LX/0TGA;
    ...
    invoke-virtual {v5, v4}, LX/0sHi;->setStickerEditListener(LX/0TDN;)V

    iget-object v4, v2, LX/0sHe;->LJII:LX/0sHi;
    ...
    iget-object v0, v4, LX/0sHi;->LLILLIZIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;
    ...
    iget-object v3, v4, LX/0sHi;->LLILLJJLI:LX/0mt1;
    ...
    iget-object v0, v4, LX/0sHi;->LLILLL:LX/0mt1;
    ...
    iget-wide v4, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->hashtagId:J

    iget-object v9, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->contentText:Ljava/lang/String;

    iget-boolean v8, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->editable:Z

    iget-boolean v7, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->clickable:Z

    iget-boolean v6, v0, Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;->visible:Z
    ...
    iput-object v4, v3, LX/0sHi;->LLILLIZIL:Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;

    iget-object v7, v3, LX/0sHi;->LLILLJJLI:LX/0mt1;
    ...
    invoke-direct {v5, v0, v4}, Lkotlin/jvm/internal/AwS536S0100000_26;-><init>(Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;I)V

    const/4 v6, 0x1

    invoke-virtual {v7, v5, v6}, LX/0mt1;->LIZLLL(Lkotlin/jvm/functions/Function1;Z)V

    iget-object v5, v3, LX/0sHi;->LLILLL:LX/0mt1;
    ...
    invoke-direct {v4, v0, v3}, Lkotlin/jvm/internal/AwS536S0100000_26;-><init>(Lcom/ss/android/ugc/aweme/tools/sticker/core/hashtag/global/GlobalHashTagStickerModel;I)V
