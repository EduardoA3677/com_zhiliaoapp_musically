...
.method public static constructor <clinit>()V
    ...
    invoke-static {v0}, Lcom/ss/bytenn/API;->INVOKESTATIC_com_ss_bytenn_API_com_ss_android_ugc_aweme_lancet_LoadSoLancet_loadLibrary(Ljava/lang/String;)V
...
.method public static INVOKESTATIC_com_ss_bytenn_API_com_ss_android_ugc_aweme_lancet_LoadSoLancet_loadLibrary(Ljava/lang/String;)V
    .locals 2
...
# virtual methods
.method public CreateEngine()LX/0s0j;
    .locals 5
    ...
    sget-object v0, LX/0s0j;->ERR_MEMORY_ALLOC:LX/0s0j;
...
.method public DestroyEngine()LX/0s0j;
    .locals 3

    invoke-static {}, LX/0s0j;->values()[LX/0s0j;
...
.method public GetEngineGradient(Ljava/lang/String;Lcom/ss/bytenn/Tensor;)LX/0s0j;
    .locals 3

    if-nez p2, :cond_0

    sget-object v0, LX/0s0j;->INPUT_DATA_ERROR:LX/0s0j;
...
.method public GetEngineInputConfig(Ljava/util/ArrayList;)LX/0s0j;
    .locals 6
    ...
    sget-object v0, LX/0s0j;->NULL_POINTER:LX/0s0j;
    ...
    sget-object v0, LX/0s0j;->ERR_UNEXPECTED:LX/0s0j;
...
.method public GetEngineOutputs(Ljava/util/ArrayList;)LX/0s0j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public GetEngineWeight(Ljava/lang/String;Lcom/ss/bytenn/Tensor;)LX/0s0j;
    .locals 3
...
.method public Inference()LX/0s0j;
    .locals 3
...
.method public InitEngine(Lcom/ss/bytenn/ByteNNConfig;)LX/0s0j;
    .locals 3
    ...
    sget-object v1, LX/0s0j;->NO_ERROR:LX/0s0j;
...
.method public ReInferShape(II)LX/0s0j;
    .locals 3
...
.method public ReInferShapeTensors(Ljava/util/ArrayList;)LX/0s0j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public ReleaseEngine()LX/0s0j;
    .locals 3
...
.method public SaveModel(Ljava/nio/ByteBuffer;)LX/0s0j;
    .locals 3
...
.method public SetEngineInputs(Ljava/util/ArrayList;)LX/0s0j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public SetEngineLabel(Ljava/util/ArrayList;)LX/0s0j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public SetEngineWeight(Lcom/ss/bytenn/Tensor;)LX/0s0j;
    .locals 3
...
.method public SetLossLayer(Ljava/util/ArrayList;)LX/0s0j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public SetOptimizer(LX/0AsE;FLjava/util/ArrayList;)LX/0s0j;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
